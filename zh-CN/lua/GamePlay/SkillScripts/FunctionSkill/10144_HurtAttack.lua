...
bs_10144.config = {buffId = 1121, buffTier = 1, effectId = 10250, buffId2 = 1120}
...
bs_10144.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_10144.LuaDispose = function(self)
