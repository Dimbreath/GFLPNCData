...
bs_300601.config = {buffId2 = 1033, buffId = 110, buffStun = 66, 
...
bs_300601.ctor = function(self)
  -- function num : 0_0
end

bs_300601.InitSkill = function(self, isMidwaySkill)
...
bs_300601.OnAfterBattleStart = function(self)
...
bs_300601.CallBack = function(self)
  -- function num : 0_3 , upvalues : _ENV
  LuaSkillCtrl:CallEffect(self.caster, (self.config).effectId, self, self.SkillEventFunc)
end

bs_300601.SkillEventFunc = function(self, effect, eventId, target)
...
bs_300601.OnAfterAddBuff = function(self, buff, target)
...
bs_300601.OnCasterDie = function(self)
