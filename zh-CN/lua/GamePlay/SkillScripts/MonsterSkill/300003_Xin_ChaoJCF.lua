...
, effectCFId = 123, startEffectId = 10105, endEffectId = 10106, buffId_67 = 67, buffId_1002 = 1002, buffID_1158 = 1158, maxHPId = 1003, buffTier = 1, startAnimId = 1002, loopAnimId = 1007, endAnimId = 1009, audioId1 = 48, audioId_end = 388, buffId_196 = 196, 
HealConfig = {baseheal_formula = 501}
, skill_time = 33, skill_speed = 1, start_time = 14}
bs_300003.ctor = function(self)
  -- function num : 0_0
end

bs_300003.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self:AddSetHurtTrigger("bs_300003_1", 100, self.OnSetHurt, nil, self.caster)
end

bs_300003.PlaySkill = function(self, data)
...
bs_300003.OnSetHurt = function(self, context)
  -- function num : 0_3 , upvalues : _ENV
  if context.target ~= self.caster then
    return 
  end
  if (self.caster):GetBuffTier((self.config).buffId_1002) > 0 and context.isTriggerSet ~= true and context.hurt_type ~= 2 then
...
bs_300003.OnAttackTrigger = function(self, target, data)
...
bs_300003.CallBack = function(self)
...
bs_300003.OnCasterDie = function(self)
  -- function num : 0_6 , upvalues : base
  (base.OnCasterDie)(self)
end

bs_300003.LuaDispose = function(self)
