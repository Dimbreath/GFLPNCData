...
, 
bigMonsterId = {9, 10}
, buffId = 1033, effectId = 10264, effectId1 = 10263, startAnimID = 1002, maxEnemyNum = 8, maxSummonNum = 10, buffId_196 = 196, buffId_1033 = 1033, skill_time = 18, maxHpPer = 150, powPer = 700, audioId1 = 300}
...
bs_40035.OnMoveAttackTrigger = function(self, gridData)
