...
bs_202201.config = {effectIdline = 10430, effectId1 = 10428, effectId2 = 10429, effectId3 = 102506, effectId4 = 10432, monsterId = 11, 
...
bs_202201.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_202201.OnAttackTrigger = function(self, grid)
