...
bs_70002.config = {buffId = 66, buffTier = 1, timeDuration = 15, formula1 = 10153, formula2 = 10154, formula3 = 10155, actionId = 1103, audioId1 = 391}
...
bs_70002.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
