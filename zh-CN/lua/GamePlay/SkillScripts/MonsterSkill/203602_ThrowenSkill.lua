...
, effectId_skill = 10779, effectId_bnfffire = 100307, audioId1 = 329}
...
bs_203602.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
