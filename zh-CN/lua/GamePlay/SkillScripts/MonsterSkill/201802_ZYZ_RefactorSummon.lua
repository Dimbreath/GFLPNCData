...
, 
bigMonsterId = {9, 10}
, buffId = 1033, effectId = 10264, effectId1 = 10263, startAnimID = 1002, maxEnemyNum = 8, maxSummonNum = 10, buffId_196 = 196, buffId_1033 = 1033, skill_time = 18, maxHpPer = 150, powPer = 700, audioId1 = 300, buffId = 175}
bs_201802.ctor = function(self)
  -- function num : 0_0
end

bs_201802.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_201802_1", 1, self.OnAfterBattleStart)
end

bs_201802.OnAfterBattleStart = function(self)
...
bs_201802.CallBack = function(self)
...
bs_201802.OnMoveAttackTrigger = function(self, gridData)
...
bs_201802.CallBack1 = function(self, x, y)
...
bs_201802.OnCasterDie = function(self)
