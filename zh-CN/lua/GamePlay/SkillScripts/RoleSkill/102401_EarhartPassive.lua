...
bs_102401.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
  -- function num : 0_2 , upvalues : _ENV
  if sender == self.caster and isCrit and sender:GetBuffTier((self.config).buffId_236) == 0 and skill.isCommonAttack then
