...
bs_102201.config = {buffId_224 = 224, buffId_225 = 225}
...
bs_102201.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
  ...
  if sender == self.caster and skill.isCommonAttack then
    ...
    if isCrit and (self.caster):GetBuffTier((self.config).buffId_225) > 0 then
