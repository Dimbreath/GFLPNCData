...
DynEpRoomData.GenerateBattleMap = function(self)
  -- function num : 0_3 , upvalues : _ENV, CS_BattleUtility, ExplorationEnum
...
DynEpRoomData.InitBattleData = function(self, monsterGroup)
  ...
  do
    ...
    do
      ...
      self.activeAlg = monsterGroup.activeAlg
      self.isNeedShowedAlg = self.activeAlg or 0 > 0
      -- DECOMPILER ERROR: 1 unprocessed JMP targets
    end
  end
end
...
DynEpRoomData.InitStoreRoomData = function(self, storeGroup)
  -- function num : 0_10 , upvalues : _ENV, ChipEnum, DynEpBuff, ChipData
    ...
    for idx,elem in ipairs(storeGroup.data) do
      ...
      if chipCfg == nil then
        ...
        if chipCfg.type == (ChipEnum.eChipType).Buff then
          local buffData = (DynEpBuff.New)(chipCfg.buff_id)
...
DynEpRoomData.IsBattleRoom = function(self, jumpCat)
  ...
  do return roomLogicType == (ExplorationEnum.eRoomLogicType).battle end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
...
DynEpRoomData.GetRoomTypeCfg = function(self)
...
DynEpRoomData.GetRoomLogicType = function(self)
  -- function num : 0_39
...
DynEpRoomData.GetIsInBigBossRoom = function(self)
  -- function num : 0_43
  do return self.mode == 5 end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
...
DynEpRoomData.SetEpRoomType = function(self, type)
  -- function num : 0_45
  if type > 0 then
    self.type = type
  else
...
DynEpRoomData.IsInTDBattle = function(self)
  -- function num : 0_46 , upvalues : ExplorationEnum
  do return (self.mapData).epMapLogic == (ExplorationEnum.eMapLogic).TowerDefence end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
