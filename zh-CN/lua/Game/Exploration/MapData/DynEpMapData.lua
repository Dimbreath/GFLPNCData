...
DynEpMapData.IsEpDefault = function(self)
  -- function num : 0_24 , upvalues : ExplorationEnum
  do return self.epMapLogic == (ExplorationEnum.eMapLogic).Default end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
...
DynEpMapData.IsEpLight = function(self)
  -- function num : 0_26 , upvalues : ExplorationEnum
  do return self.epMapLogic == (ExplorationEnum.eMapLogic).Light end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
