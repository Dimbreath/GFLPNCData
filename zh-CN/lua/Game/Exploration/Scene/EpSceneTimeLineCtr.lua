...
EpSceneTimeLineCtr.OnBattleEndToBattle = function(self)
...
EpSceneTimeLineCtr.IsTLPlaying = function(self, tlEventType)
  -- function num : 0_8 , upvalues : cs_PlayState_Playing
  local pbDirector = ((self.TLEventDic)[tlEventType]).playableDirector
  if pbDirector.state ~= cs_PlayState_Playing then
    do return pbDirector == nil end
    do return false end
