...
DormEditHouseData.InitEditHouse = function(self, houseData)
  ...
  self.editState = {}
  setmetatable(self.editState, {__index = function(tab, key)
    -- function num : 0_1_0
    return 0
  end
})
...
DormEditHouseData.ApplyModifyHouseData = function(self, prefabUpdate, allDormData, roomEntityDic)
...
DormEditHouseData.ApplyDecomposeHouseRoom = function(self, formHouse, param, prefabUpdate, allDormData)
  -- function num : 0_6
  if formHouse then
...
DormEditHouseData.IsEmptyOrBpRoom = function(self, spos)
  ...
  do return (self.editState)[spos] == EditHouseState.Empty or (self.editState)[spos] == EditHouseState.NewRoom end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
...
DormEditHouseData.CreateFormHouseData = function(houseData)
  -- function num : 0_11 , upvalues : DormEditHouseData
