...
UIPeriodicChallenge.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, UINPeriodicInfoItem, UINPeriodicChallenge, UINChallengeTaskInfoItem
...
UIPeriodicChallenge.IntroduceBtnFunc = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.GuidePicture, function(window)
    ...
    local eGuidePictureType = require("Game.Guide.GuidePicture.eGuidePictureType")
    window:InitGuidePicture(eGuidePictureType.WCIntro, nil)
  end
)
end
...
UIPeriodicChallenge.OnSelectSectorLevel = function(self, item)
  -- function num : 0_9 , upvalues : _ENV, SectorLevelDetailEnum, cs_MessageCommon
  UIManager:ShowWindowAsync(UIWindowTypeID.SectorLevelDetail, function(window)
    -- function num : 0_9_0 , upvalues : self, item, SectorLevelDetailEnum, _ENV, cs_MessageCommon
    window:SetLevelDetaiHideStartEvent(function()
      -- function num : 0_9_0_0 , upvalues : self, item
...
UIPeriodicChallenge.__OnClickWeeklyShop = function(self)
  -- function num : 0_11 , upvalues : JumpManager, ShopEnum
