...
UILogin.AccountSwitch = function(self)
  -- function num : 0_2 , upvalues : isUseSDK, CS_MicaSDKManager_Ins, CS_HotUpdateController
  if not isUseSDK then
    return 
  end
  CS_MicaSDKManager_Ins:AccountSwitch(function()
    -- function num : 0_2_0 , upvalues : CS_HotUpdateController, self
...
UILogin.OnClickLogin = function(self)
  -- function num : 0_3 , upvalues : CS_PlayerPrefs, PlayerPrefsConsts, CS_PlayerPrefsExtension, isUseSDK, _ENV, CS_MicaSDKManager_Ins, CS_HotUpdateController
...
UILogin._TryCustomConnect = function(self)
  -- function num : 0_5 , upvalues : CS_ClientConsts, _ENV
...
UILogin.StartConnectFromSDK = function(self)
  -- function num : 0_6 , upvalues : _ENV, CS_MicaSDKManager_Ins, isUseSDK
  ...
  CS_MicaSDKManager_Ins:GetGateInfo(function(success)
    -- function num : 0_6_0 , upvalues : _ENV, self, CS_MicaSDKManager_Ins, isUseSDK
...
UILogin.OnConnectComplete = function(self)
  -- function num : 0_8 , upvalues : CS_ClientConsts, _ENV, isUseSDK, CS_MicaSDKManager_Ins
...
UILogin.GetGameResUrls = function(self)
  -- function num : 0_9 , upvalues : CS_MicaSDKManager_Ins, _ENV
...
UILogin.OnClickCADPAWarring = function(self)
  -- function num : 0_16 , upvalues : _ENV
  UIManager:ShowWindowAsync(UIWindowTypeID.CADPAWarring)
end

UILogin.SwitchSpringBG = function(self, active)
  -- function num : 0_17
...
UILogin.OnDelete = function(self)
  -- function num : 0_18 , upvalues : _ENV, CS_NetworkManager, CS_Resources, base
