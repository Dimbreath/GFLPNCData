...
UINShopNormalGiftList.InitGiftList = function(self, shopCfg, pageId, purchaseRoot, autoSelectId)
...
UINShopNormalGiftList.InitDataListView = function(self)
  ...
  if #self.dataList > 0 then
    ...
    if shopWin ~= nil then
      shopWin:CreateShelfTog(self.shopCfg, nil)
      shopWin:SelectPageAuto()
    end
  end
end
