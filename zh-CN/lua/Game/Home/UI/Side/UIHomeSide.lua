...
UIHomeSide.OpenSide = function(self)
  ...
  if isUnlock then
    (((self.ui).btn_GameNotice).gameObject):SetActive(not (CS.ClientConsts).IsAudit)
...
UIHomeSide.OnClickGameNotice = function(self)
...
UIHomeSide.RefreshBuildingList = function(self, constructingBuildingLists)
  -- function num : 0_11 , upvalues : BuildingBelong, _ENV
