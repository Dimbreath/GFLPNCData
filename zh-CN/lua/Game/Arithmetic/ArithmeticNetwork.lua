...
ArithmeticNetwork.CS_ATH_OneKeyInstall = function(self, heroId, slots, callBack)
...
ArithmeticNetwork.CS_ATH_OneKeyUninstall = function(self, heroId, slotIds, callBack)
