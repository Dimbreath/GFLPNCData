...
UINAthScrollList.SetAthScrollListSuitId = function(self, suitId, curCount, suitPartId)
  -- function num : 0_5 , upvalues : UINAthListSuitItem, _ENV
  ...
  if self.withSuit then
    (self.athSuitItem):InitAthListSuitItem(suitId, nil, self.resLoader, curCount)
  end
...
UINAthScrollList.RefreshAthScrollListData = function(self)
  ...
  if self.suitId ~= nil then
    self.oriAthDataList = (PlayerDataCenter.allAthData):GetSuitAthList(self.suitId, self.suitPartId)
  else
...
UINAthScrollList.__Insert2TempGroup = function(self, tempGroupIdList, tempGroup, athData)
  -- function num : 0_11 , upvalues : sizeGroupPosIdList, _ENV, AthTableUtil
...
UINAthScrollList.__OnDragStartHorizontal = function(self)
  -- function num : 0_14 , upvalues : CS_EventSystem
...
UINAthScrollList.__OnNewItem = function(self, go)
  -- function num : 0_15 , upvalues : UINAthListGroup
...
UINAthScrollList.__OnChangeItem = function(self, go, index)
  -- function num : 0_16 , upvalues : _ENV, spaceIdDic
  ...
  if self.withSuit and index == 0 then
...
UINAthScrollList._ReturnAthItem = function(self, athItem)
  -- function num : 0_18 , upvalues : spaceIdDic
...
UINAthScrollList._ReturnAthSuit = function(self)
  -- function num : 0_20
...
UINAthScrollList.GetSpaceAthByList = function(self, size)
...
UINAthScrollList.OnAthItemClick = function(self, athItem)
  ...
  local clickItemFunc = function()
    -- function num : 0_23_0 , upvalues : self, athItem
