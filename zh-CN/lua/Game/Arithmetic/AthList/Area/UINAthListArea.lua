...
UINAthListArea.ShowAthListAreaSuitPartTog = function(self, show, suitId, curCount)
...
UINAthListArea._OnSuitPartSelect = function(self, suitPartId)
  ...
  ;
  (self.athScrollList):SetAthScrollListSuitId(self.suitId, self.suitCurCount, suitPartId)
  ;
