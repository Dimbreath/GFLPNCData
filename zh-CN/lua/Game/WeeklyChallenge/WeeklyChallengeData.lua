...
WeeklyChallengeData.UpdateByMsg = function(self, id, weeklyChallengeElem)
  ...
  self.id = id
  self.buffDic = {}
  for k,v in pairs((weeklyChallengeElem.cfg).initBuffId) do
    -- DECOMPILER ERROR at PC9: Confused about usage of register: R8 in 'UnsetPending'

    (self.buffDic)[k] = v
  end
  for k,v in pairs((weeklyChallengeElem.cfg).assistBuffId) do
    -- DECOMPILER ERROR at PC18: Confused about usage of register: R8 in 'UnsetPending'

    (self.buffDic)[k] = v
  end
  self.assistBuffId = (weeklyChallengeElem.cfg).assistBuffId
