...
SpecificHeroDataRuler.eSpecificHeroRuler = {customLevel = 1, customStar = 2, customPotential = 3, isSkillFullLevel = 4, isRemoveAllBounce = 5, customSkillLevelRange = 6, customSkillLevel = 7}
...
SpecificHeroDataRuler.ctorWithWeeklyChallengeCfg = function(cfg, weeklyData)
  ...
  ;
  (data.ruler)[(SpecificHeroDataRuler.eSpecificHeroRuler).customSkillLevelRange] = {cfg.hero_skill_level_min, cfg.hero_skill_level_max}
