...
UIGuide.PlayGuide = function(self, rectTransform, camera, custom_size)
  -- function num : 0_2
...
UIGuide.PlayGuideCollider = function(self, boxCollider, camera, custom_size)
  -- function num : 0_3
  if custom_size ~= nil and #custom_size == 2 then
  ...
  do
    ...
    if not (string.IsNullOrEmpty)(info_pos) then
      ...
      do
        ...
        if (UIManager.BackgroundStretchSize).x / 2 < (math.abs)(posX) then
          arrowOffset.x = 0
        ...
        do
          ...
          -- DECOMPILER ERROR at PC186: Confused about usage of register: R11 in 'UnsetPending'
...
UIGuide.StartLimitGuideOpArea = function(self, rectTransform)
  -- function num : 0_23
...
UIGuide.EndLimitGuideOpArea = function(self)
  -- function num : 0_24
