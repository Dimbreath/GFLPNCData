...
GuideUtil.ShowTipsGuide = function(curTargetTransform, guidePrefab, show_dir, cfg)
  -- function num : 0_1 , upvalues : GuideUtil, UINTipsGuide, eshowType
  ...
  do return tipsGuideNode end
  -- DECOMPILER ERROR: 3 unprocessed JMP targets
end

GuideUtil.ShowTipsGuideToggle = function(curTargetTransform, guidePrefab, show_dir, cfg)
...
GuideUtil.TipsGuideSectorLevelItem = function(id, isAvg, show_dir, cfg)
...
GuideUtil.GetBestBenchRoleY = function()
...
GuideUtil.UnlockOasisMask = function()
  -- function num : 0_15 , upvalues : _ENV, GuideUtil
  ...
  codeActionBinding:RegisterAction("PlayAvgAndPause", function()
    -- function num : 0_15_0 , upvalues : _ENV, GuideUtil, codeActionBinding, homeToSectorGo, pd_unlockOasis, bind
    ...
    avgCtrl:ShowAvg(avgName, function()
      -- function num : 0_15_0_0 , upvalues : _ENV, homeToSectorGo, pd_unlockOasis, GuideUtil, bind
      local continueFunc = function()
        -- function num : 0_15_0_0_0 , upvalues : _ENV, homeToSectorGo, pd_unlockOasis, GuideUtil, bind
        ...
        (TimelineUtil.Play)(pd_unlockOasis, function()
          -- function num : 0_15_0_0_0_0 , upvalues : GuideUtil, _ENV, bind
...
, true)
      ...
      if FunctionUnlockMgr:ValidateUnlock(proto_csmsg_SystemFunctionID.SystemFunctionID_ChangeName) and (ConfigData.game_config).changeNameItemNum <= PlayerDataCenter:GetItemCount((ConfigData.game_config).changeNameItemId) and PlayerDataCenter.renameCount == 0 then
        UIManager:ShowWindowAsync(UIWindowTypeID.UserNameCreate, function(window)
        -- function num : 0_15_0_0_1 , upvalues : continueFunc
...
GuideUtil.GetMailListItem = function(mailEntry)
  ...
  if mailWin ~= nil then
    ...
    -- function num : 0_18_0 , upvalues : mailWin, mailIndex
...
GuideUtil.StartFormationGuide = function(heroId, posId)
  -- function num : 0_23 , upvalues : cs_coroutine, _ENV, cs_WaitForSeconds, GuideUtil
  (cs_coroutine.start)(function()
    -- function num : 0_23_0 , upvalues : _ENV, cs_WaitForSeconds, heroId, GuideUtil, posId
...
GuideUtil.StartManualSkillSelectHero = function(heroId)
  -- function num : 0_26 , upvalues : _ENV, GuideUtil
  local battleMgr = (CS.BattleManager).Instance
  if not battleMgr.IsInBattle then
    (GuideManager:GetCurGuideCtrl()):OnCurStepFinish()
    return 
...
GuideUtil.StartManualSkillSelectCoord = function(x, y)
  -- function num : 0_27 , upvalues : _ENV, GuideUtil
  local battleMgr = (CS.BattleManager).Instance
  if not battleMgr.IsInBattle then
    (GuideManager:GetCurGuideCtrl()):OnCurStepFinish()
    return 
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.Guide, function(window)
    -- function num : 0_27_0 , upvalues : battleCtrl, x, y, _ENV
    if window == nil then
      return window
    end
...
GuideUtil.__OnManualSkillGuideEnd = function(battleCtrl)
...
GuideUtil.RestartEpBattle = function()
...
GuideUtil.GetLotteryFragChangeUI = function()
...
GuideUtil.SetTimeScale = function(timeScale)
...
GuideUtil.ClearData = function(self)
  -- function num : 0_32 , upvalues : GuideUtil
  GuideUtil.__tlUnlockOasis = nil
end
