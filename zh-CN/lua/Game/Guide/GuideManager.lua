...
GuideManager.SetGMSkipGuide = function(self, skipGuide)
  -- function num : 0_2
  self.__skipGuide = skipGuide
end

GuideManager.InitCompleteTriggerGuide = function(self, completeDic)
  -- function num : 0_3 , upvalues : _ENV, GuideConditionChecker
...
GuideManager.__InitTriggerEvent = function(self)
  -- function num : 0_4 , upvalues : _ENV, GuideEnum
  self.__onSectorStageStateChange = function(data)
    -- function num : 0_4_0 , upvalues : _ENV, self, GuideEnum
  ...
  self.__onUnlockFunc = function(fid)
    -- function num : 0_4_1 , upvalues : self, GuideEnum
...
GuideManager.HandleTriggerGuide = function(self, conditionType, conditionArg)
  -- function num : 0_6 , upvalues : _ENV, GuideConditionChecker
...
GuideManager.IsTipsGuideConditionType = function(self, condition_Type)
  -- function num : 0_7
  do return condition_Type > 100 end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

GuideManager.TryTriggerGuide = function(self, condition_Type, taskList, lastGuideId)
  -- function num : 0_8 , upvalues : GuideManager, _ENV, GuideEnum, GuideConditionChecker
    ...
    if lastGuideId == nil or not (table.contain)((taskData.stcData).guide_id, lastGuideId) or saveUserData:ContainSkipGuideTask(taskData.id) then
      for _,guideId in pairs((taskData.stcData).guide_id) do
        if not guideDic[guideId] then
          ...
          if guideCfg.guide_type == (GuideEnum.GuideType).TipsGuide and (condition_Type == nil or GuideManager:IsTipsGuideConditionType(condition_Type)) then
        ...
        do
          do
            local cfgCondition, cfgConditionArg = guideCfg:GetFirstCondition()
            if (condition_Type == nil or cfgCondition == condition_Type) and (GuideConditionChecker.CheckGuideCondition)(cfgCondition, cfgConditionArg) and (GuideConditionChecker.CheckTriggerGuideCondition)(guideCfg.guide_condition, guideCfg.guide_arg) then
  ...
  (table.sort)(guideList, function(x1, x2)
    -- function num : 0_8_0 , upvalues : guideDic
...
GuideManager.TryStartTriggerTypeGuide = function(self, condition_Type)
  -- function num : 0_9 , upvalues : _ENV, GuideConditionChecker
  if self.__allTriggerGuideComplete then
    return 
  end
  ...
  ;
  (table.sort)(guideList, function(x1, x2)
    -- function num : 0_9_0 , upvalues : guideDic
    do return guideDic[x2] < guideDic[x1] end
    -- DECOMPILER ERROR: 1 unprocessed JMP targets
  end
)
...
GuideManager.StartNewTipsGuide = function(self, id, condition_Type)
  -- function num : 0_12 , upvalues : _ENV, GuideConditionChecker, GuideType_Tips
...
GuideManager.OnGuideTaskDelete = function(self, taskList)
  -- function num : 0_19 , upvalues : GuideManager, _ENV, GuideEnum, GuideType_Tips
  if GuideManager.inGuide then
    local isInGuideFirstStep = (GuideManager:GetCurGuideCtrl()):IsFirstIndexAndNoLast()
  end
  for _,taskData in pairs(taskList) do
    for _,guideId in pairs((taskData.stcData).guide_id) do
