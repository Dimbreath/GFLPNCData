...
UINAchievementLevelNode.OnInit = function(self)
  ...
  self.needRefresh = {need = false, isOpen = false, playTween = false}
  ;
  ...
  MsgCenter:AddListener(eMsgEventId.RewardExit, self.__NeedRefreshPlayerLevel)
...
UINAchievementLevelNode.CanRefreshPlayerLevel = function(self, isOpen, playTween)
  -- function num : 0_4
...
UINAchievementLevelNode.NeedRefreshPlayerLevel = function(self)
  -- function num : 0_5
...
UINAchievementLevelNode.m_RefreshNextLevelInfo = function(self, curLevel, isMax)
  -- function num : 0_7 , upvalues : _ENV, CommonLogicUtil
  if isMax then
...
UINAchievementLevelNode.RefreshLevelList = function(self, maxLevel, curLevel, isOpen)
  -- function num : 0_9 , upvalues : _ENV, eLevelState
  self.levelDataList = {}
  for i = 2, maxLevel do
...
UINAchievementLevelNode.ChangeBtnReceiveAll = function(self)
  -- function num : 0_10 , upvalues : _ENV, eLevelState
  self.levels = {}
...
UINAchievementLevelNode.OnClickReceiveAll = function(self)
  -- function num : 0_11 , upvalues : _ENV
  (self.achivLevelNetworkCtrl):SendACHIEVEMENT_OneKeyPick(self.levels, BindCallback(self, self.ChangeBtnReceiveAll))
end

UINAchievementLevelNode.RefreshTotalLogic = function(self)
  -- function num : 0_12 , upvalues : _ENV, CommonLogicUtil
  local des = ""
...
UINAchievementLevelNode.m_OnNewItem = function(self, go)
  -- function num : 0_13 , upvalues : UINAchievementLevelItem, eLevelState
...
UINAchievementLevelNode.GetLevelRewardComplete = function(self, rewards)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.CommonReward, function(window)
    -- function num : 0_16_0 , upvalues : rewardIds, rewardNums, self
    if window == nil then
      return 
    end
...
UINAchievementLevelNode.OnDelete = function(self)
  ...
  MsgCenter:RemoveListener(eMsgEventId.RewardExit, self.__NeedRefreshPlayerLevel)
  ;
  (base.OnDelete)(self)
end
