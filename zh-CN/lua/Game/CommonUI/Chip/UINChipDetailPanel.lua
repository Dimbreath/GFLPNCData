...
UINChipDetailPanel.__InitChipHeadInfo = function(self, chipData, dynPlayer, isOwnData)
  ...
  ;
  ((self.ui).img_Mark).sprite = CRH:GetSprite(chipData:GetChipMarkIcon(), CommonAtlasType.ExplorationIcon)
                  ...
                  if dynPlayer ~= nil then
                    ...
                    if not isOwnData then
                      ...
                      if returnMoney > 0 and (self.ui).obj_ReCC ~= nil then
                        ...
                        -- DECOMPILER ERROR at PC402: Confused about usage of register: R13 in 'UnsetPending'
...
UINChipDetailPanel.GetInPlayFightPower = function(self, dynPlayer, isSubtract)
  -- function num : 0_5
  if isSubtract then
    return dynPlayer:GetChipDiscardFightPower(self.__chipData, true)
  else
    return dynPlayer:GetChipCombatEffect(self.__chipData, self.__isOwnData, true)
  end
end
