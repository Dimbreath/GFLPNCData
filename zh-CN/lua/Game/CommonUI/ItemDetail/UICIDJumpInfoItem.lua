...
UICIDJumpInfoItem.InitUseGift = function(self, selectItemId, giftList)
  ...
  item:InitUseGift()
  item:SetJumpCallback(function()
    -- function num : 0_4_0 , upvalues : _ENV, giftList, selectItemId
    for i,itemId in ipairs(giftList) do
      ...
      -- function num : 0_4_0_0 , upvalues : _ENV, itemCfg, selectItemId
      if window == nil then
        return 
      end
