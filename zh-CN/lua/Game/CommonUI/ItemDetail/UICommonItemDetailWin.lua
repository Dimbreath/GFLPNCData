...
UICommonItemDetailWin.OnClickUse = function(self)
  ...
  if ConfigData:IsManualOpenGiftItem(itemCfg) then
    ...
    if itemCfg.id == (ConfigData.game_config).changeNameItemId then
...
UICommonItemDetailWin.UseGift = function(self, itemCfg)
  ...
  if itemCfg.action_type == proto_csmsg_ItemActionType.ItemActionTypeFixedItem and count == 1 then
    ...
    -- function num : 0_23_0 , upvalues : _ENV, itemCfg, heroIdSnapShoot
    local rewardIds = {}
    local rewardCounts = {}
    ...
    UIManager:ShowWindowAsync(UIWindowTypeID.CommonReward, function(window)
      -- function num : 0_23_0_0 , upvalues : rewardIds, rewardCounts, heroIdSnapShoot
      if window == nil then
        return 
      end
    ...
    -- function num : 0_23_1 , upvalues : itemCfg
    if win == nil then
      return 
    end
