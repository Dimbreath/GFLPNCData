...
UINDungeonHeroList.InitHeroList = function(self, heroList, resloader, selectHeroCallback, buffList)
...
UINDungeonHeroList.DelayRefreshHeroHp = function(self, fromWhere)
...
UINDungeonHeroList.SetIsHideHeroList = function(self, bool)
  -- function num : 0_8
...
UINDungeonHeroList.SelectHeroWithChipId = function(self, chipId, chipColor)
