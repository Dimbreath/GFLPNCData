...
UINOasisResOutput.InitOasisResOutput = function(self, oasisCtrl)
  -- function num : 0_1
...
UINOasisResOutput.OasisResOutputLateUpdate = function(self)
...
UINOasisResOutput.UpdateOasisResPos = function(self, id)
