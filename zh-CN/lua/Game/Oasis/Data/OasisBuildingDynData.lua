...
OasisBuildingDynData.GetPreBuildingId = function(self, targetLvl)
  -- function num : 0_7 , upvalues : CheckerTypeId, _ENV
  local preBuildIds = {}
  local tarLvlCfg = (self.levelConfig)[targetLvl]
  for i = 1, #tarLvlCfg.pre_condition do
...
OasisBuildingDynData.GetPreBuildUnlockLevel = function(self, targetLvl)
  -- function num : 0_8 , upvalues : CheckerTypeId
  local preBuildDic = {}
  local tarLvlCfg = (self.levelConfig)[targetLvl]
  for i = 1, #tarLvlCfg.pre_condition do
    if (tarLvlCfg.pre_condition)[i] == CheckerTypeId.BuildingLevel then
...
OasisBuildingDynData.GetBuffItems = function(self, level, getNext, includeZero)
  ...
  local ignoreZeroFcuc = function(index, paraId)
    -- function num : 0_10_0 , upvalues : _ENV, includeZero, levelCfg, nextlvlCfg
                                                                ...
                                                                if logic == eLogicType.CampBuff and not ignoreZeroFcuc(i, 3) then
                                                                  ...
                                                                  do
                                                                    ...
                                                                    if logic == eLogicType.DynPlayerAttrBuff and not ignoreZeroFcuc(i, 2) then
                                                                      local ratioDesSubId = {[16] = true, [14] = true, [15] = true, [19] = true}
                                                                      local timeDesSubId = {[11] = true}
                                                                      local dynAttrId = (levelCfg.para1)[i]
                                                                      local value = (levelCfg.para2)[i]
                                                                      if ratioDesSubId[dynAttrId] then
                                                                        value = FormatNum(value / 10)
                                                                      elseif timeDesSubId[dynAttrId] then
                                                                                    ...
                                                                                    if logic == eLogicType.ResOutputCeiling and not ignoreZeroFcuc(i, 2) then
                                                                                      ...
                                                                                      do
                                                                                        do
                                                                                          ...
                                                                                          -- DECOMPILER ERROR at PC1490: LeaveBlock: unexpected jumping out DO_STMT

                                                                                          -- DECOMPILER ERROR at PC1490: LeaveBlock: unexpected jumping out IF_THEN_STMT

                                                                                          -- DECOMPILER ERROR at PC1490: LeaveBlock: unexpected jumping out IF_STMT
                                                                                          ...
                                                                                          -- DECOMPILER ERROR at PC1490: LeaveBlock: unexpected jumping out IF_ELSE_STMT
