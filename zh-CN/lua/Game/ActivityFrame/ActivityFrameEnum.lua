...
ActivityFrameEnum.eActivityType = {BattlePass = 1, StarUp = 2, SevenDayLogin = 4, Lotter = 5, Tickets = 6, DungeonDouble = 7, dailySignIn = "dailySignIn"}
...
ActivityFrameEnum.eActivityUIType = {StarUp = 1, BattlePass = 2, EventGrowBag = 3, SevenDayLogin = 4, Tickets = 5, FestivalSign = 100, dailySignIn = "dailySignIn"}
