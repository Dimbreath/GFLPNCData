...
BattleDungeonSceneCtrl.GetDungeonCrazyTime = function(self)
  -- function num : 0_5
...
BattleDungeonSceneCtrl.SetEpMapCameraCullMask = function(self, LayerMaskEnum)
...
BattleDungeonSceneCtrl.OnDelete = function(self)
  -- function num : 0_8 , upvalues : DungeonConst, base
