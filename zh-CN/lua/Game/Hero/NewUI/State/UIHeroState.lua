...
UIHeroState.OnInit = function(self)
  -- function num : 0_2 , upvalues : _ENV, UINHeroTag, UINHeroScoreItem, UINHeroStateSkillItem, UINAthHeroInfo, JumpManager, CS_EventTriggerListener
...
UIHeroState.LoadSkin = function(self)
  -- function num : 0_9 , upvalues : cs_ResLoader, _ENV, HeroCubismInteration, HeroLookTargetController
  ...
  if ((CS.ResManager).Instance):ContainsAsset(resPath) and showLive2d and not isLocked then
    ...
    -- function num : 0_9_0 , upvalues : self, _ENV, HeroCubismInteration, HeroLookTargetController
...
UIHeroState._OpenUseExpPacket = function(self)
  ...
  local selectItemId = nil
  local list = {}
  if not ((ConfigData.item).fixedPacketMappingDic)[ConstGlobalItem.HeroExp] then
    (table.insertto)(list, table.emptytable)
    if not ((ConfigData.item).selectPacketMappingDic)[ConstGlobalItem.HeroExp] then
      (table.insertto)(list, table.emptytable)
      if #list > 0 then
...
UIHeroState.__OpenSkinWin = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.HeroSkin, function(window)
    ...
    local parWin = UIManager:GetWindow(UIWindowTypeID.HeroState)
    window:InitSkin((self.heroData).dataId, (self.heroData).skinId, self.__SwitchHeroState, self.heroDataList, function()
...
UIHeroState.Return = function(self)
  -- function num : 0_64 , upvalues : JumpManager
...
UIHeroState.OnDelete = function(self)
  -- function num : 0_67 , upvalues : _ENV, CS_coroutine, base
  (UIUtil.AddOneCover)(UIWindowTypeID.HeroState)
  self:RemoveAllTouch()
  if self.chageCoroutine ~= nil then
    (CS_coroutine.stop)(self.chageCoroutine)
    self.chageCoroutine = nil
...
UIHeroState.OnDeleteEntity = function(self)
  -- function num : 0_68 , upvalues : _ENV, base
  (UIUtil.CloseOneCover)(UIWindowTypeID.HeroState)
  ;
