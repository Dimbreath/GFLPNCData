...
local __rt_5 = {1001}
local system_jump = {
{jump_arg = __rt_1, sys_open_id = 610}
, 
{id = 2, jump_arg = __rt_2, sys_open_id = 610}
, 
{id = 3, 
jump_arg = {204}
, sys_open_id = 610}
...
, sys_open_id = 1501}
, 
{id = 13, jump_arg = __rt_4, sys_open_id = 1500}
, 
{id = 14, 
jump_arg = {2}
, sys_open_id = 1500}
...
, 
{content = 401249, id = 24, jump_arg = __rt_1, sys_open_id = 100, title = 95518}
, 
{id = 25}
, 
{id = 26}
...
, sys_open_id = 407}
, 
[102] = {content = "%s", id = 102, jump_arg = __rt_5, sys_open_id = 1400, title = 18753}
, 
...
, 
[105] = {content = 401249, id = 105, jump_arg = __rt_2, sys_open_id = 610, title = 95518}
, 
...
local __default_values = {content = "", id = 1, jump_arg = __rt_3, sys_open_id = 0, title = ""}
