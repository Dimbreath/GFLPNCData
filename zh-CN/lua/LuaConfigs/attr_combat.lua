local attr_combat = {
[101] = {formula = "(tab[2]*1+tab[3]*25+tab[4]*11+tab[5]*33+tab[6]*0+tab[7]*35+tab[9]*17+tab[10]*8+tab[11]*0+tab[12]*11+tab[13]*0+tab[14]*27+tab[15]*1+tab[16]*0+tab[26]*25+tab[17]*11+tab[18]*11+tab[19]*40+tab[20]*40+tab[21]*27+tab[22]*27+tab[23]*22+tab[24]*27+tab[25]*49+tab[27]*11+tab[28]*11-3000)*5//100*(95+tab[16]*5)//100-430", id = 101}
, 
