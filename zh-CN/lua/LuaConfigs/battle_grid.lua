...
creations = {3}
, grid_skill = "gs_3", icon = "ICON_Grid003", id = 3, info = 495727, name = 105182, necessary = "tab[1]/tab[2]>0.4"}
, 
{attr_formula = "tab[3]", 
auto_career = {[2] = 2, [4] = 1}
, 
creations = {4}
, grid_skill = "gs_4", icon = "ICON_Grid004", id = 4, info = 508990, name = 50384}
, 
...
, 
creations = {8}
, grid_skill = "gs_8", icon = "ICON_Grid008", id = 8, info = 135143, name = 401630}
, 
...
creations = {10}
, grid_skill = "gs_10", icon = "ICON_Grid010", id = 10, info = 8160, name = 430291}
, 
{attr_formula = "tab[26]", auto_career = __rt_6, 
creations = {11}
, grid_skill = "gs_11", icon = "ICON_Grid011", id = 11, info = 129305, name = 26593}
, 
{attr_formula = "tab[26]", auto_career = __rt_6, 
creations = {12}
...
, 
creations = {14}
, grid_skill = "gs_14", icon = "ICON_Grid014", id = 14, info = 350486, name = 161689, necessary = "tab[1]/tab[2]>0.5"}
, 
{
auto_career = {}
, auto_order = false, 
...
{auto_career = __rt_7, 
creations = {21}
, grid_skill = "gs_21", icon = "ICON_Grid021", id = 21, info = 453826, name = 390409, necessary = "0"}
, 
{auto_career = __rt_7, 
creations = {22}
, grid_skill = "gs_22", icon = "ICON_Grid022", id = 22, info = 439817, necessary = "0", type = 2}
, 
{auto_career = __rt_7, 
creations = {23}
...
creations = {106}
, grid_skill = "gs_106", icon = "ICON_Grid106", id = 106, info = 500685, name = 325777}
, 
[107] = {attr_formula = "tab[4]", auto_career = __rt_4, 
creations = {107}
, grid_skill = "gs_107", icon = "ICON_Grid107", id = 107, info = 343608, name = 244480}
, 
