...
removebyvalue = function(array, value, removeall)
...
local removeall = function(array)
  -- function num : 0_10
  for i = #array, 1, -1 do
    array[i] = nil
  end
...
local walksort = function(tb, sort_func, walk_func)
  ...
  (table.sort)(keys, function(lkey, rkey)
    -- function num : 0_13_0 , upvalues : sort_func
...
local circulator = function(array)
  ...
  local i = 1
  local iter = function()
    -- function num : 0_16_0 , upvalues : i, array
...
local dump = function(tb, dump_metatable, max_level)
  ...
  local _dump = function(tb, level)
    -- function num : 0_17_0 , upvalues : rep, _ENV, lookup_table, max_level, _dump, dump_metatable
    local str = "\n" .. rep("\t", level) .. "{\n"
    for k,v in pairs(tb) do
...
local deepCopy = function(object)
  ...
  local _copy = function(object)
    -- function num : 0_19_0 , upvalues : _ENV, lookup_table, _copy
...
local GetDefaulValueTable = function(defaultValue)
  ...
  return setmetatable({}, {__index = function(tab, key)
    -- function num : 0_20_0 , upvalues : defaultValue
    return defaultValue
  end
})
end

-- DECOMPILER ERROR at PC23: Confused about usage of register: R20 in 'UnsetPending'

table.count = count
-- DECOMPILER ERROR at PC25: Confused about usage of register: R20 in 'UnsetPending'

table.length = length
-- DECOMPILER ERROR at PC27: Confused about usage of register: R20 in 'UnsetPending'

table.setlen = setlen
-- DECOMPILER ERROR at PC29: Confused about usage of register: R20 in 'UnsetPending'

table.keys = keys
-- DECOMPILER ERROR at PC31: Confused about usage of register: R20 in 'UnsetPending'

table.values = values
-- DECOMPILER ERROR at PC33: Confused about usage of register: R20 in 'UnsetPending'

table.merge = merge
-- DECOMPILER ERROR at PC35: Confused about usage of register: R20 in 'UnsetPending'

table.insertto = insertto
-- DECOMPILER ERROR at PC37: Confused about usage of register: R20 in 'UnsetPending'

table.indexof = indexof
-- DECOMPILER ERROR at PC39: Confused about usage of register: R20 in 'UnsetPending'

table.keyof = keyof
-- DECOMPILER ERROR at PC41: Confused about usage of register: R20 in 'UnsetPending'

table.map = map
-- DECOMPILER ERROR at PC43: Confused about usage of register: R20 in 'UnsetPending'
...
table.filter = filter
-- DECOMPILER ERROR at PC49: Confused about usage of register: R20 in 'UnsetPending'
...
-- DECOMPILER ERROR at PC68: Confused about usage of register: R20 in 'UnsetPending'

table.emptytable = setmetatable({}, {__newindex = function(table, key, value)
