...
, 
audio = {
bgm = {cue = "Mus_Story_Relax", sheet = "Mus_Story_Relax", fadeIn = 2, fadeOut = 3}
}
}
, 
...
, 
{imgId = 117, delay = 0, duration = 0.6, posId = 3, alpha = 1, isDark = false}
}
}
, 
...
, 
{imgId = 117, delay = 1.5, duration = 0.6, posId = 2, alpha = 1, isDark = true, 
rot = {0, 0, 0}
}
, 
{imgId = 103, delay = 0, duration = 0, posId = 5, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 1.5, duration = 0.6, posId = 4, alpha = 1, isDark = false}
}
, 
heroFace = {
{imgId = 103, faceId = 0}
...
imgTween = {
{imgId = 33, delay = 0, duration = 1, posId = 2, alpha = 0, isDark = false}
, 
{imgId = 34, delay = 0, duration = 1, posId = 4, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 1, duration = 0.3, posId = 3, alpha = 1, isDark = false}
}
, 
heroFace = {
{imgId = 103, faceId = 3}
...
imgTween = {
{imgId = 33, delay = 0, duration = 0.6, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 34, delay = 0, duration = 0, posId = 4, alpha = 0, isDark = false}
, 
{imgId = 34, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
imgTween = {
{imgId = 34, delay = 0, duration = 0.6, posId = 2, alpha = 1, isDark = false}
, 
