...
[1] = {content = 10, contentType = 4, speakerName = 11, scrambleTypeWriter = true, 
images = {
...
, 
[2] = {content = 20, contentType = 4, speakerName = 11, scrambleTypeWriter = true}
, 
...
, 
[8] = {content = 80, contentType = 4, speakerName = 81, 
imgTween = {
...
, 
{imgId = 101, delay = 0, duration = 0.3, posId = 3, alpha = 1, isDark = false}
}
}
, 
[9] = {content = 90, contentType = 4, speakerName = 81, 
heroFace = {
{imgId = 101, faceId = 2}
}
}
, 
[10] = {content = 100, contentType = 4, speakerName = 81, 
heroFace = {
{imgId = 101, faceId = 0}
}
}
...
, 
[12] = {content = 120, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, nextId = 14, 
heroFace = {
{imgId = 101, faceId = 0}
}
}
