...
[1] = {content = 10, contentType = 3, speakerHeroId = 1009, speakerHeroPosId = 2, 
images = {
{imgId = 1, imgType = 3, alpha = 0, imgPath = "mai_avg"}
}
, 
imgTween = {
...
, 
[2] = {content = 20, contentType = 3, speakerHeroId = 1009, speakerHeroPosId = 2}
}
