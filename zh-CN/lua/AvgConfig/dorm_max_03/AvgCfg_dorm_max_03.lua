...
[1] = {content = 10, contentType = 3, speakerHeroId = 1012, speakerHeroPosId = 2, 
images = {
{imgId = 1, imgType = 3, alpha = 0, imgPath = "max_avg"}
}
, 
imgTween = {
...
, 
[3] = {content = 30, contentType = 3, speakerHeroId = 1012, speakerHeroPosId = 2}
}
