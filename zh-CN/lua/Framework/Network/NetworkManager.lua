...
NetworkManager.GetConsumeShowCache = function(self)
  -- function num : 0_5
  return (self.networkDiffDeliver):GetConsumeCache()
end
...
NetworkManager.SendMsg = function(self, cmdId, msgContent)
  -- function num : 0_8 , upvalues : cs_NetMsgData, cs_NetworkManager
...
NetworkManager.Delete = function(self)
  -- function num : 0_12 , upvalues : _ENV, cs_NetworkManager
  for k,v in pairs(self.__network_ctrls) do
    v:OnDelete()
  end
