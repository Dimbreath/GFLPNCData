...
bs_1.SkillEventFunc = function(self, configData, effect, eventId, target)
  ...
  if eventId == eBattleEffectEvent.Trigger then
    if configData.audioId5 ~= nil then
      LuaSkillCtrl:PlayAuSource(self, configData.audioId5)
    end
