...
, delay = 1, id = 1600, info = 484598, target_name = "Formation(Clone)/Scene/BasePlatform4", target_parent = "002_Sector_001", target_type = 2}
, 
...
, 
[2707] = {delay = 1, id = 2707, info = 515467, step_type = 5, target_name = "SkillNode/PresentNode/PresentScroll/Rect", target_parent = 70}
, 
...
local guide_step = {
    ...
    [501] = {
        ...
        info_type = 0,
        op_refresh = true,
        target_name = "Main/Right/PageList/Rect/CenterPage/Btn_Exproation/Btn_ContinueEp",
        target_parent = 1
    },
    [600] = {
        condition = 1,
    ...
    [700] = {
        ...
        info = 457529,
        op_refresh = true,
        target_name = "Main/Right/PageList/Rect/CenterPage/Btn_Exproation",
        target_parent = 1
    },
    [701] = {
    ...
    [1305] = {
        id = 1305,
        info = 259793,
        target_name = "UINode/BuildingSidebar/BuildingList/Rect/1_2/1004",
        target_parent = 3
    },
    [1306] = {
        id = 1306,
    ...
    [1502] = {
        id = 1502,
        info = 279749,
        target_name = "Center/Btn_LevelUp",
        target_parent = 301
    },
    [1503] = {
        delay = 1,
    ...
    [2501] = {
        ...
        id = 2501,
        info = 200817,
        target_name = "Buttom/Btn_CommanderSkill",
        target_parent = 80
    },
    [2502] = {
        id = 2502,
    ...
    [2605] = {
        ...
        id = 2605,
        info = 260002,
        target_name = "ATHListNode/ScrollListAll/Content/0/1",
        target_parent = 1000
    },
    [2606] = {
        delay = 0.3,
    ...
    [2609] = {
        ...
        id = 2609,
        info = 270437,
        target_name = "AlgorithmDetail/Efficiency/Btn_Efficiency/Btn_EfficiencyAdd",
        target_parent = 1000
    },
    [2610] = {
        delay = 0.4,
    ...
    [2707] = {
        ...
        info = 515467,
        step_type = 5,
        target_name = "SkillNode/PresentNode/PresentScroll/Rect",
        target_parent = 70
    },
    [2708] = {
        delay = 0.3,
    ...
    [3301] = {
        ...
        info = 73043,
        step_type = 5,
        target_name = "StrengthPage/Page/RefactorPage/RefactorNode",
        target_parent = 1005
    },
    [3302] = {
        delay = 0.3,
        ...
        info = 180834,
        step_type = 5,
        target_name = "StrengthPage/Page/RefactorPage/RefactorNode/Befor",
        target_parent = 1005
    },
    [3303] = {
        delay = 0.2,
        ...
        info = 236293,
        step_type = 5,
        target_name = "StrengthPage/Page/RefactorPage/RefactorNode/After",
        target_parent = 1005
    },
    [3304] = {
        delay = 0.2,
        ...
        info = 195994,
        step_type = 5,
        target_name = "StrengthPage/Page/RefactorPage/ConsumeList",
        target_parent = 1005
    },
    [3400] = {
        condition = 1,
        ...
        info = 461261,
        op_refresh = true,
        target_name = "Main/Right/PageTog/Tog_FuncPageItem3",
        target_parent = 1
    },
    [3401] = {
        delay = 0.3,
        id = 3401,
        info = 224880,
        target_name = "Main/Right/PageList/Rect/OasisPage/Btn_Factor",
        target_parent = 1
    },
    [3402] = {
        id = 3402,
        info = 496360,
        target_name = "Rooms/Factory_A_001",
    ...
    [3406] = {
        ...
        id = 3406,
        info = 469333,
        target_name = "OrderNode/Btn_Confirm",
        target_parent = 1300
    },
    [3407] = {
        delay = 0.3,
        ...
        info = 479980,
        step_type = 5,
        target_name = "FactoryRomeNode/EnterhNode",
        target_parent = 1300
    },
    [90101] = {
        condition = 16,
    ...
    [150100] = {
        ...
        info = 472206,
        op_refresh = true,
        target_name = "Main/Right/PageTog/Tog_FuncPageItem1",
        target_parent = 1
    },
    [150101] = {
        delay = 1.7,
    ...
    [150102] = {
        id = 150102,
        info = 489635,
        target_name = "Main/Right/PageList/Rect/HeroPage/Btn_Lottery",
        target_parent = 1
    },
    [150103] = {
        id = 150103,
    ...
    [150105] = {
        ...
        id = 150105,
        info = 513268,
        target_name = "Buttom/InfoScroll/Rect/2",
        target_parent = 13
    },
    [150106] = {
        delay = 0.2,
