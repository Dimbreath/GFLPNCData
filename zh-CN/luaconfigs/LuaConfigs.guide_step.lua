...
, 
[501] = {condition = 1, delay = 1, id = 501, info = 125485, info_type = 0, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_Exproation/Tile/Btn_ContinueEp", target_parent = 1}
, 
...
, 
[700] = {condition = 1, delay = 1, id = 700, info = 94447, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_Exproation", target_parent = 1}
, 
...
, 
[703] = {id = 703, info = 57847, target_name = "return GuideUtil.LocationSectorStageItem(1101)", target_type = 3}
, 
[704] = {id = 704, info = 392351, target_name = "DetailNode/BtnGroup/Btn_Battle", target_parent = 75}
, 
[705] = {delay = 1, id = 705, info = 138658, target_name = "Formation(Clone)/UI/UI_3DFormation/Start", target_parent = "002_Sector_001", target_type = 2}
, 
...
, 
[900] = {condition = 15, delay = 0.4, guide_skip = false, id = 900, info = 117203, step_type = 5, target_name = "UINEnemyDetail", target_parent = 206}
, 
...
, 
[1302] = {condition = 1, delay = 1, id = 1302, info = 290340, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_Oasis", target_parent = 1}
, 
[1303] = {avg_name = "cpt00_tutorial_11", guide_skip = false, id = 1303, info_type = 0, step_type = 2, target_type = 0}
, 
[1304] = {id = 1304, info = 360483, target_name = "UINode/Btn_OpenSide", target_parent = 3}
, 
[1305] = {id = 1305, info = 51075, target_name = "UINode/BuildingSidebar/BuildingList/Rect/1_2/1003", target_parent = 3}
, 
[1306] = {id = 1306, info = 308650, target_name = "UINode/BuildingSidebar/BuildingList/Rect/1_2/DetailItem/Upgraded/Btn_Upgrade", target_parent = 3}
, 
[1307] = {id = 1307, info = 308650, target_name = "Upgraded/But_Accelerate", target_parent = 3}
, 
...
, 
[1497] = {condition = 10, id = 1497, info = 383076, target_name = "UINode/Top/TopButtonGroup/Btn_GoHome", target_parent = 3}
, 
[1500] = {condition = 1, delay = 0.8, id = 1500, info = 432021, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_HeroList", target_parent = 1}
, 
[1501] = {delay = 0.7, id = 1501, info = 195342, target_name = "return GuideUtil.GetHeroListHeroItem(1021,true,false)", target_parent = "300", target_type = 3}
, 
[1502] = {id = 1502, info = 279749, target_name = "Center/Info/Btn_LevelUp", target_parent = 301}
, 
...
, delay = 1, id = 1600, info = 451916, target_name = "Formation(Clone)/Scene/BasePlatform4", target_parent = "002_Sector_001", target_type = 2}
, 
...
, 
[1604] = {delay = 0.2, id = 1604, info = 138658, target_name = "Formation(Clone)/UI/UI_3DFormation/Start", target_parent = "002_Sector_001", target_type = 2}
, 
...
, 
[2001] = {condition = 1, delay = 1, id = 2001, info = 203342, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_HeroList", target_parent = 1}
, 
[2002] = {delay = 1, id = 2002, info = 203342, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_HeroList", target_parent = 1}
, 
...
, 
[2004] = {id = 2004, info = 64103, target_name = "Center/Info/Btn_StarUp", target_parent = 301}
, 
[2005] = {id = 2005, info = 8244, target_name = "InfoNode/Btn_StarUp", target_parent = 304}
, 
...
, 
[2202] = {id = 2202, info = 256330, target_name = "ConstructionInfo/BuildIngList/201/2001", target_parent = 18}
, 
[2203] = {id = 2203, info = 489732, target_name = "QuickUpgraded/3DModifier/Frame/Right/btn_DoComplete", target_parent = 18}
, 
[2300] = {condition = 1, delay = 1, id = 2300, info = 267314, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_HeroList", target_parent = 1}
, 
[2301] = {condition = 12, delay = 0.2, id = 2301, info = 32600, target_name = "Top/TopButtonGroup/Btn_Back", target_parent = 76}
, 
[2302] = {delay = 1, id = 2302, info = 267314, target_name = "RotateWithMian/MainUI/Middle/Btn_HeroList", target_parent = 1}
, 
...
, 
[2305] = {delay = 1, id = 2305, info = 167501, target_name = "SkillNode/obj_skillItem2/SkillUpgradeItem", target_parent = 306}
, 
[2306] = {id = 2306, info = 353128, target_name = "InfoNode/Btn_Confirm", target_parent = 306}
, 
[2401] = {condition = 1, id = 2401, info = 35944, target_name = "RotateWithMian/MainUI/Middle/Btn_Task", target_parent = 1}
, 
...
, 
[2501] = {condition = 11, id = 2501, info = 200817, target_name = "Top/CommanderSkill/Btn_OpenComSkill", target_parent = 80}
, 
...
, 
[2600] = {condition = 14, delay = 1, id = 2600, info = 483979, target_name = "Buttom/Detail/AlgorithmNode", target_parent = 301}
, 
[2601] = {guide_skip = false, id = 2601, info = 467731, step_type = 5, target_name = "AlgorithmDetail/Left", target_parent = 1000}
, 
[2602] = {delay = 0.2, guide_skip = false, id = 2602, info = 201391, step_type = 5, target_name = "AlgorithmDetail/AreaList", target_parent = 1000}
, 
[2603] = {delay = 0.3, id = 2603, info = 102520, target_name = "AlgorithmDetail/AreaList/A", target_parent = 1000}
, 
[2604] = {delay = 0.3, guide_skip = false, id = 2604, info = 374666, info_pos = "2", step_type = 5, target_name = "ATHListNode", target_parent = 1000}
, 
[2605] = {delay = 0.3, id = 2605, info = 4648, target_name = "ATHListNode/ScrollListSpace_One/AthRowOneList/0", target_parent = 1000}
, 
...
, 
[2609] = {delay = 0.2, guide_skip = false, id = 2609, info = 270437, step_type = 5, target_name = "Efficiency/Btn_Efficiency", target_parent = 1000}
, 
[2610] = {delay = 0.3, guide_skip = false, id = 2610, info = 274356, step_type = 5, target_name = "AlgorithmDetail/Right/HeroAttributeNode", target_parent = 1000}
, 
[2701] = {condition = 12, id = 2701, info = 347159, target_name = "SectorRoot/UICanvas/SectorDungeonRoot/Btn_FriendshipDungeon", target_parent = "002_Sector_001", target_type = 2}
, 
[2702] = {guide_skip = false, id = 2702, info = 17193, step_type = 5, target_name = "Frontground/Main/HeroList/Rect", target_parent = 72}
, 
...
, 
[2704] = {guide_skip = false, id = 2704, info = 312453, step_type = 5, target_name = "Frontground/Main/StoryDetailNode/2DMaskLayer/LevelRewardNode/MaybeReward/ItemWithCount(Clone)/UINBaseItem", target_parent = 72}
, 
[2705] = {delay = 0.3, guide_skip = false, id = 2705, info = 27960, step_type = 5, target_name = "Frontground/Top/LimitCount", target_parent = 72}
, 
...
, 
[2802] = {guide_skip = false, id = 2802, info = 153827, step_type = 5, target_name = "Frontground/Main/DungeonList", target_parent = 97}
, 
...
, 
[100002] = {id = 100002, info = 391741, target_name = "Frame/Btn_BattleStart", target_parent = 204}
, 
...
, 
[101101] = {id = 101101, info = 391741, target_name = "Frame/Btn_BattleStart", target_parent = 204}
, 
...
, 
[101202] = {id = 101202, info = 250734, target_name = "UltimateNode/HeroList/1005", target_parent = 203}
, 
...
, 
[150101] = {delay = 1.7, id = 150101, info = 19057, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_tempMail", target_parent = 1}
, 
[150102] = {id = 150102, info = 18485, target_name = "Frame/Detail/Normal/Detail/Reward/Btn_Get", target_parent = 35}
, 
[150103] = {condition = 1, delay = 1.5, id = 150103, info = 19057, op_refresh = true, target_name = "RotateWithMian/MainUI/Middle/Btn_tempMail", target_parent = 1}
, 
