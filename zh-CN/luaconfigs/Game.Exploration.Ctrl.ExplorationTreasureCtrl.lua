...
ExplorationTreasureCtrl.SendItemSelect = function(self, idx, waitChip, action)
  -- function num : 0_4 , upvalues : _ENV, ExplorationEnum
  (self.netWork):CS_EXPLORATION_ITEM_Select(self.currPosition, idx, waitChip, function()
...
ExplorationTreasureCtrl.SendRefreshTreasureRoom = function(self, boxId)
  ...
  if refreshTime > 0 or maxTimes == -1 then
