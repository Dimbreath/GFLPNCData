...
DynServerChipGrid.InitChipGrid = function(self, effector)
  -- function num : 0_1 , upvalues : _ENV, ChipBattleData, GridChipLevel, ExplorationEnum
  ...
  self.chipBattleData = (ChipBattleData.New)(chipCfg, GridChipLevel, (ExplorationEnum.eBattleSkillType).TempChip)
end
