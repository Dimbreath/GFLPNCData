...
bs_60002.config = {buffId1 = 175, buffId2 = 1033, buffId3 = 198, buffId = 110, buffStun = 66, buffUndefeatable = 88, 
...
bs_60002.OnAfterBattleStart = function(self)
  ...
  LuaSkillCtrl:CallBuff(self, self.caster, (self.config).buffUndefeatable, 1, nil, true)
