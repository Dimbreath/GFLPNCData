...
, 
{extra_id = 6, jump_arg = __rt_5, jump_id = 107}
, 
{extra_id = 7, jump_arg = __rt_6, jump_id = 107}
, 
{extra_id = 8, jump_arg = __rt_7, jump_id = 107}
, 
...
, 
{
{extra_id = 1, jump_arg = __rt_3, jump_id = 108, type_id = 5}
, 
{extra_id = 2, jump_arg = __rt_4, jump_id = 108, type_id = 5}
, 
{extra_id = 3, jump_arg = __rt_5, jump_id = 108, type_id = 5}
, 
{extra_id = 4, jump_arg = __rt_6, jump_id = 108, type_id = 5}
, 
{extra_id = 5, jump_arg = __rt_7, jump_id = 108, type_id = 5}
, 
{extra_id = 6, 
jump_arg = {6}
, jump_id = 108, type_id = 5}
; 
[0] = {jump_id = 108, type_id = 5}
}
, 
{
...
, 
{extra_id = 2, jump_arg = __rt_6, jump_id = 106, type_id = 10}
; 
...
local __default_values = {extra_id = 0, jump_arg = __rt_1, jump_id = 0, type_id = 2}
