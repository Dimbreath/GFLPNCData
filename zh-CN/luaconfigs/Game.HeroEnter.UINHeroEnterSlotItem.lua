...
UINHeroEnterSlotItem.cleanStaticAllSlots = function(self)
...
UINHeroEnterSlotItem.InitHeroEnterSlot = function(self, resloader, isUnlock, heroId, isShowSelect)
  ...
  if isShowSelect then
    (table.insert)(staticAllSlots, {isUnlock = isUnlock, heroID = heroId, slotItem = self})
    self.slotNum = #staticAllSlots
  end
end

UINHeroEnterSlotItem.RefreshHeroEnterSlot = function(self)
...
UINHeroEnterSlotItem.SetSlotClickEvent = function(self, event)
  -- function num : 0_5
