...
UIGetHero._InitGetHero = function(self, heroId, isNew, newSkinId)
  -- function num : 0_5 , upvalues : _ENV, m_moviePlayer, cs_MovieManager, HeroIdTo4Hex, heroNameEffColor
        ...
        if newSkinId ~= nil then
          ...
          do
            do
              ...
              -- DECOMPILER ERROR at PC240: Confused about usage of register: R8 in 'UnsetPending'
...
UIGetHero.__LoadLive2D = function(self, path)
...
UIGetHero.SetPlayEffectColor = function(self, qualityColor, nameEffColor)
  -- function num : 0_8 , upvalues : _ENV, cs_ParticleSystem
...
UIGetHero._OnConvertTween = function(self)
  -- function num : 0_16 , upvalues : cs_DoTween, _ENV
...
UIGetHero._OnStarVoice = function(self, starNum)
  ...
  if starNum <= self.starCount then
    ...
    -- function num : 0_17_0 , upvalues : self, starNum
...
UIGetHero.OnClickClose = function(self)
  -- function num : 0_21 , upvalues : m_moviePlayer, cs_PlayState
...
UIGetHero.OnClickSkip = function(self)
  -- function num : 0_22 , upvalues : eSkipMode
...
UIGetHero._ReturnMovie = function(self)
  -- function num : 0_24 , upvalues : _ENV, m_moviePlayer, cs_MovieManager
  -- DECOMPILER ERROR at PC9: Confused about usage of register: R1 in 'UnsetPending'
