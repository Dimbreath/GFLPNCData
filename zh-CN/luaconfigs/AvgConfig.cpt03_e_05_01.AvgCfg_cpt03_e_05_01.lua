...
, content = 40, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2}
, 
...
, 
[11] = {content = 110, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2, nextId = 99}
, 
[12] = {
imgTween = {
{imgId = 102, duration = 0.2, alpha = 0}
...
, content = 170, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 2}
, 
[18] = {
imgTween = {
{imgId = 102, duration = 0.2, alpha = 1}
...
, content = 220, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2}
, 
[23] = {
imgTween = {
{imgId = 102, duration = 0.2, alpha = 0, 
...
, content = 480, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, nextId = 100}
, 
[49] = {
imgTween = {
{imgId = 5, isDark = true}
...
, content = 570, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, nextId = 101}
, 
[58] = {
heroFace = {
{imgId = 5, faceId = 0}
}
, content = 580, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3}
, 
...
, content = 710, contentType = 2, autoContinue = true, nextId = 103}
, 
[72] = {
imgTween = {
{imgId = 27, isDark = true, posId = 2, duration = 0.5}
, 
{imgId = 5, isDark = false, duration = 0.5, posId = 5}
, 
{imgId = 5, isDark = false, duration = 0.5, posId = 4}
}
...
[75] = {
imgTween = {
{imgId = 27, duration = 0.2, alpha = 0, posId = 2}
, 
{imgId = 1, duration = 0.2, alpha = 1, posId = 2, isDark = false}
, 
{imgId = 5, isDark = true}
}
, 
...
, content = 780, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1, isEnd = true}
, 
[99] = {content = 111, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2, nextId = 12}
, 
[100] = {content = 481, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1, nextId = 49}
, 
[101] = {content = 571, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3}
, 
[102] = {content = 572, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, nextId = 58}
, 
[103] = {
imgTween = {
{imgId = 27, delay = 0.5, duration = 0.5, alpha = 0, posId = 3}
, 
{imgId = 27, delay = 0.5, duration = 0.5, alpha = 1, posId = 3}
, 
{imgId = 97, duration = 0.5, alpha = 1}
}
, content = 712, contentType = 3, speakerHeroId = 1027, speakerHeroPosId = 2, nextId = 72}
, 
[104] = {
imgTween = {
{imgId = 5, isDark = false}
}
, content = 731, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, nextId = 74}
}
