...
bs_102003.config = {startEffect = 10675, buffId = 221, fronttime = 7}
...
bs_102003.PlayUltEffect = function(self)
  ...
  self:AddTrigger(eSkillTriggerType.OnSelfUltMovieFadeOut, "bs_102003_3", 1, self.OnMovieFadeOut)
end

bs_102003.OnUltRoleAction = function(self)
  -- function num : 0_4 , upvalues : base, _ENV
  (base.OnUltRoleAction)(self)
  LuaSkillCtrl:StartTimerInUlt(self, (self.config).fronttime, function()
