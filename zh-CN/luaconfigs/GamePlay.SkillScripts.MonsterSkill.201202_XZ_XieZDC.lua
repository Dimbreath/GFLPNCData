...
, monsterEffectId = 10221, buffId_1007 = 1007, buffId_1130 = 1130, buffDamageFormula = 10078, effecthurtId = 10275, audioId1 = 78, audioId2 = 79, audioId3 = 80, audioId4 = 81, startAnimId = 1002, skill_time = 27, start_time = 12, freq = 15}
...
bs_40010.OnActionCallBack = function(self, target)
  ...
  self.grid = LuaSkillCtrl:GetGridWithRole(target)
...
bs_40010.SkillEventFunc = function(self, effect, eventId, target)
  ...
  if eventId == eBattleEffectEvent.Trigger then
    local gridTarget = LuaSkillCtrl:GetTargetWithGrid((self.grid).x, (self.grid).y)
