...
, effectId = 10103, damageEffectId = 10104, startAnimID = 1004, skillCount = 1, totalDamage = 0, audioId1 = 20, skillId = 200501, commonAttackId = 505, select_id = 1001, select_range = 0, skill_time = 25, start_time = 10, skill_speed = 1, healCallBackDelay = 3}
...
bs_200501.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg, isTriggerSet)
  -- function num : 0_2
...
bs_200501.OnAttackTrigger = function(self, target, data)
