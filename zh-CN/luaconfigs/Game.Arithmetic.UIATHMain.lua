...
UIATHMain.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, CS_LeanTouch, UINAthList, UINAthSuitDetail, UINAthAreaItem, UINAthMainAtrrItem, UINAthSuitMainItem, UINAthInfoTogItem
  ...
  for i = 1, (ConfigData.game_config).athSlotCount do
    ...
    areaItem:InitAthAreaItem(R8_PC188, self, self.__OnDragStart)
    -- DECOMPILER ERROR at PC193: Confused about usage of register: R6 in 'UnsetPending'

    ;
    (areaItem.gameObject).name = tostring(R8_PC188)
  end
  ;
  ...
  for k,go in ipairs((self.ui).infoTogList) do
    ...
    infoTogItem:Init(go)
    -- DECOMPILER ERROR at PC231: Overwrote pending register: R8 in 'AssignReg'

    infoTogItem:InitAthInfoTogItem(R9_PC234, self.__selectInfoTogFunc)
    -- DECOMPILER ERROR at PC237: Overwrote pending register: R8 in 'AssignReg'

    ;
    (table.insert)(R8_PC188, R9_PC234)
  end
