...
local AvgCfg_cpt00_tutorial_26 = {
[1] = {content = 10, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, 
images = {
...
, 
[3] = {content = 30, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, 
imgTween = {
...
, 
[4] = {content = 40, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1}
, 
...
, 
[7] = {content = 70, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
, 
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
...
, 
[8] = {content = 80, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, 
heroFace = {
{imgId = 102, faceId = 2}
}
}
...
return AvgCfg_cpt00_tutorial_26
