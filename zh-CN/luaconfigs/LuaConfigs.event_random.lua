...
, 
{id = 2, judge_num = 3, judge_profession = 3, 
...
local __default_values = {id = 1, judge_num = 2, judge_profession = 2, judge_result = __rt_1, 
jump_target = {0, 0, 0, 0}
, logic = __rt_2, name = 173328, para1 = __rt_3, 
...
for k,v in pairs(event_random) do
  setmetatable(v, base)
end
