...
, 
{describe = 97609, id = 26}
, 
{
choiceDeductList = {
{dataID = 510, dataNum = 1}
}
...
, 
{describe = 455670, id = 53}
, 
{describe = 500406, id = 54}
, 
{describe = 207306, id = 55}
, 
{describe = 207306, id = 56}
, 
{describe = 256802, id = 57}
, 
{describe = 455670, id = 58}
, 
...
local __default_values = {choiceDeductList = __rt_1, choice_color = false, condition = 0, describe = 417562, event_exit = true, icon = "", id = 1}
