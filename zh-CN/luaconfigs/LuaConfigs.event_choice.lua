...
local event_choice = {
    ...
    {choiceGetNew = __rt_6, describe = 97609, id = 26},
    {choiceDeductList = {__rt_5}, condition = 1, describe = 28991, id = 27},
    {choiceGetNew = __rt_3, describe = 498768, id = 28}, {
        choiceGetNew = {dataID = 1, dataNum = 25},
        describe = 524247,
        icon = "event_icon_cache",
    ...
    {describe = 155606, icon = "event_icon_func", id = 39},
    {choiceGetNew = __rt_6, id = 40},
    {choiceGetNew = {dataID = 10002, dataNum = 1}, describe = 188252, id = 41},
    {choiceGetNew = {dataID = 10016, dataNum = 1}, describe = 121460, id = 42},
    {choiceGetNew = {dataID = 10004, dataNum = 1}, describe = 107006, id = 43},
    {choiceGetNew = {dataID = 10008, dataNum = 1}, describe = 331026, id = 44},
    {choiceGetNew = {dataID = 10003, dataNum = 1}, describe = 511731, id = 45},
    {choiceGetNew = {dataID = 10017, dataNum = 1}, describe = 429068, id = 46},
    {choiceGetNew = {dataID = 10009, dataNum = 1}, describe = 276499, id = 47},
    {choiceGetNew = {dataID = 10001, dataNum = 1}, describe = 504168, id = 48},
    {choiceGetNew = {dataID = 10024, dataNum = 1}, describe = 226870, id = 49},
    {choiceGetNew = {dataID = 10026, dataNum = 1}, describe = 177778, id = 50},
    {choiceGetNew = {dataID = 10010, dataNum = 1}, describe = 252529, id = 51},
    {choiceGetNew = {dataID = 10012, dataNum = 1}, describe = 393725, id = 52},
    {choiceGetNew = __rt_7, describe = 455670, id = 53},
    {choiceGetNew = {dataID = 10021, dataNum = 1}, describe = 500406, id = 54},
    {choiceGetNew = __rt_8, describe = 207306, id = 55},
    {choiceGetNew = __rt_8, describe = 207306, id = 56},
    {choiceGetNew = {dataID = 10020, dataNum = 1}, describe = 256802, id = 57},
    {choiceGetNew = __rt_7, describe = 455670, id = 58},
    {describe = 106202, icon = "event_icon_resurrection", id = 59}, {
        choiceGetNew = {dataID = 1, dataNum = 80},
        describe = 382480,
