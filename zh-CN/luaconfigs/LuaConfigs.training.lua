...
{
pre_para2 = {6}
, training_para = 600, type_id = 6}
, 
{pre_para2 = __rt_6, training_para = 700, type_id = 7}
, 
{
pre_para2 = {8}
, training_para = 800, type_id = 8}
, 
{
pre_para2 = {9}
, training_para = 900, type_id = 9}
, 
{training_para = 1000, type_id = 10}
}
}
local __default_values = {pre_condition = __rt_1, pre_para1 = __rt_2, pre_para2 = __rt_7, training_para = 1, type_id = 1}
