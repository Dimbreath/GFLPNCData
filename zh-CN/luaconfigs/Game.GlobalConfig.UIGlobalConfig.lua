...
UIWindowTypeID = {LuaTest = 1000, Home = 1, TopStatus = 2, NavigationBar = 3, BattleResult = 4, ExplorationResult = 6, ExplorationResultSettlement = 7, OasisEditWindow = 9, HomeSide = 10, NoticeMessagePush = 11, Login = 12, LotteryWindow = 13, Loading = 14, USkySystem = 15, Task = 25, Factory = 26, CommonReward = 27, AchievementSystem = 28, GetHero = 34, Mail = 35, Guide = 36, QuickBuy = 37, FloatText = 38, ClickContinue = 39, GlobalItemDetail = 40, Setting = 45, Dorm = 50, DormEdit = 51, DormOverview = 52, DormOperate = 53, DormRoomEdit = 54, DormWarehouse = 55, DormShop = 56, DormRoomDetail = 57, DormFntDetail = 58, DormHeroEnter = 59, DormInput = 60, FriendShip = 70, FriendShipHeroFoster = 71, FriendShipPlotDungeon = 72, Avg = 73, SectorLevel = 74, SectorLevelDetail = 75, Sector = 76, Formation = 80, FormationQuick = 82, CampBond = 83, MessageSide = 90, ViewChips = 95, ViewItems = 96, MaterialDungeon = 97, SelectBoardHero = 98, UserInfo = 100, Exploration = 101, SelectChip = 102, EpChipList = 104, ThreeDSelectChip = 105, EpBuff = 106, SectorTask = 107, EpStoreRoom = 109, EpBuffShow = 110, EpAutoMode = 111, OverClock = 120, FloatingFrame = 121, GuidePicture = 122, CSTMain = 123, RichIntro = 124, ChipDisplace = 128, EpTreasureRoom = 130, EpEventRoom = 131, EpUpgradeRoom = 132, EpChipDiscard = 133, ATHDungeon = 134, EpSupportRoom = 135, EpResidentStore = 136, EpRewardBag = 141, EpRewardPreview = 142, CurrentChip = 143, EpChipSuit = 144, EpMonsterLevelUp = 145, EpSelectDebuff = 146, BattleDeploy = 201, BattleSkillModule = 203, Battle = 204, BattlePause = 205, BattleEnemyDetail = 206, BattleDPS = 207, BattleCrazyMode = 208, BattleFail = 209, DungeonStateInfo = 210, DungeonInfoDetail = 211, BattleEffectGirdInfo = 212, ResultSkada = 220, DungeonResult = 250, DungeonFailureResult = 251, DungeonWaveTip = 252, HeroList = 300, HeroState = 301, HeroLevelUp = 302, HeroLevelUpSuccess = 303, HeroStarUp = 304, HeroSkillUp = 305, HeroSkillUpgrade = 306, HeroStarUpSuccess = 307, HeroPowerUpSuccess = 308, HeroPotential = 309, HeroPotentialSuccess = 310, HeroSkin = 311, HeroSkinPreView = 312, HeroTask = 313, HeroInfomation = 314, UserNameCreate = 401, Ath = 1000, AthEfficiency = 1001, AthEfficiencyUpSuccess = 1002, AthItemDetail = 1003, AthReplaceHero = 1004, AthDecompose = 1006, AthRefactor = 1007, AthRefactorSuccess = 1008, AthItemDetailFloat = 1009, LotteryResult = 1100, LotteryShow = 1101, MessageCommon = 1200, Factory = 1300, FactoryQuickProduce = 1302, RecommeFormation = 1305, StrategyOverview = 1400, OasisMain = 1500, ActivityStarUp = 1600, EventSignin = 1605, EventBattlePass = 1701, EventBattlePassPurchase = 1702, EventGrowBag = 1703, ShopMain = 1800, CommonInfo = 1900, PeriodicDebuffSelect = 1910, DailyChallenge = 1950, WeeklyChallengeRank = 1961, WCDebuffResult = 1962, ActivityFrameMain = 2000, EventNoviceSign = 2001, Warehouse = 2002, CommonUseGift = 2003}
...
, 
[UIWindowTypeID.AchievementSystem] = {PrefabName = "UI_AchievementSystem", LayoutLevel = EUILayoutLevel.Middle, WindowClass = (_ENV.require)("Game.Achievement.UI.UIAchievementSystem"), AnimaType = (_ENV.EUIAnimaType).FadeScaleUp}
, 
...
, 
[UIWindowTypeID.Setting] = {PrefabName = "UI_Setting", LayoutLevel = EUILayoutLevel.Normal, WindowClass = (_ENV.require)("Game.Setting.UISetting"), AnimaType = (_ENV.EUIAnimaType).FadeScaleUp}
, 
...
, 
[UIWindowTypeID.FriendShip] = {PrefabName = "UI_FriendshipSkillUpgrade", LayoutLevel = EUILayoutLevel.Middle, WindowClass = (_ENV.require)("Game.Friendship.NewFriendshipUI.UIFriendshipSkillUpgrade"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
...
, 
[UIWindowTypeID.SectorTask] = {PrefabName = "UI_SectorTask", LayoutLevel = EUILayoutLevel.Middle, WindowClass = (_ENV.require)("Game.Sector.SectorTask.UISectorTask"), AnimaType = (_ENV.EUIAnimaType).FadeScaleUp}
, 
[UIWindowTypeID.OverClock] = {PrefabName = "UI_Overclock", LayoutLevel = EUILayoutLevel.High, WindowClass = (_ENV.require)("Game.Exploration.UI.Overclock.UIEpOverclock"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
[UIWindowTypeID.CSTMain] = {PrefabName = "UI_CSTMain", LayoutLevel = EUILayoutLevel.Middle, LayoutLevel = EUILayoutLevel.Middle, WindowClass = (_ENV.require)("Game.CommanderSkill.UI.UICSTMain"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
...
, 
[UIWindowTypeID.DungeonInfoDetail] = {PrefabName = "UI_DungeonInfoDetail", LayoutLevel = EUILayoutLevel.Normal, WindowClass = (_ENV.require)("Game.CommonUI.DungeonState.Info.UIDungeonInfoDetail"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
...
, 
[UIWindowTypeID.ResultSkada] = {PrefabName = "UI_ResultSkada", LayoutLevel = EUILayoutLevel.Normal, WindowClass = (_ENV.require)("Game.BattleResult.SkadaSystem.UIResultSkada"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
...
, 
[UIWindowTypeID.ATHDungeon] = {PrefabName = "UI_ATHDungeon_new", LayoutLevel = EUILayoutLevel.Middle, WindowClass = (_ENV.require)("Game.ATHDungeon.UI.UIATHDungeon")}
, 
...
, 
[UIWindowTypeID.CommonInfo] = {PrefabName = "UI_CommonInfo", LayoutLevel = EUILayoutLevel.High, WindowClass = (_ENV.require)("Game.CommonUI.CommonInfo.UICommonInfo"), AnimaType = (_ENV.EUIAnimaType).FadeScaleUp}
, 
...
, 
[UIWindowTypeID.HeroSkin] = {PrefabName = "UI_HeroSkin", LayoutLevel = EUILayoutLevel.High, WindowClass = (_ENV.require)("Game.Skin.UI.UIHeroSkin"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
[UIWindowTypeID.HeroSkinPreView] = {PrefabName = "UI_HeroStarUpSkinPreview", LayoutLevel = EUILayoutLevel.Middle, WindowClass = (_ENV.require)("Game.Skin.UI.Preview.UIPreviewSkin")}
, 
...
, 
[UIWindowTypeID.ShopMain] = {PrefabName = "UI_ShopMain", LayoutLevel = EUILayoutLevel.High, WindowClass = (_ENV.require)("Game.ShopMain.UIShopMain"), AnimaType = (_ENV.EUIAnimaType).FadeScaleUp}
, 
...
, 
[UIWindowTypeID.EpRewardPreview] = {PrefabName = "UI_EpRewardPreview", LayoutLevel = EUILayoutLevel.High, WindowClass = (_ENV.require)("Game.Exploration.UI.EpRewardPreview.UIEpRewardPreview"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
[UIWindowTypeID.CurrentChip] = {PrefabName = "UI_CurrentChip", LayoutLevel = EUILayoutLevel.High, WindowClass = (_ENV.require)("Game.Exploration.UI.CurrentChip.UICurrentChip"), AnimaType = (_ENV.EUIAnimaType).Fade}
, 
[UIWindowTypeID.EpChipSuit] = {PrefabName = "UI_EpChipSuit", LayoutLevel = EUILayoutLevel.Normal, WindowClass = (_ENV.require)("Game.Exploration.UI.ChipSuit.UIEpChipSuit")}
, 
[UIWindowTypeID.EpMonsterLevelUp] = {PrefabName = "UI_EpMonsterLevelUp", LayoutLevel = EUILayoutLevel.OverHigh, WindowClass = (_ENV.require)("Game.Exploration.UI.MonsterLevel.UIEpMonsterLevelUp")}
, 
...
, 
[UIWindowTypeID.Warehouse] = {PrefabName = "UI_Warehouse", LayoutLevel = EUILayoutLevel.Normal, WindowClass = (_ENV.require)("Game.Warehouse.UIWarehouse"), AnimaType = (_ENV.EUIAnimaType).FadeScaleUp}
, 
