...
, 
{id = 14, priority = 2, 
step_list = {140201, 140202, 1308, 140205}
}
, 
{
extra_arg = {
...
{
guide_arg = {1401}
, guide_condition = __rt_3, guide_type = 2, id = 27, 
step_list = {2701, 2702, 2703, 2704, 2705, 2706, 2707, 2708}
}
, 
{guide_arg = __rt_4, guide_condition = __rt_3, guide_type = 2, id = 28, 
step_list = {2801, 2802, 2803, 2804, 2805}
}
, 
{guide_arg = __rt_5, guide_condition = __rt_3, guide_type = 2, id = 29, 
step_list = {2901, 2902}
}
, 
{id = 30, priority = 2, 
...
{
guide_arg = {1202}
, guide_condition = __rt_3, guide_type = 2, id = 32, 
...
{
guide_arg = {900}
, guide_condition = __rt_3, guide_type = 2, id = 34, 
step_list = {3400, 3401, 3402, 3404, 3405, 3406}
}
, 
{
guide_arg = {2300}
...
{
guide_arg = {412}
, guide_condition = __rt_3, guide_type = 2, id = 37, 
...
, 
[1401] = {id = 1401, 
step_list = {140203, 140204, 140201, 140202, 1308, 140205}
}
, 
