...
, 
{goods_shelves = 3, hero = 1003, itemId = 2503, 
pre_para1 = {1003, 1003}
}
, 
...
, 
{goods_shelves = 6, hero = 1006, itemId = 2506, 
pre_para1 = {1006, 1006}
}
, 
...
, 
{goods_shelves = 11, hero = 1016, itemId = 2516, page = 404, 
pre_para1 = {1016, 1016}
}
, 
{goods_shelves = 12, hero = 1017, itemId = 2517, page = 405, 
pre_para1 = {1017, 1017}
}
, 
{goods_shelves = 13, hero = 1021, itemId = 2521, page = 404, 
pre_para1 = {1021, 1021}
}
, 
{goods_shelves = 14, hero = 1035, itemId = 2535, page = 405, 
pre_para1 = {1035, 1035}
}
, 
{goods_shelves = 15, hero = 1036, itemId = 2536, page = 405, 
pre_para1 = {1036, 1036}
}
, 
{goods_shelves = 16, hero = 1037, itemId = 2537, 
pre_para1 = {1037, 1037}
}
}
}
local __default_values = {currencyId = 1006, currencyNums = __rt_1, goods_shelves = 1, hero = 1001, itemId = 2501, itemNums = __rt_2, page = 402, pre_condition = __rt_3, 
pre_para1 = {1001, 1001}
