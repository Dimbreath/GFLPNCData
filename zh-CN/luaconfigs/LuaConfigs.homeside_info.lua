...
, 
{describe = 80406, icon = "notice_OasisBuilding", id = 6}
, 
...
, 
{describe = 443761, icon = "notice_FrgDungeonRefresh", id = 10}
, 
{describe = 379957, id = 11}
, 
{describe = 69205, id = 12}
}
local __default_values = {describe = 102717, icon = "notice_Factory", id = 1}
