...
, id = 1, priority = 2, title = 399082}
, 
{
color = {0.149, 0.949, 0.251}
, icon = "ICON_Room_empty", id = 2, priority = 11}
, 
{icon = "ICON_Room_enemy", id = 3, priority = 9, title = 165461}
, 
{
color = {0.9059, 0.7804, 0.3451}
, icon = "ICON_Room_item", id = 4, priority = 4, title = 248668}
, 
{
color = {0.3059, 0.7255, 0.902}
, icon = "ICON_Room_store", id = 5, priority = 8, title = 37428}
, 
{
color = {0.9725, 0.4118, 0.8627}
, icon = "ICON_Room_elite", id = 6, priority = 6, title = 155560}
, 
{
color = {0.6078, 0.2196, 0.8902}
, icon = "ICON_Room_challenge", id = 7, priority = 7, title = 4301}
, 
{
...
, icon = "ICON_Room_recoveIry", id = 9, priority = 3, title = 482816}
, 
{
...
local __rt_1 = {1, 1, 1}
local exploration_roomtype = {
    {color = {0.9137, 0.5569, 0.0431}, id = 1, priority = 2, title = 399082},
    {
        color = {0.149, 0.949, 0.251},
...
for k, v in pairs(exploration_roomtype) do setmetatable(v, base) end
local __rawdata = {__basemetatable = base}
setmetatable(exploration_roomtype, {__index = __rawdata})
return exploration_roomtype
