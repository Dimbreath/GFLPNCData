...
UIPlotDungeon.__loadHeroDungeonList = function(self, selectItemIndex)
  -- function num : 0_5 , upvalues : HeroDungeonItemList, _ENV
...
UIPlotDungeon.__InitItem = function(self, go)
  -- function num : 0_6 , upvalues : UIHeroDungeonItem, _ENV
...
UIPlotDungeon.__loadAvgUI = function(self, dungeonData)
  -- function num : 0_11 , upvalues : _ENV, HeroStoryItem
...
UIPlotDungeon.__loadChapterUI = function(self, dungeonData)
  -- function num : 0_12 , upvalues : UIHeroDungeonChapterList, UIHeroChapterItem, RewardItem, _ENV
...
UIPlotDungeon.OnClickStarUp = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.HeroStarUp, function(windows)
    -- function num : 0_21_0 , upvalues : _ENV, self, heroData
    if windows == nil then
...
UIPlotDungeon.ChangeHeroItem = function(self, flag, callback)
  ...
  (self.heroItemList):Roll2Index(nowIndex - 1, function()
    -- function num : 0_22_0 , upvalues : _ENV, self, nowIndex, callback
...
UIPlotDungeon.OnBattleStart = function(self)
  -- function num : 0_23 , upvalues : _ENV, cs_MessageCommon, JumpManager, CS_GSceneManager_Ins, FmtEnum
  ...
  startBattleFunc = function(curSelectFormationId, callBack)
    -- function num : 0_23_2 , upvalues : _ENV, dungeonStageData, JumpManager, dungeonData, self, CS_GSceneManager_Ins, startBattleFunc
    ...
    BattleDungeonManager:InjectBattleExitEvent(BindCallback(self, function()
      ...
      local loadMatUIFunc = BindCallback(self, function()
        ...
        UIManager:ShowWindowAsync(UIWindowTypeID.FriendShipPlotDungeon, function(window)
          ...
          window:InitPlotDungeon(newDungeonTypeData, self.selectHeroId, function(tohome)
            -- function num : 0_23_2_0_0_0_0 , upvalues : sectorCtrl
      ...
      CS_GSceneManager_Ins:LoadSceneAsyncByAB((Consts.SceneName).Sector, function()
        -- function num : 0_23_2_0_1 , upvalues : _ENV, loadMatUIFunc, self
        local sectorCtrl = ControllerManager:GetController(ControllerTypeId.SectorController, true)
        ;
...
, self.selectItemId))
    BattleDungeonManager:RequestEnterDungeon(((self.selectChapterItem).cfg).id, formationData, startBattleFunc, dungeonStageData, function()
      -- function num : 0_23_2_1 , upvalues : _ENV, callBack
  ...
  fmtCtrl:InitFromationCtrl((FmtEnum.eFmtFromModule).FriendshipDungeon, ((self.selectChapterItem).cfg).id, enterFormationFunc, exitFormationFunc, startBattleFunc, (self.selectChapterItem).costStrengthNum, lastFmtId)
end
...
UIPlotDungeon.OnTopInfoClick = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.CommonInfo, function(window)
    -- function num : 0_31_0 , upvalues : cfg
    if window == nil then
      return 
    end
