...
local __rt_1 = {{itemId = 1003, num = 500000}}
local hero_rank = {
    {rare = 1, upgrade_star_extra_cost = {{itemId = 1003, num = 0}}}, {
        rank = 2,
        rare = 1,
        star = 2,
        upgrade_star_extra_cost = {{itemId = 1003, num = 500}},
        upgrade_star_frag_cost = 5
    }, {
        rank = 3,
        rare = 2,
        star = 3,
        upgrade_star_extra_cost = {{itemId = 1003, num = 1000}},
        ...
        skill_level_max = 4,
        star = 5,
        upgrade_star_extra_cost = {{itemId = 1003, num = 5000}},
        upgrade_star_frag_cost = 30
    }, {
        rank = 6,
        skill_level_max = 5,
        star = 6,
        upgrade_star_extra_cost = {{itemId = 1003, num = 10000}},
        upgrade_star_frag_cost = 50
    }, {
        rank = 7,
        skill_level_max = 6,
        star = 7,
        upgrade_star_extra_cost = {{itemId = 1003, num = 30000}},
        upgrade_star_frag_cost = 60
    }, {
        rank = 8,
        skill_level_max = 7,
        star = 8,
        upgrade_star_extra_cost = {{itemId = 1003, num = 50000}},
        ...
        upgrade_star_extra_cost = {{itemId = 1003, num = 100000}},
        ...
        upgrade_star_extra_cost = {{itemId = 1003, num = 250000}},
...
local __default_values = {
    ...
    upgrade_star_extra_cost = __rt_1,
