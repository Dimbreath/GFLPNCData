...
DormUtil.FntCoord2Unity = function(x, y, fntType)
  -- function num : 0_6 , upvalues : _ENV, eDormFntType
...
DormUtil.GetFntUnityCoord = function(x, y)
  -- function num : 0_7 , upvalues : DormUtil, eDormFntType
...
DormUtil.GetFntArea = function(posX, posY, sizeX, sizeY, angle)
  -- function num : 0_9 , upvalues : cosTab, sinTab, _ENV
  local areaList = {}
  for i = 0, sizeX - 1 do
    for j = 0, sizeY - 1 do
      local x = i
...
DormUtil.FntAreaOutMap = function(posX, posY, sizeX, sizeY, angle, fntType)
  -- function num : 0_10 , upvalues : _ENV, cosTab, sinTab, eDormFntType
...
DormUtil.FntSize2Unity = function(sizeX, sizeY, fntType)
  -- function num : 0_12 , upvalues : _ENV, eDormFntType
...
DormUtil.AddFntToMapDic = function(mapDic, posX, posY, sizeX, sizeY, angle)
  -- function num : 0_13 , upvalues : cosTab, sinTab, DormUtil
  for x = 0, sizeX - 1 do
    for y = 0, sizeY - 1 do
...
DormUtil.GetFntOffsetCoord = function(fntX, fntY, fntR, x, y)
  -- function num : 0_15 , upvalues : cosTab, sinTab
