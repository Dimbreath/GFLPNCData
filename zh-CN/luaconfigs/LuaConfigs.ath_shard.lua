...
local ath_shard = {
    [3] = {
        {shardNumList = {6}},
        {shardNumList = {7}, size = 2},
        [4] = {size = 4},
        [8] = {shardNumList = {12}, size = 8}
    },
    [4] = {
        {quality = 4, shardNumList = {13}},
        {quality = 4, shardNumList = {15}, size = 2},
        [4] = {quality = 4, shardNumList = {20}, size = 4},
        [8] = {quality = 4, shardNumList = {25}, size = 8}
    },
    [5] = {
        {quality = 5, shardIdList = __rt_2, shardNumList = {39, 1}},
        {quality = 5, shardIdList = __rt_2, shardNumList = {45, 1}, size = 2},
        [4] = {
            quality = 5,
            shardIdList = __rt_2,
            shardNumList = {60, 1},
