...
UIEpUpgradeRoom.OnInit = function(self)
  ...
  ;
  (self.chipDetailPanel):SetBtnToParentHolder(((self.ui).btn_Upgrade).transform)
  ...
  ;
  ((self.ui).levelMax):SetActive(false)
end
...
UIEpUpgradeRoom.RefreshSelectItemDetail = function(self, selectItem)
  ...
  ((self.ui).lack):SetActive(false)
  ;
  (self.chipDetailPanel):InitEpChipDetail(self.selectedIndex, chipData, (self.roomCtrl).dynPlayer, self.resloader, nil, levelMax, eChipDetailPowerType.Add, true)
  ;
