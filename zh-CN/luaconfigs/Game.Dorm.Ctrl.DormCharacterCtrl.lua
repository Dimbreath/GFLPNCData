...
DormCharacterCtrl.OnEnterDormRoom = function(self, roomEntity)
  -- function num : 0_8 , upvalues : CS_LeanTouch, DormRoomCharacterCtrl
...
DormCharacterCtrl.OnExitDormRoom = function(self, roomEntity)
  -- function num : 0_9 , upvalues : CS_LeanTouch
...
DormCharacterCtrl.AddUnBindCharacterEvenly = function(self)
  ...
  local MaxRoomRole = 1
  while nowRoleCount < MaxRoomRole and #self.unbindCharList > 0 do
  ...
  do
    if MaxRoomRole <= nowRoleCount or #self.unbindCharList <= 0 or not isAllRoomFull then
    end
  end
end
...
DormCharacterCtrl.ResetRoomCharacter = function(self, pos)
  -- function num : 0_15 , upvalues : _ENV, DormRoomCharacterCtrl
...
DormCharacterCtrl.GenInterPointEntity = function(self, interPoint, unityPos)
  -- function num : 0_18 , upvalues : _ENV, DormInterPointEntity
