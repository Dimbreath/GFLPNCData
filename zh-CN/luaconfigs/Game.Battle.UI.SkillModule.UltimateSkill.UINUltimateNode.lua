...
UINUltimateNode.OnInit = function(self)
  ...
  ;
  (UIUtil.AddButtonListener)((self.ui).btn_ultSkip, self, self.OnClickVideo)
...
UINUltimateNode.ShowSkillInfo = function(self, item, battleSkill)
  ...
  win:SetTitleAndContext(battleSkill.name, battleSkill:GetBattleSkillDescribe())
...
UINUltimateNode.UpdateUltSkill = function(self, useEnable, curRatio, nextRatio, factor, interpolation)
  -- function num : 0_15 , upvalues : _ENV, ProgressAnimSpeed
...
UINUltimateNode.ShowUltSkillFocusMask = function(self, show)
  -- function num : 0_22 , upvalues : MaskRadiusMax, CS_DOTween, MaskRadius
  ...
  if show then
    ...
    -- function num : 0_22_0 , upvalues : startRadius
    return startRadius
  end
, function(x)
