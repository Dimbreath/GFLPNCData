...
UINavigationBar.OnTaskCommitComplete = function(self, taskStcData)
  -- function num : 0_7
  if self.__quickIsPeroid then
    return 
  end
...
UINavigationBar.OnTaskPeroidCommit = function(self, peroidData)
  -- function num : 0_8
...
UINavigationBar.GenAllBranches = function(self)
  -- function num : 0_9 , upvalues : _ENV, UINNavigationBranchItem
  local isFirst = true
...
UINavigationBar.InstallSpecialUI4Button = function(self, branchBtnItem)
  -- function num : 0_13 , upvalues : _ENV, SpecialUI4ButtonFuns
...
UINavigationBar.OnCklickAchievement = function(self)
  -- function num : 0_16 , upvalues : JumpManager, _ENV
