...
, 
{describe = 350428, id = 2, is_show = 2}
, 
...
, 
{describe = "INTERACT1", id = 10, name = "INTERACT1"}
, 
{describe = "INTERACT2", id = 11, name = "INTERACT2"}
, 
{describe = "INTERACT3", id = 12, name = "INTERACT3"}
, 
...
; 
[101] = {describe = 208045, id = 101, is_show = 8, name = "GAIN"}
, 
[102] = {describe = 62926, id = 102, is_show = 9, name = "LEVELUP"}
, 
[103] = {describe = 432664, id = 103, is_show = 10, name = "RANKUP"}
, 
[104] = {describe = "RANKMAX", id = 104, name = "RANKMAX"}
, 
[105] = {describe = 343117, id = 105, is_show = 11, name = "FORMATION"}
, 
[106] = {describe = 382309, id = 106, is_show = 12, name = "BATTLE"}
, 
[107] = {describe = 53739, id = 107, is_show = 13, name = "SKILL"}
, 
[108] = {describe = "MVP1", id = 108, is_show = 14, name = "MVP1"}
, 
[109] = {describe = "MVP2", id = 109, is_show = 15, name = "MVP2"}
, 
[110] = {describe = "DUTY", id = 110, name = "DUTY"}
, 
[111] = {describe = 214099, id = 111, is_show = 16, name = "RETREAT"}
, 
...
, 
[118] = {describe = 120297, id = 118, is_show = 17, name = "TITLE"}
}
local __default_values = {describe = "ALLHALLOWS", id = 1, is_show = 0, name = "AFTERNOON", pre_condition = __rt_1, pre_para1 = __rt_1, pre_para2 = __rt_1}
