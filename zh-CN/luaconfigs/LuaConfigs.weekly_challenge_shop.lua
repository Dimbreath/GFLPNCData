...
, 
{exp = 16, 
function_drop_ratio = {600, 350, 50}
, level = 6}
, 
{exp = 32, 
function_drop_ratio = {400, 500, 100}
, level = 7}
, 
{exp = 56, 
function_drop_ratio = {200, 650, 150}
, level = 8}
, 
{exp = 88, level = 9}
, 
{exp = 128, 
function_drop_ratio = {50, 650, 300}
, level = 10}
}
local __default_values = {exp = 0, 
function_drop_ratio = {100, 700, 200}
