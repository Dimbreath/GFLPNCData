...
GuideType_Tips.BeforeRunCode = function(self)
  -- function num : 0_4
end
...
GuideType_Tips.RunCurStep = function(self)
  -- function num : 0_6 , upvalues : GuideType_Base, GuideEnum, _ENV
...
GuideType_Tips.__PlayTipsGuide = function(self)
  -- function num : 0_8 , upvalues : _ENV, Type_RectTransform, CS_GameObject
...
GuideType_Tips.TryClearTipsGuide = function(id)
  -- function num : 0_10 , upvalues : _ENV, GuideConditionChecker, GuideEnum, CS_GSceneManager_Ins, CS_GameObject
