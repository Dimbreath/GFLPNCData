  ...
  if advTypeId < 100 then
    ...
    do
      if advTypeId == 100 then
        ...
        ;
        ((self.ui).icon).sprite = CRH:GetSprite(eChipCornerSprite[2], CommonAtlasType.ExplorationIcon)
      else
        if advTypeId == 101 then
          ...
          ;
          ((self.ui).icon).sprite = CRH:GetSprite(eChipCornerSprite[1], CommonAtlasType.ExplorationIcon)
        end
      end
