...
UIEpResidentStore.UpdEpResidentStore = function(self, storeDataList, level, exp, showRefreshTween, isOpen)
  ...
  for k,storeData in ipairs(storeDataList) do
    ...
    -- DECOMPILER ERROR: 3 unprocessed JMP targets
      ...
      if showRefreshTween and not lockd then
        if self.selectChipItem == chipItem.panel then
  ...
  if (ConfigData.weekly_challenge_shop).maxLevel <= level then
    ...
    -- DECOMPILER ERROR at PC130: Overwrote pending register: R13 in 'AssignReg'
    ...
    -- DECOMPILER ERROR at PC142: Overwrote pending register: R12 in 'AssignReg'
    ...
    do
      ...
      -- DECOMPILER ERROR at PC158: Confused about usage of register R13 for local variables in 'ReleaseLocals'
...
UIEpResidentStore._OnClickChipItem = function(self, chipPanel)
  ...
  for _,v in pairs((self.chipItemPool).listItem) do
    local elemData = (self.storeDataList)[v.idx]
    if v.panel ~= self.selectChipItem and not elemData.sold then
