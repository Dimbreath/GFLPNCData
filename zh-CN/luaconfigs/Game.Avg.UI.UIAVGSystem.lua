...
UIAVGSystem.RefreshAutoPlay = function(self, autoPlay, delayRatio)
  -- function num : 0_33 , upvalues : CS_DoTween
...
UIAVGSystem.OnClickSkip = function(self)
  -- function num : 0_34 , upvalues : CS_MessageCommon, _ENV
...
UIAVGSystem.OnClickBackground = function(self)
  -- function num : 0_35 , upvalues : _ENV, eAvgContentType
  if self.hasContent or self.hasImgTween or self.hasBranch or self.hasVideo then
    self.skipTween = true
    if self.hasImgTween then
      local list = {}
      for k,v in pairs(self.tweenImgItemDic) do
...
UIAVGSystem.GetHeroCommItem = function(self)
  -- function num : 0_36 , upvalues : _ENV, UINAvgHeroCommItem, CS_Material
...
UIAVGSystem.GetAvgHeroDissolveMat = function(self)
  -- function num : 0_38 , upvalues : _ENV, CS_Material
