...
ActivityFrameEnum.eActivityType = {BattlePass = 1, StarUp = 2, SevenDayLogin = 4, Lotter = 5, dailySignIn = "dailySignIn"}
...
ActivityFrameEnum.eActivityUIType = {StarUp = 1, BattlePass = 2, EventGrowBag = 3, SevenDayLogin = 4, dailySignIn = "dailySignIn"}
ActivityFrameEnum.eActiveityFakeId = {dailySignIn = 999999}
