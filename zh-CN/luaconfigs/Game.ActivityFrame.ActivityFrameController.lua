...
ActivityFrameController.UpdateActivity = function(self, activityElemDic)
  ...
  if self.timer == nil then
    self.timer = TimerManager:GetTimer(1, self.TimerCallback, self, false, false, false)
    ;
    (self.timer):Start()
  else
    ;
    (self.timer):Stop()
    ;
    (self.timer):Init(1, self.TimerCallback, self, false, false, false)
    ;
    (self.timer):Start()
  end
end
...
ActivityFrameController.AddFakeSigninActivityData = function(self)
  -- function num : 0_2 , upvalues : ActivityFrameEnum, ActivityFrameData
...
ActivityFrameController.GetActivityFrameState = function(self, id)
  -- function num : 0_5 , upvalues : ActivityFrameData
...
ActivityFrameController.SetReddot = function(self, actType, actId, count)
  -- function num : 0_11 , upvalues : ActivityFrameEnum, _ENV
  local id = self:GetIdByActTypeAndActId(actType, actId)
...
ActivityFrameController.__OpenActivitys = function(self, ids)
  -- function num : 0_12 , upvalues : _ENV, ActivityFrameOpenFunc
...
ActivityFrameController.ExtraTimeDeal = function(self)
  -- function num : 0_19 , upvalues : _ENV, HomeEnum
