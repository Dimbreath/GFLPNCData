...
UIEpChipDiscard.OnInit = function(self)
  ...
  ;
  (self.chipDetailPanel):SetBtnToParentHolder(((self.ui).btn_Discard).transform)
end
...
UIEpChipDiscard.OnClick = function(self, ChipDiscardItem)
  ...
  do
    ...
    (self.chipDetailPanel):Show()
    ;
    (self.chipDetailPanel):InitEpChipDetail(nil, ChipDiscardItem.chipData, self.dynPlayer, self.resloader, nil, true, eChipDetailPowerType.Subtract, true)
    ;
