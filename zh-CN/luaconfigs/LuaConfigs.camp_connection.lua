...
local camp_connection = {
    {
        [11] = {para = {2, 10}, text = 231535},
        [12] = {fetters_num = 12, para = {4, 20}, text = 231535},
        [13] = {fetters_num = 13, para = {6, 30, 2, 10}, text = 438606},
        [14] = {fetters_num = 14, para = {8, 40, 2, 20}, text = 438606}
    }, {
        [11] = {para = {5}, text = 333021},
        [12] = {fetters_num = 12, text = 333021},
        [13] = {fetters_num = 13, para = {15, 3}, text = 282554},
        [14] = {fetters_num = 14, para = {20, 4}, text = 282554}
    }, {
        [11] = {para = {10, 10}, text = 85698},
        [12] = {fetters_num = 12, para = {15, 18}, text = 85698},
        [13] = {fetters_num = 13, para = {22, 25}, text = 85698},
        [14] = {fetters_num = 14, para = {30, 40}, text = 85698}
    }, {
        [11] = {},
        [12] = {fetters_num = 12, para = __rt_2},
        [13] = {fetters_num = 13, para = __rt_3},
