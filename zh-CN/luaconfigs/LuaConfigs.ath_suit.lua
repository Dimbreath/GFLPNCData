...
, 
{describe = 359494, num = 3}
}
, 
{
{attrIdList = __rt_1, attrValueList = __rt_2, id = 2}
, 
{describe = 496623, id = 2, num = 3}
}
, 
{
{
