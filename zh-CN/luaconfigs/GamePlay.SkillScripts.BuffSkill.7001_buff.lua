...
bs_7001.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddAfterHurtTrigger("bs_7001_3", 1, self.OnAfterHurt, self.caster, nil, nil, nil, nil, nil, nil, (self.config).extra_arg)
end
...
bs_7001.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg, isTriggerSet)
