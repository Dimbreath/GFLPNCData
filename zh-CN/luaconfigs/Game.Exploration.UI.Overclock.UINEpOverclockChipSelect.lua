...
UINEpOverclockChipSelect.RefreshClockSelectItemDetail = function(self)
  ...
  ;
  (self.chipDetailPanel):InitEpChipDetail(self.selectedIndex, chipData, self.__dynPlayer, self.resLoader, nil)
  ;
...
UINEpOverclockChipSelect.OnClickCancel = function(self)
  -- function num : 0_9
  self:Hide()
