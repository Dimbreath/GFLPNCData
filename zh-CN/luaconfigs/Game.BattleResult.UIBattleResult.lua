...
UIBattleResult.__InitBattleReward = function(self)
  -- function num : 0_7 , upvalues : _ENV, ItemData, cs_DOTween
  ...
  do
    ...
    -- function num : 0_7_0 , upvalues : _ENV, rewardList, k
    UIManager:ShowWindowAsync(UIWindowTypeID.GlobalItemDetail, function(win)
      -- function num : 0_7_0_0 , upvalues : rewardList, k
      if win ~= nil then
    ...
    -- function num : 0_7_1 , upvalues : item, self
...
UIBattleResult.__OnBtnSkadaClick = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.ResultSkada, function(window)
    -- function num : 0_10_0 , upvalues : cs_BattleStatistics, self
    if window == nil then
      return 
    end
