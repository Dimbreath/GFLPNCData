...
bs_103402.config = {effectId = 10455, buffId_180 = 180, 
aoe_config = {effect_shape = 1, aoe_select_code = 3, aoe_range = 10}
, speed = 1, skill_time = 15, actionId = 1002, buffId_170 = 170}
...
bs_103402.PlaySkill = function(self, data)
  ...
  LuaSkillCtrl:CallBuff(self, self.caster, (self.config).buffId_170, 1, (self.arglist)[5], true)
  LuaSkillCtrl:StartShowSkillDurationTime(self, (self.arglist)[5])
end
  ...
  if eventId == eBattleEffectEvent.Trigger then
    ...
    if (skillResult.roleList).Count > 0 then
      for i = 0, (skillResult.roleList).Count - 1 do
        LuaSkillCtrl:CallBuff(self, (skillResult.roleList)[i], (self.config).buffId_180, 1, (self.arglist)[5])
      end
