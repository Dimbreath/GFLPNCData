...
[1] = {func = function()
  ...
  local collectRate = 0
  return tostring(PlayerDataCenter.heroCount) .. "<color=#777777><size=36>/" .. tostring(totalCount) .. "</size></color>"
end
}
, 
[2] = {func = function()
...
[3] = {func = function()
  ...
  return tostring((PlayerDataCenter.infinityData):GetCompletedInfinityLevelNum() * 10) .. "m"
end
}
, 
[4] = {func = function()
...
UIUserInfo.OnInit = function(self)
  -- function num : 0_4 , upvalues : _ENV, UINUserInfoBottomItem
...
UIUserInfo.RefreshPlayerInfo = function(self)
  ...
  local timeDate = TimestampToDate(PlayerDataCenter.createRelativeTm)
...
UIUserInfo.RefreshBottomInfo = function(self)
  -- function num : 0_11 , upvalues : _ENV, newBottomItemTab
