...
, 
[6007] = {describe = 163692, icon = "hp-", id = 6007, logic = 4, logic_per = -30, name = 98759}
, 
[6008] = {describe = 387023, icon = "recover", id = 6008, logic = 4, logic_per = 30}
, 
[6009] = {describe = 293392, icon = "recover", id = 6009, logic = 5, logic_per = 80, name = 427352}
, 
[7001] = {describe = 145616, icon = "ICON_g_buff_5", id = 7001, logic = 1, logic_per = 30, name = 302907, tigger_type = 2}
, 
...
, 
[8006] = {describe = 66046, icon = "ICON_g_buff_1", id = 8006, logic = 3, logic_per = 50, name = 11420, tigger_type = 1}
, 
...
local __default_values = {describe = 100045, icon = "ICON_g_buff_16", id = 100, is_show = true, logic = 9, logic_per = 0, name = 10102, tigger_type = 3}
