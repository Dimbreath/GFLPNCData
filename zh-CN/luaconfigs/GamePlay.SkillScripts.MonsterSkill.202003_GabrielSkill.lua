...
bs_202003.PlaySkill = function(self, data)
  ...
  if role.roleDataId == 102 then
    LuaSkillCtrl:CallBuff(self, role, 124, 1, arg5)
  else
    LuaSkillCtrl:CallBuff(self, role, (self.config).buffId_278, 1, arg5)
  end
