...
, athOptimizeFailureCount = 10000, athPowerFormula = "(ath[2]*1+ath[3]*8+ath[4]*17+ath[5]*35+ath[6]*0+ath[7]*14+ath[8]*0+ath[9]*14+ath[10]*4+ath[11]*0+ath[12]*17+ath[13]*0+ath[14]*17+ath[15]*1+ath[16]*0+ath[202]*6+ath[203]*6+ath[204]*5+ath[212]*5)*1", 
...
, battleCrazyStartTime = 45, battleMap_bench_count = 5, battleMoveEffectInterval = 6, battleMoveRoleEffectExistInterval = 6, battleMoveRoleInterval = 3, battleRoleWaitBuffer = 1000, buildQueBuildingId = 1002, bulletTime = 0.1, changeNameItemId = 905, changeNameItemNum = 1, dragInvokeDelayDuration = 0.1, dungeonHeroMainAttrIds = __rt_1, epBuffShowMax = 5, factoryLineMaxCycle = 10, firstCommonAttackRatio = 100, 
first_formation = {1001, 1005, 1003}
, firtBoardHeroID = 1001, formationCount = 5, 
formation_default_skill = {5001, 5005, 5010}
, getChipEffectTime = 0.5, getChipMoveTime = 0.5, globalChipDropNum = 2, globalExpItemId = 1012, heroEnterScoreDenominator = 720, max_bench_hero = 3, max_formation_hero = 8, max_formation_playerSkill = 3, max_stage_hero = 5, min_stage_hero = 1, mpGrowInterval = 15, oasisBuildingOutputCeiling = 28800, 
oasisObstacleArea = {}
