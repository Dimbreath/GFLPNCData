...
bs_1067.config = {effectId_loop = 10364, effectId_line = 10365, effectId_weapon = 10367, effectId_start = 10363, buffId_66 = 66, actionId = 1002, action_speed = 1, skill_time = 25, start_time = 20, 
...
bs_1067.OnActionCallBack = function(self, target, grid)
  ...
  local grid_ex = LuaSkillCtrl:CallFindGridMostRolesArounded(2)
  if grid_ex ~= nil then
    grid = grid_ex
  end
