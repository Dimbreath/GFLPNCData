...
HeroData.GetAttr = function(self, attrId, withoutAth, dontWarning, onlyBaseAttr)
  -- function num : 0_3 , upvalues : attrIdOffset, _ENV
...
HeroData.__UpdateBaseArriDic = function(self, newLevel, newRank, newPotential)
  -- function num : 0_5 , upvalues : _ENV, attrIdOffset
  if not newRank then
...
HeroData.GetHeroTaskIds = function(self)
  -- function num : 0_50
  return (self.heroCfg).personal_task
end

HeroData.IsHaveCompletedHeroTask = function(self)
  -- function num : 0_51 , upvalues : _ENV
  for index,taskId in ipairs(self:GetHeroTaskIds()) do
