...
bs_102802.config = {effectId_skill = 10707, buffId_228 = 228, 
HurtConfig = {hit_formula = 0, basehurt_formula = 10150, crit_formula = 0}
, actionId = 1002, action_speed = 1, skill_time = 31, start_time = 11}
...
bs_102802.SkillEventFunc = function(self, effect, eventId, target)
  ...
  if eventId == eBattleEffectEvent.Trigger then
    LuaSkillCtrl:CallBuffRepeated(self, target.targetRole, (self.config).buffId_228, 1, (self.arglist)[1], false, self.OnBuffExecute)
  end
end
