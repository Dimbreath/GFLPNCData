...
JumpManager.Jump = function(self, jumpType, beforeJumpCallback, jumpOverCallback, argList, isCoverJump)
  ...
  if bool then
    ...
    if not isCoverJump and JumpManager:IsJumpNeedBack2Home(jumpType) then
      ...
      do
        if not jumpCorverArgs then
          (FuncArray[num])(newJumpOverCallback, argList, isCoverJump, {
hideWinList = {}
})
        end
      end
...
JumpManager.IsJumpNeedBack2Home = function(self, jumpType)
  ...
  local notNeedBack2Home = {(JumpManager.eJumpTarget).BuyStamina, (JumpManager.eJumpTarget).Home}
  ...
  local sectorTypes = {(JumpManager.eJumpTarget).Sector, (JumpManager.eJumpTarget).ATHDungeon, (JumpManager.eJumpTarget).fragDungeon, (JumpManager.eJumpTarget).resourceDungeon, (JumpManager.eJumpTarget).DynSectorLevel}
...
JumpManager.Jump2Hro = function(self, jumpOverCallback, argList, isCoverJump, jumpCorverArgs)
  ...
  local heroStateWin = UIManager:GetWindow(UIWindowTypeID.HeroPotential)
  ...
  if (heroWin == nil or not heroWin.active) and isCoverJump then
    ...
    ;
    (table.insertto)(hideWinList, jumpCorverArgs.hideWinList)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.HeroList, function(win)
    -- function num : 0_18_0 , upvalues : _ENV, isCoverJump, jumpCorverArgs
    if win == nil then
      return 
    end
...
JumpManager.Jump2BuyStamina = function(self, jumpOverCallback)
  ...
  ctrl:GetShopData(shopId, function(shopData)
    -- function num : 0_30_0 , upvalues : goodData, shelfId, _ENV, jumpOverCallback, quickBuyData
    goodData = (shopData.shopGoodsDic)[shelfId]
    UIManager:ShowWindowAsync(UIWindowTypeID.QuickBuy, function(win)
      -- function num : 0_30_0_0 , upvalues : _ENV, jumpOverCallback, goodData, quickBuyData
      if win == nil then
...
JumpManager.Jump2DailyChallenge = function(self, jumpOverCallback)
  ...
  if isInSector then
    ...
    ;
    (sectorController.uiCanvas):OnClickDailyChallenge()
    if jumpOverCallback ~= nil then
      jumpOverCallback()
    end
    return 
  ...
  Home.enterSectorJumpCallback = BindCallback(self, function()
    ...
    local EnterFragDungeon = function()
      -- function num : 0_32_0_0 , upvalues : sectorController, EnterFragDungeon, self
      (sectorController.uiCanvas):OnClickDailyChallenge()
      ;
...
JumpManager.Jump2DailyChallengeValidate = function(self)
  ...
  local isDailyChallengeUnlock = FunctionUnlockMgr:ValidateUnlock(proto_csmsg_SystemFunctionID.SystemFunctionID_DailyChallenge)
...
JumpManager.Jump2WeeklyChallenge = function(self, jumpOverCallback)
  ...
  Home.enterSectorJumpCallback = BindCallback(self, function()
    ...
    local EnterFragDungeon = function()
      -- function num : 0_34_0_0 , upvalues : sectorController, EnterFragDungeon, self
      (sectorController.uiCanvas):OnClickWeeklyChallenge()
      ;
      (sectorController.homeToSectorDirector):stopped("-", EnterFragDungeon)
      self:ClearSectorJumpId()
...
JumpManager.Jump2StrategyOverview = function(self, jumpOverCallback, argList)
  ...
  if isInSector then
    ...
    local Home = UIManager:GetWindow(UIWindowTypeID.Home)
    Home.enterSectorJumpCallback = BindCallback(self, function()
    -- function num : 0_38_0 , upvalues : _ENV, sectorId, buildId
    local sectorController = ControllerManager:GetController(ControllerTypeId.SectorController, false)
    if sectorController == nil then
      error("can\'t get sectorController")
      return 
    end
    local EnterSectorJump = function()
      -- function num : 0_38_0_0 , upvalues : sectorController, sectorId, buildId, EnterSectorJump
      sectorController:ShowStrategyOverview(sectorId, buildId)
      ;
      (sectorController.homeToSectorDirector):stopped("-", EnterSectorJump)
    end
...
JumpManager.Jump2OasisBuilding = function(self, jumpOverCallback, argList)
  ...
  if Oasis ~= nil then
    ...
    -- function num : 0_40_0 , upvalues : oasisController, buildId
...
JumpManager.Jump2SectorFragDungeon = function(self, jumpOverCallback, argList)
  ...
  local Home = UIManager:GetWindow(UIWindowTypeID.Home)
  Home.enterSectorJumpCallback = BindCallback(self, function()
    -- function num : 0_42_0 , upvalues : _ENV, heroId, self
    local sectorController = ControllerManager:GetController(ControllerTypeId.SectorController, false)
    if sectorController == nil then
      error("can\'t get sectorController")
      return 
    ...
    local EnterFragDungeon = function()
      -- function num : 0_42_0_0 , upvalues : sectorController, heroId, EnterFragDungeon, self
      (sectorController.uiCanvas):EnterFriendshipDungeon(heroId, true)
      ;
      (sectorController.homeToSectorDirector):stopped("-", EnterFragDungeon)
      self:ClearSectorJumpId()
...
JumpManager.Jump2SectorResourceDungeon = function(self, jumpOverCallback, argList)
  ...
  local Home = UIManager:GetWindow(UIWindowTypeID.Home)
  Home.enterSectorJumpCallback = BindCallback(self, function()
    -- function num : 0_44_0 , upvalues : _ENV, typeID, self
    local sectorController = ControllerManager:GetController(ControllerTypeId.SectorController, false)
    if sectorController == nil then
      error("can\'t get sectorController")
      return 
    ...
    local EnterFragDungeon = function()
      -- function num : 0_44_0_0 , upvalues : sectorController, typeID, EnterFragDungeon, self
      (sectorController.uiCanvas):EnterMatDungeon(typeID, true)
      ;
      (sectorController.homeToSectorDirector):stopped("-", EnterFragDungeon)
      self:ClearSectorJumpId()
...
JumpManager.Jump2SectorATHDungeon = function(self, jumpOverCallback, argList)
  ...
  local Home = UIManager:GetWindow(UIWindowTypeID.Home)
  Home.enterSectorJumpCallback = BindCallback(self, function()
    -- function num : 0_46_0 , upvalues : _ENV, typeID, self
    local sectorController = ControllerManager:GetController(ControllerTypeId.SectorController, false)
    if sectorController == nil then
      error("can\'t get sectorController")
      return 
    ...
    local EnterATHDungeon = function()
      -- function num : 0_46_0_0 , upvalues : sectorController, typeID, EnterATHDungeon, self
      (sectorController.uiCanvas):EnterATHDungeon(typeID, true)
      ;
...
JumpManager.Jump2DynTask = function(self, jumpOverCallback, argList, isCoverJump, jumpCorverArgs)
  ...
  taskController:ShowTaskUI(typeID, fromWhere, function()
    -- function num : 0_48_0 , upvalues : jumpOverCallback, _ENV, isCoverJump, jumpCorverArgs
    if jumpOverCallback ~= nil then
      jumpOverCallback()
    end
    local homeWindow = UIManager:GetWindow(UIWindowTypeID.Home)
...
JumpManager.Jump2DynShop = function(self, jumpOverCallback, argList, isCoverJump, jumpCorverArgs)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.ShopMain, function(win)
    -- function num : 0_50_0 , upvalues : shopId, shopDataId, shopPageId, _ENV, isCoverJump, jumpOverCallback
    if win ~= nil then
      if shopId == nil then
        win:InitShopMain()
      else
...
JumpManager.Jump2DynSectorLevel = function(self, jumpOverCallback, argList)
  ...
  local Home = UIManager:GetWindow(UIWindowTypeID.Home)
  Home.enterSectorJumpCallback = BindCallback(self, function()
    -- function num : 0_52_0 , upvalues : _ENV, sectorLevelId, self
    local sectorController = ControllerManager:GetController(ControllerTypeId.SectorController, false)
    if sectorController == nil then
      error("can\'t get sectorController")
      return 
    ...
    sectorController:SetJumpInCallback(function()
      -- function num : 0_52_0_0 , upvalues : sectorController, sectorLevelId, self
      sectorController:OnSectorItemClicked(sectorLevelId)
      self:ClearSectorJumpId()
    end
)
...
JumpManager.DirectShowShop = function(self, beforeJumpCallback, jumpOverCallback, shopId)
  -- function num : 0_58 , upvalues : JumpManager, _ENV
  local argList = {shopId}
  if not JumpManager:Jump2DynShopValidate(argList) then
    return 
  end
  if beforeJumpCallback ~= nil then
    beforeJumpCallback()
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.ShopMain, function(win)
    -- function num : 0_58_0 , upvalues : shopId, _ENV, jumpOverCallback
    if win == nil then
      return 
    end
...
JumpManager.Jump2DynWarehouse = function(self, jumpOverCallback, argList, isCoverJump, jumpCorverArgs)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.Warehouse, function(window)
    -- function num : 0_60_0 , upvalues : _ENV, isCoverJump, itemId, jumpCorverArgs
    local homeWindow = UIManager:GetWindow(UIWindowTypeID.Home)
    if homeWindow ~= nil and not isCoverJump then
      homeWindow:OpenOtherWin()
    end
    window:InitWarehouse(itemId)
