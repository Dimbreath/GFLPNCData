...
HurtConfig1 = {hit_formula = 0, basehurt_formula = 10061, crit_formula = 0, crithur_ratio = 0}
, 
HurtConfig2 = {hit_formula = 0, basehurt_formula = 10061, crit_formula = 10003}
...
bs_103602.OnCallback = function(self, num, target, data)
  ...
  if num == 1 then
    ...
    LuaSkillCtrl:HurtResult(self, skillResult, (self.config).HurtConfig2, {hurtpro})
    ...
    do
      ...
      local skillResult = LuaSkillCtrl:CallSkillResultNoEffect(self, target)
      LuaSkillCtrl:PlayAuHit(self, target)
      LuaSkillCtrl:HurtResult(self, skillResult, (self.config).HurtConfig1, {hurtpro})
      skillResult:EndResult()
    end
  end
end
