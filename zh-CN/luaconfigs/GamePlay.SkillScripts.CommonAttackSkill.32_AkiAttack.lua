...
local base = bs_1
bs_32.config = {effectId_start1 = 10691, effectId_start2 = 10692, action1 = 1001, action2 = 1004, effectId_hit1 = 10693, effectId_hit2 = 10694, effectId_Chit1 = 10695, effectId_Chit2 = 10696}
...
bs_32.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddAfterHurtTrigger("bs_32_3", 1, self.OnAfterHurt, self.caster, nil, nil, nil, nil, nil, 32)
end

bs_32.OnAttackTrigger = function(self, target, data, atkSpeedRatio, atkActionId, atkTriggerFrame)
