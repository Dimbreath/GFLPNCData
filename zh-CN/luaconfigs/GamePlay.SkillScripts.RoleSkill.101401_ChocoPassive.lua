...
bs_101401.config = {buffId_214 = 214, buffId_215 = 215, effectId_passive = 10648, 
heal_config = {baseheal_formula = 10100, heal_number = 0, correct_formula = 9990}
...
bs_101401.OnAfterBattleStart = function(self)
  ...
  LuaSkillCtrl:StartTimer(nil, (self.arglist)[1], function()
    ...
    local num = (self.caster):GetBuffTier((self.config).buffId_214)
    ...
    if targetList.Count > 0 then
      for i = 0, targetList.Count - 1 do
        ...
        if (self.arglist)[3] > 0 then
          LuaSkillCtrl:CallBuff(self, target, (self.config).buffId_215, 1, (self.arglist)[5])
        end
      end
    end
    do
