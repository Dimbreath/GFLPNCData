...
[13] = {id = 13, 
jump_arg = {0, 2}
, jump_target = 109, marker = 2000, name = 384123, pre_condition = __rt_1, red_dot_path = "Main.ActivityFrameNovice"}
, 
...
, 
[22] = {force_lock = true, id = 22, img = "ICON_dormitory", name = 143955, 
pre_para1 = {1100}
}
, 
...
local __default_values = {force_lock = false, id = 1, img = "ICON_activity", jump_arg = __rt_1, jump_is_cover = false, jump_target = 0, marker = 0, name = 104709, pre_condition = __rt_2, pre_para1 = __rt_1, pre_para2 = __rt_1, red_dot_path = "", special = __rt_1}
