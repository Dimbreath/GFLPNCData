...
ShopGoodData.CreateNewShopGoodData = function(goodCfg, shopType, shopId, purchases, hasDouble)
  -- function num : 0_1 , upvalues : ShopGoodData
  local ShopGoodData = (ShopGoodData.New)()
  ShopGoodData:InitNewShopGoodData(goodCfg, shopType, shopId, purchases, hasDouble)
  return ShopGoodData
end
...
ShopGoodData.InitNewShopGoodData = function(self, goodCfg, shopType, shopId, purchases, hasDouble)
...
ShopGoodData.m_HandleDifferData = function(self, shopType, shopId, FreshType)
  ...
  elseif shopType == (ShopEnum.eShopType).Resource or shopType == (ShopEnum.eShopType).ResourceRefresh then
    self.isLimit = true
    self.isSoldOut = true
