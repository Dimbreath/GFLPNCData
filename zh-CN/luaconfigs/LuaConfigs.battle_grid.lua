...
local battle_grid = {
{name = 212779, src_name = "FX/Common/FX_UI/FXP_LatticeEffect/FXP_ReduceCD"}
, 
...
, 
{grid_skill = "gs_10", icon = "ICON_Grid010", id = 10, info = 177889, name = 430291, src_name = "FX/Common/FX_UI/FXP_LatticeEffect/FXP_Wangyouye"}
, 
{grid_skill = "gs_11", icon = "ICON_Grid011", id = 11, info = 86150, name = 26593, src_name = "FX/Common/FX_UI/FXP_LatticeEffect/NewgroundFX/FXP_Weiwangyoucao/FXP_Weiwangyoucao"}
, 
...
local __default_values = {grid_skill = "gs_1", icon = "ICON_Grid001", id = 1, info = 165154, name = 103404, src_name = "FX/Common/FX_UI/FXP_LatticeEffect/FXP_Aim"}
