...
UIDungeonFailureResult_Temp.FailExploration = function(self, clearAction, closeAction, statisticFunc)
...
UIDungeonFailureResult_Temp.Jump2HeroState = function(self)
