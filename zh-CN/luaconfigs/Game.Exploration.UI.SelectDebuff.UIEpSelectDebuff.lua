...
UIEpSelectDebuff.OnInit = function(self)
  ...
  self.__OnItemValueChange = BindCallback(self, self.OnItemValueChange)
...
UIEpSelectDebuff.OnItemValueChange = function(self, buffItemData, flag)
  -- function num : 0_4
  -- DECOMPILER ERROR at PC9: Confused about usage of register: R3 in 'UnsetPending'

  if flag and not (self.selectedBuffIdDic)[buffItemData.id] then
    (self.selectedBuffIdDic)[buffItemData.id] = true
  else
    -- DECOMPILER ERROR at PC20: Confused about usage of register: R3 in 'UnsetPending'

    if not flag and (self.selectedBuffIdDic)[buffItemData.id] then
      (self.selectedBuffIdDic)[buffItemData.id] = nil
    end
  end
  self:RefreshEnemyBattlePow()
end
...
UIEpSelectDebuff.RefreshMonsterLevel = function(self)
  ...
  if realCurLevel < (ConfigData.monster_level).monster_level_max then
