...
UINChipItem.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).btnRoot, self, self.OnClickChipEvent) -- DECOMPILER ERROR at PC14: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).count).text = "" -- DECOMPILER ERROR at PC22: Confused about usage of register: R1 in 'UnsetPending'
    ;
    (self.ui).obj_Count = (self.transform):FindComponent("Count",
...
UINChipItem.InitChipItem = function(self, chipData, showCount, onClickEvent)
    ...
    self.__onClickEvent = onClickEvent -- DECOMPILER ERROR at PC12: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).btnRoot).interactable = onClickEvent ~= nil -- DECOMPILER ERROR at PC17: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).quality).color = chipData:GetColor() -- DECOMPILER ERROR at PC25: Confused about usage of register: R4 in 'UnsetPending'
    ;
...
UINChipItem.BindDefaultClickEvent = function(self)
    ...
    self.__onClickEvent = onClickEvent -- DECOMPILER ERROR at PC11: Confused about usage of register: R2 in 'UnsetPending'
    ;
...
UINChipItem.UpdateChipItem = function(self)
    ...
    if self.showCount then
        (((self.ui).count).gameObject):SetActive(true) -- DECOMPILER ERROR at PC16: Confused about usage of register: R1 in 'UnsetPending'
        ;
...
UINChipItem.UnlockChipItem = function(self, isUnlock)
    ...
    if not isUnlock or not Color.white then
        ...
        color.a = 0.4 -- DECOMPILER ERROR at PC18: Confused about usage of register: R3 in 'UnsetPending'
        ;
