...
UIEpRoomInterface.SetInterfaceRightPass =
    function(self, isPass, color)
        -- function num : 0_2 , upvalues : _ENV
        if isPass then
            ((self.ui).img_Right):SetIndex(1) -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'
            ;
            (((self.ui).img_Right).image).color = color
        else

            ((self.ui).img_Right):SetIndex(0) -- DECOMPILER ERROR at PC22: Confused about usage of register: R3 in 'UnsetPending'
            ;
            (((self.ui).img_Right).image).color = Color.white
        end
    end

UIEpRoomInterface.SetInterfaceLeftPass =
    function(self, isPass, color)
        -- function num : 0_3 , upvalues : _ENV
        if isPass then
            ((self.ui).img_Left):SetIndex(1) -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'
            ;
            (((self.ui).img_Left).image).color = color
        else

            ((self.ui).img_Left):SetIndex(0) -- DECOMPILER ERROR at PC22: Confused about usage of register: R3 in 'UnsetPending'
            ;
            (((self.ui).img_Left).image).color = Color.white
        end
    end
