...
local UIEpBuffShowItem = require(
                             "Game.Exploration.UI.EpBuffShow.UIEpBuffShowItem")
UIEpBuffShow.OnInit = function(self)
    -- function num : 0_0 , upvalues : _ENV
    ((self.ui).iconItem):SetActive(false);
    ((self.ui).nameItem):SetActive(false)
    self.buffItemList = {};
    (((self.ui).ani_buffShow).onComplete):AddListener(
        BindCallback(self, self.__OnBuffAniPlayerComplete))
end
...
UIEpBuffShow.__OnBuffAniPlayerComplete =
    function(self)
        -- function num : 0_2
        self:Delete()
    end
