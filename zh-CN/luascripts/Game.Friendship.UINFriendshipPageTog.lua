...
UINFriendshipPageTog.InitAchivTypeToggle =
    function(self, index, isOn, onChangedEvent)
        -- function num : 0_1 , upvalues : FriendshipEnum
        self.index = index
        self.onChangedEvent = onChangedEvent -- DECOMPILER ERROR at PC4: Confused about usage of register: R4 in 'UnsetPending'
        ;
