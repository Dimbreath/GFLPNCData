...
UINAchievementTog.OnInit = function(self)
    ...
    (UIUtil.LuaUIBindingTable)(self.transform, self.ui);
    (UIUtil.AddValueChangedListener)((self.ui).tog_achieveTypeItem, self,
                                     self.OnValueChage)
end

UINAchievementTog.InitAchieveTog = function(self, achieveTypeCfg,
                                            openPageCallback)
    -- function num : 0_1 , upvalues : _ENV
    self.type = achieveTypeCfg.type
    self.task_type = achieveTypeCfg.task_type
    self.openPageCallback = openPageCallback -- DECOMPILER ERROR at PC11: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).tex_TypeName).text = (LanguageUtil.GetLocaleText)(
                                        achieveTypeCfg.name) -- DECOMPILER ERROR at PC17: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).tex_TypeEN).text = tostring(achieveTypeCfg.english_name)
end
...
UINAchievementTog.OnValueChage = function(self, bool)
    ...
    if bool then
        ...
        ((self.ui).tex_TypeName).color = (self.ui).color_gray -- DECOMPILER ERROR at PC36: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.ui).tex_TypeEN).color = (self.ui).color_gray;
        (self.extendTween):PlayBackwards();
        ((self.ui).img_Select):SetIndex(0)
