...
UINAthMatUpgrade.OnInit = function(self)
  ...
  self.lvUpMatPool = (UIItemPool.New)(UINHeroLevelUpItem, (self.ui).upgradeItem)
...
UINAthMatUpgrade.SetAthMatNodeChangeHeightFunc =
    function(self, athMatNodeChangeHeightFunc)
        -- function num : 0_1
        self.athMatNodeChangeHeightFunc = athMatNodeChangeHeightFunc
    end
