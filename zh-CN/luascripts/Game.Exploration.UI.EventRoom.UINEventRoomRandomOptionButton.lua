...
UINEventRoomRandomOptionButton.InitNormalButton = function(self, cfg, idx, clickCallback)
...
UINEventRoomRandomOptionButton.InitRandomButton = function(self, cfg, idx, clickCallback)
...
UINEventRoomRandomOptionButton.OnClick = function(self)
  -- function num : 0_3
...
UINEventRoomRandomOptionButton.OnDelete = function(self)
