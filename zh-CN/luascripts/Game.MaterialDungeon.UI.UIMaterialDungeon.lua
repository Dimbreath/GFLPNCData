...
UIMaterialDungeon.__loadChapterUI = function(self, matUIData)
  ...
  ;
  (self.chaptersUI):UpdateWithChapterList(chapterItemList, matUIData.totalCompleteChapterCount, matUIData.totalChapterCount, self.onBattleStart)
end
...
, self.selectItemId))
  ...
  fmtCtrl:InitFromationCtrl(eFmtFromModule.MaterialDungeon, ((self.selectChapterItem).cfg).id, enterFormationFunc, exitFormationFunc, startBattleFunc)
end
