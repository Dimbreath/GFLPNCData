...
UISectorAchivItem.InitSectorAchivItem = function(self, achivCfg)
    ...
    self.id = achivCfg.id
    local starCount = (achivCfg.conditionNums)[1] -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).count).text = tostring(starCount)
end

UISectorAchivItem.UpdateSectorAchivItem =
    function(self, state)
