...
local AvgCfg_cpt02_e_23_01 = {
    ...
    [28] = {
        imgTween = {
            {imgId = 101, pos = {-50, -350, 0}, alpha = 0.2, isDark = false},
            {
                imgId = 101,
                duration = 0.2,
                pos = {0, -350, 0},
                alpha = 1,
                isDark = false
            }, {imgId = 103, pos = {50, -350, 0}, alpha = 0, isDark = false}
        },
        content = 280,
        contentType = 3,
        speakerHeroId = -1,
    ...
    [40] = {
        ...
        speakerHeroId = 1003,
        speakerHeroPosId = 1,
        branch = {{content = 401, jumpAct = 41}, {content = 402, jumpAct = 44}}
    },
    [41] = {
        imgTween = {
            {
    ...
    [51] = {
        imgTween = {{imgId = 103, alpha = 0}, {imgId = 101, alpha = 0}},
        content = 510,
        contentType = 2
    },
    [52] = {
    ...
    [54] = {
        imgTween = {
            {imgId = 1, pos = {0, -310, 0}, alpha = 1, isDark = false},
            {imgId = 103, alpha = 0}, {imgId = 101, alpha = 0}
        },
        content = 540,
        contentType = 3,
        speakerHeroId = 1001,
    ...
    [62] = {
        imgTween = {
            {imgId = 4, alpha = 0},
            {imgId = 2, pos = {-50, -330, 0}, rot = {0, 0, 0}, alpha = 0.2},
            {
                imgId = 2,
                pos = {0, -330, 0},
                duration = 0.2,
    ...
    [66] = {
        imgTween = {
            {imgId = 3, alpha = 0},
            {imgId = 5, pos = {380, -300, 0}, rot = {0, 0, 0}, alpha = 1},
            {imgId = 1, isDark = true}
        },
        content = 660,
        contentType = 3,
    ...
    [68] = {
        ...
        imgTween = {{imgId = 1, alpha = 0}, {imgId = 5, alpha = 0}},
        content = 680,
        contentType = 1
    },
    [69] = {
        imgTween = {
            {imgId = 1, alpha = 1},
            {imgId = 101, pos = {450, -350, 0}, alpha = 0.2, rot = {0, 180, 0}},
            {
                imgId = 101,
                duration = 0.2,
                pos = {400, -350, 0},
    ...
    [71] = {
        ...
        imgTween = {{imgId = 1, alpha = 0}, {imgId = 101, alpha = 0}},
        content = 710,
        contentType = 1,
        audio = {bgm = {stop = true, sheet = "Music"}}
    },
    ...
    [86] = {
        imgTween = {{imgId = 4, isDark = false}, {imgId = 103, isDark = false}},
        content = 860,
        contentType = 3,
        speakerHeroId = -1,
        speakerHeroPosId = 3
