...
local AvgCfg_cpt00_tutorial_15 = {
[1] = {
images = {
...
, content = 10, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 3}
, 
...
return AvgCfg_cpt00_tutorial_15
...
local AvgCfg_cpt00_tutorial_15 = {
    [1] = {
        ...
        imgTween = {
            {imgId = 1, posId = 5}, {imgId = 1, duration = 0.2, posId = 4}
        },
        content = 10,
        contentType = 3,
        speakerHeroId = 1001,
