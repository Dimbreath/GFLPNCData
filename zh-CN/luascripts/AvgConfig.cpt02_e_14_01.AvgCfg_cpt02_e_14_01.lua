...
[1] = {
images = {
{imgId = 99, imgPath = "cpt02/cpt02_e_cg001", imgType = 2, 
scale = {2, 2, 2}
, fullScreen = true, 
pos = {300, 200, 0}
}
...
, content = 20, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 3}
, 
[3] = {
imgTween = {
{imgId = 99, duration = 1, 
...
, content = 40, contentType = 3, speakerHeroId = 1004, speakerHeroPosId = 1}
, 
[5] = {
imgTween = {
{imgId = 4, duration = 0.2, 
...
, content = 70, contentType = 3, speakerHeroId = 1004, speakerHeroPosId = 1}
, 
[8] = {
imgTween = {
{imgId = 4, duration = 0.2, 
...
, content = 80, contentType = 2, contentShake = true}
, 
[9] = {
imgTween = {
{imgId = 102, duration = 0.2, 
...
, content = 90, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
, 
[10] = {
imgTween = {
{imgId = 102, duration = 0.2, 
...
, content = 100, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 3, contentShake = true}
, 
[11] = {
imgTween = {
{imgId = 99, duration = 1, 
...
, content = 110, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2, contentShake = true}
, 
[12] = {
imgTween = {
{imgId = 99, duration = 1, 
...
[13] = {
images = {
{imgId = 98, imgPath = "cpt02/cpt02_e_bg004", imgType = 2, fullScreen = true}
}
, 
imgTween = {
{imgId = 99, alpha = 0, duration = 1}
, 
{imgId = 102, duration = 1.5, 
pos = {-100, -400, 0}
, alpha = 1}
}
, content = 130, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2, contentShake = true}
, 
[14] = {
imgTween = {
{imgId = 4, duration = 0.2, 
...
, content = 140, contentType = 3, speakerHeroId = 1004, speakerHeroPosId = 1}
, 
[15] = {
imgTween = {
{imgId = 4, duration = 0.2, 
...
[16] = {
imgTween = {
{imgId = 102, duration = 1, 
pos = {-100, -400, 0}
, alpha = 1}
}
, content = 160, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
, 
[17] = {
imgTween = {
{imgId = 102, alpha = 0}
...
, content = 220, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
, 
[23] = {
imgTween = {
{imgId = 1, duration = 0.5, 
...
, content = 280, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 3}
, 
[29] = {
imgTween = {
{imgId = 1, alpha = 0}
...
[34] = {
imgTween = {
{imgId = 98, duration = 2, shake = true}
}
...
, content = 420, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
}
