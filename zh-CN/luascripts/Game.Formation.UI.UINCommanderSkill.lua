...
UINCommanderSkill.InitCommanderSkill = function(self, treeId, skillId, resloader)
  -- function num : 0_1 , upvalues : _ENV
  local playerSkillData = ((((PlayerDataCenter.CommanderSkillModualData).CommanderSkillTreeDataDic)[treeId]).commanderSkillDataDic)[skillId]
  ...
  resloader:LoadABAssetAsync(PathConsts:GetAtlasAssetPath("CommanderSkillIcons"), function(spriteAtlas)
    ...
    ;
    ((self.ui).img_SkillIcon).sprite = spriteAtlas:GetSprite(playerSkillData:GetIcon())
  end
)
end
