...
bs_1056.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddTrigger(eSkillTriggerType.AfterHurt, "bs_1056_3", 1, self.OnAfterHurt)
end

bs_1056.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg)
