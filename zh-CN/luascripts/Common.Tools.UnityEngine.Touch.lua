...
Touch.New = function(fingerId, position, rawPosition, deltaPosition, deltaTime,
                     tapCount, phase)
...
Touch.Init = function(self, fingerId, position, rawPosition, deltaPosition,
                      deltaTime, tapCount, phase)
    -- function num : 0_2
...
Touch.unity_touch = (CS.UnityEngine).Touch -- DECOMPILER ERROR at PC46: Confused about usage of register: R8 in 'UnsetPending'
;
(CS.UnityEngine).TouchPhase = TouchPhase -- DECOMPILER ERROR at PC49: Confused about usage of register: R8 in 'UnsetPending'
;
