...
OasisBuildingDynData.UpdateLockAndBuild = function(self)
  ...
  if not self.unlock then
    ...
    for i = 1, #level1Cfg.pre_condition do
      if (level1Cfg.pre_condition)[i] == CheckerTypeId.BuildingLevel and (level1Cfg.pre_para1)[i] == eBuildingId.OasisMainBuilding then
        self.mainBdUnlockLevel = (level1Cfg.pre_para2)[i]
        self.mainBdName = (((PlayerDataCenter.AllBuildingData).builtSort)[1]).name
        break
      end
    end
  end
...
OasisBuildingDynData.GetBuffItems = function(self, level, getNext)
  ...
  for i = 1, #levelCfg.logic do
    ...
    if logic == eBuildingLogic.ResourceOutput then
      ...
      if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.ResourceOutput then
      ...
      do
        if logic == eBuildingLogic.FactoryPipelie then
          ...
          if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.FactoryPipelie then
          ...
          do
            if logic == eBuildingLogic.ResourceLimit then
              ...
              if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.ResourceLimit then
              ...
              do
                if logic == eBuildingLogic.GlobalExpCeiling then
                  ...
                  if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.GlobalExpCeiling then
                    (buffDict[i]).nextInfoValue = tostring((nextlvlCfg.para1)[i])
                  end
                else
                  do
                    if logic == eBuildingLogic.StaminaCeiling then
                      ...
                      if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.StaminaCeiling then
                        (buffDict[i]).nextInfoValue = tostring((nextlvlCfg.para1)[i])
                      end
                    else
                      do
                        if logic == eBuildingLogic.StaminaOutput then
                          ...
                          if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.StaminaOutput then
                          ...
                          do
                            if logic == eBuildingLogic.ResOutputEfficiency then
                              if (levelCfg.para1)[i] == 0 then
                                ...
                                if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.ResOutputEfficiency then
                                ...
                                do
                                  ...
                                  do
                                    ...
                                    do
                                      ...
                                      if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.BuildQueue then
                                        (buffDict[i]).nextInfoValue = tostring((nextlvlCfg.para2)[i])
                                      end
                                      if logic == eBuildingLogic.BuildSpeed then
                                        ...
                                        if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.BuildSpeed then
                                        ...
                                        do
                                          if logic == eBuildingLogic.GlobalExpRatio then
                                            ...
                                            if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.GlobalExpRatio then
                                              (buffDict[i]).nextInfoValue = tostring((nextlvlCfg.para1)[i] * 0.1) .. "%"
                                            end
                                          else
                                            do
                                              if logic == eBuildingLogic.AllHeroBuff then
                                                ...
                                                ;
                                                (buffDict[i]).currentInfo = describ_text
                                                if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.AllHeroBuff then
                                                ...
                                                do
                                                  if logic == eBuildingLogic.OverClock then
                                                    ...
                                                    if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.OverClock then
                                                      (buffDict[i]).nextInfoValue = tostring((nextlvlCfg.para2)[i])
                                                    end
                                                  else
                                                    do
                                                      if logic == eBuildingLogic.OverClockFreeNum then
                                                        ...
                                                        if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.OverClockFreeNum then
                                                          (buffDict[i]).nextInfoValue = tostring((nextlvlCfg.para1)[i])
                                                        end
                                                      else
                                                        do
                                                          if logic == eBuildingLogic.DynSkillUpgrade then
                                                            ...
                                                            if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.DynSkillUpgrade then
                                                            ...
                                                            do
                                                              if logic == eBuildingLogic.DynChipCountMax then
                                                                ...
                                                                if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.DynChipCountMax then
                                                                  (buffDict[i]).nextInfoValue = tostring((nextlvlCfg.para1)[i])
                                                                end
                                                              end
                                                              do
