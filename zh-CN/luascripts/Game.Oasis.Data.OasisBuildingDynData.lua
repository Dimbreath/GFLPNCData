    ...
    function(self)
        ...
        if not self.unlock then
            ...
            for i = 1, #level1Cfg.pre_condition do
                ...
                prePara1 = {(level1Cfg.pre_para1)[i]}
                prePara2 = {(level1Cfg.pre_para2)[i]}
                if not (CheckCondition.CheckLua)(preCondition, prePara1,
                                                 prePara2) then
                    self.lockReason = (CheckCondition.GetUnlockInfoLua)(
                                          preCondition, prePara1, prePara2)
                    break
                end
            end
        end
    ...
    for i = 1, #levelCfg.logic do
        ...
        if logic == eLogicType.ResourceOutput then
            ...
            if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] ==
                eLogicType.ResourceOutput then
                local nextItemCfg = (ConfigData.item)[(nextlvlCfg.para1)[i]]
            ...
            do
                if logic == eLogicType.FactoryPipelie then
                    ...
                    if getNext and nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] ==
                        eLogicType.FactoryPipelie then
                        ...
                        if logic == eLogicType.ResourceLimit then
                            ...
                            do
                                if logic == eLogicType.GlobalExpCeiling then
                                    ...
                                    if getNext and nextlvlCfg ~= nil and
                                        (nextlvlCfg.logic)[i] ==
                                        eLogicType.GlobalExpCeiling then
                                        (buffDict[i]).nextInfoValue =
                                            tostring((nextlvlCfg.para1)[i])
                                    end
                                else
                                    do
                                        if logic == eLogicType.StaminaCeiling then
                                            ...
                                            if getNext and nextlvlCfg ~= nil and
                                                (nextlvlCfg.logic)[i] ==
                                                eLogicType.StaminaCeiling then
                                                (buffDict[i]).nextInfoValue =
                                                    tostring(
                                                        (nextlvlCfg.para1)[i])
                                            end
                                            ...
                                            do
                                                if logic ==
                                                    ...
                                                    do
                                                        if logic ==
                                                            eLogicType.ResOutputEfficiency then
                                                            if (levelCfg.para1)[i] ==
                                                                0 then
                                                                local efficiency =
                                                                    (levelCfg.para2)[i] *
                                                                    ...
                                                                    do
                                                                        ...
                                                                        do
                                                                            ...
                                                                            if getNext and
                                                                                ...
                                                                                nil and
                                                                                (nextlvlCfg.logic)[i] ==
                                                                                eLogicType.BuildQueue then
                                                                                (buffDict[i]).nextInfoValue =
                                                                                    tostring(
                                                                                        (nextlvlCfg.para2)[i])
                                                                            end
                                                                            if logic ==
                                                                                eLogicType.BuildSpeed then
                                                                                local 
                                                                                    speed =
                                                                                    (levelCfg.para1)[i] *
                                                                                        0.1
                                                                                ...
                                                                                do
                                                                                    if logic ==
                                                                                        eLogicType.GlobalExpRatio then
                                                                                        local 
                                                                                            ratio =
                                                                                            (levelCfg.para1)[i] *
                                                                                                0.1
                                                                                            ...
                                                                                            if logic ==
                                                                                                ...
                                                                                                do
                                                                                                    if logic ==
                                                                                                        ...
                                                                                                        do
                                                                                                            if logic ==
                                                                                                                eLogicType.OverClockFreeNum then
                                                                                                                local 
                                                                                                                    freeNum =
                                                                                                                    (levelCfg.para1)[i]
                                                                                                                local 
                                                                                                                ...
                                                                                                                do
                                                                                                                    if logic ==
                                                                                                                        eLogicType.DynSkillUpgrade then
                                                                                                                        local 
                                                                                                                            skillUpgradeSpeed =
                                                                                                                            (levelCfg.para1)[i] *
                                                                                                                                0.01
                                                                                                                        ...
                                                                                                                        do
                                                                                                                            if logic ==
                                                                                                                                eLogicType.DynChipCountMax then
                                                                                                                                local 
                                                                                                                                    chipCount =
                                                                                                                                    (levelCfg.para1)[i]
                                                                                                                                local 
                                                                                                                                ...
                                                                                                                                do
                                                                                                                                    ...
                                                                                                                                    elseif logic ==
                                                                                                                                        eLogicType.DynPlayerAttrBuff then
                                                                                                                                        local 
                                                                                                                                            dynAttrId =
                                                                                                                                            (levelCfg.para1)[i]
                                                                                                                                        local 
                                                                                                                                        ...
                                                                                                                                        local 
                                                                                                                                            describ =
                                                                                                                                            ((ConfigData.buildingBuff)[buffDesIndex]).buff_text
                                                                                                                                        local 
                                                                                                                                            describ_text =
                                                                                                                                            (string.format)(
                                                                                                                                                (LanguageUtil.GetLocaleText)(
                                                                                                                                        ...
                                                                                                                                        if getNext and
                                                                                                                                            ...
                                                                                                                                            local 
                                                                                                                                                nextValue =
                                                                                                                                                (nextlvlCfg.para2)[i] -- DECOMPILER ERROR at PC1124: Confused about usage of register: R17 in 'UnsetPending'
                                                                                                                                            ;
                                                                                                                                            (buffDict[i]).nextInfoValue =
                                                                                                                                                tostring(
                                                                                                                                                    FormatNum(
                                                                                                                                    ...
                                                                                                                                    elseif logic ==
                                                                                                                                        eLogicType.HeroLevelCeiling then
                                                                                                                                        local 
                                                                                                                                            value =
                                                                                                                                            (levelCfg.para1)[i]
                                                                                                                                        local 
                                                                                                                                    ...
                                                                                                                                    elseif logic ==
                                                                                                                                        eLogicType.AutoRecoverItem then
                                                                                                                                        local 
                                                                                                                                            itemCfg =
                                                                                                                                            (ConfigData.item)[(levelCfg.para1)[i]]
                                                                                                                                        local 
                                                                                                                                        ...
                                                                                                                                        if getNext and
                                                                                                                                            ...
                                                                                                                                            local 
                                                                                                                                                ...
                                                                                                                                                (nextlvlCfg.para2)[i] *
                                                                                                                                                    3600 /
                                                                                                                                                    100000 -- DECOMPILER ERROR at PC1222: Confused about usage of register: R16 in 'UnsetPending'
                                                                                                                                            ;
                                                                                                                                            (buffDict[i]).nextInfoValue =
                                                                                                                                                tostring(
                                                                                                                                                    speed) ..
                                                                                                                                    ...
                                                                                                                                    elseif logic ==
                                                                                                                                        eLogicType.FactoryEfficiency then
                                                                                                                                        ConfigData:LoadDynCfg(
                                                                                                                                            eDynConfigData.factory_order)
                                                                                                                                        local 
                                                                                                                                            describ =
                                                                                                                                            ((ConfigData.buildingBuff)[logic]).buff_text
                                                                                                                                        local 
                                                                                                                                        ...
                                                                                                                                        local 
                                                                                                                                            orderName =
                                                                                                                                            (LanguageUtil.GetLocaleText)(
                                                                                                                                                ((ConfigData.factory_order)[(levelCfg.para1)[i]]).name)
                                                                                                                                        local 
                                                                                                                                            describ_text =
                                                                                                                                            (string.format)(
                                                                                                                                                text,
