...
UIOasisBuildingItem.UpdateUI = function(self)
    ...
    local isWorking = false
    local isCompleted = false
    self.locked = false -- DECOMPILER ERROR at PC13: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).img_Pic).texture = self.uiIcon -- DECOMPILER ERROR at PC18: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).name_text).text = (self.buildingData).name -- DECOMPILER ERROR at PC23: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).tex_EnName).text = (self.buildingData).nameEn;
    ((self.ui).upgradeTag):SetActive(false);
    ((self.ui).bgTip):SetActive(false);
    ...
    if not self.isBuild then
        ...
        if ((self.buildingData).dynData).unlock then
            ...
            ((self.ui).img_Lock):SetActive(true) -- DECOMPILER ERROR at PC105: Confused about usage of register: R3 in 'UnsetPending'
            ;
            ((self.ui).tex_Condition).text =
                ((self.buildingData).dynData).lockReason
            self.locked = true
            self.state = (UIOasisBuildingItem.itemState).disnormal
        end
    else
