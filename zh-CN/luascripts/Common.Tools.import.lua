...
reimport = function(name)
    ...
    local package = package -- DECOMPILER ERROR at PC2: Confused about usage of register: R2 in 'UnsetPending'
    ;
    (package.loaded)[name] = nil -- DECOMPILER ERROR at PC4: Confused about usage of register: R2 in 'UnsetPending'
    ;
