...
bs_10035.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddTrigger(eSkillTriggerType.BeforeAddBuff, "bs_10035_2", 1, self.OnBeforeAddBuff)
end
...
bs_10035.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : _ENV
    self:AddTrigger(eSkillTriggerType.BeforeAddBuff, "bs_10035_2", 1,
...
bs_10035.OnBeforeAddBuff = function(self, target, context)
    ...
    if (context.buff).buffType == 2 and (context.buff).maker == self.caster and
        self:IsReadyToTake() and LuaSkillCtrl:CallRange(1, 100) <
        (self.arglist)[1] then
        (context.buff).tier = (context.buff).tier + 1
        self:PlayChipEffect()
        self:OnSkillTake()
