...
UIPieItem.InitPieItem = function(self, fillAmount, clockwise, color)
    ...
    ((self.ui).img_Pie).fillAmount = fillAmount -- DECOMPILER ERROR at PC5: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).img_Pie).color = color
    local pieRoteValue, barRoteValue = nil, nil
    if clockwise then
    ...
    self.pieRot = (Vector3.New)(0, 0, pieRoteValue) -- DECOMPILER ERROR at PC31: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).img_bar).localEulerAngles = (Vector3.New)(0, 0, barRoteValue) -- DECOMPILER ERROR at PC35: Confused about usage of register: R6 in 'UnsetPending'
    ;
    (self.transform).localScale = Vector3.one -- DECOMPILER ERROR at PC40: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).img_bar).localScale = Vector3.one
end
...
UIPieItem.SetScaleToBig = function(self)
    ...
    local scale = (self.transform).localScale
    scale.x = scale.x * 1.1
    scale.y = scale.y * 1.1 -- DECOMPILER ERROR at PC9: Confused about usage of register: R2 in 'UnsetPending'
    ;
    (self.transform).localScale = scale
    scale = ((self.ui).img_bar).localScale
    scale.x = scale.x * 0.909
    scale.y = scale.y * 0.909 -- DECOMPILER ERROR at PC21: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.ui).img_bar).localScale = scale
end
...
UIPieItem.SetShortBar = function(self, isShort)
    ...
    if isShort then
        local scale = ((self.ui).img_bar).localScale
        scale.y = scale.y * 0.8 -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'
        ;
        ((self.ui).img_bar).localScale = scale
    end
end
