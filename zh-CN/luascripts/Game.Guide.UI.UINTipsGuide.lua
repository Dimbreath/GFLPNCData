...
UINTipsGuide.ShowUITipsGuide = function(self, curTargetTransform, showDir)
    ...
    local rotZ = showDir * 90 -- DECOMPILER ERROR at PC56: Confused about usage of register: R7 in 'UnsetPending'
    ;
    (self.transform).localEulerAngles = (Vector3.New)(0, 0, rotZ) -- DECOMPILER ERROR at PC58: Confused about usage of register: R7 in 'UnsetPending'
    ;
    (self.transform).anchoredPosition = offsetPos;
    ((self.ui).tween_TipsGuide):DOPlay()
end
