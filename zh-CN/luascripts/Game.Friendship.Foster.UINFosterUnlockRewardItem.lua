...
UINFosterUnlockRewardItem.InitItem = function(self, itemId, num)
    -- function num : 0_1 , upvalues : _ENV, UINBaseItem
    local itemCfg = (ConfigData.item)[itemId] -- DECOMPILER ERROR at PC8: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).tex_TotalCount).text = tostring(num) -- DECOMPILER ERROR at PC15: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).tex_Name).text = (LanguageUtil.GetLocaleText)(itemCfg.name)
    local baseItem = (UINBaseItem.New)()
    baseItem:Init((self.ui).obj_BaseItem)
