...
UINDungeonInfoChipDetail.RefreshData = function(self, index)
    ...
    ;
    ((self.ui).img_QualityLine).color = qualityColor -- DECOMPILER ERROR at PC42: Confused about usage of register: R5 in 'UnsetPending'
    ;
    ...
    local chipItem = (UINChipItem.New)()
    chipItem:Init((self.ui).obj_chipItem)
    chipItem:InitChipItem(chipData) -- DECOMPILER ERROR at PC56: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).tex_ChipName).text = chipData:GetName() -- DECOMPILER ERROR at PC61: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).tex_ChipIntro).text = chipData:GetChipInfo();
    ((self.ui).tex_ChipLevel):SetIndex(0, tostring(chipData:GetCount()))
    if #chipCfg.skill_list > 0 then
        ...
        if skillCfg == nil then
            ...
            local num = chipData:GetCount() -- DECOMPILER ERROR at PC101: Confused about usage of register: R9 in 'UnsetPending'
            ;
            ((self.ui).tex_Description).text = skillCfg:GetLevelDescribe(num)
        end
    else
        do
            if #chipCfg.attribute_id > 0 then
                ...
                local attrInfo = (BattleUtil.GetChipAttrInfo)(attrId, initValue,
                                                              increaseVal, num) -- DECOMPILER ERROR at PC131: Confused about usage of register: R12 in 'UnsetPending'
                ;
                ((self.ui).tex_Description).text = fluenceIntro .. attrInfo
            else
                do
