...
UIBattleEffectGirdInfo.OnInit = function(self)
    ...
    self.gridInfoSizeDelta = ((self.battleGirdInfoNode).transform).sizeDelta -- DECOMPILER ERROR at PC13: Confused about usage of register: R1 in 'UnsetPending'
    ;
...
UIBattleEffectGirdInfo.InitBattleGridInfo =
    function(self, dynEffectGrid, worldPos)
        ...
        local arrowOffset = (self.gridInfoSizeDelta / 2 +
                                (self.ui).gridInfoOffset) * offsetRatio +
                                position -- DECOMPILER ERROR at PC65: Confused about usage of register: R6 in 'UnsetPending'
        ;
        ((self.battleGirdInfoNode).transform).localPosition =
            (Vector3.New)(arrowOffset.x, arrowOffset.y, 0);
