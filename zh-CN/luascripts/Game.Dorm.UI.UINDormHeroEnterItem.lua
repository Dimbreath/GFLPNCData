...
UINDormHeroEnterItem.RefreshDormHeroEnterItem =
    function(self, index, heroData, clickEvent, resloader, bind, select)
...
UINDormHeroEnterItem.SelectDormHeroEnterItem =
