...
UIDormRoomEdit.OnFntItemClick = function(self, fntEntity)
    -- function num : 0_9
    if self.roomCtrl ~= nil then (self.roomCtrl):SelectFntEntity(fntEntity) end
end
...
UIDormRoomEdit.RefreshRoomEditComfortUI =
    function(self)
        -- function num : 0_15
        local comfort = (((self.roomCtrl).dormCtrl):GetCurHouse()):GetComfort()
        local comfortLimit =
            (((self.roomCtrl).dormCtrl):GetCurHouse()):GetComfortLimit();
