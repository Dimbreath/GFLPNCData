...
UIAthItemBase.InitAthItem = function(self, color, height, space, athData)
    -- function num : 0_1
    self.athData = athData -- DECOMPILER ERROR at PC3: Confused about usage of register: R5 in 'UnsetPending'
    ;
    ((self.ui).img_ATH).color = color
    local size = (((self.ui).img_ATH).transform).sizeDelta
    size.y = height -- DECOMPILER ERROR at PC12: Confused about usage of register: R6 in 'UnsetPending'
    ;
