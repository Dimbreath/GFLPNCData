    ...
    if self.attackNum > 3 then
        ...
        do
            ...
            if (self.caster).attackRange == 1 then
                if (self.caster):GetBuffTier((self.config).buffId1) == 0 then
                    if atkActionId == (self.config).action1 then
                        ((self.caster).auSource):PlayAudioById(
                            (self.config).audioId1) -- DECOMPILER ERROR at PC127: Confused about usage of register: R9 in 'UnsetPending'
                        ;
                        ((self.caster).recordTable)["1_attack_effect"] =
                            LuaSkillCtrl:CallEffect(target,
                    ...
                    if atkActionId == (self.config).action1 then
                        ((self.caster).auSource):PlayAudioById(
                            (self.config).audioId2) -- DECOMPILER ERROR at PC163: Confused about usage of register: R9 in 'UnsetPending'
                        ;
                        ((self.caster).recordTable)["1_attack_effect"] =
                            LuaSkillCtrl:CallEffect(target,
