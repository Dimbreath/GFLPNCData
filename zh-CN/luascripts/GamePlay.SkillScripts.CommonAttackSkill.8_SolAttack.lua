                ...
                if (self.caster):GetBuffTier((self.config).buffId1) == 0 then
                    if atkActionId == (self.config).action1 then
                        ((self.caster).auSource):PlayAudioById(
                            (self.config).audioId1) -- DECOMPILER ERROR at PC124: Confused about usage of register: R9 in 'UnsetPending'
                        ;
                    ...
                    if atkActionId == (self.config).action1 then
                        ((self.caster).auSource):PlayAudioById(
                            (self.config).audioId2) -- DECOMPILER ERROR at PC160: Confused about usage of register: R9 in 'UnsetPending'
                        ;
                        ((self.caster).recordTable)["1_attack_effect"] =
                            LuaSkillCtrl:CallEffect(target,
