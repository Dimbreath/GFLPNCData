...
UIHeroStarUp.RefreshRank = function(self)
    ...
    if self.isItemUpdate then self:RefreshAll() end
end
                                        ...
                                        for _, skillData in
                                            ...
                                            if (skillData.skillCfg).open_star ==
                                                ...
                                                (self.skillItem):InitBaseSkillItem(
                                                    skillData, self.resloader);
                                                (self.skillItem):__SetUnlockUI(
                                                    true) -- DECOMPILER ERROR at PC326: Confused about usage of register: R11 in 'UnsetPending'
                                                ;
