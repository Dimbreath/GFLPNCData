...
, monsterEffectId = 10221, effectId = 10219, attackdelay = 15, buffId = 1007, buffTier = 1, buffDuration = 45, buffDamageFormula = 10007}
...
bs_40011.CallBack = function(self)
  ...
  if (skillResult.roleList).Count ~= 0 then
    for i = 0, (skillResult.roleList).Count - 1 do
      ...
      LuaSkillCtrl:CallBuffRepeated(self, role, (self.config).buffId, (self.config).buffTier, (self.config).buffDuration, self.OnBuffExecute)
    end
  end
  do
