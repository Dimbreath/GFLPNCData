...
HomeEnum.eNoticeType = {None = 0, Mail = 1, Achievement = 2, HasOasisBuildingOperate = 6, HasSectorBuildingOperate = 7, FragDungeonRefresh = 8, ResDungeonRefresh = 9, ATHDungeonRefresh = 10, FactoryLineReachSpecificValue = 11, FactoryLineFull = 12}
return HomeEnum
