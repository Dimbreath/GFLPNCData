...
UIAthStrengthen.OnInit = function(self)
  ...
  (UIUtil.AddValueChangedListener)((self.ui).tog_ATHItem0, self, self.OnClickOptimalNode)
  ;
  (UIUtil.AddValueChangedListener)((self.ui).tog_ATHItem1, self, self.OnClickInheritNode)
  ;
