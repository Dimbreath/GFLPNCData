...
FormationSceneCtrl.__GetGroundPoint = function(self)
  ...
  if (self.__lastGroundPos).z < ((self.bind).groudPosZRange).x or ((self.bind).groudPosZRange).y < (self.__lastGroundPos).z then
        ...
        do
            ...
            do
                ...
                entity:SetFmtPlatformDragEvent(self.__OnBeginDrag,
                                               self.__OnDrag, self.__OnEndDrag) -- DECOMPILER ERROR at PC79: Confused about usage of register: R11 in 'UnsetPending'
                ;
                (self.platformEntityDic)[fmtIndex] = entity -- DECOMPILER ERROR at PC81: Confused about usage of register: R11 in 'UnsetPending'
                ;
                (self.platformEntityGoDic)[go] = entity
                if self.__platformPosY == nil then
                    self.__platformPosY = ((go.transform).position).y
...
FormationSceneCtrl.RefreshFmtScene = function(self, fmtData, forceAnim)
    ...
    for k, heroId in pairs(fmtData.data) do
        ...
        if heroEntity ~= nil then
            heroEntity:UpdateFmtHeroEntityHeadInfo()
            newHeroEntityIdDic[heroId] = heroEntity
        end -- DECOMPILER ERROR at PC14: Confused about usage of register: R10 in 'UnsetPending'
    ...
    for index, heroId in pairs(fmtData.data) do
        ...
        if heroData ~= nil then
            ...
            local heroEntity = self:__CreateHeroEntity(heroData,
                                                       ...
                                                       forceAnim) -- DECOMPILER ERROR at PC51: Confused about usage of register: R12 in 'UnsetPending'
            ;
            (self.heroEntityDic)[index] = heroEntity
        end
    end
