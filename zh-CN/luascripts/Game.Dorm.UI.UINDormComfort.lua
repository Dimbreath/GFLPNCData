...
UINDormComfort.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).rootBtn, self,
                               self.OnClickDormComfortRoot)
end

UINDormComfort.InitDormComfort = function(self, comfort, comfortLimit)
    -- function num : 0_1 , upvalues : _ENV
    ((self.ui).tex_ComfortNum):SetIndex(0, tostring(comfort),
                                        tostring(comfortLimit)) -- DECOMPILER ERROR at PC14: Confused about usage of register: R3 in 'UnsetPending'
    ;
