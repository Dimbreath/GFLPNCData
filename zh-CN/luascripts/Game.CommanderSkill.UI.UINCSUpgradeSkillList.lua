...
local UINCSUpgradeSkillItem = require("Game.CommanderSkill.UI.UINCSUpgradeSkillItem")
UINCSUpgradeSkillList.OnInit = function(self)
  ...
  ;
  ((self.ui).loopList_skillList).onInstantiateItem = BindCallback(self, self.__OnNewItem)
  -- DECOMPILER ERROR at PC20: Confused about usage of register: R1 in 'UnsetPending'

  ;
  ((self.ui).loopList_skillList).onChangeItem = BindCallback(self, self.__OnChangeItem)
end
...
UINCSUpgradeSkillList.__OnNewItem = function(self, go)
  ...
  skillItem:Init(go)
  skillItem:InitSkillItem(self.resloader)
