...
ShopController.ReqShopDetail = function(self, shopId, callback)
  ...
  if shopCfg == nil then
    ...
    if shopCfg.shop_type == (ShopEnum.eShopType).Charcter or shopCfg.shop_type == (ShopEnum.eShopType).Resource then
...
ShopController.RefreshShopData = function(self, shopDataMsg)
  ...
  local shopData = (ShopData.CreateShopData)(shopDataMsg)
...
ShopController.RefreshGoodsData = function(self, CommonStoreShelfData, shopId)
  -- function num : 0_8
  local goodsData = (((self.shopDataDic)[shopId]).shopGoodsDic)[CommonStoreShelfData.shelfId]
...
ShopController.StartShopAllRedDot = function(self)
  -- function num : 0_10 , upvalues : _ENV, ShopEnum
  ...
  for k,shopId in ipairs((ConfigData.shop).id_sort_list) do
    do
      local shopCfg = (ConfigData.shop)[shopId]
      if shopCfg.shop_type == (ShopEnum.eShopType).Random and (CheckCondition.CheckLua)(shopCfg.pre_condition, shopCfg.pre_para1, shopCfg.pre_para2) then
        self:GetShopData(shopId, function(shopData)
    -- function num : 0_10_0 , upvalues : self, shopId, _ENV
    ...
    local tmpShopId = shopId
    -- DECOMPILER ERROR at PC24: Confused about usage of register: R4 in 'UnsetPending'

    ;
    (self.redDotTimerDic)[tmpShopId] = (TimerManager:GetTimer(timeBeforeNextRe, function()
      -- function num : 0_10_0_0 , upvalues : self, tmpShopId, _ENV, shopId
...
ShopController.StartOneShopRedDot = function(self, shopData)
  ...
  local tmpShopId = shopData.shopId
  -- DECOMPILER ERROR at PC31: Confused about usage of register: R5 in 'UnsetPending'

  ;
  (self.redDotTimerDic)[tmpShopId] = (TimerManager:GetTimer(timeBeforeNextRe, function()
    -- function num : 0_11_0 , upvalues : self, tmpShopId, _ENV, shopData
    -- DECOMPILER ERROR at PC2: Confused about usage of register: R0 in 'UnsetPending'

    (self.redDotTimerDic)[tmpShopId] = nil
    local shopNode = RedDotController:AddRedDotNodeWithPath(RedDotDynPath.ShopPath, RedDotStaticTypeId.Main, RedDotStaticTypeId.ShopWindow, shopData.shopId)
    shopNode:SetRedDotCount(1)
  end
, self, true, false, true)):Start()
end
