...
UIHeroEnterSelect.InitHeroEnterSelect = function(self, enterLimt, buildingID, enterSlotList, enterModifyId)
...
UIHeroEnterSelect.RefreshEnteredHeroFunc = function(self)
...
UIHeroEnterSelect.SelectHeroInSortedList = function(self, heroID)
    ...
    return false
      ...
      if self.SelectedSlotIndex == slotIndex and self.heroSortListSelectedId ~= slotInfo.heroID then
        ...
        if selectHeroData then
          local temp = isHeroHaveLifeSkill(selectHeroData.skillDic, true)
        end
