...
OasisController.ConstructComplete = function(self, id)
  ...
  ;
  (cs_MessageCommon.ShowMessageTips)((string.format)(ConfigData:GetTipContent(TipContent.Oasis_Building_StartConstruct), buildingData.name))
  ;
...
OasisController.UpgradeComplete = function(self, id)
  ...
  local builtData = ((self.buildingDatas).built)[id]
  ;
  (cs_MessageCommon.ShowMessageTips)((string.format)(ConfigData:GetTipContent(TipContent.Oasis_Building_StartUpgrade), builtData.name))
  ;
