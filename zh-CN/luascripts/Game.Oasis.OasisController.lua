...
;
(xlua.private_accessible)(cs_CameraController)
...
OasisController.OnInit = function(self)
  ...
  local codeActionBinding = (self.focusDirector):FindComponent(eUnityComponentID.CodeActionBinding)
  codeActionBinding:RegisterAction("HideOtherBuilding", BindCallback(self, self.__HideOtherBuilding))
...
OasisController.__HideOtherBuilding = function(self)
  -- function num : 0_9 , upvalues : cs_CameraController, cs_Physics, _ENV
...
OasisController.FocusBuildingTween = function(self, toBuilding, buildingItem)
  -- function num : 0_10 , upvalues : cs_CameraController, _ENV
  ...
  if toBuilding then
    ...
    -- function num : 0_10_0 , upvalues : self, cs_CameraController
    local bdItem = (self.buildingItems)[(self.selectedBuildingData).id]
    if bdItem == nil then
      bdItem = self.newBuildingItem
    end
...
OasisController.__FocusBuildingTweenRewindComplete = function(self)
  -- function num : 0_11 , upvalues : __inputMode, InputMode, cs_CameraController
...
OasisController.EnterEditMode = function(self)
  -- function num : 0_12 , upvalues : _ENV, __inputMode, InputMode
...
OasisController.ExitEditMode = function(self)
  -- function num : 0_13 , upvalues : __inputMode, InputMode, _ENV
  __inputMode = InputMode.ClickBuilding
...
OasisController.CreateBuilding = function(self, buildingData)
  -- function num : 0_14 , upvalues : CoordinateConvert
...
OasisController.CreateBuildingItem = function(self, unityPosition, size, height, areaId)
  -- function num : 0_15 , upvalues : OasisBuildingItem, _ENV
...
OasisController.__GetBuildablePos = function(self, oasisPos, size, areaId)
  -- function num : 0_22 , upvalues : _ENV, CoordinateConvert
...
OasisController.NewBuilding = function(self, id)
  -- function num : 0_23 , upvalues : CoordinateConvert
...
OasisController.StartConstruct = function(self)
  -- function num : 0_24 , upvalues : cs_MessageCommon, _ENV, CoordinateConvert
...
OasisController.__ShowUpgradeBuilding = function(self, data, buildingItem, isFromClickBuildingIns)
  -- function num : 0_26 , upvalues : __inputMode, InputMode, cs_CameraController
...
OasisController.OnFingerDown = function(self, leanFinger)
  -- function num : 0_46 , upvalues : __inputMode, InputMode, cs_InputUtility, cs_Physics, _ENV, __selectedBuilding, __selectedBuildingLastPos, __originalPosition, cs_CameraController
...
OasisController.OnFingerSet = function(self, leanFinger)
  -- function num : 0_47 , upvalues : cs_InputUtility, __inputMode, InputMode, __selectedBuilding, cs_CameraController, cs_Physics, _ENV, __selectedBuildingLastPos
...
OasisController.OnFingerUp = function(self, leanFinger)
  -- function num : 0_48 , upvalues : __selectedBuilding, __inputMode, InputMode, cs_Physics, _ENV, cs_CameraController
...
OasisController.OnFingerTap = function(self, leanFinger)
  -- function num : 0_49 , upvalues : __inputMode, InputMode, cs_Physics, _ENV
  if leanFinger.StartedOverGui or leanFinger.IsOverGui or __inputMode == InputMode.None then
    return 
  end
  if self.window ~= nil and not (self.window).isScreenUIShow then
...
OasisController.CheckBuildingOverlap = function(self, areaId, areaList)
  -- function num : 0_52 , upvalues : _ENV, CoordinateConvert
  local oasisArea = (self.oasisAreaList)[areaId]
...
OasisController.BuildInMap = function(self, areaId, positionList, build)
  -- function num : 0_54 , upvalues : _ENV, CoordinateConvert
  local oasisArea = (self.oasisAreaList)[areaId]
  local oasisAreaCfg = (ConfigData.oasis_area)[areaId]
  if oasisAreaCfg == nil then
    error("Can\'t find oasisAreaCfg, id = " .. tostring(areaId))
...
OasisController.OnExitOasis = function(self)
  -- function num : 0_61 , upvalues : _ENV, cs_CameraController, cs_LeanTouch, __inputMode, InputMode
