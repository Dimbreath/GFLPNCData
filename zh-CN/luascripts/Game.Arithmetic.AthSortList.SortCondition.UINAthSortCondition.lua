...
UINAthSortCondition.InitAthSortCondition = function(self, eKindType, eKindMaxCount, onConfirmAction, itemSelectFunc)
  ...
  for index,_ in ipairs(orderedTypes) do
    ...
    for i = 1, eKindMaxCount[index] do
      ...
      kindItem:InitAthSortKindItem(index, i, itemSelectFunc)
      ;
