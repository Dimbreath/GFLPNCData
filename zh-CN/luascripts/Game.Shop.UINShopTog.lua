...
UINShopTog.InitShopTog = function(self, shopCfg, openPageCallback)
    -- function num : 0_1 , upvalues : _ENV
    self.shopId = shopCfg.id
    self.openPageCallback = openPageCallback -- DECOMPILER ERROR at PC9: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).tex_TypeName).text = (LanguageUtil.GetLocaleText)(shopCfg.name) -- DECOMPILER ERROR at PC16: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).tex_TypeEN).text = (LanguageUtil.GetLocaleText)(shopCfg.name_en)
end
