...
UINHeroHeadItem.InitHeroHeadItem = function(self, heroData, resloader,
                                            clickEvent)
    -- function num : 0_1 , upvalues : _ENV
    self.heroData = heroData
    self.clickEvent = clickEvent
...
UINHeroHeadItem.TransparentHeroHeadItem =
    function(self, transparent)
        -- function num : 0_2
        -- DECOMPILER ERROR at PC9: Confused about usage of register: R2 in 'UnsetPending'


        ((self.ui).canvasGroup).alpha = transparent and
                                            (self.ui).transparentValue or 1
    end
