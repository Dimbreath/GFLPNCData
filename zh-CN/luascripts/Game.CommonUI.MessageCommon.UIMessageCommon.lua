...
UIMessageCommon.OnInit = function(self)
    ...
    (((self.ui).btnClose).gameObject):SetActive(false);
    (((self.ui).buttonConfirm).gameObject):SetActive(false);
    (UIUtil.AddButtonListener)((self.ui).buttonConfirm, self,
...
UIMessageCommon._ShowItemCostInternal = function(self, msg, itemId, costNum)
    -- function num : 0_1 , upvalues : _ENV
    ((self.ui).itemNode):SetActive(true) -- DECOMPILER ERROR at PC7: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).tex_ItemContent).text = msg
    local itemCfg = (ConfigData.item)[itemId]
    if itemCfg == nil then
...
UIMessageCommon.ShowItemCostConfirm = function(self, msg, itemId, costNum,
                                               confirmFunc)
    -- function num : 0_2
    self:_ShowItemCostInternal(msg, itemId, costNum);
    (((self.ui).buttonConfirm).gameObject):SetActive(true)
...
UIMessageCommon.ShowItemCost = function(self, msg, itemId, costNum, yesFunc,
                                        noFunc)
    -- function num : 0_3
    self:_ShowItemCostInternal(msg, itemId, costNum);
    ((self.ui).yesNoNode):SetActive(true)
...
UIMessageCommon.ShowItemConvert = function(self, msg, itemId1, cost1Num,
                                           itemId2, item2Num, yesFunc, noFunc)
    -- function num : 0_4 , upvalues : _ENV
    self:_ShowItemCostInternal(msg, itemId1, cost1Num)
    local itemCfg = (ConfigData.item)[itemId2]
    if itemCfg == nil then
...
UIMessageCommon.ShowItemCost2Confirm = function(self, msg, itemId1, costNum1,
                                                itemId2, costNum2, confirmFunc)
    -- function num : 0_5 , upvalues : _ENV
    self:_ShowItemCostInternal(msg, itemId1, costNum1)
    local itemCfg = (ConfigData.item)[itemId2]
    if itemCfg == nil then
