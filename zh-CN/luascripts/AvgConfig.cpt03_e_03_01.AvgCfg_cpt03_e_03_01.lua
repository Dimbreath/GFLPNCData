...
local AvgCfg_cpt03_e_03_01 = {
    ...
    [15] = {
        ...
        speakerHeroId = 1027,
        speakerHeroPosId = 3,
        audio = {sfx = {cue = "AVG_Fir_Bonfire", sheet = "AVG_gf", audioId = 0}}
    },
    [16] = {
        imgTween = {
            {
    ...
    [33] = {
        ...
        audio = {sfx = {cue = "AVG_tinnitus", sheet = "AVG_gf"}}
    },
    [34] = {content = 340, contentType = 2},
    [35] = {
        content = 350,
    ...
    [36] = {
        imgTween = {{imgId = 2, duration = 0.5, shake = true}},
        content = 360,
        contentType = 4,
        speakerName = 361,
        audio = {
    ...
    [39] = {content = 390, contentType = 4, speakerName = 371},
    [40] = {content = 400, contentType = 4, speakerName = 21},
    [41] = {audio = {bgm = {stop = true}}, content = 410, contentType = 2},
    [42] = {content = 420, contentType = 2},
    [43] = {
        imgTween = {
            {imgId = 2, delay = 0, duration = 3, alpha = 0, isDark = false},
    ...
    [52] = {
        imgTween = {{imgId = 23, duration = 0.2, shake = true}},
        content = 520,
        contentType = 3,
        speakerHeroId = 23,
        speakerHeroPosId = 3
