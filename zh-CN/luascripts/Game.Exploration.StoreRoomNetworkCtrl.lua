...
StoreRoomNetworkCtrl.CS_EXPLORATION_STORE_Refresh = function(self, position)
  ...
  cs_WaitNetworkResponse:StartWait(proto_csmsg_MSG_ID.MSG_CS_EXPLORATION_STORE_Refresh, proto_csmsg_MSG_ID.MSG_SC_EXPLORATION_STORE_Refresh)
end
