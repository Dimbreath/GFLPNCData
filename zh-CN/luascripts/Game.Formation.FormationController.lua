...
FormationController.InitFromationCtrl = function(self, fromModule, stageId, enterFunc, exitFunc, startBattleFunc)
...
FormationController.LoadFormation = function(self)
  ...
  ;
  (self.fmtSceneCtrl):InitFmtSceneCtrl(go, self.isOpenedOverClock, self.isOpenedCampInfluence)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.Formation, function(window)
    -- function num : 0_4_0 , upvalues : defaulFormationId, self
    window:InitUIFormation(defaulFormationId, self)
