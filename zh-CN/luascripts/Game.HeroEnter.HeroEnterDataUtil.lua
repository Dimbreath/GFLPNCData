...
local valueFuncTable = {
    [eLogicType.ResourceLimit] = function(heroScoreRate, levelBuffCfg, index,
                                          isRemove, buildingId)
        -- function num : 0_0 , upvalues : _ENV
        local para1 = (levelBuffCfg.buff_para1)[index]
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                ...
                buildingId, eLogicType.ResourceLimit)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.ResourceLimit, para1, para2, para3)
        end
    end,
    [eLogicType.ResourceOutput] = function(heroScoreRate, levelBuffCfg, index,
                                           isRemove, buildingId)
        -- function num : 0_1 , upvalues : _ENV
        local para1 = (levelBuffCfg.buff_para1)[index]
        local speed = (levelBuffCfg.buff_para2)[index] * 36
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.ResourceOutput)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.ResourceOutput, para1, para2, para3)
        end
    end,
    [eLogicType.CampBuff] = function(heroScoreRate, levelBuffCfg, index,
                                     isRemove, buildingId)
        -- function num : 0_2 , upvalues : _ENV
        local para1 = (levelBuffCfg.buff_para1)[index]
        local para2 = (levelBuffCfg.buff_para2)[index]
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.CampBuff)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.CampBuff, para1, para2, para3)
        end
    end,
    [eLogicType.CareerBuff] = function(heroScoreRate, levelBuffCfg, index,
                                       isRemove, buildingId)
        -- function num : 0_3 , upvalues : _ENV
        local para1 = (levelBuffCfg.buff_para1)[index]
        local para2 = (levelBuffCfg.buff_para2)[index]
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.CareerBuff)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.CareerBuff, para1, para2, para3)
        end
    end,
    [eLogicType.FactoryPipelie] = function(heroScoreRate, levelBuffCfg, index,
                                           isRemove, buildingId)
        -- function num : 0_4 , upvalues : _ENV
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.FactoryPipelie)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.FactoryPipelie, para1, para2, para3)
        end
    end,
    [eLogicType.GlobalExpCeiling] = function(heroScoreRate, levelBuffCfg, index,
                                             isRemove, buildingId)
        -- function num : 0_5 , upvalues : _ENV
        local expLimt = (levelBuffCfg.buff_para1)[index]
        local para1 = (math.floor)(expLimt * heroScoreRate)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.GlobalExpCeiling)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.GlobalExpCeiling, para1, para2, para3)
        end
    end,
    [eLogicType.StaminaCeiling] = function(heroScoreRate, levelBuffCfg, index,
                                           isRemove, buildingId)
        -- function num : 0_6 , upvalues : _ENV
        local staminaLimt = (levelBuffCfg.buff_para1)[index]
        local para1 = (math.floor)(staminaLimt * heroScoreRate)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.StaminaCeiling)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.StaminaCeiling, para1, para2, para3)
        end
    end,
    [eLogicType.StaminaOutput] = function(heroScoreRate, levelBuffCfg, index,
                                          isRemove, buildingId)
        -- function num : 0_7 , upvalues : _ENV
        local speed = (levelBuffCfg.buff_para1)[index] * 0.036
        local para1 = (math.floor)(speed * heroScoreRate)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.StaminaOutput)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.StaminaOutput, para1, para2, para3)
        end
    end,
    [eLogicType.ResOutputEfficiency] = function(heroScoreRate, levelBuffCfg,
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.ResOutputEfficiency)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.ResOutputEfficiency, para1, para2, para3)
        end
    end,
    [eLogicType.BuildQueue] = function(heroScoreRate, levelBuffCfg, index,
                                       isRemove, buildingId)
        -- function num : 0_9 , upvalues : _ENV
        local para1 = (levelBuffCfg.buff_para1)[index]
        local para2 = (math.floor)((levelBuffCfg.buff_para2)[index] *
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.BuildQueue)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.BuildQueue, para1, para2, para3)
        end
    end,
    [eLogicType.BuildSpeed] = function(heroScoreRate, levelBuffCfg, index,
                                       isRemove, buildingId)
        -- function num : 0_10 , upvalues : _ENV
        local para1 = (math.floor)((levelBuffCfg.buff_para1)[index] *
                                       heroScoreRate)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.BuildSpeed)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.BuildSpeed, para1, para2, para3)
        end
    end,
    [eLogicType.GlobalExpRatio] = function(heroScoreRate, levelBuffCfg, index,
                                           isRemove, buildingId)
        -- function num : 0_11 , upvalues : _ENV
        local para1 = (math.floor)((levelBuffCfg.buff_para1)[index] *
                                       heroScoreRate)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.GlobalExpRatio)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.GlobalExpRatio, para1, para2, para3)
        end
    end,
    [eLogicType.AllHeroBuff] = function(heroScoreRate, levelBuffCfg, index,
                                        isRemove, buildingId)
        -- function num : 0_12 , upvalues : _ENV
        local para1 = (levelBuffCfg.buff_para1)[index]
        local para2 = (math.floor)((levelBuffCfg.buff_para2)[index] *
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.AllHeroBuff)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eLogicType.AllHeroBuff, para1, para2, para3)
        end
    end
}
HeroEnterDataUtil.ctor = function(self)
