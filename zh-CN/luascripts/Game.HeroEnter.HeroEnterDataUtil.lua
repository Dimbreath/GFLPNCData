...
local valueFuncTable = {
    [eBuildingLogic.ResourceLimit] = function(heroScoreRate, levelBuffCfg,
                                              index, isRemove, buildingId)
        -- function num : 0_0 , upvalues : _ENV
        local para1 = (levelBuffCfg.buff_para1)[index]
        local para2 = (math.floor)((levelBuffCfg.buff_para2)[index] *
                                       heroScoreRate)
        local para3 = (levelBuffCfg.buff_para3)[index]
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.ResourceLimit)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.ResourceLimit, para1, para2, para3)
        end
    end,
    [eBuildingLogic.ResourceOutput] = function(heroScoreRate, levelBuffCfg,
                                               index, isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.ResourceOutput)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.ResourceOutput, para1, para2, para3)
        end
    end,
    [eBuildingLogic.CampBuff] = function(heroScoreRate, levelBuffCfg, index,
                                         isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.CampBuff)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.CampBuff, para1, para2, para3)
        end
    end,
    [eBuildingLogic.CareerBuff] = function(heroScoreRate, levelBuffCfg, index,
                                           isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.CareerBuff)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.CareerBuff, para1, para2, para3)
        end
    end,
    [eBuildingLogic.FactoryPipelie] = function(heroScoreRate, levelBuffCfg,
                                               index, isRemove, buildingId)
        -- function num : 0_4 , upvalues : _ENV
        local para1 = (math.floor)((levelBuffCfg.buff_para1)[index] *
                                       heroScoreRate)
        local para2 = (levelBuffCfg.buff_para2)[index]
        local para3 = (levelBuffCfg.buff_para3)[index]
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.FactoryPipelie)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.FactoryPipelie, para1, para2, para3)
        end
    end,
    [eBuildingLogic.GlobalExpCeiling] = function(heroScoreRate, levelBuffCfg,
                                                 index, isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.GlobalExpCeiling)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.GlobalExpCeiling, para1, para2, para3)
        end
    end,
    [eBuildingLogic.StaminaCeiling] = function(heroScoreRate, levelBuffCfg,
                                               index, isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.StaminaCeiling)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.StaminaCeiling, para1, para2, para3)
        end
    end,
    [eBuildingLogic.StaminaOutput] = function(heroScoreRate, levelBuffCfg,
                                              index, isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.StaminaOutput)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.StaminaOutput, para1, para2, para3)
        end
    end,
    [eBuildingLogic.ResOutputEfficiency] = function(heroScoreRate, levelBuffCfg,
                                                    index, isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.ResOutputEfficiency)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.ResOutputEfficiency, para1, para2,
                para3)
        end
    end,
    [eBuildingLogic.BuildQueue] = function(heroScoreRate, levelBuffCfg, index,
                                           isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.BuildQueue)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.BuildQueue, para1, para2, para3)
        end
    end,
    [eBuildingLogic.BuildSpeed] = function(heroScoreRate, levelBuffCfg, index,
                                           isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.BuildSpeed)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.BuildSpeed, para1, para2, para3)
        end
    end,
    [eBuildingLogic.GlobalExpRatio] = function(heroScoreRate, levelBuffCfg,
                                               index, isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.GlobalExpRatio)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.GlobalExpRatio, para1, para2, para3)
        end
    end,
    [eBuildingLogic.AllHeroBuff] = function(heroScoreRate, levelBuffCfg, index,
                                            isRemove, buildingId)
        ...
        if isRemove then
            (PlayerDataCenter.playerBonus):UninstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.AllHeroBuff)
        else

            (PlayerDataCenter.playerBonus):InstallPlayerBonus(
                proto_csmsg_SystemFunctionID.SystemFunctionID_HeroEnter,
                buildingId, eBuildingLogic.AllHeroBuff, para1, para2, para3)
        end
    end
}
...
HeroEnterDataUtil.InitMsgListern = function(self)
    ...
    self.__OnBuildingLevelChange =
        BindCallback(self, self.OnBuildingLevelChange)
...
HeroEnterDataUtil.AddBuff = function(self, heroId, buildingId, manualRate)
    ...
    local level =
        (((PlayerDataCenter.AllBuildingData).oasisBuilt)[buildingId]).level
    ...
    for i, logic in ipairs(levelBuffCfg.buff_logic) do
        if manualRate ~= nil then
            ...
            (valueFuncTable[logic])(self:CalRate(heroData), levelBuffCfg, i,
                                    nil, buildingId)
        end
    end
...
HeroEnterDataUtil.RemoveBuff = function(self, heroId, levelBuffCfg, manualRate,
                                        buildingId)
    ...
    for i, logic in ipairs(levelBuffCfg.buff_logic) do
        if manualRate ~= nil then
            (valueFuncTable[logic])(manualRate, levelBuffCfg, i, true,
                                    buildingId)
        else
...
HeroEnterDataUtil.AddSkillBuff = function(self, skilldata, heroId)
    ...
    for index, logic in ipairs(cfg.logic) do
        ...
        (PlayerDataCenter.playerBonus):InstallPlayerBonus(
            proto_csmsg_SystemFunctionID.SystemFunctionID_LifeSkill, heroId,
            logic, para1, para2, para3)
    end
end

HeroEnterDataUtil.RemoveSkillBuff = function(self, skilldata, oldLevel, heroId)
    -- function num : 0_19 , upvalues : _ENV
    if not oldLevel then local skillLevel = skilldata.level end
    local cfg = (skilldata.lifeSkillCfg)[skillLevel]
    for index, logic in ipairs(cfg.logic) do
        local para1 = (cfg.para1)[index]
        local para2 = (cfg.para2)[index]
...
HeroEnterDataUtil.GetHeroEnteredBuildingCfgById =
            ...
            for allDtatHeroId, _ in pairs(data.data) do
                if allDtatHeroId == heroId then
                    local level =
                        (((PlayerDataCenter.AllBuildingData).oasisBuilt)[buildingId]).level
                    local levelBuffCfg =
                        ((ConfigData.buildingLevel)[buildingId])[level]
                    return levelBuffCfg
                end
            end
        end
...
HeroEnterDataUtil.CalRate = function(self, heroData, manualRank, manualLevel)
    ...
    if heroData == nil then return 0 end
    if not manualRank then local rank = heroData.rank end
    if not manualLevel then local level = heroData.level end
...
HeroEnterDataUtil.OnHeroRankChange = function(self, oldRanK, newRank, heroId)
    ...
    for dataBuildingId, data in pairs(PlayerDataCenter.allEnterData) do
        for dataHeroId, _ in pairs(data.data) do
            if dataHeroId == heroId then buildingId = dataBuildingId end
        end
    end
...
HeroEnterDataUtil.OnBuildingLevelChange =
            ...
            if dataBuildingId == buildingId then
                for heroId, _ in pairs(data.data) do
                    local level =
                        (((PlayerDataCenter.AllBuildingData).oasisBuilt)[buildingId]).level
                    local oldLevelCfg =
                        ((ConfigData.buildingLevel)[buildingId])[level - 1]
                    self:AddBuff(heroId, buildingId)
                end
            end
        end
