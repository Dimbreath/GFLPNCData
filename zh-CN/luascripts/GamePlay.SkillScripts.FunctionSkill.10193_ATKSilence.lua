...
bs_10193.config = {buffId = 26, buffTier = 1}
...
bs_10193.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddTrigger(eSkillTriggerType.AfterPlaySkill, "bs_10193_1", 1, self.OnAfterPlaySkill)
  self:AddTrigger(eSkillTriggerType.SetHurt, "bs_10193_2", 2, self.OnSetHurt)
...
bs_10193.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : base, _ENV
    (base.InitSkill)(self, isMidwaySkill)
    self:AddTrigger(eSkillTriggerType.AfterPlaySkill, "bs_10193_1", 1,
                    self.OnAfterPlaySkill)
    self:AddTrigger(eSkillTriggerType.SetHurt, "bs_10193_2", 2, self.OnSetHurt) -- DECOMPILER ERROR at PC20: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.caster).recordTable)["10193_AttackTime"] = 0 -- DECOMPILER ERROR at PC23: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.caster).recordTable).DamageFlag = false
end
...
bs_10193.OnAfterPlaySkill = function(self, skill, role)
    ...
    if skill.maker == self.caster and skill.isCommonAttack then
        ((self.caster).recordTable)["10193_AttackTime"] =
            ((self.caster).recordTable)["10193_AttackTime"] + 1
        -- DECOMPILER ERROR at PC23: Confused about usage of register: R3 in 'UnsetPending'

        if (self.arglist)[1] < ((self.caster).recordTable)["10193_AttackTime"] then
            ((self.caster).recordTable).DamageFlag = true -- DECOMPILER ERROR at PC26: Confused about usage of register: R3 in 'UnsetPending'
            ;
            ((self.caster).recordTable)["10193_AttackTime"] = 0
        end
    end
...
bs_10193.OnSetHurt = function(self, context)
    ...
    if context.sender == self.caster and (context.skill).isCommonAttack and
        ...
        LuaSkillCtrl:CallBuff(self, context.target, (self.config).buffId,
                              (self.config).buffTier, (self.arglist)[2]) -- DECOMPILER ERROR at PC29: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.caster).recordTable).DamageFlag = false
    end
end
