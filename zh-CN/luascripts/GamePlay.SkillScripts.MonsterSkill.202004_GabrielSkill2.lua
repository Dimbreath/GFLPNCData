...
bs_202004.config = {
hurtConfig = {hit_formula = 0, def_formula = 0, basehurt_formula = 1047, crit_formula = 0}
, effectId = 10758}
...
bs_202004.OnAfterBattleStart = function(self)
  ...
  self.caoTimer = LuaSkillCtrl:StartTimer(nil, (self.arglist)[2], arriveCallBack, nil, -1, 15)
end
