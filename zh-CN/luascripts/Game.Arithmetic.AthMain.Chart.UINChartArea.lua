...
local UINChartAreaSector = require(
                               "Game.Arithmetic.AthMain.Chart.UINChartAreaSector")
...
UINChartArea.OnInit = function(self)
    ...
    self.areaSectorPool = (UIItemPool.New)(UINChartAreaSector,
                                           (self.ui).img_Char)
end

UINChartArea.InitAthChartArea = function(self, spaceData, allSpace, totalAngle,
                                         curAngleOffset)
    -- function num : 0_1 , upvalues : _ENV, ArthmeticEnum
    local eAngle = (self.transform).localEulerAngles
    eAngle.z = curAngleOffset -- DECOMPILER ERROR at PC4: Confused about usage of register: R6 in 'UnsetPending'
    ;
    (self.transform).localEulerAngles = eAngle -- DECOMPILER ERROR at PC11: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).rootImg).fillAmount =
        spaceData.maxSpace / allSpace * totalAngle / 360
