...
bs_5006.config = {effectIdAttack = 10301, buffId = 141}
...
bs_5006.PlaySkill = function(self, data)
...
bs_5006.OnSetHurt = function(self, context)
    ...
    if (context.skill).dataId ~= 5006 and
        ...
        do
            LuaSkillCtrl:StartTimer(self, 5, function()
                -- function num : 0_4_0 , upvalues : _ENV, EXhurt, self, context
