...
, content = 450, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 2, 
imgTween = {
...
, 
{imgId = 26, posId = 3, isDark = false}
}
, content = 550, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2}
, 
[47] = {
imgTween = {
{imgId = 26, posId = 3, isDark = true}
, 
{imgId = 26, duration = 0.2, shake = true}
}
, 
audio = {
...
[48] = {
imgTween = {
{imgId = 105, duration = 0.2, alpha = 1}
, 
{imgId = 26, duration = 0.2, alpha = 0}
}
, 
audio = {
bgm = {cue = "Mus_Story_BattleTension", sheet = "Music", fadeIn = 2, fadeOut = 3}
}
, content = 570, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 2, contentShake = true}
, 
[49] = {
imgTween = {
{imgId = 26, alpha = 0}
...
{imgId = 105, alpha = 0}
, 
{imgId = 127, posId = 3, alpha = 1}
, 
{imgId = 127, duration = 0.2, shake = true}
}
, 
audio = {
...
, 
[50] = {content = 460, contentType = 4, speakerName = 111, 
imgTween = {
{imgId = 105, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
, 
{imgId = 127, duration = 0.2, alpha = 0}
}
}
, 
[51] = {content = 470, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 2, 
imgTween = {
{imgId = 105, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
}
, 
[52] = {content = 480, contentType = 4, speakerName = 111, 
imgTween = {
{imgId = 105, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
}
, 
[53] = {content = 490, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 2, 
imgTween = {
{imgId = 105, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
}
, 
[54] = {content = 500, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2, 
imgTween = {
...
, 
[55] = {content = 510, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2}
, 
[56] = {content = 520, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2}
, 
[57] = {content = 530, contentType = 3, speakerHeroId = 26, speakerHeroPosId = 2}
, 
[58] = {content = 540, contentType = 3, speakerHeroId = 1027, speakerHeroPosId = 2, 
imgTween = {
{imgId = 127, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 26, alpha = 0, isDark = false}
, 
