...
bs_40005.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddTrigger(eSkillTriggerType.HurtResultStart, "bs_40005_14", 1, self.OnHurtResultStart)
end
...
bs_40005.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg)
  -- function num : 0_3
  if target ~= self.caster or isCrit then
  end
end
