...
ExplorationMapCtrl.GenMap = function(self, mapData, curRoomData)
  ...
  for i = 1, mapData.maxMapColNumber do
    ...
    for k2,room in pairs(roomMapRow) do
      ...
      -- DECOMPILER ERROR at PC254: Confused about usage of register: R48 in 'UnsetPending'
      ...
      -- DECOMPILER ERROR at PC274: Confused about usage of register: R50 in 'UnsetPending'

      ;
      (self.roomDic)[room.position] = roomEntity
      local interfaceObj = roomInterfacePrefab:Instantiate((self.bind).interfaceHolder)
      -- DECOMPILER ERROR at PC283: Confused about usage of register: R51 in 'UnsetPending'
      ...
      if mapColType.trackType == (ExplorationEnum.eTrackLineType).NormalYTrack then
        ...
        -- DECOMPILER ERROR at PC317: Confused about usage of register: R54 in 'UnsetPending'
        ...
        -- DECOMPILER ERROR at PC332: Confused about usage of register: R55 in 'UnsetPending'
      ...
      if mapColType.trackType == (ExplorationEnum.eTrackLineType).SingleTrack then
        ...
        -- DECOMPILER ERROR at PC357: Confused about usage of register: R55 in 'UnsetPending'
        ...
        -- DECOMPILER ERROR at PC371: Confused about usage of register: R56 in 'UnsetPending'
      ...
      if mapColType.trackType == (ExplorationEnum.eTrackLineType).ReverseETrack and self.bossWarnLine == nil then
        ...
        -- DECOMPILER ERROR at PC393: Confused about usage of register: R54 in 'UnsetPending'

        ;
        (bossWarnLine.transform).localPosition = warningLinePos
        -- DECOMPILER ERROR at PC398: Confused about usage of register: R54 in 'UnsetPending'
  ...
  -- DECOMPILER ERROR at PC430: Confused about usage of register: R33 in 'UnsetPending'
        ...
        do
          ...
          for position,state in pairs(roomStateDic) do
            if (self.roomStateDic)[position] ~= state then
              local roomEntity = self:GetRoomEntity(R14_PC139)
              -- DECOMPILER ERROR at PC142: Overwrote pending register: R14 in 'AssignReg'

              ;
              (roomEntity:GetUIRoom()):ChangeUIState(R15_PC145, withTween)
              -- DECOMPILER ERROR at PC146: Overwrote pending register: R14 in 'AssignReg'

              self:RefreshRoomInterfaceAndLine(R15_PC145, R16_PC150, roomStateDic)
            end
          end
...
ExplorationMapCtrl.RefreshRoomInterfaceAndLine = function(self, roomEntity, state, roomStateDic)
...
ExplorationMapCtrl.__SetRoomLineLeftPass = function(self, roomEntity, isPass, roomStateDic)
  ...
  if lastColTrackType == (ExplorationEnum.eTrackLineType).ReverseETrack then
    local lastRoom = (self.mapData):GetOneRoomByX(roomData.x - 1)
    local trackItem = (self.roomTrackDic)[lastRoom.position]
    trackItem:SetTrunkLinePass(isPass, (self.bind).pathPassColor, (self.bind).linePassHeight)
  else
    do
      if lastColTrackType == (ExplorationEnum.eTrackLineType).NormalETrack then
        local lastRoom = (self.mapData):GetRoomByXY(roomData.x - 1, 0)
        local trackItem = (self.roomTrackDic)[lastRoom.position]
        trackItem:SetForkLinePass(roomData, self, isPass, (self.bind).pathPassColor, (self.bind).linePassHeight)
      else
        do
          if lastColTrackType == (ExplorationEnum.eTrackLineType).SingleTrack then
            local lastRoom = (self.mapData):GetRoomByXY(roomData.x - 1, 0)
            ...
            do
              if lastColTrackType == (ExplorationEnum.eTrackLineType).NormalYTrack then
                ...
                for _,tmpRoomData in pairs(lastRoomList) do
                  local trackItem = (self.roomTrackDic)[tmpRoomData.position]
                  if trackItem ~= nil then
                    if roomStateDic[tmpRoomData.position] == (ExplorationEnum.eRoomTypeState).Complete and isPass then
                      trackItem:SetForkLinePass(roomData, self, true, (self.bind).pathPassColor, (self.bind).linePassHeight)
                    else
                      trackItem:SetForkLinePass(roomData, self, false, (self.bind).pathPassColor, (self.bind).linePassHeight)
                    end
                  end
                end
              end
...
ExplorationMapCtrl.__SetRoomLineRightPass = function(self, roomEntity, isPass, roomStateDic)
