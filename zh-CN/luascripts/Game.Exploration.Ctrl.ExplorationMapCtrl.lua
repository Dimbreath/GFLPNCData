...
ExplorationMapCtrl.GenMap = function(self, mapData, curRoomData)
  ...
  for i = 1, mapData.maxMapColNumber do
    ...
    for k2,room in pairs(roomMapRow) do
      ...
      -- DECOMPILER ERROR at PC256: Confused about usage of register: R48 in 'UnsetPending'

      ;
      (roomUIObj.transform).localScale = (roomUIObj.transform).localScale * objScale
      -- DECOMPILER ERROR at PC258: Confused about usage of register: R48 in 'UnsetPending'
...
ExplorationMapCtrl.__GenSpecialTrackLine = function(self)
  -- function num : 0_3
end
...
ExplorationMapCtrl.OnEpOpStateChanged = function(self, opDetail)
  ...
  if opDetail.deco and self.dynplayer ~= nil then
    if (opDetail.deco)[1] then
      (self.dynplayer):UpdateEpSaveMoneyList(((opDetail.deco)[1]).arrParams, opDetail.curPostion, opDetail.path)
    else
      ;
...
ExplorationMapCtrl.RefreshMapShowState = function(self, opDetail, curRoomData, withTween, tweenCallback)
  ...
  for _,position in ipairs(opDetail.path) do
            ...
            do
              ...
              for position,state in pairs(roomStateDic) do
                ...
                if (self.roomStateDic)[position] ~= state or (self.autoPathDic)[position] ~= isAutoPath or autoPathChanged and isAutoPath then
                  ...
                  local roomEntity = self:GetRoomEntity(R17_PC201)
                  -- DECOMPILER ERROR at PC204: Overwrote pending register: R17 in 'AssignReg'

                  ;
                  (roomEntity:GetUIRoom()):ChangeUIState(R18_PC208, withTween, isAutoPath)
                  -- DECOMPILER ERROR at PC209: Overwrote pending register: R17 in 'AssignReg'

                  self:RefreshRoomInterfaceAndLine(R18_PC208, R19_PC215, roomStateDic, isAutoPath, autoPathDic)
                end
              end
...
ExplorationMapCtrl.ClearPassedRoomData = function(self, opDetail, curRoomData)
...
ExplorationMapCtrl.GenMap = function(self, mapData, curRoomData)
    ...
    for i = 1, mapData.maxMapColNumber do
        ...
        for k2, room in pairs(roomMapRow) do
            ...
            local roomPos = (Vector3.New)(pos.x, pos.y, pos.z)
            local roomUIObj = roomUIPrefab:Instantiate((self.bind).roomHolder) -- DECOMPILER ERROR at PC256: Confused about usage of register: R48 in 'UnsetPending'
            ;
            (roomUIObj.transform).localScale =
                (roomUIObj.transform).localScale * objScale -- DECOMPILER ERROR at PC258: Confused about usage of register: R48 in 'UnsetPending'
            ;
            (roomUIObj.transform).localPosition = roomPos
            local uiRoom = (UIEpRoom.New)()
            uiRoom:Init(roomUIObj)
            uiRoom:InitRoomUI(room)
            local roomEntity = (EpRoomEntity.New)()
            roomEntity:InitEpRoom(uiRoom, room, roomVisibleEvent) -- DECOMPILER ERROR at PC276: Confused about usage of register: R50 in 'UnsetPending'
            ;
            (self.roomDic)[room.position] = roomEntity
            local interfaceObj = roomInterfacePrefab:Instantiate(
                                     (self.bind).interfaceHolder) -- DECOMPILER ERROR at PC285: Confused about usage of register: R51 in 'UnsetPending'
            ;
            (interfaceObj.transform).localScale =
                (interfaceObj.transform).localScale * objScale -- DECOMPILER ERROR at PC287: Confused about usage of register: R51 in 'UnsetPending'
            ;
            (interfaceObj.transform).localPosition = roomPos
            local roomInterface = (UIEpRoomInterface.New)()
            roomInterface:Init(interfaceObj)
            ...
            if mapColType.trackType ==
                ...
                local roomTrackObj = roomYTrackPrefab:Instantiate(
                                         (self.bind).yTrackHolder) -- DECOMPILER ERROR at PC319: Confused about usage of register: R54 in 'UnsetPending'
                ;
                (roomTrackObj.transform).localScale =
                    (roomTrackObj.transform).localScale * scale -- DECOMPILER ERROR at PC321: Confused about usage of register: R54 in 'UnsetPending'
                ;
                (roomTrackObj.transform).localPosition = trackPos
                local roomTrack = (UIEpYTrack.New)()
                roomTrack:Init(roomTrackObj)
                roomTrack:InitEpYTrack(room, yTrackTrunkSizeX, yTrackForkLength) -- DECOMPILER ERROR at PC334: Confused about usage of register: R55 in 'UnsetPending'
                ;
                (self.roomTrackDic)[room.position] = roomTrack
            end
            if mapColType.trackType ==
                ...
                local roomTrackObj = roomSingleTrackPrefab:Instantiate(
                                         (self.bind).eTrackHolder) -- DECOMPILER ERROR at PC359: Confused about usage of register: R55 in 'UnsetPending'
                ;
                (roomTrackObj.transform).localScale =
                    (roomTrackObj.transform).localScale * scale -- DECOMPILER ERROR at PC361: Confused about usage of register: R55 in 'UnsetPending'
                ;
                (roomTrackObj.transform).localPosition = trackPos
                local roomTrack = (UIEpSingleTrack.New)()
                roomTrack:Init(roomTrackObj)
                roomTrack:InitEpSingleTrack(room, singleTrackTrunkSizeX) -- DECOMPILER ERROR at PC373: Confused about usage of register: R56 in 'UnsetPending'
                ;
                (self.roomTrackDic)[room.position] = roomTrack
            end
            if mapColType.trackType ==
                ...
                local bossWarnLine = bossWarnLinePrefab:Instantiate(
                                         (self.bind).otherHolder) -- DECOMPILER ERROR at PC395: Confused about usage of register: R54 in 'UnsetPending'
                ;
                (bossWarnLine.transform).localPosition = warningLinePos -- DECOMPILER ERROR at PC400: Confused about usage of register: R54 in 'UnsetPending'
                ;
    ...
    local playerObject = playerPosPrefab:Instantiate((self.bind).otherHolder) -- DECOMPILER ERROR at PC432: Confused about usage of register: R33 in 'UnsetPending'
    ;
...
ExplorationMapCtrl.OnEpOpStateChanged = function(self, opDetail)
    ...
    if opDetail.deco and self.dynplayer ~= nil then
        if (opDetail.deco)[1] then
            (self.dynplayer):UpdateEpSaveMoneyList(
                ((opDetail.deco)[1]).arrParams, opDetail.curPostion,
                opDetail.path)
        else
...
ExplorationMapCtrl.RefreshMapShowState =
    function(self, opDetail, curRoomData, withTween, tweenCallback)
        ...
        if ((self.epCtrl).autoCtrl):IsEnableAutoMode() then
            ...
            if autoPath ~= nil then
                for k, position in pairs(autoPath) do
                    if roomStateDic[position] ~=
                        (ExplorationEnum.eRoomTypeState).Complete then
                        autoPathDic[position] = true
                    end
                end
            end
                    ...
                    if trackItem ~= nil then
                        ...
                        do
                            ...
                            do
                                ...
                                for position, state in pairs(roomStateDic) do
                                    local isAutoPath = autoPathDic[position]
                                    if (self.roomStateDic)[position] ~= state or
                                        (self.autoPathDic)[position] ~=
                                        isAutoPath or autoPathChanged and
                                        isAutoPath then
                                        if not isAutoPath then
                                            isAutoPath = false
                                        end
                                        local roomEntity =
                                            self:GetRoomEntity(R17_PC201) -- DECOMPILER ERROR at PC204: Overwrote pending register: R17 in 'AssignReg'
                                        ;
                                        (roomEntity:GetUIRoom()):ChangeUIState(
                                            R18_PC208, withTween, isAutoPath)
                                        -- DECOMPILER ERROR at PC209: Overwrote pending register: R17 in 'AssignReg'

                                        self:RefreshRoomInterfaceAndLine(
                                            R18_PC208, R19_PC215, roomStateDic,
                                            isAutoPath, autoPathDic)
                                    end
                                end
                                self.roomStateDic = roomStateDic
                                self.autoPathDic = autoPathDic
...
ExplorationMapCtrl.RefreshRoomInterfaceAndLine =
    function(self, roomEntity, state, roomStateDic, isAutoPath, autoPathDic)
        -- function num : 0_10 , upvalues : ExplorationEnum
        local roomInterface = roomEntity:GetRoomInterface()
        if not isAutoPath or not (ExplorationEnum.eTrackLineState).Auto then
            local lineFalseState = (ExplorationEnum.eTrackLineState).Normal
        ...
        if state == (ExplorationEnum.eRoomTypeState).Complete then
            ...
            self:__SetRoomLineLeftPass(roomEntity,
                                       (ExplorationEnum.eTrackLineState).Pass,
                                       roomStateDic, autoPathDic)
            self:__SetRoomLineRightPass(roomEntity,
                                        (ExplorationEnum.eTrackLineState).Pass,
                                        roomStateDic, autoPathDic)
        else
            if state == (ExplorationEnum.eRoomTypeState).CurrentStay then
                ...
                self:__SetRoomLineLeftPass(roomEntity,
                                           (ExplorationEnum.eTrackLineState).Pass,
                                           roomStateDic, autoPathDic)
                self:__SetRoomLineRightPass(roomEntity, lineFalseState,
                                            roomStateDic, autoPathDic)
            else
                if roomInterface ~= nil then
                    roomInterface:SetAllInterfacePass(false)
                end
                self:__SetRoomLineLeftPass(roomEntity, lineFalseState,
                                           roomStateDic, autoPathDic)
                self:__SetRoomLineRightPass(roomEntity, lineFalseState,
                                            roomStateDic, autoPathDic)
            end
...
ExplorationMapCtrl.__SetRoomLineLeftPass =
    function(self, roomEntity, lineState, roomStateDic, autoPathDic)
        -- function num : 0_12 , upvalues : ExplorationEnum, _ENV
        local roomData = roomEntity:GetRoomData()
        local roomType = roomData:GetRoomType()
        ...
        if lastColTrackType == (ExplorationEnum.eTrackLineType).ReverseETrack then
            local lastRoom = (self.mapData):GetOneRoomByX(roomData.x - 1)
            local trackItem = (self.roomTrackDic)[lastRoom.position]
            trackItem:SetTrunkLinePass(lineState, (self.bind).pathPassColor,
            ...
            do
                if lastColTrackType ==
                    ...
                    local lastRoom = (self.mapData):GetRoomByXY(roomData.x - 1,
                                                                0)
                    local trackItem = (self.roomTrackDic)[lastRoom.position]
                    trackItem:SetForkLinePass(roomData, self, lineState,
                                              (self.bind).pathPassColor,
                                              (self.bind).linePassHeight)
                else
                    do
                                    ...
                                    for _, tmpRoomData in pairs(lastRoomList) do
                                        ...
                                        if trackItem ~= nil then
                                            if roomStateDic[tmpRoomData.position] ==
                                                ...
                                                lineState ==
                                                (ExplorationEnum.eTrackLineState).Pass then
                                                trackItem:SetForkLinePass(
                                                    roomData, self, lineState,
                                                    (self.bind).pathPassColor,
                                                    (self.bind).linePassHeight)
                                            else
                                                if autoPathDic[tmpRoomData.position] and
                                                    lineState ==
                                                    (ExplorationEnum.eTrackLineState).Auto then
                                                    trackItem:SetForkLinePass(
                                                        roomData, self,
                                                        lineState,
                                                        (self.bind).pathPassColor,
                                                    ...
                                                    trackItem:SetForkLinePass(
                                                        roomData, self,
                                                        (ExplorationEnum.eTrackLineState).Normal,
                                                        (self.bind).pathPassColor,
                                                        (self.bind).linePassHeight)
                                                end
                                            end
    ...
    function(self, roomEntity, lineState, roomStateDic, autoPathDic)
        ...
        if colTrackType == (ExplorationEnum.eTrackLineType).ReverseETrack then
            ...
            do
                if colTrackType == (ExplorationEnum.eTrackLineType).NormalETrack then
                    local trackItem = (self.roomTrackDic)[roomData.position]
                    trackItem:SetTrunkLinePass(lineState,
                                               (self.bind).pathPassColor,
                                               (self.bind).linePassHeight)
                else
                    do
