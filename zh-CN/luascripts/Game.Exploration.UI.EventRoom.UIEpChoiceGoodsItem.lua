...
UIEpChoiceGoodsItem.ShowWithChipData = function(self, data, dataNum)
  ...
  ;
  (self.chipItem):InitChipItem(data, dataNum)
  ;
  (self.chipItem):Show()
end
...
UIEpChoiceGoodsItem.__OnChipItemPress = function(self, item, chipData)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.FloatingFrame, function(win)
    -- function num : 0_2_0 , upvalues : _ENV, name, describe, item, HAType, VAType
