...
UIHeroUpgradePreviewNode.RefreshHeroData =
    function(self)
            ...
            do
                do
                    if item == nil then
                        ...
                        item:Init(go.transform) -- DECOMPILER ERROR at PC26: Confused about usage of register: R9 in 'UnsetPending'
                        ;
        ...
        end -- DECOMPILER ERROR at PC37: Confused about usage of register: R1 in 'UnsetPending'
        
        ((self.ui).img_Exp).fillAmount = (self.heroData).expRatio;
        ((self.ui).tex_Level):SetIndex(0, tostring((self.heroData).level))
    end

UIHeroUpgradePreviewNode.RefreshNextExp =
    function(self, addExp)
        ...
        local nextLevel, nextExp, nextTotalExp =
            (self.heroData):AddTestExp(addExp)
