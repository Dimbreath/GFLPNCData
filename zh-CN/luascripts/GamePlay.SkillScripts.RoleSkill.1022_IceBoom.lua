...
bs_1022.PlayUltEffect = function(self)
    ...
    self:AddTrigger(eSkillTriggerType.AfterSelfUltInTimeLineEnd, "bs_1022_1", 1,
                    self.AfterFocusTimeLine)
    self:AddTrigger(eSkillTriggerType.AfterSelfUltMovieEnd, "bs_1022_2", 1,
                    self.OnMovieEnd)
    self:AddTrigger(eSkillTriggerType.OnSelfUltMovieFadeOut, "bs_1022_3", 1,
                    self.OnMovieFadeOut)
end
