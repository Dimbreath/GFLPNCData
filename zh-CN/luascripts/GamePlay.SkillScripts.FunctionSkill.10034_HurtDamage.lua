...
bs_10034.config = {hurt_config = {basehurt_formula = 10007}, effectId = 1002}
...
bs_10034.InitSkill = function(self, isMidwaySkill)
    ...
    self:AddTrigger(eSkillTriggerType.AfterHurt, "bs_10034_3", 1,
                    self.OnAfterHurt)
end

bs_10034.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss,
                                isCrit, isRealDmg)
