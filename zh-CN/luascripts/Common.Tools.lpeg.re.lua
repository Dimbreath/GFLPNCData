...
local getdef = function(id, defs)
    -- function num : 0_2 , upvalues : error
    if defs then local c = defs[id] end
...
local name = (m.R)("AZ", "az", "__") * (m.R)("AZ", "az", "__", "09") ^ 0
local arrow = S * "<-"
local seq_follow = (m.P)("/") + ")" + "}" + ":}" + "~}" + "|}" + name * arrow +
                       -1
name = (m.C)(name)
local Def = name * (m.Carg)(1)
local num = (m.C)((m.R)("09") ^ 1) * S / tonumber
...
local Range = (m.Cs)(any * ((m.P)("-") / "") * (any - "]")) / mm.R
local item = defined + Range + (m.C)(any)
local Class = "[" * (m.C)((m.P)("^") ^ -1) *
                  (m.Cf)(item * item - "]" ^ 0, mt.__add) / function(c, p)
    -- function num : 0_7 , upvalues : any
    return c == "^" and any - p or p
end * "]"
local adddef = function(t, k, exp)
...
local exp = (m.P)({
    ...
    Prefix = "&" * S * (m.V)("Prefix") / mt.__len + "!" * S * (m.V)("Prefix") /
        mt.__unm + (m.V)("Suffix"),
    Suffix = (m.Cf)((m.V)("Primary") * S *
                        ((m.P)("+") * (m.Cc)(1, mt.__pow) + (m.P)("*") *
                            (m.Cc)(0, mt.__pow) + (m.P)("?") *
                            (m.Cc)(-1, mt.__pow) + "^" *
                            ((m.Cg)(num * (m.Cc)(mult)) +
                                (m.Cg)((m.C)((m.S)("+-") * (m.R)("09") ^ 1) *
                                           (m.Cc)(mt.__pow))) + "->" * S *
                            ((m.Cg)((String + num) * (m.Cc)(mt.__div)) +
                                (m.P)("{}") * (m.Cc)(nil, m.Ct) +
                                (m.Cg)(Def / getdef * (m.Cc)(mt.__div))) + "=>" *
                            S * (m.Cg)(Def / getdef * (m.Cc)(m.Cmt))) * S ^ 0,
                    function(a, b, f)
        -- function num : 0_11
        return f(a, b)
    end),
    Primary = "(" * (m.V)("Exp") * ")" + String / mm.P + Class + defined + "{:" *
        ...
        -- function num : 0_13 , upvalues : mm, equalcap
        return (mm.Cmt)((mm.Cb)(n), equalcap)
    end + (m.P)("{}") / mm.Cp + "{~" * (m.V)("Exp") * "~}" / mm.Cs + "{|" *
        (m.V)("Exp") * "|}" / mm.Ct + "{" * (m.V)("Exp") * "}" / mm.C +
        (m.P)(".") * (m.Cc)(any) + (name * -arrow + "<" * name * ">") *
        (m.Cb)("G") / NT,
...
local pattern = S * (m.Cg)((m.Cc)(false), "G") * exp / mm.P *
                    (-any + patt_error)
local compile = function(p, defs)
    -- function num : 0_14 , upvalues : mm, pattern, error
...
local gsub = function(s, p, rep)
    -- function num : 0_17 , upvalues : gmem, compile, mm
    if not gmem[p] then local g = {} end
    gmem[p] = g
    local cp = g[rep]
    if not cp then
        cp = compile(p)
...
if version == "Lua 5.1" then return re end
