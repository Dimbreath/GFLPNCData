...
benchHeroPos = {1, 2}
, introHeroGuideTextId = 136, introHeroGuideHeroId = 1001, introHeroGuidePos = "2", dragGuideTextId = 126, guideTalkHeroId = 1001, guideTalkPos = "2", beforeDragAvg = "cpt00_tutorial_03", 
formCSList = {5001, 5010}
, csTreeId = 1, csGuideDelay = 85, 
