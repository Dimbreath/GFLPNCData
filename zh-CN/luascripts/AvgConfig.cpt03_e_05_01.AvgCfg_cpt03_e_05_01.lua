...
local AvgCfg_cpt03_e_05_01 = {
    ...
    [8] = {
        imgTween = {
            {imgId = 102, duration = 0.2, scale = {1.2, 1.2, 1.2}},
            {imgId = 102, duration = 0.5, delay = 0.3, shake = true},
            {imgId = 102, delay = 1, isDark = true}
        },
        content = 80,
        contentType = 2,
        audio = {sfx = {cue = "AVG_Door_Hit", sheet = "AVG_gf", audioId = 0}}
    },
    [9] = {
        imgTween = {
            {
        ...
        speakerHeroId = 1027,
        speakerHeroPosId = 2,
        audio = {sfx = {cue = "Atk_Croque_01", sheet = "Chara_Croque"}}
    },
    [10] = {
        imgTween = {
            {
    ...
    [12] = {
        imgTween = {{imgId = 102, duration = 0.2, alpha = 0}},
        content = 120,
        contentType = 2
    },
    [13] = {
        imgTween = {{imgId = 102, duration = 0.2, alpha = 1}},
        content = 130,
        contentType = 3,
        speakerHeroId = 26,
        speakerHeroPosId = 2
    ...
    [23] = {
        imgTween = {
            {imgId = 102, duration = 0.2, alpha = 0, pos = {180, -150, 0}},
            {imgId = 1, posId = 1},
            {imgId = 1, posId = 2, isDark = false, duration = 0.2}
        },
        content = 230,
    ...
    [30] = {
        imgTween = {{imgId = 27, isDark = false}, {imgId = 1, isDark = true}},
        content = 300,
        contentType = 3,
        speakerHeroId = 1027,
        speakerHeroPosId = 3
    ...
    [64] = {
        ...
        speakerHeroId = 1005,
        speakerHeroPosId = 3,
        branch = {{content = 641, jumpAct = 65}, {content = 642, jumpAct = 68}}
    },
    [65] = {
        content = 650,
        contentType = 3,
    ...
    [75] = {
        imgTween = {
            {imgId = 1, duration = 0.2, alpha = 1}, {imgId = 5, isDark = true}
        },
        content = 750,
        contentType = 3,
        speakerHeroId = 1001,
