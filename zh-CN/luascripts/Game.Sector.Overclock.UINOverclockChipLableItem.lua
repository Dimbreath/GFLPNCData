...
local UINOverclockChipItem = require("Game.Sector.Overclock.UINOverclockChipItem")
UINOverclockChipLableItem.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, UINOverclockChipItem
  (UIUtil.LuaUIBindingTable)(self.transform, self.ui)
  self.chipItemPool = (UIItemPool.New)(UINOverclockChipItem, (self.ui).obj_sortChipKindItem)
  ;
  ((self.ui).obj_sortChipKindItem):SetActive(false)
end

UINOverclockChipLableItem.InitLable = function(self, quality, chipList, selectedChipItem)
