...
local CreateWindowInternal = function(self, typeID, isAsync)
    ...
    assert(uiconfig)
    assert(not (string.IsNullOrEmpty)(uiconfig.PrefabName)) -- DECOMPILER ERROR at PC20: Confused about usage of register: R5 in 'UnsetPending'
    ;
