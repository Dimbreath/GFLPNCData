...
bs_10049.OnSetHurt = function(self, context)
    ...
    if context.target == self.caster and ((self.caster).recordTable).SkillTime >
        0 then
        ...
        self:PlayChipEffect() -- DECOMPILER ERROR at PC37: Confused about usage of register: R3 in 'UnsetPending'
        ;
