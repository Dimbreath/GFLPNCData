...
UUINFriendshipPersonalInfoPage.OnInit = function(self)
  ...
  MsgCenter:AddListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshTotalLevel)
end
...
UUINFriendshipPersonalInfoPage.OnDelete = function(self)
  ...
  MsgCenter:RemoveListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshTotalLevel)
  ;
