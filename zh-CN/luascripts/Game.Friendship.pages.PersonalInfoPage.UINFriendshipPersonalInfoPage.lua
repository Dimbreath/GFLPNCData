...
-- params : ...
-- function num : 0 , upvalues : _ENV
local UUINFriendshipPersonalInfoPage = class("UUINFriendshipPersonalInfoPage",
                                             UIBaseNode)
local base = UIBaseNode
local UINFriendshipAttrItem = require(
                                  "Game.Friendship.pages.PersonalInfoPage.UINFriendshipAttrItem")
UUINFriendshipPersonalInfoPage.OnInit = function(self)
    -- function num : 0_0 , upvalues : _ENV, UINFriendshipAttrItem
    (UIUtil.LuaUIBindingTable)(self.transform, self.ui) -- DECOMPILER ERROR at PC9: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).tex_UserName).text = PlayerDataCenter.playerName
    self.attrItemPool = (UIItemPool.New)(UINFriendshipAttrItem,
...
UUINFriendshipPersonalInfoPage.LaterInit =
...
UUINFriendshipPersonalInfoPage.RefreshAttrs =
    function(self, totalLevel)
        -- function num : 0_2 , upvalues : _ENV
        (self.attrItemPool):HideAll()
        local cfg = (ConfigData.friendship_total_level)[totalLevel]
        for index, logic in ipairs(cfg.logic) do
...
UUINFriendshipPersonalInfoPage.RefreshTotalLevel =
    function(self)
        -- function num : 0_3 , upvalues : _ENV
        local totalLevel =
...
UUINFriendshipPersonalInfoPage.OnDelete =
    function(self)
        -- function num : 0_4 , upvalues : _ENV, base
