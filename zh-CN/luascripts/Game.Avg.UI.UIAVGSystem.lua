...
UIAVGSystem.__UpdateBlackEdge = function(self)
    ...
    sizeDelta.y = extraHeight -- DECOMPILER ERROR at PC32: Confused about usage of register: R8 in 'UnsetPending'
    ;
    ((self.ui).blackEdge_Top).sizeDelta = sizeDelta -- DECOMPILER ERROR at PC35: Confused about usage of register: R8 in 'UnsetPending'
    ;
...
UIAVGSystem.PlayAvgAudio = function(self)
    ...
    if audioCfg.sfx ~= nil then
        AudioManager:PlayAudio((audioCfg.sfx).cue, (audioCfg.sfx).sheet,
...
UIAVGSystem.OnClickShwoLogList = function(self)
    ...
    if self.__lastAutoPlay then (self.avgCtrl):SwitchAvgAutoPlay() end
...
UIAVGSystem.RefreshAutoPlay = function(self, autoPlay)
    ...
    (((self.ui).img_AutoIcon).transform).position = self.autoIconPos -- DECOMPILER ERROR at PC19: Confused about usage of register: R2 in 'UnsetPending'
    ;
    (self.autoIconColor).a = 1 -- DECOMPILER ERROR at PC23: Confused about usage of register: R2 in 'UnsetPending'
    ;
