...
UINFriendshipChatPageFriendItem.OnInit = function(self)
  ...
  MsgCenter:AddListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshFavorLevel)
end
...
UINFriendshipChatPageFriendItem.OnDelete = function(self)
  ...
  MsgCenter:RemoveListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshFavorLevel)
  ;
  (base.OnDelete)(self)
end
