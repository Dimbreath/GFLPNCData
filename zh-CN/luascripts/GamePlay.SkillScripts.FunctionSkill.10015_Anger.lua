...
bs_10015.InitSkill = function(self, isMidwaySkill)
    ...
    self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_10015_1", 1,
                    self.OnAfterBattleStart)
    self:AddTrigger(eSkillTriggerType.AfterHurt, "bs_10015_3", 1,
                    self.OnAfterHurt)
    self:AddTrigger(eSkillTriggerType.AfterHeal, "bs_10015_5", 1,
                    self.OnAfterHeal)
end

bs_10015.OnAfterBattleStart = function(self)
    -- function num : 0_2 , upvalues : _ENV
    local buffTier = LuaSkillCtrl:CallFormulaNumberWithSkill(
                         (self.config).buffTierFormula, self.caster,
                         self.caster, self)
...
bs_10015.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss,
                                isCrit, isRealDmg)
