...
UINDormOverviewHouse.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).dormInfoItem, self,
                               self.OnDormInfoItemClicked)
end

UINDormOverviewHouse.InitDormHouseInfo =
    function(self, houseCfg, houseData, clickAction)
        ...
        elseif houseCfg.unlock_logic == 1 then
            ((self.ui).tex_Condition):SetIndex(0,
                                               tostring(houseCfg.unlock_level));
        ...
        elseif houseCfg.unlock_logic == 2 then
            ...
            if itemCfg ~= nil then
                ((self.ui).img_CurrencyIcon).sprite =
                    CRH:GetSprite(itemCfg.icon)
            end -- DECOMPILER ERROR at PC80: Confused about usage of register: R6 in 'UnsetPending'
...
UINDormOverviewHouse.OnDormInfoItemClicked =
    function(self)
        -- function num : 0_3
