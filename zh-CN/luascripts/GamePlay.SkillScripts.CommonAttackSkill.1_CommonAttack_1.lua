...
bs_1.config = {rangeOffset = 0, effectId = 52, effectStartId = nil, effectStartId3 = nil, effectstartId1 = nil, effectstartId2 = nil, effectId1 = nil, effectId2 = nil, effectId3 = nil, targetSelect = 1001, action1 = 1001, action2 = 1004, audioId1 = nil, audioId2 = nil, audioId3 = nil, audioId4 = nil, audioId5 = nil}
...
bs_1.PlaySkill = function(self, passdata)
  ...
  if bewitch ~= self.lastBewitch then
    ...
    if self.lastAttackRole ~= nil and LuaSkillCtrl:IsAbleAttackTarget(self.caster, self.lastAttackRole, data.rangeOffset + (self.caster).attackRange) and LuaSkillCtrl:IsWorthAttacking(self.lastAttackRole) then
