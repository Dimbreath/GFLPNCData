...
bs_10036.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : _ENV
    self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_10036_1", 1,
                    self.OnAfterBattleStart)
end

bs_10036.OnAfterBattleStart = function(self)
    -- function num : 0_2 , upvalues : _ENV
    self.damTimer = LuaSkillCtrl:StartTimer(self, (self.config).healDelay,
                                            self.CallBack, self, -1,
                                            (self.config).healDelay)
end

bs_10036.CallBack = function(self)
    -- function num : 0_3 , upvalues : _ENV
    local healNum = (math.max)(LuaSkillCtrl:CallFormulaNumberWithSkill(
