...
ExplorationManager.ReqEnterExploration = function(self, epId, fomationId, moduleId, callback)
  ...
  ;
  (self.network):CS_EXPLORATION_Start(epId, fomationId, moduleId, callback)
end
...
ExplorationManager.__NewExploration = function(self, msg, isReconnect)
  -- function num : 0_7 , upvalues : _ENV, eDynConfigData, DynPlayer, EpMvpData
  ...
  if self:GetEpModuleId() == proto_csmsg_SystemFunctionID.SystemFunctionID_Exploration then
    ...
    do
      if self:GetEpModuleId() == proto_csmsg_SystemFunctionID.SystemFunctionID_Endless then
        ...
        self.stageCfg = {endlessCfg = cfg, size_row = cfg.size_row, size_col = cfg.size_col, deploy_rows = cfg.deploy_rows, name = cfg.name, sector = levelDic.sectorId, cost_strength_num = (cfg.cost_strength_itemNums)[1], difficulty = (ConfigData.sector_stage).difficultyCount + 1, dungeonId = endlessId}
    ...
    -- function num : 0_7_0 , upvalues : self, msg, isReconnect
...
ExplorationManager.ContinueLastExploration = function(self)
...
ExplorationManager.ExitExploration = function(self, SceneName, loadMainCallback)
  -- function num : 0_23 , upvalues : CS_PlayerPrefs, _ENV, util
  (CS_PlayerPrefs.SetInt)("battleSpeed", 1)
