...
bs_1002.config = {
hurt_config = {hit_formula = 0, basehurt_formula = 1048, crit_formula = 0, crithur_ratio = 0}
, 
hurt_config2 = {hit_formula = 0, def_formula = 0, basehurt_formula = 1048}
, effectId = 1043, buffId = 66, buffTier = 1}
...
bs_1002.PlaySkill = function(self, data)
  ...
  for i = 1, (self.arglist)[1] do
    ...
    local skillResult = LuaSkillCtrl:CallSkillResultNoEffect(self, targetList[0])
    LuaSkillCtrl:HurtResult(skillResult, (self.config).hurt_config, {i})
  ...
  if (self.arglist)[5] == 1 then
    LuaSkillCtrl:CallBuff(self, (targetList[0]).targetRole, (self.config).buffId, (self.config).buffTier, (self.arglist)[4])
  end
end
