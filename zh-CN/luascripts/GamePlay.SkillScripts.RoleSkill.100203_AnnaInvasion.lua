...
bs_1062.PlaySkill = function(self, data)
  ...
  for i = 0, targetList.Count - 1 do
    ...
    LuaSkillCtrl:CallBuff(self, (targetList[i]).targetRole, (self.config).buffId, 1, (self.arglist)[1], false)
  end
, nil)
    end
  end
...
bs_1062.OnMovieFadeOut = function(self)
  ...
  self.loopaudio = LuaSkillCtrl:PlayAuSource(self.caster, (self.config).audioId4)
