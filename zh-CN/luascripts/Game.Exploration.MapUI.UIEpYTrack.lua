...
UIEpYTrack.SetTrunkLinePass = function(self, isPass, color, height)
    ...
    if isPass then
        ((self.ui).img_Trunk).color = color -- DECOMPILER ERROR at PC11: Confused about usage of register: R5 in 'UnsetPending'
        ;
        ...
        ((self.ui).img_Trunk).color = self.lineDefaultColor -- DECOMPILER ERROR at PC21: Confused about usage of register: R5 in 'UnsetPending'
        ;
        ((self.ui).img_Point).color = self.pointColor
        sizeDelta.y = self.lineDefaultHeight
    end -- DECOMPILER ERROR at PC27: Confused about usage of register: R5 in 'UnsetPending'
    
    (((self.ui).img_Trunk).transform).sizeDelta = sizeDelta
end

UIEpYTrack.SetForkLinePass = function(self, forkRoom, mapCtrl, isPass, color,
                                      height)
    -- function num : 0_3
    ...
    if isPass then
        ...
        sizeDelta.y = self.lineDefaultHeight
    end -- DECOMPILER ERROR at PC18: Confused about usage of register: R8 in 'UnsetPending'
