...
, 
bigMonsterId = {9, 10}
, buffId = 1033, effectId = 10264, effectId1 = 10263, startAnimID = 1002}
...
bs_40035.OnAfterBattleStart = function(self)
  ...
  LuaSkillCtrl:CallBuff(self, self.caster, 1033, 1, 1000000)
...
bs_40035.CallBack = function(self)
  ...
  if targetList.Count < 8 then
    ...
    LuaSkillCtrl:CallRoleActionWithTrigger(self, self.caster, (self.config).startAnimID, 1, 18, moveAttackTrigger)
  end
end
...
bs_40035.CallBack1 = function(self, x, y)
  ...
  if ((self.caster).recordTable)["40035_SummonTime"] < 10 then
    local summoner = LuaSkillCtrl:CreateSummoner(self, ((self.config).middleMonsterId)[(math.random)(1, 3)], x, y)
    summoner:SetAttr(eHeroAttr.maxHp, (self.caster).maxHp * 150 // 1000)
    summoner:SetAttr(eHeroAttr.pow, (self.caster).pow * 700 // 1000)
    ...
    if ((self.caster).recordTable)["40035_SummonTime"] < 10 then
        ...
        do
            ...
            do
                ...
                local damage = (self.caster).maxHp * (self.arglist)[2] // 1000
                if (self.caster).hp > 1 then
                    LuaSkillCtrl:RemoveLife(damage, self, self.caster) -- DECOMPILER ERROR at PC126: Confused about usage of register: R5 in 'UnsetPending'
                    ;
