...
UIBuildingQueueItem.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).btn_Finish, self,
                               self.OnClickFinishButton)
end

UIBuildingQueueItem.UpdateQueueProgress =
    function(self, buitData, sectorName)
        ...
        if sectorName == nil then
            ...
            ((self.ui).tex_BuildInfo):SetIndex(1, (LanguageUtil.GetLocaleText)(
                                                   sectorName), name)
        end
        local progress = buitData.progress
        self:__SwitchUI(progress ~= 1) -- DECOMPILER ERROR at PC30: Confused about usage of register: R5 in 'UnsetPending'
        ;
...
UIBuildingQueueItem.OnClickFinishButton =
    function(self)
        -- function num : 0_3
