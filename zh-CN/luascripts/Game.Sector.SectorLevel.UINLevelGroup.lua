...
UINLevelGroup.InitLevelGroup = function(self, levelGroupData, lastEpStateCfg,
    ...
    for k, v in ipairs(levelGroupData) do
        ...
        if v.stageCfg ~= nil then
            ...
            self:__ShowLAvgSubItem(levelItem, isVertical) -- DECOMPILER ERROR at PC228: Confused about usage of register: R30 in 'UnsetPending'
            ;
        ...
        elseif v.avgCfg ~= nil then
            ...
            randomSeed = avgCfg.id -- DECOMPILER ERROR at PC253: Confused about usage of register: R30 in 'UnsetPending'
            ;
        ...
        do
            ...
            -- DECOMPILER ERROR at PC403: Confused about usage of register: R33 in 'UnsetPending'
            ...
            local isLeft =
                not self:__IsOuNumber(levelGroupData.startIndex + k) or
                    startIsLeft
            ...
            do
                ...
                lineItem:InitLevelLine(lineType, startPos, angle)
                lastPos = startPos
                -- DECOMPILER ERROR at PC456: LeaveBlock: unexpected jumping out DO_STMT
