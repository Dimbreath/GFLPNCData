...
local UINFriendshipChatPageFriendList = require(
                                            "Game.Friendship.pages.ChatPage.UINFriendshipChatPageFriendList")
local UINFriendshipChatPageChatDetail = require(
                                            "Game.Friendship.pages.ChatPage.UINFriendshipChatPageChatDetail")
...
UINFriendshipChatPage.LaterInit = function(self, resloader)
    ...
    (self.friendList):InitFriendList(self.resloader,
                                     (self.chatDetail).GetHeroData)
end
