...
HeroAttrChecker.DirtyPlayerHeroAttri = function(self, heroId, attriId, attriValue)
  ...
  if self.__checkHeroAttriTimer == nil then
    self.__checkHeroAttriTimer = (TimerManager:GetTimer(1, self.__StartCheckPlayerHeroAttri, self, true, true)):Start()
  end
end

HeroAttrChecker.__StartCheckPlayerHeroAttri = function(self)
...
HeroAttrChecker.__CheckPlayerHeroAttri = function(self, msg)
...
HeroAttrChecker.__ClearCheckHeroAttriTimer = function(self)
  -- function num : 0_4
  if self.__checkHeroAttriTimer ~= nil then
