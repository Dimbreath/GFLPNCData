...
ControllerTypeId = {SectorController = 1, OasisController = 2, FunctionUnlock = 3, Shop = 4, Factory = 5, Task = 6, Mail = 7, Setting = 8, Dorm = 9, Avg = 10, Overclock = 11, Formation = 12, AvgPlay = 13}
