...
bs_523.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddSelfTrigger(eSkillTriggerType.AfterHurt, "bs_523_11", 1, self.OnAfterHurt)
  self.killcaster = nil
  self.time = ((self.caster).recordTable).time + 2
end

bs_523.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg, isTriggerSet)
