...
[1] = {
images = {
{imgId = 99, imgPath = "cpt01/cpt01_e_bg003", imgType = 2, order = 97, fullScreen = true, delete = false}
, 
...
, content = 100, contentType = 3, speakerHeroId = 1006, speakerHeroPosId = 1}
, 
[11] = {content = 110, contentType = 3, speakerHeroId = 1006, speakerHeroPosId = 1, contentShake = true}
, 
[12] = {
images = {
...
, content = 120, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 1, contentShake = true}
, 
[13] = {content = 130, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 1, 
branch = {
{content = 131, jumpAct = 14}
, 
{content = 132, jumpAct = 15}
}
}
, 
[14] = {content = 140, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 1, nextId = 16}
, 
[15] = {content = 150, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 1}
, 
[16] = {content = 160, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 1}
, 
[17] = {content = 170, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 1}
, 
[18] = {content = 180, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 1}
, 
[19] = {
imgTween = {
{imgId = 3, 
...
, content = 210, contentType = 2, contentShake = true}
, 
[22] = {
imgTween = {
{imgId = 3, duration = 0.5, 
...
, content = 230, contentType = 4, speakerName = 231}
, 
...
[32] = {
images = {
{imgId = 98, imgPath = "cpt01/cpt01_e_bg004", imgType = 2, order = 97, alpha = 0, fullScreen = true, delete = false}
, 
...
, content = 330, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3, 
audio = {
bgm = {cue = "Mus_Story_BattleTension", sheet = "Music"}
}
}
...
, content = 390, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3}
, 
[40] = {
imgTween = {
{imgId = 1, duration = 0.2, 
...
[41] = {
images = {
{imgId = 120, imgPath = "anna_hood_avg", imgType = 3, 
pos = {0, 0, 0}
, 
rot = {0, 0, 0}
, 
...
, content = 440, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1, contentShake = true}
, 
[45] = {
imgTween = {
{imgId = 1, duration = 0.2, 
...
, content = 460, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3, contentShake = true}
, 
[47] = {
imgTween = {
{imgId = 3, 
...
[51] = {
images = {
{imgId = 97, imgPath = "cpt00/cpt00_e_bg004", imgType = 4, order = 99, fullScreen = true, delete = false, alpha = 0}
, 
{imgId = 96, imgPath = "cpt01/cpt01_e_bg004_2", imgType = 2, order = 100, fullScreen = true, delete = false, alpha = 0}
}
, 
imgTween = {
...
, content = 510, contentType = 2, contentShake = true}
, 
[52] = {
images = {
...
, content = 560, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3}
, 
[57] = {
imgTween = {
{imgId = 1, isDark = true}
...
, content = 620, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3}
, 
[63] = {
imgTween = {
{imgId = 3, isDark = true}
...
, 
[65] = {content = 650, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3}
, 
[66] = {
imgTween = {
{imgId = 3, isDark = true}
...
, content = 690, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3}
, 
[70] = {
imgTween = {
{imgId = 3, isDark = true}
