...
UIResetRoomChip.InitChipItem = function(self, chipData, chipCount, clickAction)
    ...
    (((self.ui).onSelect).transform):SetAsLastSibling() -- DECOMPILER ERROR at PC24: Confused about usage of register: R4 in 'UnsetPending'
    ;
...
UIResetRoomChip.UpdateCountUI = function(self, selectCount)
    ...
    if selectCount > 0 then
        ...
        (((self.ui).tex_ChipCount).gameObject):SetActive(true) -- DECOMPILER ERROR at PC16: Confused about usage of register: R2 in 'UnsetPending'
        ;
