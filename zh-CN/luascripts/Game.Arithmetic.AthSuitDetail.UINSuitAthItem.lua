...
UINSuitAthItem.InitSuitAthItem = function(self, athData, athCfg, resLoader)
    ...
    ((self.ui).img_Quality).color = qualityColor
    local suitId = athCfg.suit
    local suitParamCfg = ((ConfigData.ath_suit).suitParamDic)[suitId] -- DECOMPILER ERROR at PC35: Confused about usage of register: R8 in 'UnsetPending'
    ;
    ((self.ui).img_Icon).enabled = suitParamCfg ~= nil
    if suitParamCfg ~= nil then
    ...
    ((self.ui).tex_Area):SetIndex(0, areaCfg.name1) -- DECOMPILER ERROR at PC72: Confused about usage of register: R9 in 'UnsetPending'
    ;
    ((self.ui).tex_Name).text = (LanguageUtil.GetLocaleText)(itemCfg.name)
    if athData ~= nil and #(athData.athMainAttrCfg).attrtibute_id > 0 then
        local attrId = ((athData.athMainAttrCfg).attrtibute_id)[1]
        local attrValue = ((athData.athMainAttrCfg).attrtibute_num)[1]
        local name, valueStr, icon = ConfigData:GetAttribute(attrId, attrValue) -- DECOMPILER ERROR at PC93: Confused about usage of register: R14 in 'UnsetPending'
        ;
        ((self.ui).img_Attri).enabled = true -- DECOMPILER ERROR at PC100: Confused about usage of register: R14 in 'UnsetPending'
        ;
        ((self.ui).img_Attri).sprite = CRH:GetSprite(icon) -- DECOMPILER ERROR at PC103: Confused about usage of register: R14 in 'UnsetPending'
        ;
        ((self.ui).tex_AttriNum).text = valueStr -- DECOMPILER ERROR at PC106: Confused about usage of register: R14 in 'UnsetPending'
        ;
        ((self.ui).tex_AttriName).text = name -- DECOMPILER ERROR at PC109: Confused about usage of register: R14 in 'UnsetPending'
        ;
        ((self.ui).fade).alpha = 1 -- DECOMPILER ERROR at PC114: Confused about usage of register: R14 in 'UnsetPending'
        ;
        ((self.ui).img_AttriQuality).color = (ArthmeticEnum.AthColor)[5]
    else
        -- DECOMPILER ERROR at PC118: Confused about usage of register: R9 in 'UnsetPending'

        ((self.ui).img_Attri).enabled = false -- DECOMPILER ERROR at PC121: Confused about usage of register: R9 in 'UnsetPending'
        ;
        ((self.ui).tex_AttriNum).text = nil -- DECOMPILER ERROR at PC124: Confused about usage of register: R9 in 'UnsetPending'
        ;
        ((self.ui).tex_AttriName).text = nil -- DECOMPILER ERROR at PC127: Confused about usage of register: R9 in 'UnsetPending'
        ;
        ((self.ui).img_AttriQuality).color = nil -- DECOMPILER ERROR at PC130: Confused about usage of register: R9 in 'UnsetPending'
        ;
        ((self.ui).fade).alpha = 0.6
    end
    ((self.ui).notInstall):SetActive(athData == nil)
