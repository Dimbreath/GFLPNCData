...
UINFriendshipSortKindItem.OnInit = function(self)
    ...
    (UIUtil.AddValueChangedListener)((self.ui).tog_sortKindItem, self,
                                     self.onItemValueChange)
end

UINFriendshipSortKindItem.InitSortItem =
...
UINFriendshipSortKindItem.onItemValueChange =
    function(self, bool)
        -- function num : 0_2
        if self.callBack ~= nil then (self.callBack)(bool) end
    end
