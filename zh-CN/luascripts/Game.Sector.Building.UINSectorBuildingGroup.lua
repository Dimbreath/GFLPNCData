...
UINSectorBuildingGroup.InitSctBuildGroup =
    function(self, buildingIdList, buildType, resloader, clickItemFunc)
        -- function num : 0_2 , upvalues : BuildingBelong, _ENV, BuildingItem

        ((self.ui).tex_Tile):SetIndex(buildType ==
                                          (BuildingBelong.SectorType).production and
                                          0 or 1)
        ...
        for _, id in ipairs(buildingIdList) do
            ...
            if data == nil then
                ...
                item.OnClickEvent = clickItemFunc -- DECOMPILER ERROR at PC63: Confused about usage of register: R14 in 'UnsetPending'
                ;
...
UINSectorBuildingGroup.OnDelete = function(self)
    ...
    for k, v in pairs(self.groupBuildItems) do v:Delete() end
    (base.OnDelete)(self)
end
