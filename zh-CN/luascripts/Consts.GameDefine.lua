...
eMsgEventId = {
    ...
    OnBattleCreateSettlementUI = 1350,
...
eCustomWaitType = {WaitGateInfo = 1, WaitCheckVersion = 2}
...
_ENV.eHeroSkillType = {BattleSkill = 1, LifeSkill = 2}
...
_ENV.eSectorByCareer = {[1] = "2_camp", [2] = "1_camp", [3] = "1_camp"}
