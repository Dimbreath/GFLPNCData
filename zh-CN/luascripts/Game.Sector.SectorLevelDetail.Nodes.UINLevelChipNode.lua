...
UINLevelChipNode.InitChipDataQualityDic = function(self, LevelDtail)
      ...
      do
        ...
        for itemId,_ in pairs(chip_dic) do
          ...
          if (self.chipDataQualityDic)[R10_PC67] == nil then
            (self.chipDataQualityDic)[R10_PC67] = {}
...
UINLevelChipNode.OnChipClick = function(self, chipData, chipItem)
  ...
  if self.selectedChipData == chipData then
    ...
    ;
    (self.chipDetailPanel):InitChipDetailPanel(nil, chipData, nil, self.resloader, nil, true, true, false)
  end
end
