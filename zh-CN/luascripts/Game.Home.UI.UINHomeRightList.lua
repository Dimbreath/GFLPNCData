...
UINHomeRightList.RefreshDormBtn = function(self)
  -- function num : 0_14 , upvalues : UINHomeGeneralBtn
...
UINHomeRightList.RefreshFrgShopBtn = function(self)
  -- function num : 0_16 , upvalues : UINHomeGeneralBtn, _ENV
...
UINHomeRightList.OnClickHeroListBtn = function(self)
  ...
  if (self.heroListBtn).isUnlock then
    ...
    win:SetReturnEvent(function()
      -- function num : 0_17_0_0 , upvalues : self, win
...
UINHomeRightList.RefreshEpBtn = function(self)
  ...
  if self.epBtn == nil then
    ...
    -- function num : 0_21_1 , upvalues : self, _ENV
    ...
    if (self.bind).sectorPlayableDirector == director then
      ...
      -- function num : 0_21_1_0 , upvalues : self, _ENV
...
UINHomeRightList.QickBuyStamina = function(self)
  -- function num : 0_27 , upvalues : JumpManager
...
UINHomeRightList.OnClickOasisBtn = function(self)
  ...
  if (self.oasisBtn).isUnlock then
    ...
    self.__tlOasisCo = (TimelineUtil.Rewind)((self.bind).oasisPlayableDirector, function()
      -- function num : 0_29_0_0 , upvalues : _ENV, self
...
UINHomeRightList.RefreshWarehouseBtn = function(self)
  -- function num : 0_33 , upvalues : UINHomeGeneralBtn
...
UINHomeRightList.RefreshShopBtn = function(self)
  -- function num : 0_35 , upvalues : UINHomeGeneralBtn, _ENV
...
UINHomeRightList.OnInit = function(self)
    ...
    self.homeController = ControllerManager:GetController(
                              ControllerTypeId.HomeController, false)
    self._ChangeTog = BindCallback(self, self.ChangeTog)
    self.btnDatasDic = {}
    self.curTogType = (HomeEnum.eHomeTogTypeOrder)[1];
    (UIUtil.LuaUIBindingTable)(self.transform, self.ui)
    self.togPool = (UIItemPool.New)(UINHomeRightListTog,
                                    (self.ui).tog_FuncPageItem);
    ((self.ui).tog_FuncPageItem):SetActive(false);
    (((self.ui).scrollRect_pageList).onValueChanged):AddListener(
        BindCallback(self, self.OnValueChange))
    local eventTrigger = (CS_EventTriggerListener.Get)(
                             ((self.ui).scrollRect_pageList).gameObject)
    eventTrigger:onEndDrag("+", BindCallback(self, self.OnEndDrag));
    (UIUtil.AddButtonListener)((self.ui).btn_Lottery, self,
                               self.OnClickLotteryBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_Dorm, self, self.OnClickDormBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_ShopToHeroChip, self,
                               self.OnClickFrgShopBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_HeroList_BIG, self,
                               self.OnClickHeroListBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_Exproation, self, self.OnClickEpBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_Oasis_BIG, self,
                               self.OnClickOasisBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_Warehouse, self,
                               self.OnClickWarehouseBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_Store, self, self.OnClickShopBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_Factor, self,
                               self.OnClickFactoryBtn)
    self.m_OnLateUpdate = BindCallback(self, self.OnLateUpdate)
    UpdateManager:AddLateUpdate(self.m_OnLateUpdate)
end
...
UINHomeRightList.GenTogs = function(self, defaultSelectType)
    ...
    for _, type in pairs(HomeEnum.eHomeTogTypeOrder) do
        local item = (self.togPool):GetOne()
        item:InitTog(type, self._ChangeTog) -- DECOMPILER ERROR at PC21: Confused about usage of register: R9 in 'UnsetPending'
        ;
        (item.gameObject).name = "Tog_FuncPageItem" .. tostring(type)
        if type == defaultSelectType or not defualtSelectItem then
            defualtSelectItem = item
        end
        item:ChangeColorOnClick(type ~= defaultSelectType and
                                    not defualtSelectItem)
...
UINHomeRightList.OnLateUpdate = function(self)
    -- function num : 0_5 , upvalues : _ENV
    if self.attaching then
        if not self.waitEpTimeLine and
            (math.abs)(
                ((self.ui).scrollRect_pageList).verticalNormalizedPosition -
                    self.scrollNPos) < 0.01 then self.attaching = false end
        self.passedTime = self.passedTime + Time.deltaTime -- DECOMPILER ERROR at PC32: Confused about usage of register: R1 in 'UnsetPending'
        ;
        ((self.ui).scrollRect_pageList).verticalNormalizedPosition =
            (Mathf.Lerp)(self.currNPos, self.scrollNPos,
                         self.passedTime / self.totalCostTime)
    end
end
...
UINHomeRightList.ChangeCanvasGroup = function(self, type)
    ...
    local isHuman = type == (HomeEnum.eHomeTogType).ControlCenter or type ==
                        (HomeEnum.eHomeTogType).HumanResource -- DECOMPILER ERROR at PC31: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).HeroListFade).interactable = isHuman -- DECOMPILER ERROR at PC40: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).HeroListFade).alpha = isHuman and 1 or 0.3
    local isInfrastructure = type == (HomeEnum.eHomeTogType).ControlCenter or
                                 type == (HomeEnum.eHomeTogType).Infrastructure -- DECOMPILER ERROR at PC53: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).OasisFade).interactable = isInfrastructure -- DECOMPILER ERROR at PC62: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).OasisFade).alpha = isInfrastructure and 1 or 0.3
    -- DECOMPILER ERROR: 10 unprocessed JMP targets
end
...
UINHomeRightList.PrepareBtnList = function(self)
    -- function num : 0_8 , upvalues : HomeEnum, _ENV
    self.changPosMid = (((((self.ui).posPoint_top).transform).position).y +
                           ((((self.ui).posPoint_down).transform).position).y) /
                           2
    self.normalizedPosition4TypeDic = {
        [(HomeEnum.eHomeTogType).HumanResource] = 1,
        [(HomeEnum.eHomeTogType).ControlCenter] = 0.5,
        [(HomeEnum.eHomeTogType).Infrastructure] = 0
    } -- DECOMPILER ERROR at PC44: Confused about usage of register: R1 in 'UnsetPending'
    ;
    (self.btnDatasDic)[(HomeEnum.eChangeBtnType).HeroData] =
        {
...
UINHomeRightList.OnValueChange = function(self, pos)
    -- function num : 0_9 , upvalues : _ENV, HomeEnum
    local nowNPos = pos.y
    local btn_HeroList_BIG_Rate = 1 -
                                      (((((self.ui).posPoint_top).transform).position).y -
                                          ((((self.ui).posPoint_HeroDataBig_Top).transform).position).y) /
                                      (((((self.ui).posPoint_top).transform).position).y -
                                          self.changPosMid) -- DECOMPILER ERROR at PC40: Confused about usage of register: R4 in 'UnsetPending'
    ;
    (((self.ui).btn_HeroList_BIG).transform).sizeDelta =
        (Vector2.Lerp)(
            (((self.btnDatasDic)[(HomeEnum.eChangeBtnType).HeroData]).big).sizeDelta,
            (((self.btnDatasDic)[(HomeEnum.eChangeBtnType).HeroData]).small).sizeDelta,
            btn_HeroList_BIG_Rate)
    local btn_Oasis_BIG_Rate = 1 -
                                   (((((self.ui).posPoint_OasisBig_Bottom).transform).position).y -
                                       ((((self.ui).posPoint_down).transform).position).y) /
                                   (self.changPosMid -
                                       ((((self.ui).posPoint_down).transform).position).y) -- DECOMPILER ERROR at PC79: Confused about usage of register: R5 in 'UnsetPending'
    ;
    ((self.ui).OasisLayout).sizeDelta = (Vector2.Lerp)(
                                            (((self.btnDatasDic)[(HomeEnum.eChangeBtnType).Oasis]).big).sizeDelta,
                                            (((self.btnDatasDic)[(HomeEnum.eChangeBtnType).Oasis]).small).sizeDelta,
                                            btn_Oasis_BIG_Rate) -- DECOMPILER ERROR at PC84: Confused about usage of register: R5 in 'UnsetPending'
    ;
    (((self.heroListBtn).ui).fade_Big).alpha = 1 - btn_HeroList_BIG_Rate -- DECOMPILER ERROR at PC88: Confused about usage of register: R5 in 'UnsetPending'
    ;
    (((self.heroListBtn).ui).fade_Small).alpha = btn_HeroList_BIG_Rate -- DECOMPILER ERROR at PC93: Confused about usage of register: R5 in 'UnsetPending'
    ;
    (((self.oasisBtn).ui).fade_Big).alpha = 1 - btn_Oasis_BIG_Rate -- DECOMPILER ERROR at PC97: Confused about usage of register: R5 in 'UnsetPending'
    ;
    (((self.oasisBtn).ui).fade_Small).alpha = btn_Oasis_BIG_Rate
end
...
UINHomeRightList.OnEndDrag = function(self)
    ...
    if self.normalizedPosition4TypeDic ~= nil then
        ...
        hasBefore = (HomeEnum.eHomeTogTypeOrder)[self.curTogType - 1] ~= nil
        if curTypeNPos < currNPos and hasBefore then
            local beforeTypeNpos =
                (self.normalizedPosition4TypeDic)[self.curTogType - 1]
            -- DECOMPILER ERROR at PC47: Confused about usage of register: R6 in 'UnsetPending'

            if (beforeTypeNpos - curTypeNPos) / 3 < currNPos - curTypeNPos then
                (((((self.togPool).listItem)[self.curTogType - 1]).ui).tog_FuncPageItem).isOn =
                    true
            else
                self:AttachToType(self.curTogType)
            end
...
UINHomeRightList.OnClickLotteryBtn = function(self)
    -- function num : 0_11 , upvalues : _ENV
    if (self.lotteryBtn).isUnlock then
        local ctrl = ControllerManager:GetController(ControllerTypeId.Lottery,
                                                     true)
        ctrl:InitLottery(function()
            -- function num : 0_11_0 , upvalues : self
            (self.homeUI):OpenOtherWin()
...
UINHomeRightList.RefreshLotteryBtn = function(self)
    ...
    if self.lotteryBtn == nil then
        self.lotteryBtn = (UINHomeGeneralBtn.New)();
        (self.lotteryBtn):Init(((self.ui).btn_Lottery).gameObject);
        (self.homeController):AddRedDotEvent((self.lotteryBtn):GetRedDotFunc(),
    ...
    if (self.frgShopBtn).isUnlock then
        UIManager:ShowWindowAsync(UIWindowTypeID.Shop, function(win)
            ...
            if win ~= nil then
                local ShopEnum = require("Game.Shop.ShopEnum")
                win:InitShopTogList(
                    (ShopEnum.ShopId)[(ShopEnum.eShopType).Charcter]);
                (self.homeUI):OpenOtherWin()
            end
        end)
    end
...
UINHomeRightList.RefreshHeroListBtn = function(self)
    ...
    if self.heroListBtn == nil then
        self.heroListBtn = (UINHomeGeneralBtn.New)();
        (self.heroListBtn):Init(((self.ui).btn_HeroList_BIG).gameObject);
        (self.homeController):AddRedDotEvent((self.heroListBtn):GetRedDotFunc(),
                                             RedDotStaticTypeId.Main,
                                             RedDotStaticTypeId.HeroWindow)
    end
    local isUnlock, unlockDes = (self.homeController):IsFuncUnlock(
...
UINHomeRightList.RefreshEpBtn = function(self)
    ...
    if self.epBtn == nil then
        self.epBtn = (UINHomeGeneralBtn.New)();
        (self.epBtn):Init(((self.ui).btn_Exproation).gameObject);
        (self.homeController):AddRedDotEvent((self.epBtn):GetRedDotFunc(),
                                             RedDotStaticTypeId.Main,
                                             RedDotStaticTypeId.Sector);
        (UIUtil.AddButtonListener)(((self.epBtn).ui).btn_ContinueEp, self,
                                   function()
            -- function num : 0_21_0 , upvalues : _ENV
            ExplorationManager:ContinueLastExploration()
        end);
        (UIUtil.AddButtonListener)(((self.epBtn).ui).btn_AddEpPoint, self,
                                   BindCallback(self, self.QickBuyStamina));
        (UIUtil.AddButtonListener)(((self.epBtn).ui).btn_pountInfo, self,
                                   BindCallback(self, self.ShowStaminaDetail));
        ((self.bind).sectorPlayableDirector):stopped("+", function(director)
            -- function num : 0_21_1 , upvalues : self, _ENV
            -- DECOMPILER ERROR at PC9: Confused about usage of register: R1 in 'UnsetPending'
            ...
            if (self.bind).sectorPlayableDirector == director then
                ...
                UIManager:DeleteWindow(UIWindowTypeID.Home)
                UIManager:HideWindow(UIWindowTypeID.ClickContinue);
                ((CS.GSceneManager).Instance):LoadSceneByAB(
                    (Consts.SceneName).Sector, function()
                        -- function num : 0_21_1_0 , upvalues : self, _ENV
                        if (self.homeUI).enterSectorJumpCallback ~= nil then
                            (ControllerManager:GetController(
                                ControllerTypeId.SectorController, true)):SetFrom(
                                AreaConst.Home);
                            ((self.homeUI).enterSectorJumpCallback)() -- DECOMPILER ERROR at PC18: Confused about usage of register: R0 in 'UnsetPending'
                            ;
                            (self.homeUI).enterSectorJumpCallback = nil
                        else
                            if ExplorationManager:HasUncompletedEp() and
                                not self.doNotOpenEpStages then
                                (ControllerManager:GetController(
                                    ControllerTypeId.SectorController, true)):SetFrom(
...
UINHomeRightList.RefreshCurEpStage = function(self)
    -- function num : 0_22 , upvalues : _ENV
    local sectorId, stageIndex, differIdex =
        (PlayerDataCenter.sectorStage):GetEpStageCfg4Home();
    (((self.epBtn).ui).tex_LevelName):SetIndex(differIdex, tostring(sectorId),
                                               tostring(stageIndex))
end
...
UINHomeRightList.RefreshNormalStage = function(self, stageId)
    ...
    local stageIndex = 0
    local difflist =
        (((ConfigData.sector_stage).sectorDiffDic)[sectorId])[difficultyId]
    for index, id in ipairs(difflist) do
        if id == stageId then stageIndex = index end
    end
    (((self.epBtn).ui).tex_LevelName):SetIndex(difficultyId, tostring(sectorId),
                                               tostring(stageIndex))
end
...
UINHomeRightList.RefreshEndlessStage = function(self, stageId)
    ...
    local depth = endlessLevelDic.index * 10
    local sectorCfg = (ConfigData.sector)[sectorId]
    ConfigData:ReleaseDynCfg(eDynConfigData.endless) -- DECOMPILER ERROR at PC23: Confused about usage of register: R7 in 'UnsetPending'
    ;
    (package.loaded)[eDynConfigData] = nil;
    (((self.epBtn).ui).tex_LevelName):SetIndex(3, tostring(
...
UINHomeRightList.RefreshContinueEp = function(self)
    -- function num : 0_25 , upvalues : _ENV
    local hasHasUncompletedEp, stageId, moduleId =
        ExplorationManager:HasUncompletedEp();
    ((((self.epBtn).ui).btn_ContinueEp).gameObject):SetActive(
        hasHasUncompletedEp);
    (((self.epBtn).ui).tex_LevelType):SetIndex(hasHasUncompletedEp and 0 or 1)
    if moduleId ~= proto_csmsg_SystemFunctionID.SystemFunctionID_Endless then
        do
...
UINHomeRightList.RefreshStamina = function(self)
    -- function num : 0_26 , upvalues : _ENV
    local ceiling = (PlayerDataCenter.stamina):GetStaminaCeiling()
    local stamina, remainSecond = (PlayerDataCenter.stamina):GetCurrentStamina() -- DECOMPILER ERROR at PC14: Confused about usage of register: R4 in 'UnsetPending'
    ;
    (((self.epBtn).ui).tex_EpPoint).text = tostring(stamina);
    (((self.epBtn).ui).tex_EpPointLimit):SetIndex(0, tostring(ceiling))
end
...
UINHomeRightList.OnClickOasisBtn = function(self)
    ...
    if (self.oasisBtn).isUnlock then
        ...
        local homeClicked = function()
            -- function num : 0_29_0 , upvalues : self, _ENV
            ((self.bind).oasisPlayableDirector):Pause() -- DECOMPILER ERROR at PC6: Confused about usage of register: R0 in 'UnsetPending'
            ;
            ((self.bind).oasisPlayableDirector).time = 0;
            ((self.bind).oasisPlayableDirector):Evaluate();
            ((self.homeController).oasisController):OnExitOasis()
            AudioManager:PlayAudioById(1017)
            self.__tlOasisCo = (TimelineUtil.Rewind)(
                                   (self.bind).oasisPlayableDirector, function()
                    -- function num : 0_29_0_0 , upvalues : _ENV, self
                    UIManager:ShowWindow(UIWindowTypeID.Home);
                    (self.homeUI):OnShow()
                end)
        end -- DECOMPILER ERROR at PC38: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.homeController).oasisController).backToHomeEvent =
            BindCallback(self, homeClicked)
    end
end
...
UINHomeRightList.RefreshOasisBtn = function(self)
    ...
    if self.oasisBtn == nil then
        self.oasisBtn = (UINHomeGeneralBtn.New)();
        (self.oasisBtn):Init(((self.ui).btn_Oasis_BIG).gameObject);
        (self.homeController):AddRedDotEvent((self.oasisBtn):GetRedDotFunc(),
                                             RedDotStaticTypeId.Main,
...
UINHomeRightList.OnClickWarehouseBtn = function(self)
    -- function num : 0_32
    if (self.warehouseBtn).isUnlock then end
end
...
UINHomeRightList.RefreshShopBtn = function(self)
    ...
    if self.shopBtn == nil then
        self.shopBtn = (UINHomeGeneralBtn.New)();
        (self.shopBtn):Init(((self.ui).btn_Store).gameObject);
        (self.homeController):AddRedDotEvent((self.shopBtn):GetRedDotFunc(),
                                             RedDotStaticTypeId.Main,
                                             RedDotStaticTypeId.ShopWindow)
    end
    local isUnlock, unlockDes = (self.homeController):IsFuncUnlock(
                                    proto_csmsg_SystemFunctionID.SystemFunctionID_Store);
    (self.shopBtn):RefeshUnlockInfo(isUnlock, unlockDes)
...
UINHomeRightList.RefreshFactoryEnergy = function(self)
    -- function num : 0_37 , upvalues : _ENV
    local factoryCtrl = ControllerManager:GetController(
    ...
    if totalCeiling == 0 then
        (((self.factoryBtn).ui).tex_energy):SetIndex(0, "0") -- DECOMPILER ERROR at PC59: Confused about usage of register: R5 in 'UnsetPending'
        ;
        (((self.factoryBtn).ui).img_fill).fillAmount = 0
    else
        local rate = (totalValue) / (totalCeiling);
        (((self.factoryBtn).ui).tex_energy):SetIndex(0, tostring(
                                                         (math.ceil)(rate * 100))) -- DECOMPILER ERROR at PC77: Confused about usage of register: R6 in 'UnsetPending'
        ;
        (((self.factoryBtn).ui).img_fill).fillAmount = rate
    end
end
...
UINHomeRightList.RefreshFactoryBtn = function(self)
    ...
    if self.factoryBtn == nil then
        self.factoryBtn = (UINHomeGeneralBtn.New)();
        (self.factoryBtn):Init(((self.ui).btn_Factor).gameObject);
        (self.homeController):AddRedDotEvent((self.factoryBtn):GetRedDotFunc(),
                                             RedDotStaticTypeId.Main,
    ...
    (self.factoryBtn):RefeshUnlockInfo(isUnlock, unlockDes)
    if isUnlock then self:RefreshFactoryEnergy() end
    ((self.bind).factorydormPlayableDirector):stopped("+", function(director)
        -- function num : 0_38_0 , upvalues : self, _ENV
        -- DECOMPILER ERROR at PC9: Confused about usage of register: R1 in 'UnsetPending'
...
UINHomeRightList.OnDelete = function(self)
    -- function num : 0_39 , upvalues : _ENV, base
    if self.__tlOasisCo ~= nil then (TimelineUtil.StopTlCo)(self.__tlOasisCo) end
    UpdateManager:RemoveLateUpdate(self.m_OnLateUpdate);
    (base.OnDelete)(self)
end
