...
UINFriendshipChatPageChatDetail.OnInit = function(self)
  ...
  MsgCenter:AddListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshIntimacyBar)
end
...
UINFriendshipChatPageChatDetail.OnDelete = function(self)
  ...
  MsgCenter:RemoveListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshIntimacyBar)
  ;
