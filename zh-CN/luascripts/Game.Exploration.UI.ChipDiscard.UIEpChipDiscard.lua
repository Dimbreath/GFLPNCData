...
UIEpChipDiscard.OnInit = function(self)
    ...
    self._OnClick = BindCallback(self, self.OnClick) -- DECOMPILER ERROR at PC90: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).chipLoopList).onInstantiateItem =
        BindCallback(self, self.m_OnNewItem) -- DECOMPILER ERROR at PC97: Confused about usage of register: R1 in 'UnsetPending'
    ;
...
UIEpChipDiscard.DiscardChip = function(self)
    ...
    (self.explorationNetworkCtrl):CS_EXPLORATION_AlgUpperLimit_Sold(
        self.position, (self.selectedData).dataId)
