...
Color.Lerp = function(a, b, t)
    ...
    t = (Mathf.Clamp01)(t)
    return (Color.New)(a.r + t * (b.r - a.r), a.g + t * (b.g - a.g),
...
_getter.gamma = function(c)
    ...
    return (Color.New)((Mathf.LinearToGammaSpace)(c.r),
...
_getter.linear = function(c)
    ...
    return (Color.New)((Mathf.GammaToLinearSpace)(c.r),
                       (Mathf.GammaToLinearSpace)(c.g),
                       (Mathf.GammaToLinearSpace)(c.b), c.a)
end
...
Color.unity_color = (CS.UnityEngine).Color -- DECOMPILER ERROR at PC78: Confused about usage of register: R8 in 'UnsetPending'
;
