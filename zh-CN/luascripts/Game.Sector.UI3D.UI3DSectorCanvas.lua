...
UI3DSectorCanvas.AddSctInfoItem = function(self, sectorId, clickFunc)
    ...
    infoItem:InitSctItemInfo(sectorId, clickFunc) -- DECOMPILER ERROR at PC11: Confused about usage of register: R4 in 'UnsetPending'
    ;
    (infoItem.gameObject).name = tostring(sectorId) -- DECOMPILER ERROR at PC13: Confused about usage of register: R4 in 'UnsetPending'
    ;
