...
TrainingSlotData.InitAllTrainingSlotData =
    function()
        -- function num : 0_0 , upvalues : _ENV, TrainEnum, TrainingSlotData
        local trainingCfg =
            (ConfigData.training)[(TrainEnum.eTrainingDataType).Slot]
        local slotDatas = {}
...
TrainingSlotData.CheckUnlock = function(self)
    ...
    local unlock = (CheckCondition.CheckLua)(stcData.pre_condition,
                                             stcData.pre_para1,
                                             stcData.pre_para2)
