...
bs_1065.config = {
hurt_config = {hit_formula = 10010, basehurt_formula = 10007}
, 
aoe_config = {effect_shape = 3, aoe_select_code = 4, aoe_range = 3}
, effectId = 10310, effectId1 = 10343, buffId = 113}
...
bs_1065.PlayUltEffect = function(self)
  ...
  self:AddTrigger(eSkillTriggerType.AfterSelfUltInTimeLineEnd, "bs_1065_1", 1, self.AfterFocusTimeLine)
...
bs_1065.AfterFocusTimeLine = function(self)
  -- function num : 0_7 , upvalues : _ENV
  LuaSkillCtrl:StartTimerInUlt(5, function()
