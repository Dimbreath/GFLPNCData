...
UISectorBuildingItem.__UpdateLogic = function(self)
  ...
  do
    if levelCfg == nil or (levelCfg.logic).Count == 0 then
      return 
    end
    ...
    for i = 1, #levelCfg.logic do
      ...
      if logic == eBuildingLogic.ResourceOutput then
        ...
        if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.ResourceOutput then
        ...
        do
          if logic == eBuildingLogic.FactoryPipelie then
            ...
            ;
            ((self.ui).tex_Description).text = describ_text
            if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.FactoryPipelie then
              self.nextDescription = tostring((nextlvlCfg.para1)[i])
            end
          else
            do
              if logic == eBuildingLogic.ResourceLimit then
                ...
                ;
                ((self.ui).tex_Description).text = describ_text
                if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.ResourceLimit then
                  self.nextDescription = tostring((nextlvlCfg.para2)[i])
                end
              else
                do
                  if logic == eBuildingLogic.GlobalExpCeiling then
                    local describ = ((ConfigData.buildingBuff)[logic]).buff_text
                    local describ_text = (string.format)((LanguageUtil.GetLocaleText)(describ), tostring((levelCfg.para1)[i]))
                    -- DECOMPILER ERROR at PC202: Confused about usage of register: R11 in 'UnsetPending'

                    ;
                    ((self.ui).tex_Description).text = describ_text
                    if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.GlobalExpCeiling then
                      self.nextDescription = tostring((nextlvlCfg.para1)[i])
                    end
                  else
                    do
                      if logic == eBuildingLogic.StaminaCeiling then
                        local describ = ((ConfigData.buildingBuff)[logic]).buff_text
                        local describ_text = (string.format)((LanguageUtil.GetLocaleText)(describ), tostring((levelCfg.para1)[i]))
                        -- DECOMPILER ERROR at PC238: Confused about usage of register: R11 in 'UnsetPending'

                        ;
                        ((self.ui).tex_Description).text = describ_text
                        if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.StaminaCeiling then
                          self.nextDescription = tostring((nextlvlCfg.para1)[i])
                        end
                      else
                        do
                          if logic == eBuildingLogic.StaminaOutput then
                            ...
                            ;
                            ((self.ui).tex_Description).text = describ_text
                            if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.StaminaOutput then
                              self.nextDescription = tostring((nextlvlCfg.para1)[i] * 0.0006)
                            end
                          else
                            do
                              if logic == eBuildingLogic.ResOutputEfficiency then
                                if (levelCfg.para1)[i] == 0 then
                                  ...
                                  -- DECOMPILER ERROR at PC321: Confused about usage of register: R13 in 'UnsetPending'

                                  ;
                                  ((self.ui).tex_Description).text = describ_text
                                  if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.ResOutputEfficiency then
                                    self.nextDescription = tostring((nextlvlCfg.para2)[i] * 0.1) .. "%"
                                  end
                                else
                                  do
                                    local itemCfg = (ConfigData.item)[(levelCfg.para1)[i]]
                                    ...
                                    do
                                      ...
                                      if (levelCfg.para1)[i] ~= eBuildQueueType.Oasis or not "绿洲" then
                                        local buildingBelongText = logic ~= eBuildingLogic.BuildQueue or "扇区"
                                      end
                                      local describ = ((ConfigData.buildingBuff)[logic]).buff_text
                                      do
                                        local describ_text = (string.format)((LanguageUtil.GetLocaleText)(describ), buildingBelongText, tostring((levelCfg.para2)[i]))
                                        -- DECOMPILER ERROR at PC417: Confused about usage of register: R12 in 'UnsetPending'

                                        ;
                                        ((self.ui).tex_Description).text = describ_text
                                        if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.BuildQueue then
                                          self.nextDescription = tostring((nextlvlCfg.para2)[i])
                                        end
                                        if logic == eBuildingLogic.BuildSpeed then
                                          local speed = (levelCfg.para1)[i] * 0.1
                                          local describ = ((ConfigData.buildingBuff)[logic]).buff_text
                                          local describ_text = (string.format)((LanguageUtil.GetLocaleText)(describ), tostring(speed))
                                          -- DECOMPILER ERROR at PC455: Confused about usage of register: R12 in 'UnsetPending'

                                          ;
                                          ((self.ui).tex_Description).text = describ_text
                                          if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.BuildSpeed then
                                            self.nextDescription = tostring((nextlvlCfg.para1)[i] * 0.1) .. "%"
                                          end
                                        else
                                          do
                                            if logic == eBuildingLogic.GlobalExpRatio then
                                              ...
                                              ;
                                              ((self.ui).tex_Description).text = describ_text
                                              if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.GlobalExpRatio then
                                                self.nextDescription = tostring((nextlvlCfg.para1)[i] * 0.1) .. "%"
                                              end
                                            else
                                              do
                                                if logic == eBuildingLogic.AllHeroBuff then
                                                  ...
                                                  -- DECOMPILER ERROR at PC542: Confused about usage of register: R15 in 'UnsetPending'

                                                  ;
                                                  ((self.ui).tex_Description).text = describ_text
                                                  if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.AllHeroBuff then
                                                    local nextValue = (nextlvlCfg.para2)[i]
                                                    local nextAttrDes, nextValueDes = ConfigData:GetAttribute(attrId, nextValue)
                                                    self.nextDescription = tostring(nextValueDes)
                                                  end
                                                else
                                                  do
                                                    if logic == eBuildingLogic.OverClock then
                                                      ...
                                                      ;
                                                      ((self.ui).tex_Description).text = describ_text
                                                      if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.OverClock then
                                                        self.nextDescription = tostring((nextlvlCfg.para2)[i])
                                                      end
                                                    else
                                                      do
                                                        if logic == eBuildingLogic.OverClockFreeNum then
                                                          ...
                                                          ;
                                                          ((self.ui).tex_Description).text = describ_text
                                                          if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.OverClockFreeNum then
                                                            self.nextDescription = tostring((nextlvlCfg.para1)[i])
                                                          end
                                                        else
                                                          do
                                                            if logic == eBuildingLogic.DynSkillUpgrade then
                                                              ...
                                                              -- DECOMPILER ERROR at PC673: Confused about usage of register: R12 in 'UnsetPending'

                                                              ;
                                                              ((self.ui).tex_Description).text = describ_text
                                                              if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.DynSkillUpgrade then
                                                                self.nextDescription = tostring((nextlvlCfg.para1)[i] * 0.01) .. "%"
                                                              end
                                                            else
                                                              do
                                                                if logic == eBuildingLogic.DynChipCountMax then
                                                                  local chipCount = (levelCfg.para1)[i]
                                                                  local describ = ((ConfigData.buildingBuff)[logic]).buff_text
                                                                  local describ_text = (string.format)((LanguageUtil.GetLocaleText)(describ), tostring(chipCount))
                                                                  -- DECOMPILER ERROR at PC713: Confused about usage of register: R12 in 'UnsetPending'

                                                                  ;
                                                                  ((self.ui).tex_Description).text = describ_text
                                                                  if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.DynChipCountMax then
                                                                    self.nextDescription = tostring((nextlvlCfg.para1)[i])
                                                                  end
                                                                else
                                                                  do
                                                                    if logic == eBuildingLogic.CareerBuff then
                                                                      local logicIndex1 = 1
                                                                      local logicIndex2 = 2
                                                                      ...
                                                                      local content = ""
                                                                      if isRatio then
                                                                        content = (LanguageUtil.GetLocaleText)(careerCfg.name) .. attrName .. "提升" .. tostring(count / 10) .. "%"
                                                                      else
                                                                        content = (LanguageUtil.GetLocaleText)(careerCfg.name) .. attrName .. "提升" .. tostring(count)
                                                                      end
                                                                      ...
                                                                      if hasAtrr2 then
                                                                        ...
                                                                        if isRatio2 then
                                                                          content = content .. ",并额外提升" .. tostring(count2 / 10) .. "%"
                                                                        else
                                                                          content = content .. ",并额外提升" .. tostring(count2)
                                                                        end
                                                                      end
                                                                      -- DECOMPILER ERROR at PC851: Confused about usage of register: R20 in 'UnsetPending'

                                                                      ;
                                                                      ((self.ui).tex_Description).text = content .. "(全局生效)"
                                                                      self.description = content
                                                                      if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.CareerBuff then
                                                                        local nextCount = (nextlvlCfg.para3)[logicIndex1]
                                                                        if isRatio then
                                                                          self.nextDescription = tostring(nextCount / 10) .. "%"
                                                                        else
                                                                          self.nextDescription = tostring(nextCount)
                                                                        end
                                                                      end
                                                                    elseif logic == eBuildingLogic.CampBuff then
                                                                      ...
                                                                      local content = ""
                                                                      if isRatio then
                                                                        content = (LanguageUtil.GetLocaleText)(campCfg.name) .. attrName .. "提升" .. tostring(count / 10) .. "%"
                                                                      else
                                                                        content = (LanguageUtil.GetLocaleText)(campCfg.name) .. attrName .. "提升" .. tostring(count)
                                                                      end
                                                                      local hasAtrr2 = #levelCfg.para1 >= 2
                                                                      if hasAtrr2 then
                                                                        local attrId = (levelCfg.para2)[logicIndex2]
                                                                      ...
                                                                      -- DECOMPILER ERROR at PC1000: Confused about usage of register: R18 in 'UnsetPending'

                                                                      ;
                                                                      ((self.ui).tex_Description).text = content
                                                                      self.description = content
                                                                      if nextlvlCfg ~= nil and (nextlvlCfg.logic)[i] == eBuildingLogic.CampBuff then
                                                                        local nextCount = (nextlvlCfg.para3)[logicIndex1]
                                                                        if isRatio then
                                                                          self.nextDescription = tostring(nextCount / 10) .. "%"
                                                                        else
