...
UINLoginLoading.InitLoginLoading = function(self)
    ...
    MsgCenter:AddListener(eMsgEventId.OnSceneLoadingProgress,
...
UINLoginLoading.RefreshSceneProgress = function(self, value)
    ...
    local p = value * 100;
    ((self.ui).tex_Bar):SetIndex(0, tostring((Mathf.Ceil)(p))) -- DECOMPILER ERROR at PC22: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).img_process).sizeDelta = (Vector2.New)(
                                            (self.sizeDelta).x * value,
                                            (self.sizeDelta).y)
...
UINLoginLoading.UpdateDecorativeInfo = function(self, loadingPercent)
    ...
    if loadingPercent <= 10 then
        ((self.ui).texinfo_Value_basicSim):SetIndex(1) -- DECOMPILER ERROR at PC11: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.ui).tex_Value_basicSim).color = (self.ui).color_process;
        ((self.ui).texinfo_Value_oasisSys):SetIndex(1) -- DECOMPILER ERROR at PC21: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.ui).tex_Value_oasisSys).color = (self.ui).color_process
        self:UpdateLoadingRate(0, 0)
    else
        if loadingPercent <= 55 then
            ((self.ui).texinfo_Value_basicSim):SetIndex(1) -- DECOMPILER ERROR at PC38: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).tex_Value_basicSim).color = (self.ui).color_process;
            ((self.ui).texinfo_Value_oasisSys):SetIndex(1) -- DECOMPILER ERROR at PC48: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).tex_Value_oasisSys).color = (self.ui).color_process
            self:UpdateLoadingRate(1 - (55 - loadingPercent) / 45, 0)
        else

            ((self.ui).texinfo_Value_basicSim):SetIndex(2) -- DECOMPILER ERROR at PC65: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).tex_Value_basicSim).color = (self.ui).color_solid;
            ((self.ui).texinfo_Value_oasisSys):SetIndex(1) -- DECOMPILER ERROR at PC75: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).tex_Value_oasisSys).color = (self.ui).color_process
...
UINLoginLoading.OnDelete = function(self)
    ...
    MsgCenter:RemoveListener(eMsgEventId.OnSceneLoadingProgress,
                             self.onProgressRefresh);
    (base.OnDelete)(self)
end
