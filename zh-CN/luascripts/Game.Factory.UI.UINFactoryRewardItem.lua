...
UINFactoryRewardItem.OnInit = function(self)
  ...
  ;
  (UIUtil.AddButtonListener)((self.ui).btn_reward, self, self.OnRewardItemClicked)
end

UINFactoryRewardItem.InitFactoryRewardItem = function(self, itemCfg, count, clickAction)
...
UINFactoryRewardItem.OnRewardItemClicked = function(self)
  -- function num : 0_2
