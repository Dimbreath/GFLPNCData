...
New_UIQuickPurchaseBox.OnInit = function(self)
    ...
    (((self.ui).btn_Add).onPress):AddListener(
        BindCallback(self, self.OnClickAdd));
...
New_UIQuickPurchaseBox.m_CouldAdd = function(self)
    -- function num : 0_8 , upvalues : _ENV
    if (self.goodData).isLimit and (self.goodData).limitTime -
        (self.goodData).purchases < self.buyNum + 1 then return false end
...
New_UIQuickPurchaseBox.Add2Max = function(self)
