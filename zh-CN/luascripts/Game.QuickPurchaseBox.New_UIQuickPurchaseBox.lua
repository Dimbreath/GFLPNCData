...
New_UIQuickPurchaseBox.m_CouldAdd = function(self)
  ...
  if (self.goodData).isLimit and (self.goodData).limitTime - (self.goodData).purchases < self.buyNum + 1 then
    return false
  end
...
New_UIQuickPurchaseBox.OnClickBuy = function(self)
  ...
  (self.ctrl):ReqBuyGoods((self.goodData).shopId, (self.goodData).shelfId, self.buyNum, function()
    ...
    UIManager:ShowWindowAsync(UIWindowTypeID.CommonReward, function(window)
      ...
      window:InitRewardsItem({(self.goodData).itemId}, {self.buyNum * (self.goodData).itemNum})
      self.buyNum = 0
      self:m_RefreshTotalMoney()
