...
local AvgCfg_cpt02_e_04_01 = {
    [1] = {
        ...
        imgTween = {
            {imgId = 98, duration = 1, alpha = 1}, {imgId = 13, posId = 1},
            {imgId = 13, duration = 0.2, posId = 2}
        },
        content = 10,
        contentType = 3,
    ...
    [3] = {
        imgTween = {
            {imgId = 13, isDark = true}, {imgId = 34, posId = 5},
            {imgId = 34, duration = 0.2, posId = 4}
        },
        content = 30,
        contentType = 3,
    ...
    [9] = {
        imgTween = {
            {imgId = 2, posId = 5}, {imgId = 2, duration = 0.2, posId = 4},
            {imgId = 13, isDark = true}
        },
        content = 90,
        contentType = 3,
    ...
    [10] = {
        imgTween = {{imgId = 13, isDark = false}, {imgId = 2, isDark = true}},
        content = 100,
        contentType = 3,
        speakerHeroId = 1013,
        speakerHeroPosId = 1
    ...
    [11] = {
        imgTween = {{imgId = 2, isDark = false}, {imgId = 13, isDark = true}},
        content = 110,
        contentType = 3,
        speakerHeroId = 1002,
        speakerHeroPosId = 3
    ...
    [31] = {
        imgTween = {{imgId = 3, duration = 0.5, posId = 5}},
        audio = {sfx = {cue = "AVG_Walk", sheet = "AVG_gf", audioId = 0}},
        content = 310,
        contentType = 4,
        speakerName = 11
    },
    [32] = {content = 320, contentType = 4, speakerName = 11},
    [33] = {
        imgTween = {{imgId = 2, duration = 0.5, posId = 4, isDark = false}},
        content = 330,
        contentType = 3,
        speakerHeroId = 1002,
        speakerHeroPosId = 3
    ...
    [38] = {
        imgTween = {{imgId = 13, isDark = false}, {imgId = 1, isDark = true}},
        content = 380,
        contentType = 3,
        speakerHeroId = 1013,
        speakerHeroPosId = 3
