...
ExplorationEventCtrl.OnEventRoomOpen = function(self, roomData)
...
ExplorationEventCtrl.IsEventChoiceAble = function(self, choiceDatalist)
  -- function num : 0_2 , upvalues : _ENV, eChoiceCondition
...
ExplorationEventCtrl.SendChipUpgrade = function(self, chipItem, currencyId, callback)
  ...
  if price <= money then
    ...
    -- function num : 0_14_0 , upvalues : cs_MessageCommon, _ENV, callback
