...
UINAthTable.OnClickAthItem = function(self, athItem)
    -- function num : 0_21
    (self.athRoot):OnClickAthItem(athItem)
end
...
UINAthTable.SetAthItemPosTween = function(self)
    ...
    for uid, Item in pairs(self.athItemDic) do
        local toAnchoredPos = (Item.transform).anchoredPosition -- DECOMPILER ERROR at PC16: Confused about usage of register: R9 in 'UnsetPending'
        ;
        (Item.transform).anchoredPosition =
            (Item.transform).anchoredPosition + transPos;
        (Item.transform):DOAnchorPos(toAnchoredPos, duration)
