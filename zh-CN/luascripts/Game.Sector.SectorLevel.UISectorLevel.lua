...
UISectorLevel.OnLevelItemClicked = function(self, levelItem)
  ...
  do
    ...
    if self.selectLevel ~= nil then
      (self.selectLevel):SeletedLevelItem(false, true)
    end
    if self.selectLAvgMain ~= nil then
      (self.selectLAvgMain):SelectedLAvgMain(false)
    end
    self.selectLevel = levelItem
    ;
    (self.selectLevel):SeletedLevelItem(true, true)
    self:ShowLevelDetailWindow(function(window)
    -- function num : 0_4_0 , upvalues : self, stageData
...
UISectorLevel.ShowLevelDetailWindow = function(self, callback)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.SectorLevelDetail, function(window)
    -- function num : 0_5_0 , upvalues : self, callback
    ...
    window:SetLevelDetaiHideEndEvent(function()
      -- function num : 0_5_0_1 , upvalues : self
...
UISectorLevel.OnLevelAvgMainItemClicked = function(self, lAvgMainItem)
  ...
  self.selectLAvgMain = lAvgMainItem
  ;
  (self.selectLAvgMain):SelectedLAvgMain(true)
  self:ShowLevelDetailWindow(function(window)
    -- function num : 0_6_0 , upvalues : self, avgCfg
...
UISectorLevel.OnLevelAvgSubClicked = function(self, lAvgSubItem)
  ...
  self:ShowLevelDetailWindow(function(window)
    -- function num : 0_7_0 , upvalues : self, avgCfg, lAvgSubItem
    window:InitSectorLevelAvgDetail(self.id, avgCfg, function()
      -- function num : 0_7_0_0 , upvalues : lAvgSubItem
