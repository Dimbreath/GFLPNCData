...
UILevelItemDetail.InitItemDetail = function(self, itemCfg)
    ...
    ((self.ui).name).text = (LanguageUtil.GetLocaleText)(itemCfg.name) -- DECOMPILER ERROR at PC13: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.ui).description).text =
        (LanguageUtil.GetLocaleText)(itemCfg.describe)
end
