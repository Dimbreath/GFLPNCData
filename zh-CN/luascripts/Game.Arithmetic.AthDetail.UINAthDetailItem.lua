...
UINAthDetailItem.InitAthDetailItem = function(self, detailRoot, athData,
    ...
    end -- DECOMPILER ERROR at PC91: Confused about usage of register: R6 in 'UnsetPending'
    ...
    self:__RefreshLock() -- DECOMPILER ERROR at PC117: Confused about usage of register: R8 in 'UnsetPending'
    ;
    ...
    if #athData.attrList > 0 then
        ...
        local name, valueStr, icon = ConfigData:GetAttribute(athAttr.id,
                                                             athAttr.value) -- DECOMPILER ERROR at PC144: Confused about usage of register: R12 in 'UnsetPending'
        ;
        ((self.ui).img_Icon).sprite = CRH:GetSprite(icon) -- DECOMPILER ERROR at PC147: Confused about usage of register: R12 in 'UnsetPending'
        ;
        ((self.ui).tex_MianAttriNum).text = valueStr -- DECOMPILER ERROR at PC150: Confused about usage of register: R12 in 'UnsetPending'
        ;
            ...
            if suitAthList ~= nil then
                ...
                for k, athId in ipairs(suitAthList) do
                    ...
                    if heroData ~= nil then
                        installed =
                            (PlayerDataCenter.allAthData):HeroContainAthById(
                ...
                for k, v in ipairs(suitCfg) do
                    ...
                    if k == 1 then
                        ((self.ui).tex_SuitName).text =
                            (LanguageUtil.GetLocaleText)(v.name)
                    end
