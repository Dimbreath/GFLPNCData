...
[1] = {
images = {
{imgId = 1, imgPath = "cpt00/cpt00_e_bg001", imgType = 2, fullScreen = true}
}
, content = 10, contentType = 4, speakerName = 11, 
audio = {
...
[4] = {
images = {
{imgId = 2, imgPath = "cpt00/cpt00_e_bg005", imgType = 2, fullScreen = true, alpha = 0}
, 
...
[6] = {
images = {
{imgId = 4, imgPath = "persicaria_avg", imgType = 3, 
pos = {480, -310, 0}
, 
scale = {-1.7, 1.7, 1.7}
, alpha = 0.1, order = 2}
...
, content = 60, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 3}
, 
...
, content = 90, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 3}
, 
[10] = {
imgTween = {
{imgId = 3, isDark = false}
...
, content = 120, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1}
, 
[13] = {
imgTween = {
{imgId = 3, isDark = true}
...
, content = 130, contentType = 4, speakerName = 131}
, 
[14] = {
imgTween = {
{imgId = 3, isDark = false}
...
[16] = {
images = {
{imgId = 5, imgPath = "cpt00/cpt00_e_bg004", imgType = 4, alpha = 0.5, fullScreen = true}
}
, 
imgTween = {
...
, content = 170, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 3}
, 
