...
, content = 10, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1, 
audio = {
...
[2] = {
images = {
{imgId = 111, imgPath = "faith_avg", imgType = 3, 
pos = {0, 0, 0}
, 
rot = {0, 0, 0}
, 
...
, content = 20, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
, 
...
, content = 40, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1}
, 
...
, content = 70, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
, 
[8] = {
imgTween = {
{imgId = 111, duration = 1.5, shake = true}
}
...
, 
[18] = {content = 180, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 3}
, 
[19] = {
imgTween = {
{imgId = 1, alpha = 1}
...
, content = 190, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1}
, 
[20] = {
imgTween = {
{imgId = 1, duration = 0.2, 
...
, content = 210, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1, contentShake = true}
, 
[22] = {content = 220, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1, contentShake = true}
, 
[23] = {
imgTween = {
...
, content = 250, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
, 
[26] = {
imgTween = {
{imgId = 111, duration = 1.5, shake = true}
...
, content = 270, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1}
, 
[28] = {
imgTween = {
{imgId = 3, duration = 0.5, 
...
, content = 280, contentType = 2, contentShake = true}
, 
...
[42] = {
images = {
{imgId = 99, imgPath = "cpt01/cpt01_e_cg001", imgType = 2, 
scale = {2, 2, 2}
, 
pos = {500, 100, 0}
, fullScreen = true, delete = false}
}
, 
imgTween = {
{imgId = 99, duration = 3, 
...
, alpha = 1, isDark = false}
, 
{imgId = 99, duration = 3, delay = 2.8, 
pos = {500, -200, 0}
, alpha = 1, isDark = false}
, 
{imgId = 99, duration = 5, delay = 5.5, 
pos = {0, 0, 0}
, alpha = 1, 
scale = {1.1, 1.1, 1.1}
, isDark = false}
}
, content = 420, contentType = 4, speakerName = 362}
, 
[43] = {content = 430, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
, 
[44] = {content = 440, contentType = 4, speakerName = 363, contentShake = true}
, 
...
, content = 490, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1}
, 
[50] = {
imgTween = {
{imgId = 111, alpha = 1}
...
, content = 540, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 3}
, 
[55] = {
imgTween = {
{imgId = 3, alpha = 1, isDark = false}
, 
{imgId = 120, isDark = true}
}
