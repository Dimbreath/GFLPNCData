...
UINDungeonChipList.__InitItem = function(self, go)
  -- function num : 0_8 , upvalues : UINDungeonChipItem
...
UINDungeonChipList.SelectItem = function(self, index)
  ...
  if self.selectHeroWithChipIdCallback ~= nil then
    ...
    local chipColor = ItemQualityColor[((self.chipDataList)[index + 1]).quality]
    ;
...
UINDungeonChipList.__SortChipsWithHeroChipList = function(self, chipList, heroChipIDDic)
  ...
  (table.sort)(chipList, function(a, b)
    -- function num : 0_20_0 , upvalues : heroChipIDDic
...
UINDungeonChipList.ScrollChipItemInScreen = function(self, chipData, action)
  ...
  do
    ...
    -- function num : 0_21_0 , upvalues : self, chipItemIndex, action
...
UINDungeonChipList.GetAndPlayUseChipSkillEffect = function(self, chipItem)
  ...
  effectItem:PlayEffect(0.8, chipItem)
end
...
UINDungeonChipList.HideUseChipSkillEffect = function(self, effectItem)
  ...
  if effectItem ~= nil and effectItem.transform ~= nil then
    (effectItem.transform):SetParent(((self.ui).obj_effList).transform)
  end
end
...
local UINDungeonChipList = class("UINDungeonChipList", UIBaseNode)
local base = UIBaseNode
local UINDungeonChipItem = require(
                               "Game.CommonUI.DungeonState.UINDungeonChipItem")
local UINDungeonChipUseSkillEffect = require(
                                         "Game.CommonUI.DungeonState.UINDungeonChipUseSkillEffect")
local CS_DOTween = ((CS.DG).Tweening).DOTween
UINDungeonChipList.OnInit = function(self)
    -- function num : 0_0 , upvalues : _ENV, UINDungeonChipItem, UINDungeonChipUseSkillEffect
    (UIUtil.LuaUIBindingTable)(self.transform, self.ui)
    ...
    self.chipDataList = {}
    self.selectHeroWithChipIdCallback = nil
    self.chipUseSkillEffectPool = (UIItemPool.New)(UINDungeonChipUseSkillEffect,
                                                   (self.ui).obj_eff_OutLine) -- DECOMPILER ERROR at PC46: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).chipList).onInstantiateItem = BindCallback(self, self.__InitItem) -- DECOMPILER ERROR at PC53: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).chipList).onChangeItem = BindCallback(self, self.__OnItemChange);
    (((self.ui).chipList).onValueChanged):AddListener(
        BindCallback(self, self.__TestOnValueChange))
    self.__onChipListChange = BindCallback(self, self.OnChipListUpdata)
    ...
    self.selectHeroCallback = BindCallback(self, self.OnSelectHero)
    self.__ChipItemClickFunc = BindCallback(self, self.ChipItemClickFunc)
    self.__HideUseChipSkillEffect = BindCallback(self,
                                                 self.HideUseChipSkillEffect);
    (((self.ui).img_Adapter).gameObject):SetActive(false)
    self.__startCacheChipUpdate = false
    self.__cacheChipList = nil
    self:InitChipLimitSequence()
...
UINDungeonChipList.InitChipList = function(self, chipList,
                                           selectHeroWithChipIdCallback,
                                           chipLimitInfo)
    -- function num : 0_1
    self.selectHeroWithChipIdCallback = selectHeroWithChipIdCallback
    self.chipLimitInfo = chipLimitInfo
...
UINDungeonChipList.__ChipListUpdateInternal =
    function(self, chipList)
        -- function num : 0_3 , upvalues : _ENV
        if #chipList < #self.chipDataList then self.chipDataList = {} end
        for index, value in ipairs(chipList) do
            -- DECOMPILER ERROR at PC12: Confused about usage of register: R7 in 'UnsetPending'
...
UINDungeonChipList.__ReFillList = function(self)
    ...
    local listWidth = (((self.ui).rect_chipList).rect).width
    self.maxNumInRect = (math.ceil)(listWidth / self.chipUnitWidth)
    self.chipNum = #self.chipDataList -- DECOMPILER ERROR at PC16: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.ui).chipList).totalCount = self.chipNum
    if self.maxNumInRect < self.chipNum then
        local realChipNum = 0
...
UINDungeonChipList.InitChipLimitSequence =
    function(self)
        -- function num : 0_6 , upvalues : _ENV, CS_DOTween
        local obj_Limit_SizeDelta = (((self.ui).obj_Limit).transform).sizeDelta
        local obj_chipCountLimit_SizeDelta =
            (((self.ui).obj_chipCountLimit).transform).sizeDelta
        local small_Limit_SizeDelta = (Vector2.New)(0, obj_Limit_SizeDelta.y)
        local small_chipCountLimit_SizeDelta =
            (Vector2.New)(
                obj_chipCountLimit_SizeDelta.x - obj_Limit_SizeDelta.x,
                obj_chipCountLimit_SizeDelta.y) -- DECOMPILER ERROR at PC23: Confused about usage of register: R5 in 'UnsetPending'
        ;
        (((self.ui).obj_Limit).transform).sizeDelta = small_Limit_SizeDelta -- DECOMPILER ERROR at PC27: Confused about usage of register: R5 in 'UnsetPending'
        ;
        (((self.ui).obj_chipCountLimit).transform).sizeDelta =
            small_chipCountLimit_SizeDelta
        self.chipLimitSequence = ((((((((CS_DOTween.Sequence)()):Append(
                                     ((((self.ui).obj_Limit).transform):DOSizeDelta(
                                         obj_Limit_SizeDelta, 0.5)):SetDelay(0))):Join(
                                     ((((self.ui).obj_chipCountLimit).transform):DOSizeDelta(
                                         obj_chipCountLimit_SizeDelta, 0.5)):SetDelay(
                                         0))):Append(
                                     ((((self.ui).obj_Limit).transform):DOSizeDelta(
                                         small_Limit_SizeDelta, 0.5)):SetDelay(
                                         2.5))):Join(
                                     (((self.ui).obj_chipCountLimit).transform):DOSizeDelta(
                                         small_chipCountLimit_SizeDelta, 0.5))):AppendCallback(
                                     function()
                -- function num : 0_6_0 , upvalues : self
                (self.chipLimitSequence):Rewind()
...
UINDungeonChipList.RefreshLimit = function(self)
    ...
    if num <= limit then
        ...
        if (self.chipLimitInfo).firstLimit then
            if self.chipLimitSequence ~= nil then
                (self.chipLimitSequence):PlayForward()
            end -- DECOMPILER ERROR at PC41: Confused about usage of register: R3 in 'UnsetPending'
...
UINDungeonChipList.ChipItemClickFunc = function(self, index)
    ...
    self:SelectItem(index)
    local win = UIManager:ShowWindow(UIWindowTypeID.DungeonInfoDetail)
    win:ShowChipDetail(self.chipDataList, index + 1, self.__DeselectAllItem,
                       self.__SelectItem)
    win:SetSwitchBtnActive(true)
end
...
UINDungeonChipList.__GetItemByIndex = function(self, index)
    -- function num : 0_11
    local go = ((self.ui).chipList):GetCellByIndex(index)
    if go ~= nil then return (self.itemDic)[go] end
    return nil
end
...
UINDungeonChipList.DeselectAllItem = function(self)
    ...
    if self.isHideHero then (self.heroList):Hide() end
end
...
UINDungeonChipList.SelectItem = function(self, index)
    ...
    self.selectedIndex = index
    self.selectItem = self:__GetItemByIndex(index)
    if self.selectItem ~= nil then (self.selectItem):SetSelect(true) end
    if self.selectHeroWithChipIdCallback ~= nil then
        local chipId = ((self.chipDataList)[index + 1]).dataId
        local chipColor =
            ItemQualityColor[((self.chipDataList)[index + 1]).quality];
        (self.selectHeroWithChipIdCallback)(chipId, chipColor)
    end
    do if self.isHideHero then (self.heroList):Show() end end
end
...
UINDungeonChipList.HighlightChipItem = function(self, chipData)
    ...
    local hilightChipData, needScrollIndex = nil, nil
    for k, v in ipairs(self.chipDataList) do
        if hilightChipData == nil and v.dataId == chipData.dataId and
            not v:IsCopyItem() then
            hilightChipData = v
            self.__highlightChipIndex = k
            needScrollIndex = k - 1
            local item = self:__GetItemByIndex(k - 1)
            if item ~= nil then item:SetDungeonChipItemShowAlpha(1) end
        else
            do
                do
                    local item = self:__GetItemByIndex(k - 1)
...
UINDungeonChipList.CancelHighlightChipItem =
    function(self)
        -- function num : 0_15 , upvalues : _ENV
        if not self.__enableHighlightChipItem then return end
        self.__enableHighlightChipItem = false
        self.__highlightChipIndex = nil
        for k, v in ipairs(self.chipDataList) do
            local item = self:__GetItemByIndex(k - 1)
...
UINDungeonChipList.__TestOnValueChange =
    function(self, pos)
        -- function num : 0_16 , upvalues : _ENV
        local listFrontPos, listRarePos = nil, nil
        listFrontPos = ((self.ui).frontPoint).position
        ...
        if (((self.ui).img_Adapter).gameObject).activeInHierarchy then
            ...
            for i = 0, self.chipNum - 1 do
                local go = ((self.ui).chipList):GetCellByIndex(i)
                if go ~= nil then
                    fistHeroItemFrontPos =
                        ((((self.itemDic)[go]).ui).frontPoint).position
                    break
                end
            end
            do
                for i = self.heroChipNum - 1, 0, -1 do
                    ...
                    if go ~= nil then
                        lastHeroItemRarePos =
                            ((((self.itemDic)[go]).ui).endPoint).position
                        break
                    end
                end
                do
                    local oldpos = ((self.ui).img_Adapter).position -- DECOMPILER ERROR at PC67: Confused about usage of register: R7 in 'UnsetPending'
                    ;
                    ((self.ui).img_Adapter).position =
                        (Vector3.New)((math.max)(listFrontPos.x,
                                                 fistHeroItemFrontPos.x),
                                      oldpos.y, oldpos.z)
                    local uiCoordinateStart = nil
                    if fistHeroItemFrontPos.x < listFrontPos.x then
                        uiCoordinateStart =
                            (UIManager:World2UIPosition(listFrontPos, nil, nil,
                                                        UIManager.UICamera)).x
                    else
                        uiCoordinateStart =
                            (UIManager:World2UIPosition(fistHeroItemFrontPos,
                                                        nil, nil,
                                                        UIManager.UICamera)).x
                    end
                    local uiCoordinateEnd = nil
                    if lastHeroItemRarePos == nil then
                        ...
                        if listRarePos.x < lastHeroItemRarePos.x then
                            uiCoordinateEnd =
                                (UIManager:World2UIPosition(listRarePos, nil,
                                                            nil,
                                                            UIManager.UICamera)).x
                        else
                            uiCoordinateEnd =
                                (UIManager:World2UIPosition(lastHeroItemRarePos,
                                                            nil, nil,
                                                            UIManager.UICamera)).x
                        end
                    end
                    local width = uiCoordinateEnd - uiCoordinateStart
                    local oldSize = ((self.ui).img_Adapter).sizeDelta -- DECOMPILER ERROR at PC136: Confused about usage of register: R11 in 'UnsetPending'
                    ;
                    ((self.ui).img_Adapter).sizeDelta =
                        Vector2(width, oldSize.y)
                end
            end
        end
    end
...
UINDungeonChipList.OnSelectHero = function(self, heroItem)
    ...
    if self.maxNumInRect < self.heroChipNum then
        ...
        num = self.heroChipNum
    end -- DECOMPILER ERROR at PC77: Confused about usage of register: R6 in 'UnsetPending'
    
    ((self.ui).img_Adapter).sizeDelta = Vector2(self.chipUnitWidth * num,
                                                oldSize.y);
    ((self.ui).obj_adapterBelow):SetActive(true)
end

UINDungeonChipList.__SortChipsWithHeroChipList =
    function(self, chipList, heroChipIDDic)
        -- function num : 0_20 , upvalues : _ENV
        (table.sort)(chipList, function(a, b)
            -- function num : 0_20_0 , upvalues : heroChipIDDic
            local aInDic = heroChipIDDic[a.dataId] ~= nil
...
UINDungeonChipList.ScrollChipItemInScreen =
    function(self, chipData, action)
        -- function num : 0_21 , upvalues : _ENV
        local needScrollIndex, chipItemIndex = nil, nil
        for k, v in ipairs(self.chipDataList) do
            if v.dataId == chipData.dataId and not v:IsCopyItem() then
        ...
        do
            if needScrollIndex ~= nil then
                ((self.ui).chipList):SrollToCell(needScrollIndex, 20000,
                                                 function()
                    -- function num : 0_21_0 , upvalues : self, chipItemIndex, action
                    local item = self:__GetItemByIndex(chipItemIndex - 1)
                    if action ~= nil then action(item) end
                end)
            else
...
UINDungeonChipList.SetListBlocksRaycasts =
...
UINDungeonChipList.SetChipGetEffectEnable =
...
UINDungeonChipList.GetAndPlayUseChipSkillEffect =
...
UINDungeonChipList.HideUseChipSkillEffect =
    function(self, effectItem)
        -- function num : 0_27
        (self.chipUseSkillEffectPool):HideOne(effectItem)
        if effectItem ~= nil and effectItem.transform ~= nil then
            (effectItem.transform):SetParent(((self.ui).obj_effList).transform)
...
UINDungeonChipList.CheckChipListBgShow =
    function(self, check)
        -- function num : 0_28
        if check then
            if #self.chipDataList > 0 then
