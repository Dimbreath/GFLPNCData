...
local UIAchivLevelRewardItem = require(
                                   "Game.Achievement.LevelRewardPage.UIAchivLevelRewardItem")
local eLevelState = {UnCompleted = 1, Completed = 2, Picked = 3}
UIAchivLevelRewardPage.OnInit = function(self)
    -- function num : 0_0 , upvalues : _ENV
    (UIUtil.LuaUIBindingTable)(self.transform, self.ui);
    (UIUtil.AddButtonListener)((self.ui).background, self, self.OnClickClose) -- DECOMPILER ERROR at PC18: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).scrollRect).onInstantiateItem =
        BindCallback(self, self.__OnNewItem) -- DECOMPILER ERROR at PC25: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ...
    self.__onUpdatePlayerLevel =
        BindCallback(self, self.RefreshAchivLevelReward)
    self.__onUpdatePickedRewardLevel = BindCallback(self,
                                                    self.RefreshAchivLevelReward)
...
UIAchivLevelRewardPage.RefreshAchivLevelReward =
    function(self, isInit)
        ...
        if maxLevel <= curLevel then
            ((self.ui).tex_Process):SetIndex(1) -- DECOMPILER ERROR at PC23: Confused about usage of register: R4 in 'UnsetPending'
            ;
            ...
            ((self.ui).tex_Process):SetIndex(0, tostring(exp),
                                             tostring(expCeiling)) -- DECOMPILER ERROR at PC46: Confused about usage of register: R6 in 'UnsetPending'
            ;
        ...
        do
            ...
            if levelCfg == nil then
                error("Can\'t find achievement_level, level = " ..
                          tostring(curLevel))
            else
                local path = PathConsts:GetAchivLevelIconPath(levelCfg.icon)
                local icon = (self.resLoader):LoadABAsset(path) -- DECOMPILER ERROR at PC70: Confused about usage of register: R7 in 'UnsetPending'
                ;
            ...
            do
                ...
                self:__SortLevelItem() -- DECOMPILER ERROR at PC111: Confused about usage of register: R5 in 'UnsetPending'
                ;
...
UIAchivLevelRewardPage.__SortLevelItem =
    function(self)
...
UIAchivLevelRewardPage.GetLevelRewardComplete =
...
UIAchivLevelRewardPage.__OnChangeItem = function(self, go, index)
    ...
    levelItem:RefreshLevelRewardItem(levelData.level, picked,
                                     BindCallback(self, self.__GetReward))
