...
local AvgCfg_cpt00_e_01_03 = {
    ...
    [28] = {
        imgTween = {{imgId = 4, duration = 1, alpha = 0}},
        content = 280,
        contentType = 2,
        effect = {
            stopList = {"effect1"},
    ...
    [38] = {
        imgTween = {{imgId = 1, isDark = true}, {imgId = 2, isDark = true}},
        content = 380,
        contentType = 2
    },
    [39] = {
    ...
    [48] = {
        ...
        speakerHeroId = 1001,
        speakerHeroPosId = 3,
        branch = {{content = 481, jumpAct = 49}, {content = 482, jumpAct = 50}}
    },
    [49] = {
        content = 490,
        contentType = 3,
    ...
    [52] = {
        imgTween = {
            {imgId = 1, alpha = 0}, {imgId = 3, alpha = 1, isDark = false},
            {imgId = 2, isDark = true}
        },
        content = 520,
        contentType = 3,
