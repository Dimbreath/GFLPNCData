...
[11] = {
audio = {
bgm = {cue = "Mus_Story_Relax", sheet = "Music", fadeIn = 4, fadeOut = 3}
}
...
local AvgCfg_cpt00_e_01_03 = {
    ...
    [2] = {
        audio = {sfx = {cue = "AVG_tinnitus", sheet = "AVG_gf", audioId = 1}},
        content = 20,
        contentType = 4,
        speakerName = 11
    },
    ...
    [28] = {
        ppv = {cg = {saturation = 0}},
        imgTween = {{imgId = 1, delay = 1, duration = 1, alpha = 0.99}},
        content = 280,
        contentType = 3,
        speakerHeroId = 1001,
        speakerHeroPosId = 1
    ...
    [33] = {
        imgTween = {{imgId = 5, isDark = true}, {imgId = 1, isDark = false}},
        content = 330,
        contentType = 3,
        speakerHeroId = 1001,
        speakerHeroPosId = 1
    ...
    [37] = {
        imgTween = {
            {imgId = 3, isDark = true}, {imgId = 1, posId = 1},
            {imgId = 1, duration = 0.2, posId = 2, isDark = false}
        },
        content = 370,
        contentType = 3,
