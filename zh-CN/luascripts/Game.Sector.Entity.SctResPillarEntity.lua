...
SctResPillarEntity.InitSctResPillar = function(self, gameObject, position, mat, uiResPillar)
...
SctResPillarEntity.UpdateResPillarProgress = function(self, progress)
  -- function num : 0_1
