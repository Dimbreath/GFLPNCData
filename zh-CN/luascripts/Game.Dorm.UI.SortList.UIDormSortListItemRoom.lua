...
UIDormSortListItemRoom.InitSortListItemRoom =
    function(self, data, isShop, clickIconEvent)
        ...
        if isShop then
            ((self.ui).tex_Name).text = (LanguageUtil.GetLocaleText)(
                                            (data.itemCfg).name);
            ((self.ui).tex_Num):SetIndex(0, tostring(data.itemNum)) -- DECOMPILER ERROR at PC31: Confused about usage of register: R4 in 'UnsetPending'
            ;
            ((self.ui).img_Quality).color =
                ItemQualityColor[(data.itemCfg).quality] -- DECOMPILER ERROR at PC39: Confused about usage of register: R4 in 'UnsetPending'
            ;
            ...
            end -- DECOMPILER ERROR at PC64: Confused about usage of register: R5 in 'UnsetPending'
            
            ((self.ui).tex_currPrice).text = tostring(data.discountPrice) -- DECOMPILER ERROR at PC71: Confused about usage of register: R5 in 'UnsetPending'
            ;
