...
UINShopNormalGoodsList.__OnNewItem = function(self, go)
    ...
    goodItem:Init(go) -- DECOMPILER ERROR at PC6: Confused about usage of register: R3 in 'UnsetPending'
    ;
