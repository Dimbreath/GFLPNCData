...
{imgId = 102, posId = 4}
, 
{imgId = 102, posId = 3, isDark = false, duration = 1}
, 
...
[12] = {
imgTween = {
{imgId = 102, posId = 3, isDark = false, duration = 0.5}
}
...
[59] = {
imgTween = {
{imgId = 102, duration = 0.5, posId = 3}
, 
{imgId = 27, posId = 1}
, 
...
local AvgCfg_cpt03_e_02_01 = {
    [1] = {
        ...
        imgTween = {{imgId = 98, duration = 1, alpha = 1}},
        content = 10,
        contentType = 4,
        speakerName = 12,
        audio = {
    ...
    [2] = {
        content = 20,
        contentType = 2,
        audio = {sfx = {cue = "AVG_Crowd_Run", sheet = "AVG_gf", audioId = 2}}
    },
    [3] = {content = 30, contentType = 4, speakerName = 12},
    [4] = {content = 40, contentType = 4, speakerName = 12},
    [5] = {
    ...
    [12] = {
        imgTween = {{imgId = 102, posId = 3, isDark = false, duration = 0.5}},
        content = 120,
        contentType = 3,
        speakerHeroId = 24,
        speakerHeroPosId = 2
    ...
    [14] = {
        imgTween = {{imgId = 102, isDark = true, duration = 0.5}},
        content = 140,
        contentType = 4,
        speakerName = 11
    },
    [15] = {
        imgTween = {{imgId = 102, isDark = false}},
        content = 150,
        contentType = 3,
        speakerHeroId = 24,
        speakerHeroPosId = 2
    ...
    [18] = {
        ...
        speakerHeroId = 24,
        speakerHeroPosId = 3,
        audio = {sfx = {cue = "AVG_BaseDoor_Close", sheet = "AVG_gf"}}
    },
    [19] = {
        content = 190,
        contentType = 3,
    ...
    [26] = {
        imgTween = {{imgId = 101, duration = 0.2, shake = true}},
        content = 260,
        contentType = 3,
        speakerHeroId = 23,
        speakerHeroPosId = 1
    ...
    [28] = {
        imgTween = {{imgId = 101, isDark = false}},
        content = 280,
        contentType = 3,
        speakerHeroId = 23,
        speakerHeroPosId = 1
    ...
    [42] = {
        imgTween = {{imgId = 102, isDark = true}},
        content = 420,
        contentType = 4,
        speakerName = 11
    },
    ...
    [49] = {
        imgTween = {{imgId = 101, isDark = false}, {imgId = 5, isDark = true}},
        content = 490,
        contentType = 3,
        speakerHeroId = 23,
        speakerHeroPosId = 3
    ...
    [59] = {
        imgTween = {
            {imgId = 102, duration = 0.5, posId = 3}, {imgId = 27, posId = 1},
            {imgId = 27, posId = 2, isDark = false, delay = 0.5, duration = 0.2},
            {imgId = 5, posId = 1, duration = 0.2},
            {imgId = 102, duration = 0.5, delay = 1, posId = 4},
            {imgId = 102, duration = 0.1, isDark = true, delay = 1.5}
    ...
    [60] = {
        imgTween = {{imgId = 102, isDark = false}, {imgId = 27, isDark = true}},
        content = 600,
        contentType = 3,
        speakerHeroId = 24,
        speakerHeroPosId = 3
    ...
    [61] = {
        imgTween = {{imgId = 27, isDark = false}, {imgId = 102, isDark = true}},
        content = 610,
        contentType = 3,
        speakerHeroId = 1,
        speakerHeroPosId = 1
    ...
    [63] = {
        imgTween = {{imgId = 27, isDark = false}, {imgId = 101, isDark = true}},
        content = 630,
        contentType = 3,
        speakerHeroId = 1027,
        speakerHeroPosId = 1
    ...
    [71] = {
        imgTween = {{imgId = 1, isDark = false}, {imgId = 27, isDark = true}},
        content = 710,
        contentType = 3,
        speakerHeroId = 1001,
        speakerHeroPosId = 3
    ...
    [72] = {
        imgTween = {
            {imgId = 97, duration = 2, shake = true},
            {imgId = 1, isDark = true}, {imgId = 1, duration = 2, shake = true},
            {imgId = 27, duration = 2, shake = true},
            {imgId = 97, duration = 0.5, alpha = 0.5, delay = 2}
        },
        content = 720,
