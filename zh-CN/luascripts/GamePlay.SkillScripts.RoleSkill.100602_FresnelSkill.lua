...
bs_1036.PlaySkill = function(self, data)
  ...
  local attackTrigger = BindCallback(self, self.OnAttackTrigger, realtargetrole, data, 1, 1002)
...
bs_1036.OnAttackTrigger = function(self, target, data, atkSpeedRatio, atkActionId)
  ...
  if (self.arglist)[2] >= 1 then
    ...
    local skillEmission = LuaSkillCtrl:CallCircledEmissionStraightly(self, self.caster, target, 40, 15, eColliderInfluenceType.Enemy, collisionTrigger, nil, nil, cusEffect, true, false, EmissionArrive)
    local cusEffect1 = LuaSkillCtrl:CallEffectWithEmission(skillEmission, 10034, self, nil, nil, nil, true)
    local cusEffect2 = LuaSkillCtrl:CallEffectWithEmission(skillEmission, 10037, self, nil, nil, nil, true)
  else
    do
      local collisionTrigger = BindCallback(self, self.OnCollision)
      local skillEmission = LuaSkillCtrl:CallCircledEmissionStraightly(self, self.caster, target, 40, 15, eColliderInfluenceType.Enemy, collisionTrigger, nil, nil, cusEffect, true, true, self.Over)
      local cusEffect1 = LuaSkillCtrl:CallEffectWithEmission(skillEmission, 10034, self, nil, nil, nil, true)
      local cusEffect2 = LuaSkillCtrl:CallEffectWithEmission(skillEmission, 10037, self, nil, nil, nil, true)
    end
  end
...
bs_1036.OnEmissionArrive = function(self, skillEmission)
  ...
  LuaSkillCtrl:CallRestartEmit(self, skillEmission, 15, self.caster, true, true, self.Over2)
end
