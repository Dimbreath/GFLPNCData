...
UINFactoryOrderListNode.OnTogValueChange = function(self, type, bool)
  -- function num : 0_8 , upvalues : FactoryEnum
  if bool then
...
local UINFactoryOrderListNode = class("UINFactoryOrderListNode", UIBaseNode)
local base = UIBaseNode
local UINFactoryOrderListItem = require(
                                    "Game.Factory.UI.UINFactoryOrderListItem")
local FactoryEnum = require("Game.Factory.FactoryEnum")
UINFactoryOrderListNode.OnInit = function(self)
    -- function num : 0_0 , upvalues : _ENV, FactoryEnum
    ...
    self.isSelectDefault = false;
    (UIUtil.LuaUIBindingTable)(self.transform, self.ui);
    (UIUtil.AddValueChangedListener)((self.ui).tog_Dig, self,
                                     self.OnTogValueChange,
                                     (FactoryEnum.eOrderType).dig);
    (UIUtil.AddValueChangedListener)((self.ui).tog_Production, self,
                                     self.OnTogValueChange,
                                     (FactoryEnum.eOrderType).produce) -- DECOMPILER ERROR at PC45: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).loop_factoryItemList).onInstantiateItem =
        BindCallback(self, self.m_OnNewItem) -- DECOMPILER ERROR at PC52: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).loop_factoryItemList).onChangeItem =
        BindCallback(self, self.m_OnChangeItem) -- DECOMPILER ERROR at PC59: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).loop_factoryItemList).onReturnItem =
        BindCallback(self, self.m_OnReturnItem)
    self.__OnSelectItem = BindCallback(self, self.OnSelectOrderItem)
end
...
UINFactoryOrderListNode.InitList = function(self, roomIndex, callback,
    ...
    if defaultListType == (FactoryEnum.eOrderType).dig then
        ((self.ui).tog_Dig).isOn = true -- DECOMPILER ERROR at PC11: Confused about usage of register: R4 in 'UnsetPending'
        ;
        ((self.ui).tog_Production).isOn = false
    else
        -- DECOMPILER ERROR at PC19: Confused about usage of register: R4 in 'UnsetPending'
        ...
        if defaultListType == (FactoryEnum.eOrderType).produce then
            ((self.ui).tog_Dig).isOn = false -- DECOMPILER ERROR at PC22: Confused about usage of register: R4 in 'UnsetPending'
            ;
            ((self.ui).tog_Production).isOn = true
        else
            -- DECOMPILER ERROR at PC26: Confused about usage of register: R4 in 'UnsetPending'
            ...
            ((self.ui).tog_Dig).isOn = true -- DECOMPILER ERROR at PC29: Confused about usage of register: R4 in 'UnsetPending'
            ;
            ((self.ui).tog_Production).isOn = false
        end
    end
...
UINFactoryOrderListNode.RefreshOrderList =
    function(self)
        -- function num : 0_2
        self.orderDataList = (self.factoryController):GetOrders(
                                 self.togSelectType)
        if #self.orderDataList >= 1 then
            self.selectedData = (self.orderDataList)[1]
        end -- DECOMPILER ERROR at PC16: Confused about usage of register: R1 in 'UnsetPending'
...
UINFactoryOrderListNode.m_OnNewItem = function(self, go)
    ...
    local orderItem = (UINFactoryOrderListItem.New)()
    orderItem:Init(go)
    orderItem:SetValueChangeCallback(self.__OnSelectItem) -- DECOMPILER ERROR at PC9: Confused about usage of register: R3 in 'UnsetPending'
    ;
    (self.orderItemDic)[go] = orderItem
end

UINFactoryOrderListNode.m_OnChangeItem =
...
UINFactoryOrderListNode.m_OnReturnItem =
    function(self, go)
        -- function num : 0_5 , upvalues : _ENV
        local levelItem = (self.orderItemDic)[go]
        if levelItem == nil then
...
UINFactoryOrderListNode.moveSelect2Item =
    function(self, orderItem)
        -- function num : 0_6
        ((self.ui).obj_Select):SetActive(true);
        (((self.ui).obj_Select).transform):SetParent(orderItem.transform) -- DECOMPILER ERROR at PC16: Confused about usage of register: R2 in 'UnsetPending'
        ;
        (((self.ui).obj_Select).transform).position =
            (orderItem.transform).position
    end

UINFactoryOrderListNode.OnSelectOrderItem =
    function(self, orderItem)
        -- function num : 0_7
        self.selectedData = orderItem.orderData
        self:moveSelect2Item(orderItem)
...
UINFactoryOrderListNode.OnTogValueChange =
    function(self, type, bool)
        -- function num : 0_8 , upvalues : FactoryEnum
        if bool then
            if type ~= self.togSelectType then
                self.togSelectType = type
            ...
            if type == (FactoryEnum.eOrderType).dig then
                (self.factoryController):ChangeRoomModelGo(self.roomIndex,
                                                           (FactoryEnum.eRoomType).dig);
                (((self.ui).img_unSelect_Dig).gameObject):SetActive(false) -- DECOMPILER ERROR at PC30: Confused about usage of register: R3 in 'UnsetPending'
                ;
                ((self.ui).img_Icon_Dig).color = (self.ui).color_black -- DECOMPILER ERROR at PC35: Confused about usage of register: R3 in 'UnsetPending'
                ;
                ((self.ui).text_Dig).color = (self.ui).color_black
            else
                if type == (FactoryEnum.eOrderType).produce then
                    (self.factoryController):ChangeRoomModelGo(self.roomIndex,
                                                               (FactoryEnum.eRoomType).normal);
                    (((self.ui).img_unSelect_Production).gameObject):SetActive(
                        false) -- DECOMPILER ERROR at PC57: Confused about usage of register: R3 in 'UnsetPending'
                    ;
                    ((self.ui).img_Icon_Production).color =
                        (self.ui).color_black -- DECOMPILER ERROR at PC62: Confused about usage of register: R3 in 'UnsetPending'
                    ;
                    ((self.ui).text_Production).color = (self.ui).color_black
                end
            end
            ...
            if type == (FactoryEnum.eOrderType).dig then
                (((self.ui).img_unSelect_Dig).gameObject):SetActive(true) -- DECOMPILER ERROR at PC78: Confused about usage of register: R3 in 'UnsetPending'
                ;
                ((self.ui).img_Icon_Dig).color = (self.ui).color_gray -- DECOMPILER ERROR at PC83: Confused about usage of register: R3 in 'UnsetPending'
                ;
                ((self.ui).text_Dig).color = (self.ui).color_gray
            else
                if type == (FactoryEnum.eOrderType).produce then
                    (((self.ui).img_unSelect_Production).gameObject):SetActive(
                        true) -- DECOMPILER ERROR at PC99: Confused about usage of register: R3 in 'UnsetPending'
                    ;
                    ((self.ui).img_Icon_Production).color = (self.ui).color_gray -- DECOMPILER ERROR at PC104: Confused about usage of register: R3 in 'UnsetPending'
                    ;
                    ((self.ui).text_Production).color = (self.ui).color_gray
                end
            end
