...
UINSctItemInfo.InitSctItemInfo = function(self, sectorId, clickFunc)
    ...
    self.sectorCfg = sectorCfg -- DECOMPILER ERROR at PC24: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).img_Career).sprite = CRH:GetSprite(eSectorByCareer[sectorId],
                                                  CommonAtlasType.CareerCamp) -- DECOMPILER ERROR at PC27: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).fade).alpha = 1 -- DECOMPILER ERROR at PC34: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).tex_SectorName).text = (LanguageUtil.GetLocaleText)(
                                          sectorCfg.type_name) -- DECOMPILER ERROR at PC41: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).tex_Name).text = (LanguageUtil.GetLocaleText)(sectorCfg.name) -- DECOMPILER ERROR at PC45: Confused about usage of register: R4 in 'UnsetPending'
    ;
