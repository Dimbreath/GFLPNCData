...
local AvgCfg_Test = {
    [1] = {
        ...
        audio = {bgm = {cue = "m_bat_default", sheet = "Music"}},
        effect = {effect1 = {prefabName = "Avg/AvgTest", layer = 2}}
    },
    [2] = {
        ...
        speakerHeroId = 1009,
        speakerHeroPosId = 1,
        audio = {voice = {cue = "ui_recieve", sheet = "SFX"}},
        branch = {
            {content = 21, jumpAct = 3}, {content = 22, jumpChapter = "Test"}
        },
    ...
    [3] = {
        ...
        imgTween = {
            ...
            {imgId = 4, duration = 0.5, pos = {0, 0, 0}, alpha = 1},
    ...
    [4] = {
        ...
        contentType = 3,
        speakerHeroId = 1034,
        vedioPath = "avg/avg001"
    },
    [5] = {
        images = {{imgId = 1, delete = true}},
        content = 50,
        contentType = 2,
        ppv = {cg = {saturation = -100}}
    },
    [6] = {
        images = {{imgId = 2, delete = true}, {imgId = 3, delete = true}},
        content = 60,
        contentType = 2,
        contentShake = true
    },
    ...
    [-1] = {
        ...
        vedioLoopStop = true,
        effect = {
            effect1 = {prefabName = "Avg/AvgTest", pos = {0, 0, 0}, layer = 1},
            stopList = {"effect1"}
        },
        audio = {
