...
bs_50003.OnSetHurt = function(self, context)
  ...
  if context.sender ~= self.caster and context.roleType ~= eBattleRoleType.skillCaster and context.target == self.caster and (context.sender).attackRange == 1 and not context.isMiss and ((self.caster).recordTable).sheildValue_50003 then
...
bs_50003.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : base, _ENV, ShieldSkillBase
    (base.InitSkill)(self, isMidwaySkill)
    self:AddTrigger(eSkillTriggerType.SetHurt, "bs_50003_1", 1, self.OnSetHurt) -- DECOMPILER ERROR at PC17: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.caster).recordTable).sheildValue_50003 =
...
bs_50003.OnSetHurt = function(self, context)
    ...
    if context.sender ~= self.caster and context.roleType ~=
        ...
        ((self.caster).recordTable).sheildValue_50003 then
        ((self.caster).recordTable).sheildValue_50003hurt = context.hurt
        ...
        if ((self.caster).recordTable).sheildValue_50003 == 0 and
