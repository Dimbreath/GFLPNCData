...
bs_1050.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddSelfTrigger(eSkillTriggerType.AfterHeal, "bs_1050_1", 1, self.OnAfterHeal)
  self:AddSelfTrigger(eSkillTriggerType.AfterAddBuff, "bs_1050_1", 1, self.OnAfterAddBuff)
  self:AddSelfTrigger(eSkillTriggerType.BuffDie, "bs_1050_1", 1, self.OnBuffDie)
end
