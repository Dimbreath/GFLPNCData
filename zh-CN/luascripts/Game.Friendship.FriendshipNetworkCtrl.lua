...
FriendshipNetworkCtrl.CS_INTIMACY_Presentation = function(self, heroId, giftId, giftNum)
...
FriendshipNetworkCtrl.SC_INTIMACY_Presentation = function(self, msg)
  ...
  if msg.ret ~= proto_csmsg_ErrorCode.None then
    ...
    do
      ...
      cs_WaitNetworkResponse:StartWait(proto_csmsg_MSG_ID.MSG_SC_INTIMACY_Detail, function()
...
FriendshipNetworkCtrl.CS_INTIMACY_UpgradeLine = function(self, heroId, lineId)
