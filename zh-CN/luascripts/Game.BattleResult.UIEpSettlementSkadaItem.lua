...
UIEpSettlementSkadaItem.InitSettlementSkadaItem = function(self, heroInfo, process, resloader)
  -- function num : 0_1 , upvalues : _ENV
  -- DECOMPILER ERROR at PC9: Confused about usage of register: R4 in 'UnsetPending'

  ((self.ui).img_Pic).texture = resloader:LoadABAsset(PathConsts:GetCharacterPicPath(heroInfo:GetResName()))
