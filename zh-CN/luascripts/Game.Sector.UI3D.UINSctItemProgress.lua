...
UINSctItemProgress.InitSctProgress =
    function(self, sectorId, isStage, clickFunc)
        -- function num : 0_1 , upvalues : _ENV
        self.sectorId = sectorId
        self.clickFunc = clickFunc
        local value = isStage and 0 or 1;
        ((self.ui).img_Icon):SetIndex(value);
        ((self.ui).tex_Tile):SetIndex(value) -- DECOMPILER ERROR at PC27: Confused about usage of register: R5 in 'UnsetPending'
        ;
        (self.gameObject).name = tostring(sectorId) .. "_" .. tostring(value)
    end

UINSctItemProgress.SetSctProgressPosConstraint =
...
UINSctItemProgress.ShowSctProgressRedDot =
    function(self, show)
        -- function num : 0_4
...
UINSctItemProgress.__OnClickRootBtn = function(self)
    -- function num : 0_5
    if self.clickFunc ~= nil then (self.clickFunc)(self.sectorId) end
end
