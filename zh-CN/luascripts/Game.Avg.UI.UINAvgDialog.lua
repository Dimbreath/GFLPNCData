...
UINAvgDialog.ShowAvgDialog = function(self, content, shake, immediate, scramble, speakerName, isNarratage, posX)
  ...
  if self.isNarratage then
    ...
    if immediate then
      ...
      ;
      (((self.ui).tween_Narrator).tween):ChangeEndValue(content, (ConfigData.buildinConfig).AvgTextTweenSpeed, true)
      ;
    ...
    if immediate then
      ...
      ;
      (((self.ui).tween_Dialog).tween):ChangeEndValue(content, (ConfigData.buildinConfig).AvgTextTweenSpeed, true)
      ;
