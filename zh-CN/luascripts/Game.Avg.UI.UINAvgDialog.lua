...
UINAvgDialog.ShowAvgDialog = function(self, content, shake, immediate, scramble,
    ...
    if self.isNarratage then
        ...
        do
            ...
            local extents = (((self.ui).text_Dialog).rectTransform).sizeDelta
            extents.y = 0
            local sizeDelta = ((self.ui).text_Dialog):PreSetTextSizeDelta(
                                  content, false, true, extents) -- DECOMPILER ERROR at PC100: Confused about usage of register: R10 in 'UnsetPending'
            ;
            ((self.ui).text_Dialog_Layout).preferredHeight = sizeDelta.y
            -- DECOMPILER ERROR at PC105: Confused about usage of register: R10 in 'UnsetPending'
            ...
            if immediate then
                ...
                ((self.ui).text_Dialog).text = nil;
                ((self.ui).tween_Dialog):DOKill() -- DECOMPILER ERROR at PC124: Confused about usage of register: R10 in 'UnsetPending'
                ;
                ((self.ui).tween_Dialog).optionalScrambleMode =
                    scramble and CS_ScrambleMode.Uppercase or
                        CS_ScrambleMode.None;
                ((self.ui).tween_Dialog):CreateTween()
                local textSpeed = (ConfigData.buildinConfig).AvgTextTweenSpeed;
            ...
            do
                do
                    local pos =
                        (((self.ui).dialogNode).transform).anchoredPosition
                    pos.x = posX or 0 -- DECOMPILER ERROR at PC155: Confused about usage of register: R11 in 'UnsetPending'
                    ;
                    (((self.ui).dialogNode).transform).anchoredPosition = pos
                    self.contentLenth = #content
                end
