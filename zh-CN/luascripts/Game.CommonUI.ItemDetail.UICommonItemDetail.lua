...
UICommonItemDetail.InitCommonItemDetail =
    function(self, itemCfg)
        -- function num : 0_1 , upvalues : _ENV, UICommonItem, JumpManager
        -- DECOMPILER ERROR at PC6: Confused about usage of register: R2 in 'UnsetPending'

        ((self.ui).text_itemName).text =
            (LanguageUtil.GetLocaleText)(itemCfg.name) -- DECOMPILER ERROR at PC13: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.ui).text_itemDes).text = (LanguageUtil.GetLocaleText)(
                                            itemCfg.describe)
        ...
        if itemCfg.achieve_des ~= nil and itemCfg.achieve_des ~= "" then
            ((self.ui).text_approachTex).text =
                (LanguageUtil.GetLocaleText)(itemCfg.achieve_des)
        else
            -- DECOMPILER ERROR at PC47: Confused about usage of register: R3 in 'UnsetPending'


            ((self.ui).text_approachTex).text =
                ConfigData:GetTipContent(TipContent.CommonItemDetailNoDesc)
        end
        if itemCfg.jump_id ~= nil and itemCfg.jump_id ~= 0 and self.canJump then
            ...
            (UIUtil.AddButtonListener)((self.ui).btn_jumpButton, self,
                                       function()
