...
UIAchivTypeToggle.InitAchivTypeToggle = function(self, id, name, isOn, onChangedEvent)
  -- function num : 0_1 , upvalues : _ENV
  self.id = id
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R5 in 'UnsetPending'

  ;
  ((self.ui).tex_TypeName).text = (LanguageUtil.GetLocaleText)(name)
...
UIAchivTypeToggle.ShowAchivTypeToggleRedDot = function(self, show)
  -- function num : 0_3
