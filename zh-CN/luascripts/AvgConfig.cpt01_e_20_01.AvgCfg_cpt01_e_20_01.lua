...
local AvgCfg_cpt01_e_20_01 = {
    ...
    [52] = {
        imgTween = {{imgId = 2, alpha = 1}, {imgId = 101, alpha = 0}},
        content = 520,
        contentType = 3,
        speakerHeroId = 1002,
        speakerHeroPosId = 3
    ...
    [53] = {
        imgTween = {
            {imgId = 2, alpha = 0},
            {imgId = 101, pos = {475, -360, 0}, alpha = 0.2},
            {
                imgId = 101,
                duration = 0.2,
                pos = {400, -360, 0},
    ...
    [75] = {
        imgTween = {{imgId = 101, isDark = true}, {imgId = 3, isDark = false}},
        content = 750,
        contentType = 3,
        speakerHeroId = 1003,
        speakerHeroPosId = 1
    ...
    [78] = {
        imgTween = {
            {imgId = 3, isDark = true}, {imgId = 101, alpha = 0},
            {
                imgId = 102,
                duration = 0.2,
                pos = {400, -300, 0},
    ...
    [83] = {
        imgTween = {
            {imgId = 3, isDark = true}, {imgId = 102, alpha = 1},
            {imgId = 101, alpha = 0}
        },
        content = 830,
        contentType = 3,
