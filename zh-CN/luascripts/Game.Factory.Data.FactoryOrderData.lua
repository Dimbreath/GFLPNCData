...
FactoryOrderData.CreateOrderData = function(orderCfg, isRoomUnlock)
  ...
  FactoryOrderData.energyCost = (math.ceil)(orderCfg.energy_cost * (1 - FactoryOrderData.efficiencyEnhance / 1000))
...
FactoryOrderData.UpdateEfficiencyEnhance = function(self)
  ...
  self.energyCost = (math.ceil)((self.orderCfg).energy_cost * (1 - self.efficiencyEnhance / 1000))
end
...
FactoryOrderData.GetEnergyCost = function(self)
  -- function num : 0_8
...
FactoryOrderData.GetCouldProdunc = function(self, factoryController)
  -- function num : 0_12 , upvalues : _ENV, factoryEnergyItemId
  if not self:GetIsUnlock() then
    return false
  end
  return factoryController:CheckOrderResource(self, 1, {}, {}, PlayerDataCenter:GetItemCount(factoryEnergyItemId))
end
