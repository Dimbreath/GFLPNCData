...
UINHeroLevelUpExpItem.InitEmptyExpItem =
    function(self, itemId)
        -- function num : 0_2 , upvalues : _ENV
        local itemCfg = (ConfigData.item)[itemId] -- DECOMPILER ERROR at PC5: Confused about usage of register: R3 in 'UnsetPending'
        ;
        ((self.ui).CanvasGroup).alpha = 0.5;
        (((self.ui).btn_Reduce).gameObject):SetActive(false) -- DECOMPILER ERROR at PC18: Confused about usage of register: R3 in 'UnsetPending'
        ;
        ((self.ui).tex_Name).text = (LanguageUtil.GetLocaleText)(itemCfg.name);
...
UINHeroLevelUpExpItem.UpdateSelectedNum =
    function(self, num)
