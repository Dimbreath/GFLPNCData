...
HeroSkillData.ctor = function(self, dataId, heroData)
    ...
    if self.type == eHeroSkillType.BattleSkill then
        self.battleSkillCfg =
...
HeroSkillData.GetDescribe = function(self)
    ...
    if self.type == eHeroSkillType.BattleSkill then
        ...
        if self.type == eHeroSkillType.LifeSkill then return "" end
    end
end
...
HeroSkillData.IsUniqueSkill = function(self)
    ...
    if self.type == eHeroSkillType.BattleSkill then
        ...
        if self.type == eHeroSkillType.LifeSkill then return false end
    end
end
