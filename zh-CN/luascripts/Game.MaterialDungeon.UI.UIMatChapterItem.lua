...
UIMatChapterItem.OnInit = function(self)
...
UIMatChapterItem.CheckDailyLimit = function(self)
  -- function num : 0_1
  do return self.usedLimit < self.dailyLimit end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

UIMatChapterItem.InitWithData = function(self, chapterCfg, state, index, fstRwdPool, mbRwdPool, moduleId, lockReason)
...
UIMatChapterItem.UpdateChapterData = function(self)
  -- function num : 0_3
  ((self.ui).img_State):SetIndex(self.state)
end

UIMatChapterItem.UpdateLimit = function(self)
...
UIMatChapterItem.__onClick = function(self)
  -- function num : 0_5
...
UIMatChapterItem.ShowRewardsItem = function(self)
...
UIMatChapterItem.OnHide = function(self)
  -- function num : 0_7
  self.onClickAction = nil
  self.fstRewardItemData = {}
  self.mbDropIdList = nil
...
UIMatChapterItem.OnDelete = function(self)
...
UIMatChapterItem.InitWithData = function(self, chapterCfg, state, index,
