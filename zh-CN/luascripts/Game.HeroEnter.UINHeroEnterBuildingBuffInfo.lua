...
local valueFuncTable = {
    [eBuildingLogic.ResourceLimit] = function(heroScoreRate, newHreoScoreRate,
        ...
        ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.ResourceLimit,
                                              itemName) -- DECOMPILER ERROR at PC30: Confused about usage of register: R4 in 'UnsetPending'
        ;
    ...
    [eBuildingLogic.ResourceOutput] = function(heroScoreRate, newHreoScoreRate,
        ...
        local itemName = (LanguageUtil.GetLocaleText)(
                             ((ConfigData.item)[((theSelf.levelBuffCfg).buff_para1)[theSelf.buffCfhID]]).name);
        ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.ResourceOutput,
                                              itemName)
    ...
    [eBuildingLogic.CareerBuff] = function(heroScoreRate, newHreoScoreRate,
        ...
        ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.CareerBuff,
                                              careerName)
        local attrName = (LanguageUtil.GetLocaleText)(
                             ((ConfigData.attribute)[((theSelf.levelBuffCfg).buff_para2)[theSelf.buffCfhID]]).name)
        local attrValue = ((theSelf.levelBuffCfg).buff_para3)[theSelf.buffCfhID] -- DECOMPILER ERROR at PC42: Confused about usage of register: R6 in 'UnsetPending'
    ...
    [eBuildingLogic.FactoryPipelie] = function(heroScoreRate, newHreoScoreRate,
        ...
        ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.FactoryPipelie) -- DECOMPILER ERROR at PC18: Confused about usage of register: R3 in 'UnsetPending'
        ;
        ((theSelf.ui).tex_OldNum).text =
            tostring((math.floor)(
    ...
    [eBuildingLogic.ResOutputEfficiency] = function(heroScoreRate,
        ...
        do
            ...
            ((theSelf.ui).tex_AttriName):SetIndex(
                eBuildingLogic.ResOutputEfficiency, itemName) -- DECOMPILER ERROR at PC45: Confused about usage of register: R4 in 'UnsetPending'
            ;
            ((theSelf.ui).tex_OldNum).text =
