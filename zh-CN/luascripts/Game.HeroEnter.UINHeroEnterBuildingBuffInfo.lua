...
local valueFuncTable = {[eBuildingLogic.ResourceLimit] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_0 , upvalues : _ENV
  local itemName = (LanguageUtil.GetLocaleText)(((ConfigData.item)[((theSelf.levelBuffCfg).buff_para1)[theSelf.buffCfhID]]).name)
  ;
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.ResourceLimit, itemName)
...
, [eBuildingLogic.ResourceOutput] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_1 , upvalues : _ENV
  local itemName = (LanguageUtil.GetLocaleText)(((ConfigData.item)[((theSelf.levelBuffCfg).buff_para1)[theSelf.buffCfhID]]).name)
  ;
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.ResourceOutput, itemName)
...
, [eBuildingLogic.CampBuff] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_2 , upvalues : _ENV
  local campName = (LanguageUtil.GetLocaleText)(((ConfigData.camp)[((theSelf.levelBuffCfg).buff_para1)[theSelf.buffCfhID]]).name)
  ;
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.CampBuff, campName)
...
, [eBuildingLogic.CareerBuff] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  ;
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.CareerBuff, careerName)
  local attrName = (LanguageUtil.GetLocaleText)(((ConfigData.attribute)[((theSelf.levelBuffCfg).buff_para2)[theSelf.buffCfhID]]).name)
  local attrValue = ((theSelf.levelBuffCfg).buff_para3)[theSelf.buffCfhID]
  -- DECOMPILER ERROR at PC42: Confused about usage of register: R6 in 'UnsetPending'
...
, [eBuildingLogic.FactoryPipelie] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_4 , upvalues : _ENV
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.FactoryPipelie)
...
, [eBuildingLogic.GlobalExpCeiling] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_5 , upvalues : _ENV
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.GlobalExpCeiling)
...
, [eBuildingLogic.StaminaCeiling] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_6 , upvalues : _ENV
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.StaminaCeiling)
...
, [eBuildingLogic.StaminaOutput] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_7 , upvalues : _ENV
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.StaminaOutput)
...
, [eBuildingLogic.ResOutputEfficiency] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  do
    ;
    ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.ResOutputEfficiency, itemName)
...
, [eBuildingLogic.BuildQueue] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_9 , upvalues : _ENV
  local listPlace = ((theSelf.levelBuffCfg).buff_para1)[theSelf.buffCfhID]
  if listPlace == 1 then
    ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.BuildQueue)
  else
    ;
...
, [eBuildingLogic.BuildSpeed] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_10 , upvalues : _ENV
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.BuildSpeed)
...
, [eBuildingLogic.GlobalExpRatio] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_11 , upvalues : _ENV
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.GlobalExpRatio)
...
, [eBuildingLogic.AllHeroBuff] = function(heroScoreRate, newHreoScoreRate, theSelf)
  -- function num : 0_12 , upvalues : _ENV
  ((theSelf.ui).tex_AttriName):SetIndex(eBuildingLogic.AllHeroBuff)
