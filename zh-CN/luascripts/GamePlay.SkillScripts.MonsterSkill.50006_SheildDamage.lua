...
bs_50006.OnSetHurt = function(self, context)
  ...
  if (context.sender).attackRange > 1 and context.sender == self.caster then
    ...
    if ((context.target).recordTable).sheildValue_50003 ~= nil and ((context.target).recordTable).sheildValue_50003 > 0 then
      if (context.target):GetBuffTier((self.config).fakeJinId) > 0 then
        return 
      end
      local sheild = ((context.target).recordTable).sheildValue_50003
      -- DECOMPILER ERROR at PC119: Confused about usage of register: R3 in 'UnsetPending'

      ;
      ((context.target).recordTable).sheildValue_50003 = (math.max)(0, ((context.target).recordTable).sheildValue_50003 - context.hurt * 1500 // 1000)
      ;
      (ShieldSkillBase.ShieldBaseFunc)(context.hurt * 1500 // 1000, context.target, (self.config).shieldKeyJin)
      context.hurt = (math.max)(0, context.hurt - sheild)
    ...
    do
      if (context.sender).attackRange == 1 and context.sender == self.caster then
        if ((context.target).recordTable).sheildValue_50002 ~= nil and ((context.target).recordTable).sheildValue_50002 > 0 then
          if (context.target):GetBuffTier((self.config).fakeYuanId) > 0 then
            return 
          end
          local sheild = ((context.target).recordTable).sheildValue_50002
          -- DECOMPILER ERROR at PC214: Confused about usage of register: R3 in 'UnsetPending'

          ;
          ((context.target).recordTable).sheildValue_50002 = (math.max)(0, ((context.target).recordTable).sheildValue_50002 - context.hurt * 1500 // 1000)
          ;
          (ShieldSkillBase.ShieldBaseFunc)(context.hurt * 1500 // 1000, context.target, (self.config).shieldKeyYuan)
          context.hurt = (math.max)(0, context.hurt - sheild)
          if ((context.target).recordTable).sheildValue_50002 == 0 and (context.target):GetBuffTier((self.config).sheildBuffId) > 0 then
            LuaSkillCtrl:DispelBuff(context.target, (self.config).buffIdYuan)
            LuaSkillCtrl:DispelBuff(context.target, (self.config).sheildBuffId)
...
bs_50006.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : base, _ENV
    (base.InitSkill)(self, isMidwaySkill)
    self:AddTrigger(eSkillTriggerType.SetHurt, "bs_50006_1", 1000,
                    self.OnSetHurt)
end
...
bs_50006.OnSetHurt = function(self, context)
    ...
    if (context.sender).attackRange > 1 and context.sender == self.caster then
        if ((context.target).recordTable).sheildValue_50002 ~= nil and
            ...
            ((context.target).recordTable).sheildValue_50002 =
                (math.max)(0, ((context.target).recordTable).sheildValue_50002 -
                               ...
                               500 // 1000);
            (ShieldSkillBase.ShieldBaseFunc)(
                ((context.target).recordTable).sheildValue_50002hurt * 500 //
                    1000, context.target, (self.config).shieldKeyYuan)
        ...
        if ((context.target).recordTable).sheildValue_50003 ~= nil and
            ...
            local sheild = ((context.target).recordTable).sheildValue_50003 -- DECOMPILER ERROR at PC119: Confused about usage of register: R3 in 'UnsetPending'
            ;
            ((context.target).recordTable).sheildValue_50003 =
                (math.max)(0, ((context.target).recordTable).sheildValue_50003 -
                               context.hurt * 1500 // 1000);
            (ShieldSkillBase.ShieldBaseFunc)(context.hurt * 1500 // 1000,
                                             context.target,
        ...
        do
            if (context.sender).attackRange == 1 and context.sender ==
                self.caster then
                if ((context.target).recordTable).sheildValue_50002 ~= nil and
                    ((context.target).recordTable).sheildValue_50002 > 0 then
                    if (context.target):GetBuffTier((self.config).fakeYuanId) >
                        0 then return end
                    local sheild =
                        ((context.target).recordTable).sheildValue_50002 -- DECOMPILER ERROR at PC214: Confused about usage of register: R3 in 'UnsetPending'
                    ;
                    ((context.target).recordTable).sheildValue_50002 =
                        (math.max)(0,
                                   ((context.target).recordTable).sheildValue_50002 -
                                       context.hurt * 1500 // 1000);
                    (ShieldSkillBase.ShieldBaseFunc)(
                        context.hurt * 1500 // 1000, context.target,
                    ...
                    if ((context.target).recordTable).sheildValue_50002 == 0 and
                        ...
                        0 then
                        LuaSkillCtrl:DispelBuff(context.target,
                                                (self.config).buffIdYuan)
                        LuaSkillCtrl:DispelBuff(context.target,
                                                (self.config).sheildBuffId)
                        LuaSkillCtrl:CallSheldBroken(context.sender,
                                                     context.target)
                        LuaSkillCtrl:CallEffect(context.target,
                                                (self.config).effectIdYuan, self)
                    end
                ...
                do
                    ...
                    if ((context.target).recordTable).sheildValue_50003 ~= nil and
                        ...
                        nil and ((context.target).recordTable).sheildValue_50003 >
                        0 then
                        ((context.target).recordTable).sheildValue_50003 =
                            (math.max)(0,
                                       ((context.target).recordTable).sheildValue_50003 -
                        ...
                        (ShieldSkillBase.ShieldBaseFunc)(
                            ((context.target).recordTable).sheildValue_50003hurt *
                                500 // 1000, context.target,
                            (self.config).shieldKeyJin)
                        if ((context.target).recordTable).sheildValue_50003 == 0 and
                            (context.target):GetBuffTier(
                                (self.config).sheildBuffId) > 0 then
                            LuaSkillCtrl:DispelBuff(context.target,
                                                    (self.config).buffIdJin)
                            LuaSkillCtrl:DispelBuff(context.target,
                                                    (self.config).sheildBuffId)
                            LuaSkillCtrl:CallSheldBroken(context.sender,
                                                         context.target)
                            LuaSkillCtrl:CallEffect(context.target,
                                                    (self.config).effectIdJin,
                                                    self)
                        end
                    end
                end
