...
UINFactoryResProduceItem.OnInit = function(self)
  ...
  ;
  (UIUtil.AddButtonListener)((self.ui).btn_resItem, self, self.OnBtnSelectClicked)
end

UINFactoryResProduceItem.InitResProduce = function(self, itemCfg, stockNum, output, clickedAction)
  -- function num : 0_1 , upvalues : _ENV
  self.itemCfg = itemCfg
  self.id = itemCfg.id
  self.stockNum = stockNum
  self.output = output
  self.clickAction = clickedAction
...
UINFactoryResProduceItem.RefreshProduceState = function(self)
...
UINFactoryResProduceItem.RefreshResNum = function(self, stockNum, output)
  -- function num : 0_3
  self.stockNum = stockNum
  self.output = output
  self:RefreshProduceState()
...
UINFactoryResProduceItem.RefreshStockNum = function(self, stockNum)
  -- function num : 0_4
  self.stockNum = stockNum
  self:RefreshProduceState()
end

UINFactoryResProduceItem.OnBtnSelectClicked = function(self)
  -- function num : 0_5
...
UINFactoryResProduceItem.SetProduceSelect = function(self, active)
  -- function num : 0_6
