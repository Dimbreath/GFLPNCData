...
UIEpETrack.SetTrunkLinePass = function(self, isPass, color, height)
    -- function num : 0_8
    ...
    end -- DECOMPILER ERROR at PC20: Confused about usage of register: R5 in 'UnsetPending'
    
    (((self.ui).img_Trunk).transform).sizeDelta = sizeDelta
end

UIEpETrack.SetForkLinePass = function(self, forkRoom, mapCtrl, isPass, color,
                                      height)
    ...
    do
        if lineItem ~= nil then
            ...
            if isPass then
                ...
                sizeDelta.y = self.lineDefaultHeight
            end -- DECOMPILER ERROR at PC17: Confused about usage of register: R8 in 'UnsetPending'
            
            (lineItem.transform).sizeDelta = sizeDelta
        end
        -- DECOMPILER ERROR at PC25: Unhandled construct in 'MakeBoolean' P1

        if not isPass and forkRoom.position == self.curForkLineRoomPos then
            self:__ResetDynLine()
            self.curForkLineRoomPos = nil
        end
        do return end
        self.curForkLineRoomPos = forkRoom.position -- DECOMPILER ERROR at PC31: Confused about usage of register: R7 in 'UnsetPending'
        ;
        ...
        do
            ...
            local sizeDelta = ((self.verticalLineCenter).transform).sizeDelta
            sizeDelta.x = height -- DECOMPILER ERROR at PC86: Confused about usage of register: R13 in 'UnsetPending'
            ;
            ((self.verticalLineCenter).transform).sizeDelta = sizeDelta
            if roomIndex > 1 then
