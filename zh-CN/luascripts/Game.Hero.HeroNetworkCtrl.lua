...
HeroNetworkCtrl.CS_HERO_FormationNameFresh = function(self, fmtId, name)
  ...
  cs_WaitNetworkResponse:StartWait(proto_csmsg_MSG_ID.MSG_CS_HERO_FormationNameFresh, proto_csmsg_MSG_ID.MSG_SC_HERO_FormationNameFresh)
end
