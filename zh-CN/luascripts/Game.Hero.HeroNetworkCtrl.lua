...
HeroNetworkCtrl.OnUpdateHeroEvent = function(self, heroList)
    ...
    if lastData.type == LastSendType.HeroStarUp and lastData.rank ~=
        ...
        UIManager:ShowWindowAsync(UIWindowTypeID.GetHero, function(window)
            ...
            window:InitGetHeroList({lastData.heroData})
...
HeroNetworkCtrl.CS_HERO_FormationNameFresh =
    function(self, fmtId, name)
        -- function num : 0_14 , upvalues : _ENV, cs_WaitNetworkResponse
        -- DECOMPILER ERROR at PC1: Confused about usage of register: R3 in 'UnsetPending'

        (self.fmtNameFreshData).id = fmtId -- DECOMPILER ERROR at PC3: Confused about usage of register: R3 in 'UnsetPending'
        ;
