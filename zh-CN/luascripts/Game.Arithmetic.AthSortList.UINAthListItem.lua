...
UINAthListItem.ctor = function(self)
  -- function num : 0_0
end
...
UINAthListItem.InitAthListItem = function(self, athData, clickFunc, resloader, inAthTable)
  -- function num : 0_2
...
UINAthListItem.SetAthItemRootScrollRectRoot = function(self, scrollRectRoot)
  -- function num : 0_3
...
UINAthListItem.RereshAthItem = function(self)
  ...
  local qualityColor = athData:GetColor()
  -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'

  ;
  ((self.ui).img_QualityLine).color = qualityColor
  local athColor = athData:GetAthColor()
  ...
  if suitParamDic ~= nil then
    ...
    ;
    ((self.ui).img_Suit).sprite = spriteAtlas:GetSprite(suitParamDic.icon)
  end
)
  end
  ...
  if self.subAttrPool ~= nil then
    ...
    for k,affix in ipairs(athData.affixList) do
      ...
      if cfg == nil then
        ...
        local color = (Color.New)(0.211, 0.211, 0.211, 1)
...
UINAthListItem.AthMoveTweenWithRootParent = function(self, anchoredPosition)
  -- function num : 0_11
...
UINAthListItem.ClearAthItemDragEndTween = function(self)
  -- function num : 0_13
...
UINAthListItem.RefreshAthItemStateInstall = function(self)
...
UINAthListItem.RefreshAthItemStateLock = function(self)
  -- function num : 0_18
...
UINAthListItem.SetAthItemRootParent = function(self, parent, reset, withoutSetPos)
  -- function num : 0_20
  if reset then
...
UINAthListItem.SetAthItemRootParentResetFunc = function(self, callBack)
  -- function num : 0_21
  self.__OnResetAthItemRootParent = callBack
end

UINAthListItem.SetAsTransparentAthItem = function(self, parent, athData, resloader)
...
UINAthListItem.SetAthItemSuit = function(self, suitItem)
  -- function num : 0_23
  self.suitItem = suitItem
end

UINAthListItem.TryReturnAthItemSuit = function(self, returnFunc)
  -- function num : 0_24
...
UINAthListItem.RereshAthItem = function(self)
    ...
    ((self.ui).img_Quality).color = athColor
    local suitId = athData:GetAthSuit()
    local suitParamDic = ((ConfigData.ath_suit).suitParamDic)[suitId] -- DECOMPILER ERROR at PC28: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).img_Suit).enabled = suitParamDic ~= nil
    if suitParamDic ~= nil then
        (self.resloader):LoadABAssetAsync(
            PathConsts:GetAtlasAssetPath("AthSuitIcon"), function(spriteAtlas)
                ...
                ((self.ui).img_Suit).sprite =
                    spriteAtlas:GetSprite(suitParamDic.icon)
            end)
    end
    if #(athData.athMainAttrCfg).attrtibute_id > 0 then
        local attrId = ((athData.athMainAttrCfg).attrtibute_id)[1]
        local attrValue = ((athData.athMainAttrCfg).attrtibute_num)[1]
        local name, valueStr, icon = ConfigData:GetAttribute(attrId, attrValue) -- DECOMPILER ERROR at PC61: Confused about usage of register: R11 in 'UnsetPending'
        ;
        ((self.ui).img_Icon).sprite = CRH:GetSprite(icon) -- DECOMPILER ERROR at PC64: Confused about usage of register: R11 in 'UnsetPending'
        ;
        ((self.ui).tex_Vlaue).text = valueStr
    end
    if self.subAttrPool ~= nil then
