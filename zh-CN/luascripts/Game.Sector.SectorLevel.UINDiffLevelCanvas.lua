...
UINDiffLevelCanvas.SetSectorStageItemRedDot =
...
UINDiffLevelCanvas.SetSectorLAvgMainItemRedDot =
        ...
        if v.stageCfg ~= nil then
            ...
            if levelItem ~= nil then
                local ok, node = RedDotController:GetRedDotNode(
                                     ...
                                     RedDotStaticTypeId.Sector, self.sectorId,
                                     self.difficulty, (v.stageCfg).id)
                if node:GetRedDotCount() <= 0 then
                    do
                        ...
                        if v.avgCfg ~= nil then
                            ...
                            if lAvgMainItem ~= nil then
                                local ok, node =
                                    RedDotController:GetRedDotNode(
                                        RedDotStaticTypeId.Main,
                                        RedDotStaticTypeId.Sector,
                                        self.sectorId, self.difficulty,
