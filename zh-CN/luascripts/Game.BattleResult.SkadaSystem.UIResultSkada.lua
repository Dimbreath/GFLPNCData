...
UIResultSkada.InitBattleSkada = function(self, battleStatistics, playerRoleList,
                                         enemyRoleList)
    -- function num : 0_4
    (self.panelSkadaTeamPage):InitSkadaTeamPage(battleStatistics,
                                                playerRoleList, enemyRoleList,
                                                self.resloader,
                                                self.panelSkadaInfoPage);
    (self.panelSkadaInfoPage):FirstInitSkadaInfoPage(self.resloader,
                                                     battleStatistics);
    ((self.__skadaTypeGroup)[1]):SetSkadaTypeOpen(true)
end
