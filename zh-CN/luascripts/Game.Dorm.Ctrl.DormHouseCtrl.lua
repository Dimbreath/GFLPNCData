...
DormHouseCtrl.OnHouseClicked = function(self, roomEntity)
  ...
  if state == eDormState.House then
    ...
    ;
    (TimelineUtil.Play)(((self.dormCtrl).bind).tl_dormToRoom, self.__onD2HTimelineComplete)
    ;
...
DormHouseCtrl.ExitRoom = function(self)
  ...
  ;
  (TimelineUtil.Rewind)(((self.dormCtrl).bind).tl_dormToRoom, self.__onH2DTimelineComplete)
  ;
