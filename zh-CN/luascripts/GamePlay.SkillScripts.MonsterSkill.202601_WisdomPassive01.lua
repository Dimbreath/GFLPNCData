...
bs_202601.InitSkill = function(self, isMidwaySkill)
    ...
    (base.InitSkill)(self, isMidwaySkill)
    self:AddTrigger(eSkillTriggerType.SetHurt, "bs_202601_2", 1, self.OnSetHurt)
    self:AddTrigger(eSkillTriggerType.BeforePlaySkill, "bs_202601_11", 1,
                    self.OnBeforePlaySkill) -- DECOMPILER ERROR at PC22: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.caster).recordTable)["521_Roll"] = (self.arglist)[1] -- DECOMPILER ERROR at PC27: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.caster).recordTable)["521_arg2"] = (self.arglist)[2]
end
