...
local receiveheaders = function(sock, headers)
    ...
    return headers
end -- DECOMPILER ERROR at PC34: Confused about usage of register: R12 in 'UnsetPending'
;
...
end -- DECOMPILER ERROR at PC37: Confused about usage of register: R12 in 'UnsetPending'
;
...
_M.open = function(host, port, create)
    ...
    return h
end -- DECOMPILER ERROR at PC45: Confused about usage of register: R13 in 'UnsetPending'
;
(metat.__index).sendrequestline = function(self, method, uri)
    -- function num : 0_4 , upvalues : string
    local reqline = (string.format)("%s %s HTTP/1.1\r\n", method or "GET", uri)
    return (self.try)((self.c):send(reqline))
end -- DECOMPILER ERROR at PC48: Confused about usage of register: R13 in 'UnsetPending'
;
(metat.__index).sendheaders = function(self, tosend)
    ...
    return 1
end -- DECOMPILER ERROR at PC51: Confused about usage of register: R13 in 'UnsetPending'
;
(metat.__index).sendbody = function(self, headers, source, step)
    -- function num : 0_6 , upvalues : ltn12, socket
    if not source then source = ((ltn12.source).empty)() end
    if not step then step = (ltn12.pump).step end
    local mode = "http-chunked"
    if headers["content-length"] then mode = "keep-open" end
    return (self.try)(((ltn12.pump).all)(source, (socket.sink)(mode, self.c),
                                         step))
end -- DECOMPILER ERROR at PC54: Confused about usage of register: R13 in 'UnsetPending'
;
(metat.__index).receivestatusline = function(self)
    ...
    local code = (socket.skip)(2,
                               (string.find)(status, "HTTP/%d*%.%d* (%d%d%d)"))
    return (self.try)((base.tonumber)(code), status)
end -- DECOMPILER ERROR at PC57: Confused about usage of register: R13 in 'UnsetPending'
;
(metat.__index).receiveheaders = function(self)
    -- function num : 0_8 , upvalues : receiveheaders
    return (self.try)(receiveheaders(self.c))
end -- DECOMPILER ERROR at PC60: Confused about usage of register: R13 in 'UnsetPending'
;
(metat.__index).receivebody = function(self, headers, sink, step)
    -- function num : 0_9 , upvalues : ltn12, base, socket
    if not sink then sink = ((ltn12.sink).null)() end
    if not step then step = (ltn12.pump).step end
    ...
    return (self.try)(((ltn12.pump).all)((socket.source)(mode, self.c, length),
                                         sink, step))
end -- DECOMPILER ERROR at PC63: Confused about usage of register: R13 in 'UnsetPending'
;
(metat.__index).receive09body = function(self, status, sink, step)
    -- function num : 0_10 , upvalues : ltn12, socket
    local source = ((ltn12.source).rewind)(
                       (socket.source)("until-closed", self.c))
    source(status)
    return (self.try)(((ltn12.pump).all)(source, sink, step))
end -- DECOMPILER ERROR at PC66: Confused about usage of register: R13 in 'UnsetPending'
;
    ...
    do
        return reqt.redirect ~= false and
                   ((code == 301 or code == 302 or code == 303 or code == 307) and
                       reqt.method and reqt.method ~= "GET" and reqt.nredirects and
                       reqt.nredirects < 5)
    end
