...
UINSelectChipAttrItem.OnInit = function(self)
    ...
    (self.ui).tex_AttrName = (self.transform):FindComponent("Tex_AttrName",
                                                            eUnityComponentID.ExText) -- DECOMPILER ERROR at PC15: Confused about usage of register: R1 in 'UnsetPending'
    ;
    (self.ui).tex_Num = (self.transform):FindComponent("Tex_Num",
                                                       eUnityComponentID.ExText)
end

UINSelectChipAttrItem.InitChipAttrItem =
    function(self, attrId, initValue, increaseValue, count)
        -- function num : 0_1 , upvalues : _ENV
        local attibuteCfg = (ConfigData.attribute)[attrId]
        if attibuteCfg == nil then
            error("Can\'t find attibuteCfg, id = " .. tostring(attrId))
        ...
        if value < 0 then
            ...
            sign = "+"
        end -- DECOMPILER ERROR at PC53: Confused about usage of register: R11 in 'UnsetPending'
        
        ((self.ui).tex_AttrName).text = atrName -- DECOMPILER ERROR at PC59: Confused about usage of register: R11 in 'UnsetPending'
        ;
        ((self.ui).tex_Num).text = sign .. valueStr
        -- DECOMPILER ERROR: 6 unprocessed JMP targets
    end
