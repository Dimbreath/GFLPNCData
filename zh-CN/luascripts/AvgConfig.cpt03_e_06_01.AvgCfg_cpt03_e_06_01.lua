...
, 
[67] = {content = 670, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 1, contentShake = true}
, 
[68] = {
imgTween = {
{imgId = 1, posId = 5}
...
local AvgCfg_cpt03_e_06_01 = {
    [1] = {
        ...
        imgTween = {
            {imgId = 98, duration = 1, alpha = 1}, {imgId = 1, posId = 1},
            {imgId = 1, posId = 2, isDark = false, duration = 0.2}
        },
        content = 10,
        contentType = 3,
    ...
    [10] = {
        ...
        speakerHeroId = 23,
        speakerHeroPosId = 3,
        imgTween = {{imgId = 101, duration = 0.1, shake = true}}
    },
    [11] = {
        content = 110,
        contentType = 3,
    ...
    [23] = {
        imgTween = {{imgId = 101, duration = 0.5, alpha = 1}},
        content = 230,
        contentType = 3,
        speakerHeroId = 23,
        speakerHeroPosId = 3,
    ...
    [37] = {
        imgTween = {{imgId = 27, isDark = false}},
        content = 370,
        contentType = 3,
        speakerHeroId = 1027,
        speakerHeroPosId = 1
    ...
    [41] = {
        ...
        content = 410,
        contentType = 2,
        audio = {sfx = {cue = "AVG_Alarm", sheet = "AVG_gf", audioId = 1}}
    },
    [42] = {
        imgTween = {
            {imgId = 102, duration = 0.5, alpha = 1, isDark = false},
    ...
    [65] = {
        imgTween = {
            {imgId = 102, duration = 0.5, posId = 5}, {imgId = 5, isDark = true}
        },
        content = 650,
        contentType = 2,
        audio = {sfx = {cue = "AVG_RunStep", sheet = "AVG_gf"}}
