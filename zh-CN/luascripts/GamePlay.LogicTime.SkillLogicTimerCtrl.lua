...
SkillLogicTimerCtrl.OnUpdateLogic = function(self)
    ...
    for timer, _ in pairs(self.__logic_toadd) do
        ...
        (self.__logic_timer)[timer] = true -- DECOMPILER ERROR at PC7: Confused about usage of register: R6 in 'UnsetPending'
        ;
        (self.__logic_toadd)[timer] = nil
    end
    for timer, _ in pairs(self.__logic_timer) do timer:Update() end
    DelayRecycle(self, self.__logic_timer)
end

SkillLogicTimerCtrl.GetTimer = function(self, delay, func, obj, is_loop,
                                        start_time)
    -- function num : 0_4 , upvalues : InnerGetTimer
    local timer = InnerGetTimer(self, delay, func, obj, is_loop, start_time) -- DECOMPILER ERROR at PC9: Confused about usage of register: R7 in 'UnsetPending'
    ;
    (self.__logic_toadd)[timer] = true
    return timer
end
