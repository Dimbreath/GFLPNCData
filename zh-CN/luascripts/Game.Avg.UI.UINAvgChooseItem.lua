...
UINAvgChooseItem.InitAvgChooseItem = function(self, index, content, clickEvent)
    ...
    ((self.ui).tex_Tile):SetIndex(0, tostring(index)) -- DECOMPILER ERROR at PC12: Confused about usage of register: R4 in 'UnsetPending'
    ;
...
UINAvgChooseItem.OnClickRootBtn = function(self)
    -- function num : 0_2
    if self.clickEvent ~= nil then (self.clickEvent)(self.index) end
end
