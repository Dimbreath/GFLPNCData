...
UIUserNameCreate.OnInit = function(self)
    -- function num : 0_0 , upvalues : _ENV
    (UIUtil.AddButtonListener)((self.ui).btn_RandomName, self,
                               self.OnclickRandomNameBtn);
    (UIUtil.AddButtonListener)((self.ui).btn_Confirm, self,
                               self.OnClickCreateUserConfirm)
end
...
UIUserNameCreate.OnClickCreateUserConfirm =
    function(self)
        -- function num : 0_4 , upvalues : _ENV
        local inputUserName = ((self.ui).input_UserName).text
        if (string.IsNullOrEmpty)(inputUserName) then
        ...
        (NetworkManager:GetNetwork(NetworkTypeID.Object)):CS_User_UserNameModify(
