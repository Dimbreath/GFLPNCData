...
UINAthHasSuitItem.InitAthHasSuitItem = function(self, parent, holder)
    ...
    (self.transform):SetAsFirstSibling() -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'
    ;
    (self.transform).offsetMax = rectAnchorOffsetMax -- DECOMPILER ERROR at PC13: Confused about usage of register: R3 in 'UnsetPending'
    ;
...
UINAthHasSuitItem.OnHide = function(self)
    ...
    if not IsNull(self.holder) then (self.transform):SetParent(self.holder) end
end
