...
bs_500.PlaySkill = function(self, passdata)
    ...
    if targetList.Count ~= 0 then
        self.lastAttackRole = (targetList[0]).targetRole -- DECOMPILER ERROR at PC98: Confused about usage of register: R5 in 'UnsetPending'
        ;
        ...
        self.lastAttackRole = nil -- DECOMPILER ERROR at PC158: Confused about usage of register: R5 in 'UnsetPending'
        ;
        ((self.caster).recordTable).lastAttackRole = nil
    end
end
