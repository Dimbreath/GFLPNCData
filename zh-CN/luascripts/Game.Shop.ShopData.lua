                    ...
                    do
                        if (self.shopPagesDic)[goodData.pageId] == nil then
                            ...
                            if (ConfigData.shop_page)[goodData.pageId] == nil or
                                ...
                                name =
                                    ((ConfigData.shop_page)[goodData.pageId]).page
                            end -- DECOMPILER ERROR at PC52: Confused about usage of register: R8 in 'UnsetPending'
                            
                            (self.shopPagesDic)[goodData.pageId] = {} -- DECOMPILER ERROR at PC56: Confused about usage of register: R8 in 'UnsetPending'
                            ;
                            ((self.shopPagesDic)[goodData.pageId]).name = name -- DECOMPILER ERROR at PC61: Confused about usage of register: R8 in 'UnsetPending'
                            ;
                                ...
                                if serverData ~= nil then
                                    (self.shopGoodsDic)[shelfId] =
                                        (ShopGoodData.CreateNewShopGoodData)(
                                            data, self.shopType, self.shopId,
                                    ...
                                    (self.shopGoodsDic)[shelfId] =
                                        (ShopGoodData.CreateNewShopGoodData)(
                                            data, self.shopType, self.shopId, 0)
                                end
                            else
                                do
                                    do
                                                ...
                                                do
                                                    if (self.shopPagesDic)[data.page] ==
                                                        ...
                                                        if (ConfigData.shop_page)[data.page] ==
                                                            ...
                                                            name =
                                                                ((ConfigData.shop_page)[data.page]).page
                                                        end -- DECOMPILER ERROR at PC286: Confused about usage of register: R9 in 'UnsetPending'
                                                        ...
                                                        ((self.shopPagesDic)[data.page]).name =
                                                            name -- DECOMPILER ERROR at PC295: Confused about usage of register: R9 in 'UnsetPending'
                                                        ;
                                                    ...
                                                    -- DECOMPILER ERROR at PC304: LeaveBlock: unexpected jumping out IF_ELSE_STMT
