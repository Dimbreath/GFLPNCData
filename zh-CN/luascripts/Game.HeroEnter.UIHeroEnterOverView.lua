...
local UIHeroEnterOverView = class("UIHeroEnterOverView", UIBaseWindow)
local base = UIBaseWindow
local UINHeroEnterOverViewItem = require(
                                     "Game.HeroEnter.UINHeroEnterOverViewItem")
UIHeroEnterOverView.OnInit = function(self)
    -- function num : 0_0 , upvalues : _ENV
    self.slotItemDic = {}
    self.curSlotList = {} -- DECOMPILER ERROR at PC10: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).scrollView).onInstantiateItem =
        BindCallback(self, self.__OnNewItem) -- DECOMPILER ERROR at PC17: Confused about usage of register: R1 in 'UnsetPending'
    ;
...
UIHeroEnterOverView.InitHeroEnterOverView =
...
UIHeroEnterOverView.RefreshOverViewItem =
    function(self)
        -- function num : 0_2 , upvalues : _ENV
        local num = 0
        for index, value in pairs((PlayerDataCenter.AllBuildingData).oasisBuilt) do
        ...
        end -- DECOMPILER ERROR at PC22: Confused about usage of register: R2 in 'UnsetPending'
...
UIHeroEnterOverView.__OnNewItem = function(self, go)
    -- function num : 0_3 , upvalues : UINHeroEnterOverViewItem
    local slotItem = (UINHeroEnterOverViewItem.New)()
    slotItem:Init(go) -- DECOMPILER ERROR at PC6: Confused about usage of register: R3 in 'UnsetPending'
    ;
    (self.slotItemDic)[go] = slotItem
end
...
UIHeroEnterOverView.OnDelete = function(self)
    -- function num : 0_5 , upvalues : _ENV, base
    UIManager:DeleteWindow(UIWindowTypeID.HeroEnterOverView)
    for _, value in pairs(self.slotItemDic) do value:Delete() end
    (base.OnDelete)(self)
end
