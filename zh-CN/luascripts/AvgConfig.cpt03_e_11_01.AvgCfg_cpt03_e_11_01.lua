...
local AvgCfg_cpt03_e_11_01 = {
    ...
    [5] = {
        ...
        speakerHeroId = 26,
        speakerHeroPosId = 2,
        audio = {sfx = {cue = "Atk_Sol_02", sheet = "Chara_Sol"}}
    },
    [6] = {
        imgTween = {
            {imgId = 27, duration = 0.2, alpha = 1},
    ...
    [29] = {
        imgTween = {
            {imgId = 1, posId = 3}, {imgId = 104, duration = 0.2, alpha = 0}
        },
        content = 290,
        contentType = 3,
        speakerHeroId = 1001,
    ...
    [35] = {
        imgTween = {
            {imgId = 104, duration = 0.5, pos = {180, -150, 0}, alpha = 0}
        },
        content = 350,
        contentType = 2
    },
    ...
    [38] = {
        imgTween = {{imgId = 27, duration = 0.5, shake = true}},
        content = 380,
        contentType = 3,
        speakerHeroId = 1027,
        speakerHeroPosId = 3,
    ...
    [49] = {
        imgTween = {{imgId = 103, isDark = false}, {imgId = 27, isDark = true}},
        content = 490,
        contentType = 3,
        speakerHeroId = 25,
        speakerHeroPosId = 3
    ...
    [62] = {
        imgTween = {{imgId = 103, duration = 0.2, isDark = true}},
        content = 620,
        contentType = 2,
        audio = {sfx = {cue = "Skill_Anna_01", sheet = "Chara_Anna"}}
    },
    [63] = {
        imgTween = {
            {imgId = 102, posId = 5},
    ...
    [68] = {
        imgTween = {{imgId = 103, duration = 1.5, alpha = 0}},
        content = 680,
        contentType = 2,
