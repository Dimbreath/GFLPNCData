...
UIEpEventChoiceItem.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).btn_chipNode, self,
...
UIEpEventChoiceItem.RefreshChoiceUI = function(self, choiceData)
    ...
    end -- DECOMPILER ERROR at PC50: Confused about usage of register: R2 in 'UnsetPending'
    
    ((self.ui).tex_Describe).text = (LanguageUtil.GetLocaleText)(
                                        (self.cfg).describe) -- DECOMPILER ERROR at PC60: Confused about usage of register: R2 in 'UnsetPending'
    ;
...
UIEpEventChoiceItem.OnChipItemClick = function(self)
    -- function num : 0_6 , upvalues : _ENV
    if self.chipData == nil then return end
    local win = UIManager:ShowWindow(UIWindowTypeID.DungeonInfoDetail)
    local chipDataList = {};
    (table.insert)(chipDataList, self.chipData)
    win:ShowChipDetail(chipDataList, 1, nil, nil)
