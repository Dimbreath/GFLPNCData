...
list.push = function(self, value)
    -- function num : 0_2
    local node = {value = value, _prev = 0, _next = 0, removed = false} -- DECOMPILER ERROR at PC6: Confused about usage of register: R3 in 'UnsetPending'
    ;
...
list.pushnode = function(self, node)
    -- function num : 0_3
    if not node.removed then return end -- DECOMPILER ERROR at PC5: Confused about usage of register: R2 in 'UnsetPending'
...
list.unshift = function(self, v)
    -- function num : 0_5
    local node = {value = v, _prev = 0, _next = 0, removed = false} -- DECOMPILER ERROR at PC6: Confused about usage of register: R3 in 'UnsetPending'
    ;
...
list.find = function(self, v, iter)
    -- function num : 0_8
    if not iter then iter = self end
    repeat
...
list.next = function(self, iter)
    -- function num : 0_10
    local _next = iter._next
    if _next ~= self then return _next, _next.value end
    return nil
end
...
list.prev = function(self, iter)
    -- function num : 0_11
    local _prev = iter._prev
    if _prev ~= self then return _prev, _prev.value end
    return nil
end
...
list.insert = function(self, v, iter)
    -- function num : 0_13
    if not iter then return self:push(v) end
...
list.clone = function(self)
    ...
    local t = list:new()
    for i, v in list.next do t:push(v) end
    return t
end
