...
UIAthIconItem.InitAthIconItem = function(self, athData, clickEvent)
    ...
    ((self.ui).tex_ATHSpace):SetIndex(0, tostring(athData.size)) -- DECOMPILER ERROR at PC31: Confused about usage of register: R3 in 'UnsetPending'
    ;
...
UIAthIconItem.OnClick = function(self)
    -- function num : 0_2
    if self.clickEvent ~= nil then (self.clickEvent)(self.athData, self) end
end
...
UIAthIconItem.Reset = function(self)
    -- function num : 0_7
    self.athData = nil
    self.clickEvent = nil -- DECOMPILER ERROR at PC4: Confused about usage of register: R1 in 'UnsetPending'
    ;
