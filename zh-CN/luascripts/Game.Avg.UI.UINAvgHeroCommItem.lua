...
UINAvgHeroCommItem.InitAvgHeroCommItem =
    function(self, localPos, heroTransform)
        -- function num : 0_1
        (self.transform):SetParent(heroTransform.parent) -- DECOMPILER ERROR at PC5: Confused about usage of register: R3 in 'UnsetPending'
        ;
        (self.transform).localPosition = localPos
        heroTransform:SetParent((self.ui).mask)
    end
