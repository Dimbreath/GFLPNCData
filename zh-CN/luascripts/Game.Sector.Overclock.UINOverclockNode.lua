...
UINOverclockNode.RefreshAssembleNum = function(self)
    ...
    local unitOrangeSizeDelta = ((self.ui).img_UnitOrange).sizeDelta -- DECOMPILER ERROR at PC24: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).img_UnitOrange).sizeDelta =
        (Vector2.New)(curAssembleNum * 65, unitOrangeSizeDelta.y)
    local unitSlotSizeDelta = ((self.ui).img_UnitSlot).sizeDelta -- DECOMPILER ERROR at PC35: Confused about usage of register: R5 in 'UnsetPending'
    ;
    ((self.ui).img_UnitSlot).sizeDelta =
        (Vector2.New)(maxAssembleNum * 65, unitSlotSizeDelta.y)
end
