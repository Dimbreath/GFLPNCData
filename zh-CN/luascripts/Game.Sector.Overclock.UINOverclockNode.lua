...
UINOverclockNode.RefreshAssembleNum = function(self)
  ...
  local width = (self.ui).float_oneUnitWideth
  -- DECOMPILER ERROR at PC26: Confused about usage of register: R4 in 'UnsetPending'

  ;
  ((self.ui).img_UnitOrange).sizeDelta = (Vector2.New)(width * curAssembleNum, (((self.ui).img_UnitOrange).rect).height)
  -- DECOMPILER ERROR at PC37: Confused about usage of register: R4 in 'UnsetPending'

  ;
  ((self.ui).img_UnitSlot).sizeDelta = (Vector2.New)(width * maxAssembleNum, (((self.ui).img_UnitOrange).rect).height)
end
