...
local AvgCfg_cpt02_e_03_01 = {
    ...
    [6] = {
        imgTween = {{imgId = 98, duration = 0.5, shake = true}},
        audio = {sfx = {cue = "AVG_bigglassbreak", sheet = "AVG_gf"}}
    },
    [7] = {
        imgTween = {{imgId = 3, duration = 0.2, posId = 4}},
        content = 70,
        contentType = 3,
        speakerHeroId = 1003,
        speakerHeroPosId = 3,
    ...
    [8] = {
        imgTween = {
            {imgId = 3, isDark = true}, {imgId = 4, posId = 1},
            {imgId = 4, duration = 0.2, posId = 2}
        },
        content = 80,
        contentType = 3,
    ...
    [9] = {
        ...
        content = 90,
        contentType = 2,
        audio = {sfx = {cue = "AVG_pistol_finalshot_sup", sheet = "AVG_gf"}}
    },
    [10] = {
        imgTween = {{imgId = 98, duration = 0.5, shake = true}},
        audio = {sfx = {cue = "AVG_Broken_Glass", sheet = "AVG_gf"}},
        content = 100,
        contentType = 4,
        speakerName = 11
    },
    ...
    [13] = {
        imgTween = {{imgId = 97, duration = 2, shake = true}},
        content = 130,
        contentType = 2,
        audio = {sfx = {cue = "AVG_Door_Hit", sheet = "AVG_gf"}}
    },
    ...
    [54] = {
        ...
        speakerHeroId = 1001,
        speakerHeroPosId = 1,
        audio = {sfx = {cue = "AVG_Walk", sheet = "AVG_gf"}}
    },
    [55] = {
        imgTween = {{imgId = 3, isDark = false}, {imgId = 1, isDark = true}},
        content = 550,
    ...
    [61] = {
        imgTween = {
            {imgId = 3, posId = 3}, {imgId = 3, duration = 0.5, shake = true}
        },
        audio = {sfx = {cue = "Atk_Sol_01", sheet = "Chara_Sol"}},
        content = 610,
        contentType = 3,
        speakerHeroId = 1003,
        speakerHeroPosId = 2
    ...
    [62] = {
        imgTween = {
            {imgId = 3, duration = 0.2, alpha = 0}, {imgId = 34, posId = 5},
            {imgId = 34, posId = 4, isDark = false, duration = 0.2}
        },
        content = 620,
        contentType = 3,
    ...
    [64] = {
        imgTween = {
            {imgId = 34, isDark = true}, {imgId = 13, posId = 1},
            {imgId = 13, posId = 2, isDark = false, duration = 0.2}
        },
        content = 640,
        contentType = 3,
