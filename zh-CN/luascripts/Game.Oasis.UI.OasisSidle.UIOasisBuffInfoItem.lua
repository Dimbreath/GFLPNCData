...
UIOasisBuffInfoItem.SetInfoItemExText = function(self, text)
  -- function num : 0_2
  -- DECOMPILER ERROR at PC3: Confused about usage of register: R2 in 'UnsetPending'

  (((self.ui).tex_Bonus).text).text = text
end

UIOasisBuffInfoItem.SetInfoItemTextIndex = function(self, index, text1, text2)
  -- function num : 0_3
