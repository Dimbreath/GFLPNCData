...
UINTaskPageTog.OnInit = function(self)
    ...
    local target = (Vector2.New)(1.0666666666667 * oringinalSize.x,
                                 oringinalSize.y)
    self.extendTween =
        (((self.transform):DOSizeDelta(target, 0.25)):SetAutoKill(false)):Pause();
    (UIUtil.LuaUIBindingTable)(self.transform, self.ui);
    (UIUtil.AddValueChangedListener)((self.ui).tog_taskPageTog, self,
                                     self.OnValueChage)
end

UINTaskPageTog.InitPageTog = function(self, groupIndex, group, InitSubPages,
                                      OnSelectPage)
    -- function num : 0_1
    ...
    local name, name_en = (self.ctrl):GetPageName(self.groupIndex) -- DECOMPILER ERROR at PC16: Confused about usage of register: R7 in 'UnsetPending'
    ;
    ((self.ui).tex_TypeName).text = name -- DECOMPILER ERROR at PC19: Confused about usage of register: R7 in 'UnsetPending'
    ;
...
UINTaskPageTog.OnValueChage = function(self, bool)
    ...
    if bool then
        ((self.ui).tex_TypeName).color = (self.ui).color_black -- DECOMPILER ERROR at PC11: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ...
        if self.isMult then
            ...
            do
                ...
                if self.OnSelectPage ~= nil then
                    (self.OnSelectPage)((self.group)[1])
                end -- DECOMPILER ERROR at PC61: Confused about usage of register: R2 in 'UnsetPending'
                
                ((self.ui).tex_TypeName).color = (self.ui).color_gray -- DECOMPILER ERROR at PC66: Confused about usage of register: R2 in 'UnsetPending'
                ;
