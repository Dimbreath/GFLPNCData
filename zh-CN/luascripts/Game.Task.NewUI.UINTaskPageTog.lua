    ...
    if bool then
        ...
        if self.isMult then
            ...
            do
                ...
                if self.OnSelectPage ~= nil then
                    (self.OnSelectPage)((self.group)[1], self.groupIndex)
                end -- DECOMPILER ERROR at PC62: Confused about usage of register: R2 in 'UnsetPending'
                
                ((self.ui).tex_TypeName).color = (self.ui).color_gray -- DECOMPILER ERROR at PC67: Confused about usage of register: R2 in 'UnsetPending'
                ;
                ((self.ui).tex_TypeEN).color = (self.ui).color_gray;
                (self.extendTween):PlayBackwards();
                ((self.ui).img_Select):SetIndex(0)
