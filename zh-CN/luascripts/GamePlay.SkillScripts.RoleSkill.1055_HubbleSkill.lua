...
, 
HurtConfig2 = {hit_formula = 0, def_formula = 0, basehurt_formula = 10065, minhurt_formula = 9994, crit_formula = 0, crithur_ratio = 0, correct_formula = 9989, lifesteal_formula = 1001, spell_lifesteal_formula = 1002, returndamage_formula = 1000}
, 
...
bs_1055.OnAttackTrigger = function(self, target)
  ...
  LuaSkillCtrl:StartTimer(self, 11, function()
    ...
    do
      ...
      LuaSkillCtrl:HurtResult(skillResult, (self.config).HurtConfig2, {pro})
      skillResult:EndResult()
    end
  end
)
