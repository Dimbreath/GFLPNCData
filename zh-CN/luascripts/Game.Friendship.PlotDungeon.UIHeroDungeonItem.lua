...
UIHeroDungeonItem.InjectResLoaderAndClickEvent =
    function(self, resLoader, clickEvent)
        -- function num : 0_1
...
UIHeroDungeonItem.OnItemClick = function(self)
    -- function num : 0_2
    if self.clickEvent ~= nil then (self.clickEvent)() end
end

UIHeroDungeonItem.OnUpdateWithData = function(self, data)
    -- function num : 0_3 , upvalues : _ENV
    self.data = data -- DECOMPILER ERROR at PC7: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.ui).tex_Name).text = (LanguageUtil.GetLocaleText)(data.itemName) -- DECOMPILER ERROR at PC14: Confused about usage of register: R2 in 'UnsetPending'
    ;
...
UIHeroDungeonItem.UpdateAndSetProgress =
