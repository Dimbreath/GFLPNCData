...
local AvgCfg_cpt01_h_02_01 = {
    ...
    [6] = {
        imgTween = {{imgId = 97, duration = 1, alpha = 0.5}},
        content = 60,
        contentType = 2
    },
    [7] = {
        imgTween = {{imgId = 97, duration = 1, alpha = 1}},
        content = 70,
        contentType = 2
    },
    [8] = {
        ...
        imgTween = {
            {
                ...
                alpha = 1,
                isDark = false
            }, {imgId = 9, isDark = true}, {imgId = 101, alpha = 0}
        },
        content = 220,
        contentType = 3,
        speakerHeroId = 1006,
    ...
    [31] = {
        ...
        imgTween = {{imgId = 6, alpha = 1, isDark = false}},
        content = 310,
        contentType = 3,
        speakerHeroId = 1006,
        speakerHeroPosId = 3
    ...
    [40] = {
        imgTween = {{imgId = 6, isDark = true}},
        content = 400,
        contentType = 4,
        speakerName = 311
    },
    [41] = {
        imgTween = {{imgId = 6, isDark = false}},
        content = 410,
        contentType = 3,
        speakerHeroId = 1006,
        speakerHeroPosId = 3
    ...
    [52] = {
        imgTween = {{imgId = 9, alpha = 0}, {imgId = 6, isDark = true}},
        content = 520,
        contentType = 4,
        speakerName = 311
    },
