...
UITreasureRoomChipItem.InitTreasureRoomChip =
    function(self, idx, chipData, dynPlayer, resloader, __onToggleChipItemClick,
             __onlockClickAction)
        -- function num : 0_1
        (self.panel):InitChipDetailPanel(idx, chipData, dynPlayer, resloader,
                                         __onToggleChipItemClick)
        self.idx = idx
        self.__onlockClickAction = __onlockClickAction
        self.chipId = chipData.dataId
    end
...
UITreasureRoomChipItem.OnLockClick = function(self)
    -- function num : 0_2
    if self.__onlockClickAction ~= nil then (self.__onlockClickAction)(self) end
end
...
UITreasureRoomChipItem.GetChipDetailPanel =
    function(self)
        -- function num : 0_4
        return self.panel
    end

UITreasureRoomChipItem.SetObjNewTagActive =
