...
bs_60000.config = {buffId1 = 175, buffId2 = 1033, buffId3 = 198, buffId4 = 88}
...
bs_60000.OnAfterBattleStart = function(self)
  ...
  LuaSkillCtrl:CallBuff(self, self.caster, (self.config).buffId4, 1)
end
...
bs_60000.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : base, _ENV
    (base.InitSkill)(self, isMidwaySkill)
    self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_60000_1", 1,
