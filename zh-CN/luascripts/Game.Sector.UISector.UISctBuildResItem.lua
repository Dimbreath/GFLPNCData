...
UISctBuildResItem.UpdateSctBuildResItem =
    function(self, name, count, progress)
        -- function num : 0_2 , upvalues : _ENV
        -- DECOMPILER ERROR at PC2: Confused about usage of register: R4 in 'UnsetPending'

        ((self.ui).tex_ResName).text = name -- DECOMPILER ERROR at PC8: Confused about usage of register: R4 in 'UnsetPending'
        ;
        ((self.ui).tex_ResCount).text = tostring(count) -- DECOMPILER ERROR at PC11: Confused about usage of register: R4 in 'UnsetPending'
        ;
