...
bs_1025.PlayUltEffect = function(self)
    ...
    self:AddTrigger(eSkillTriggerType.AfterSelfUltInTimeLineEnd, "bs_1025_1", 1,
                    self.AfterFocusTimeLine)
    self:AddTrigger(eSkillTriggerType.AfterSelfUltMovieEnd, "bs_1025_2", 1,
                    self.OnMovieEnd)
end
...
bs_1025.AfterFocusTimeLine = function(self)
