...
bs_10239.config = {buffId = 1092, buffTier = 1}
...
bs_10239.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddSelfTrigger(eSkillTriggerType.AfterHurt, "bs_10239_3", 1, self.OnAfterHurt)
end

bs_10239.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg, isTriggerSet)
