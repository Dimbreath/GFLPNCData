...
local AvgCfg_cpt01_e_08_01 = {
    ...
    [17] = {
        imgTween = {{imgId = 102, duration = 0.5, pos = {400, -300, 0}}},
        content = 170,
        contentType = 3,
        speakerHeroId = -1,
        speakerHeroPosId = 3,
    ...
    [18] = {
        imgTween = {
            {imgId = 3, pos = {-200, -400, 0}, alpha = 0.2},
            {
                imgId = 3,
                duration = 0.5,
                pos = {-270, -400, 0},
    ...
    [24] = {
        ...
        speakerHeroId = 1003,
        speakerHeroPosId = 1,
        branch = {{content = 241, jumpAct = 25}, {content = 242, jumpAct = 27}}
    },
    [25] = {
        imgTween = {
            {imgId = 3, pos = {-345, -400, 0}, alpha = 0, isDark = false},
    ...
    [62] = {
        ...
        imgTween = {
            ...
            {imgId = 102, alpha = 0}, {imgId = 98, delay = 0.5, alpha = 1},
    ...
    [63] = {
        ...
        imgTween = {
            {imgId = 3, isDark = true},
            {imgId = 102, pos = {450, -300, 0}, alpha = 0.2, isDark = false},
            {
                imgId = 102,
                duration = 0.2,
                pos = {400, -300, 0},
