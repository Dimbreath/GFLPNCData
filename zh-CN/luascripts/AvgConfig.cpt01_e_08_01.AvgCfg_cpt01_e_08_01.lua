...
{imgId = 98, duration = 0.5, alpha = 1}
, 
{imgId = 3, delay = 0.5, duration = 0.2, alpha = 1}
}
...
local AvgCfg_cpt01_e_08_01 = {
    ...
    [10] = {
        imgTween = {{imgId = 3, duration = 0.5, alpha = 0}},
        content = 100,
        contentType = 2
    },
    [11] = {
    ...
    [12] = {
        imgTween = {
            {imgId = 1, posId = 1}, {imgId = 1, duration = 0.5, posId = 2},
            {imgId = 2, duration = 0.5, pos = {400, -190, 0}, isDark = true}
        },
        content = 120,
        contentType = 3,
        speakerHeroId = 1001,
    ...
    [16] = {
        imgTween = {
            {imgId = 3, posId = 2}, {imgId = 3, duration = 0.2, posId = 3}
        },
        audio = {sfx = {cue = "AVG_Combat_Hits", sheet = "AVG_gf"}},
        content = 160,
        contentType = 3,
        speakerHeroId = 1003,
        speakerHeroPosId = 2
    ...
    [19] = {
        imgTween = {
            {imgId = 3, alpha = 1}, {imgId = 3, duration = 0.3, shake = true},
            {imgId = 101, alpha = 0}
        },
    ...
    [27] = {
        imgTween = {{imgId = 1, duration = 0.5, alpha = 0}},
        audio = {sfx = {cue = "AVG_ElecSpace", sheet = "AVG_gf", audioId = 1}},
        content = 270,
        contentType = 4,
        speakerName = 271
    },
    ...
    [29] = {
        imgTween = {
            {imgId = 2, posId = 1}, {imgId = 2, duration = 0.5, posId = 2},
            {imgId = 101, duration = 0.5, posId = 4, isDark = true}
        },
        content = 290,
        contentType = 3,
    ...
    [30] = {
        imgTween = {{imgId = 2, alpha = 0}, {imgId = 101, alpha = 0}},
        content = 300,
        contentType = 2
    },
    [31] = {
    ...
    [38] = {
        imgTween = {
            {imgId = 1, posId = 1}, {imgId = 1, duration = 0.2, alpha = 1},
            {imgId = 101, duration = 0.2, alpha = 0}
        },
        content = 380,
        contentType = 3,
    ...
    [40] = {
        imgTween = {
            {imgId = 97, duration = 3, scale = {1, 1, 1}, pos = {0, 0, 0}}
        },
        audio = {
            sfx = {cue = "AVG_tele_disconnect", sheet = "AVG_gf", audioId = 1}
        },
