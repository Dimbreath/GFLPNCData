...
local UINBaseItemWithReceived = class("UINBaseItemWithReceived",
                                      UINBaseItemWithCount)
...
UINBaseItemWithReceived.InitItemWithCount =
    function(self, itemCfg, count, clickEvent, isPicked)
        -- function num : 0_1 , upvalues : base
        self:SetPickedUIActive(isPicked);
        (base.InitItemWithCount)(self, itemCfg, count, clickEvent)
    end

UINBaseItemWithReceived.SetPickedUIActive =
    function(self, isPicked)
        -- function num : 0_2
