...
UINOBUAccelerateNode.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).btn_Return, self, self.OnClickReturn)
    if (self.ui).btn_DoComplete ~= nil then
        (UIUtil.AddButtonListener)((self.ui).btn_DoComplete, self,
                                   self.OnClickConfirm)
    end
...
UINOBUAccelerateNode.UpdateWithData = function(self, currentLevl, nextLevel)
    ...
    ((self.ui).curLvlnum1).text = tostring(currentLevl // 10) -- DECOMPILER ERROR at PC11: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).curLvlnum2).text = tostring(currentLevl % 10) -- DECOMPILER ERROR at PC17: Confused about usage of register: R3 in 'UnsetPending'
    ;
