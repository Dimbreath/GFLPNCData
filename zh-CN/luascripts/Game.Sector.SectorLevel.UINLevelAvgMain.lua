...
UINLevelAvgMain.ShowBlueDotLAvgMain = function(self, show)
  -- function num : 0_4
...
UINLevelAvgMain.InitLAvgMain = function(self, avgCfg, arrangeCfg, clickEvent,
                                        resLoader)
    -- function num : 0_1 , upvalues : _ENV, verticalAnchor, horizontalAnchor
    self.avgCfg = avgCfg
    self.clickEvent = clickEvent -- DECOMPILER ERROR at PC4: Confused about usage of register: R5 in 'UnsetPending'
    ;
    ((self.ui).img_Pic).enabled = false
    resLoader:LoadABAssetAsync(PathConsts:GetAtlasAssetPath("SectorLevelIcon"),
        ...
        ((self.ui).img_Pic).sprite = spriteAtlas:GetSprite(avgCfg.pic) -- DECOMPILER ERROR at PC11: Confused about usage of register: R1 in 'UnsetPending'
        ;
        ((self.ui).img_Pic).enabled = true
    ...
    if arrangeCfg.vertical then
        (self.transform).anchorMin = verticalAnchor -- DECOMPILER ERROR at PC37: Confused about usage of register: R5 in 'UnsetPending'
        ;
        (self.transform).anchorMax = verticalAnchor
    else
        -- DECOMPILER ERROR at PC41: Confused about usage of register: R5 in 'UnsetPending'
        ...
        (self.transform).anchorMin = horizontalAnchor -- DECOMPILER ERROR at PC44: Confused about usage of register: R5 in 'UnsetPending'
        ;
        (self.transform).anchorMax = horizontalAnchor
...
UINLevelAvgMain.SelectedLAvgMain = function(self, select)
    ...
    if select then
        ...
        self.__selectFadeTween =
            ((((self.ui).ani_Select):DOFade(0, 1)):SetLoops(-1)):SetDelay(0.3)
    end
end
