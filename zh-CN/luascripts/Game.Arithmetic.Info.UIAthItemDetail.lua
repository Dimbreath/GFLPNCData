...
UIAthItemDetail.InitAthItem = function(self, color, height, space, athData,
                                       isEmptyArea)
    -- function num : 0_1 , upvalues : base, _ENV
    (base.InitAthItem)(self, color, height, space, athData) -- DECOMPILER ERROR at PC12: Confused about usage of register: R6 in 'UnsetPending'
    ;
