...
UINRandomBeforeBattlePassItem.SetJudgeIcon = function(self, careerId)
...
UINRandomBeforeBattlePassItem.InitPassItem = function(self, isPass)
  -- function num : 0_2
  self.isPass = isPass
  if isPass then
...
UINRandomBeforeBattlePassItem.LuckPass = function(self)
  -- function num : 0_3
...
UINRandomBeforeBattlePassItem.OnDelete = function(self)
