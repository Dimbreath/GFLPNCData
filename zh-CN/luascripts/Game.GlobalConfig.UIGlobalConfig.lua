...
-- function num : 0 , upvalues : _ENV
EUILayoutLevel = {
    "Bottom", "Normal", "Middle", "High", "OverHigh", "LowTop", "Top", "Msg",
    "Max"
}
EUILayoutLevel = CreatEnumTable(EUILayoutLevel, -1)
UIWindowTypeID = {
...
UIWindowGlobalConfig = {
    ...
    [UIWindowTypeID.Home] = {
        PrefabName = "UI_Home",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Home.UI.UIHome")
    },
    ...
    [UIWindowTypeID.TopStatus] = {
        PrefabName = "UI_TopStatus_Legacy",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.TopStatus.UITopStatus")
    },
    [UIWindowTypeID.Oasis] = {
        PrefabName = "UI_Oasis",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Oasis.UI.UIOasis")
    },
    [UIWindowTypeID.OasisEditWindow] = {
        PrefabName = "UI_OasisEditWindow",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Oasis.UI.UIOasisEditWindow")
    },
    [UIWindowTypeID.BuildingQueue] = {
        PrefabName = "UI_BuildingQueue",
        LayoutLevel = EUILayoutLevel.Bottom,
        WindowClass = require("Game.Oasis.UI.UIBuildingQueue")
    },
    ...
    [UIWindowTypeID.BossResult] = {
        PrefabName = "UI_BossResult",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.BattleResult.UIBossResult"),
    ...
    [UIWindowTypeID.SectorBuilding] = {
        PrefabName = "UI_STBuilding",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Sector.Building.UISectorBuilding"),
        AnimaType = EUIAnimaType.FadeScaleUp
    },
    ...
    [UIWindowTypeID.HeroState] = {
        ...
        AnimaType = EUIAnimaType.ScaleUp
    },
    ...
    [UIWindowTypeID.HeroLevelUpSuccess] = {
        ...
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require(
            "Game.Hero.NewUI.UpgradeLevel.UIHeroLevelUpSuccess")
    },
    ...
    [UIWindowTypeID.Training] = {
        PrefabName = "UI_HeroTraining_Obsolete",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Training.UITraining")
    },
    [UIWindowTypeID.TrainingState] = {
        PrefabName = "UI_HeroTrainingStateBox_Obsolete",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Training.TrainingState.UITrainingState")
    },
    [UIWindowTypeID.TrainingHeroList] = {
        PrefabName = "UI_HeroTrainingList_Obsolete",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Training.SelectHero.UITrainingHeroList")
    },
    [UIWindowTypeID.Shop] = {
        PrefabName = "UI_Shop",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Shop.UIShop"),
        AnimaType = EUIAnimaType.FadeScaleUp
    },
    [UIWindowTypeID.Task] = {
        PrefabName = "UI_Task",
    ...
    [UIWindowTypeID.ResetRoom] = {
        PrefabName = "UI_ResetRoom",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Exploration.UI.ResetRoom.UIResetRoom")
    },
    ...
    [UIWindowTypeID.EpChipDiscard] = {
        ...
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Exploration.UI.ChipDiscard.UIEpChipDiscard"),
        AnimaType = EUIAnimaType.FadeScaleUp
    },
    [UIWindowTypeID.GlobalChipDetail] = {
        PrefabName = "UI_GlobalPropItemDetail_Obsolete",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Exploration.UI.UIGlobalChipDetail")
    },
    [UIWindowTypeID.AddChipToHero] = {
        PrefabName = "UI_AddChipToHero_Obsolete",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Exploration.UI.ResetRoom.UIAddChipToHero")
    },
    [UIWindowTypeID.BattleDeploy] = {
        PrefabName = "UI_BattleDeploy",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Battle.UI.UIBattleDeploy")
    },
    [UIWindowTypeID.BattleRandomBeforeBattle] = {
        PrefabName = "UI_BattleRandomBeforeBattle",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Battle.UI.UINRandomBeforeBattle")
    },
    ...
    [UIWindowTypeID.Ath] = {
        PrefabName = "UI_ATH",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Arithmetic.UIATH")
    },
    ...
    [UIWindowTypeID.AthEfficiencyUpSuccess] = {
        PrefabName = "UI_ATHEfficiencyUpgradeSuccess",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require(
            "Game.Arithmetic.AthEfficiency.UIAthEfficiencyUpSuccess")
    },
    ...
    [UIWindowTypeID.AthStrengthen] = {
        PrefabName = "UI_ATHStrengthen",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Arithmetic.Strengthen.UIAthStrengthen"),
        AnimaType = EUIAnimaType.Fade
    },
    ...
    [UIWindowTypeID.HeroEnter] = {
        PrefabName = "UI_StationedDetail_Obsolete",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.HeroEnter.UIHeroEnterSelect")
    },
    [UIWindowTypeID.HeroEnterOverView] = {
        PrefabName = "UI_StationedOverviewBox_Obsolete",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.HeroEnter.UIHeroEnterOverView")
    },
    [UIWindowTypeID.Dorm] = {
        PrefabName = "UI_Dorm",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Dorm.UI.UIDorm")
    },
    [UIWindowTypeID.DormEdit] = {
        PrefabName = "UI_DormEdit",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Dorm.UI.UIDormEdit")
    },
    [UIWindowTypeID.DormRoomEdit] = {
        PrefabName = "UI_DormRoomEdit",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Dorm.UI.Room.UIDormRoomEdit")
    },
    [UIWindowTypeID.DormOverview] = {
        PrefabName = "UI_DormOverview",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Dorm.UI.UIDormOverview")
    },
    [UIWindowTypeID.DormOperate] = {
        PrefabName = "UI_DormOperate",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Dorm.UI.UIDormOperate")
    },
    [UIWindowTypeID.DormWarehouse] = {
        PrefabName = "UI_DormWarehouse",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Dorm.UI.SortList.UIDormWarehouse")
    },
    [UIWindowTypeID.DormShop] = {
        PrefabName = "UI_DormShop",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Dorm.UI.UIDormShop")
    },
    [UIWindowTypeID.DormRoomDetail] = {
        PrefabName = "UI_DormRoomDetail",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Dorm.UI.UIDormRoomDetail")
    },
    [UIWindowTypeID.DormFntDetail] = {
        PrefabName = "UI_DormFntDetail",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Dorm.UI.UIDormFntDetail")
    },
    [UIWindowTypeID.DormHeroEnter] = {
        PrefabName = "UI_DormHeroEnter",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Dorm.UI.UIDormHeroEnter")
    },
    [UIWindowTypeID.FriendShip] = {
        PrefabName = "UI_FriendshipSkillUpgrade",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require(
            "Game.Friendship.NewFriendshipUI.UIFriendshipSkillUpgrade")
    },
    [UIWindowTypeID.Avg] = {
    ...
    [UIWindowTypeID.SectorLevelDetail] = {
        ...
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require(
            "Game.Sector.SectorLevelDetail.UISectorLevelDetail")
    },
    [UIWindowTypeID.Sector] = {
        PrefabName = "UI_Sector",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Sector.UISector.UISector"),
        AnimaType = EUIAnimaType.Fade
    },
    [UIWindowTypeID.SectorTask] = {
        PrefabName = "UI_SectorTask",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Sector.SectorTask.New.UISectorTask"),
        AnimaType = EUIAnimaType.FadeScaleUp
    },
    [UIWindowTypeID.OverClock] = {
        PrefabName = "UI_Overclock",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Sector.Overclock.UIOverclock")
    },
    [UIWindowTypeID.CommanderSkill] = {
        PrefabName = "UI_CommanderSkill",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.CommanderSkill.UI.UICommanderSkill"),
        AnimaType = EUIAnimaType.FadeScaleUp
    },
    ...
    [UIWindowTypeID.DungeonFailureResult] = {
        ...
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require(
            "Game.BattleDungeon.UI.UIDungeonFailureResult_Temp")
    },
    ...
    [UIWindowTypeID.Formation] = {
        ...
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Formation.UI.UIFormation"),
        AnimaType = EUIAnimaType.Fade
    },
    [UIWindowTypeID.FmtHeroDetail] = {
        PrefabName = "UI_FormationHeroDetail",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Formation.UI.HeroDetail.UIFmtHeroDetail")
    },
    ...
    [UIWindowTypeID.CampBond] = {
        ...
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Formation.UI.CampBond.UICampBond")
    },
    [UIWindowTypeID.UICJResult] = {
        PrefabName = "UI_EpCJResult_Obsolete",
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.Exploration.UI.CJResult.UICJResult")
    },
    ...
    [UIWindowTypeID.DungeonInfoDetail] = {
        ...
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require(
            "Game.CommonUI.DungeonState.Info.UIDungeonInfoDetail")
    },
    ...
    [UIWindowTypeID.CommonCollectRes] = {
        PrefabName = "UI_CommonCollectRes",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.CommonUI.CollectRes.UICommonCollectRes")
    },
    ...
    [UIWindowTypeID.FactoryHerolist] = {
        PrefabName = "UI_FactorytHeroList",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require(
            "Game.Factory.UI.FactoryHeroList.UIFactoryHeroListCover")
    },
