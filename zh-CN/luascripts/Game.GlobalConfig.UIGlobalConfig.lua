...
UIWindowGlobalConfig = {
    ...
    [UIWindowTypeID.Home] = {
        PrefabName = "UI_Home_Legacy",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Home.UIHome")
    },
    [UIWindowTypeID.HomeSide] = {
        PrefabName = "UI_HomeSide",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Home.UIHomeSide")
    },
    ...
    [UIWindowTypeID.LotteryWindow] = {
        ...
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Lottery.UILottery")
    },
    ...
    [UIWindowTypeID.GetHero] = {
        ...
        LayoutLevel = EUILayoutLevel.High,
        WindowClass = require("Game.CommonUI.Hero.UIGetHero")
    },
    ...
    [UIWindowTypeID.Achievement] = {
        PrefabName = "UI_UserAchievement",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Achievement.UIAchievement")
    },
    ...
    [UIWindowTypeID.AthSlotUpgradeInfo] = {
        PrefabName = "UI_ATHBarLevelUp",
        LayoutLevel = EUILayoutLevel.Top,
        WindowClass = require(
            "Game.Arithmetic.SlotUpgrade.UIAthSlotUpgradeSuccess")
    },
    ...
    [UIWindowTypeID.FriendShip] = {
        PrefabName = "UI_HeroesFriendship",
        LayoutLevel = EUILayoutLevel.Normal,
        WindowClass = require("Game.Friendship.UIFriendship"),
        AnimaType = EUIAnimaType.FadeScaleUp
    },
    [UIWindowTypeID.Avg] = {
    ...
    [UIWindowTypeID.Formation] = {
        PrefabName = "UI_Formation_Legacy",
        LayoutLevel = EUILayoutLevel.Normal,
    ...
    [UIWindowTypeID.SelectBoardHero] = {
        PrefabName = "UI_SelectBoardHero",
        LayoutLevel = EUILayoutLevel.Middle,
        WindowClass = require("Game.Home.UISelectBoardHero"),
        AnimaType = EUIAnimaType.FadeScaleUp
    },
