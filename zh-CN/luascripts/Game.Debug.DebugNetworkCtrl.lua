...
DebugNetworkCtrl.InitNetwork = function(self)
    -- function num : 0_1 , upvalues : _ENV
    self:RegisterNetwork(proto_csmsg_MSG_ID.MSG_SC_HERO_Debug_Attr, self,
                         proto_csmsg.SC_HERO_Debug_Attr, self.SC_HERO_Debug_Attr)
end
...
DebugNetworkCtrl.CS_HERO_Debug_Attr = function(self, heroDic, callBack)
    ...
    (self.heroAttrTab).hero = heroDic
    self.__HERO_Debug_Attr_callBack = callBack
    self:SendMsg(proto_csmsg_MSG_ID.MSG_CS_HERO_Debug_Attr,
                 proto_csmsg.CS_HERO_Debug_Attr, self.heroAttrTab)
end
