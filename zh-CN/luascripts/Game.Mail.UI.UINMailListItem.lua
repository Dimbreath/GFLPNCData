...
UINMailListItem.SetSelect = function(self, bool)
  ...
  if not bool or not (Color.New)(0, 0, 0, 0.3) then
    local rewardColor = (Color.New)(1, 1, 1, 0.3)
  end
...
UINMailListItem.SetSelect = function(self, bool)
    ...
    if not bool or not (Color.New)(0, 0, 0, 0.3) then
        local rewardColor = (Color.New)(1, 1, 1, 0.3)
    end -- DECOMPILER ERROR at PC50: Confused about usage of register: R3 in 'UnsetPending'
