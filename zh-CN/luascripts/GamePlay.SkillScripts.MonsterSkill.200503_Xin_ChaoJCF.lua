...
bs_40004.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddSelfTrigger(eSkillTriggerType.SetHurt, "bs_40004_1", 100, self.OnSetHurt)
end

bs_40004.PlaySkill = function(self, data)
  -- function num : 0_2 , upvalues : _ENV
  LuaSkillCtrl:CallBuff(self, self.caster, (self.config).buffId196, 1, (self.arglist)[1] + 33)
...
bs_40004.OnSetHurt = function(self, context)
  ...
  if (self.caster):GetBuffTier((self.config).defBuffId) > 0 then
    ...
    context.hurt = 0
    LuaSkillCtrl:CallHeal(damageNum, self, self.caster, true)
  end
end
