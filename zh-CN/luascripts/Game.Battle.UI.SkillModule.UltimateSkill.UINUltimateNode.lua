...
UINUltimateNode.OnInit = function(self)
    ...
    self.mpParticleItem = (UIItemPool.New)(UINUltSkillMpParticleItem,
                                           (self.ui).mpParticleItem) -- DECOMPILER ERROR at PC51: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).focusMask).enabled = false
    self.maskMaterial = ((self.ui).focusMask).material -- DECOMPILER ERROR at PC58: Confused about usage of register: R1 in 'UnsetPending'
    ;
