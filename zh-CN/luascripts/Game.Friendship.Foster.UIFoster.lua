...
UIFoster.OnInit = function(self)
  ...
  MsgCenter:AddListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshFosterLines)
...
UIFoster.OnDelete = function(self)
  ...
  MsgCenter:RemoveListener(eMsgEventId.OnHeroIntimacyDataChange, self.__RefreshFosterLines)
