...
local UIOasisBuildingProductionItem = class("UIOasisBuildingProductionItem", UIBaseNode)
...
UIOasisBuildingProductionItem.UpdateInfo = function(self, id, rate, count, collectEvent)
...
UIOasisBuildingProductionItem.OnClick = function(self)
  -- function num : 0_2
  if self.collectEvent ~= nil then
    (self.collectEvent)(self.id)
  end
end
