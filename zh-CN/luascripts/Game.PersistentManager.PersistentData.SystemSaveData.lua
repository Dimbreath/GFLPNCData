...
SystemSaveData.InitBySaveData = function(self, data)
    ...
    if not data.audio then
        self.audio = {}
        if not data.display then self.display = {} end
    end
end

SystemSaveData.InitByDefaultData = function(self)
    -- function num : 0_1 , upvalues : _ENV
    self.audio = {} -- DECOMPILER ERROR at PC4: Confused about usage of register: R1 in 'UnsetPending'
    ;
    (self.audio).volumes = {} -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'
    ;
    (self.audio).mutes = {}
    for index = 1, AudioManager.AudioTypeCount do
        -- DECOMPILER ERROR at PC15: Confused about usage of register: R5 in 'UnsetPending'

        ((self.audio).volumes)[index] = 1 -- DECOMPILER ERROR at PC18: Confused about usage of register: R5 in 'UnsetPending'
        ;
        ((self.audio).mutes)[index] = false
    end
    self.display = {
