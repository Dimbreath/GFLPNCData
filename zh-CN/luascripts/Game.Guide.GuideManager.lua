...
GuideManager.TryTriggerGuide = function(self, condition_Type, taskList,
                                        lastGuideId)
    -- function num : 0_4 , upvalues : skipGuide, _ENV, GuideEnum, GuideConditionChecker, GuideManager
    ...
    for _, taskData in pairs(taskList) do
        if lastGuideId ~= nil and
            (table.contain)((taskData.stcData).guide_id, lastGuideId) then
    ...
    GuideManager:StartNewGuide(guideId)
    return true
end
...
GuideManager.TryStartTriggerTypeGuide = function(self, condition_Type)
    ...
    local guideDic = (self.__triggerGuideUnfinished)[condition_Type]
    if guideDic ~= nil then
        for guideId, sid in pairs(guideDic) do
...
GuideManager.StartNewGuide = function(self, id, endAction)
...
GuideManager.OnGuideTaskDelete = function(self, taskList)
    -- function num : 0_13 , upvalues : GuideManager, _ENV, GuideEnum, GuideType_Tips
