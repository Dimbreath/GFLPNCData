...
UINHeroSkillUpgradeInfo.RefreshNowSkillUI = function(self, isUpgrade)
  ...
  ;
  ((self.ui).now_tex_Descr).text = (self.skillData):GetColorLevelDescribe((self.skillData).level, "ff8400")
  ;
...
UINHeroSkillUpgradeInfo.RefreshNextSkillUI = function(self, isUpgrade)
  ...
  local nextLevelSkillData = (HeroSkillData.New)((self.skillData).dataId, (self.skillData).heroData)
  nextLevelSkillData:UpdateSkill((self.skillData).level + 1)
  -- DECOMPILER ERROR at PC43: Confused about usage of register: R3 in 'UnsetPending'

  if nextLevelSkillData.level <= 9 then
    ((self.ui).tex_NextLv).text = "0" .. tostring(nextLevelSkillData.level)
  else
  ...
  ;
  ((self.ui).next_tex_Lv).text = "LV" .. tostring(nextLevelSkillData.level)
  -- DECOMPILER ERROR at PC63: Confused about usage of register: R3 in 'UnsetPending'

  ;
  ((self.ui).next_tex_Name).text = nextLevelSkillData:GetName()
  -- DECOMPILER ERROR at PC70: Confused about usage of register: R3 in 'UnsetPending'

  ;
  ((self.ui).next_tex_Descr).text = nextLevelSkillData:GetColorLevelDescribe(nextLevelSkillData.level, "ff8400")
  ;
  (self.nextSkillItem):InitBaseSkillItem(nextLevelSkillData, self.resloader)
  if isUpgrade then
