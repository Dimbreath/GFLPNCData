...
bs_1004.config = {
hurt_config1 = {hit_formula = 0, basehurt_formula = 1051, crit_formula = 0, crithur_ratio = 0}
, 
hurt_config2 = {hit_formula = 0, def_formula = 0, basehurt_formula = 1066, crit_formula = 0, crithur_ratio = 0, correct_formula = 0}
, buffId = 0, buffTier = 0, buffDuration = 0}
