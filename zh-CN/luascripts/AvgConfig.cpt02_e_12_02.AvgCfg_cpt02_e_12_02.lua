...
, 
[4] = {content = 40, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 3}
, 
[5] = {content = 50, contentType = 2}
, 
[6] = {
imgTween = {
{imgId = 9, duration = 0.5, shake = true}
}
...
, content = 220, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 1}
, 
[23] = {
imgTween = {
{imgId = 5, isDark = true}
, 
{imgId = 112, isDark = false}
}
...
, content = 260, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 1}
, 
[27] = {
imgTween = {
{imgId = 5, isDark = true}
...
, content = 290, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 1}
, 
[30] = {
imgTween = {
{imgId = 5, isDark = true}
...
[42] = {
imgTween = {
{imgId = 112, duration = 0.1, alpha = 1}
, 
{imgId = 112, delay = 0.1, duration = 0.5, 
pos = {0, 0, 0}
, alpha = 1}
}
, content = 420, contentType = 3, speakerHeroId = -1, speakerHeroPosId = 2}
}
return AvgCfg_cpt02_e_12_02
