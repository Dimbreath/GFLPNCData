...
local HomeSideNoticeData = class("HomeSideNoticeData")
local HomeEnum = require("Game.Home.HomeEnum")
HomeSideNoticeData.CreateNoticeData = function(timeStamp, type, noticeStr,
                                               jumpInfo, noticeStrList, extrId)
    -- function num : 0_0 , upvalues : HomeSideNoticeData, _ENV
    local NoticeData = (HomeSideNoticeData.New)()
    NoticeData:InitNoticeData(timeStamp, type, noticeStr, jumpInfo,
                              noticeStrList, extrData)
    return NoticeData
end
...
HomeSideNoticeData.InitNoticeData = function(self, timeStamp, type, jumpInfo,
...
HomeSideNoticeData.GetNoticeStr = function(self)
    -- function num : 0_3 , upvalues : _ENV
    if self.noticeStrList ~= nil then
        return (string.format)((LanguageUtil.GetLocaleText)(
                                   ((ConfigData.homeside_info)[self.type]).describe),
                               (table.unpack)(self.noticeStrList))
    else
