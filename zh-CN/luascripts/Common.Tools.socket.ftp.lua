...
_M.open = function(server, port, create)
    ...
    local tp = (socket.try)((tp.connect)(server, port or PORT, _M.TIMEOUT,
                                         create))
    ...
    return f
end -- DECOMPILER ERROR at PC36: Confused about usage of register: R11 in 'UnsetPending'
;
...
end -- DECOMPILER ERROR at PC39: Confused about usage of register: R11 in 'UnsetPending'
;
...
end -- DECOMPILER ERROR at PC42: Confused about usage of register: R11 in 'UnsetPending'
;
...
end -- DECOMPILER ERROR at PC45: Confused about usage of register: R11 in 'UnsetPending'
;
...
end -- DECOMPILER ERROR at PC48: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).epsv = function(self)
    ...
    return (self.pasvt).address, (self.pasvt).port
end -- DECOMPILER ERROR at PC51: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).port = function(self, address, port)
    ...
    (self.try)((self.tp):check("2.."))
    return 1
end -- DECOMPILER ERROR at PC54: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).eprt = function(self, family, address, port)
    ...
    (self.try)((self.tp):check("2.."))
    return 1
end -- DECOMPILER ERROR at PC57: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).send = function(self, sendt)
    ...
    if not self.pasvt then
        ...
        if not sendt.path then
            local argument = (url.unescape)(
                                 (string.gsub)(sendt.argument or "", "^[/\\]",
                                               ""))
            ...
            if not sendt.step then local step = (ltn12.pump).step end
            local readt = {self.tp}
...
end -- DECOMPILER ERROR at PC60: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).receive = function(self, recvt)
    ...
    if not self.pasvt then
        ...
        if not recvt.path then
            ...
            if not recvt.step then local step = (ltn12.pump).step end
...
end -- DECOMPILER ERROR at PC63: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).cwd = function(self, dir)
    ...
    return 1
end -- DECOMPILER ERROR at PC66: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).type = function(self, type)
    ...
    return 1
end -- DECOMPILER ERROR at PC69: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).greet = function(self)
    ...
    return 1
end -- DECOMPILER ERROR at PC72: Confused about usage of register: R11 in 'UnsetPending'
;
(metat.__index).quit = function(self)
    ...
    (self.try)((self.tp):check("2.."))
    return 1
end -- DECOMPILER ERROR at PC75: Confused about usage of register: R11 in 'UnsetPending'
;
...
_M.command = (socket.protect)(function(cmdt)
    ...
    if type(cmdt.command) == "table" then
        if not cmdt.argument then local argument = {} end
        if not cmdt.check then local check = {} end
