...
local UINAthEfficiencyOneKeyFiltrate = class("UINAthEfficiencyOneKeyFiltrate", UIBaseNode)
local base = UIBaseNode
local UINAthEfccOneKeyFiltItem = require("Game.Arithmetic.AthEfficiency.UINAthEfccOneKeyFiltItem")
local eAthEfccAutoSelectType = require("Game.Arithmetic.Enum.eAthEfccAutoSelectType")
UINAthEfficiencyOneKeyFiltrate.OnInit = function(self)
  ...
  self.filtItemPool = (UIItemPool.New)(UINAthEfccOneKeyFiltItem, (self.ui).obj_kindItem)
  self.filtItemDic = {}
  self.selectDic = {}
end

UINAthEfficiencyOneKeyFiltrate.InitAthEfccOneKeyFilt = function(self, confirmFunc)
  ...
  for k,v in ipairs(eAthEfccAutoSelectType) do
    ...
    filteItem:InitAthEfccOneKeyFiltItem(v, self.__OnSelectFilt, (self.selectDic)[v])
...
UINAthEfficiencyOneKeyFiltrate.OnSelectFilt = function(self, index, select)
  -- function num : 0_2
...
UINAthEfficiencyOneKeyFiltrate.__OnConfirmClick = function(self)
  -- function num : 0_3
...
UINAthEfficiencyOneKeyFiltrate.__OnResetClick = function(self)
  -- function num : 0_4 , upvalues : _ENV
  self.selectDic = {}
  for k,v in pairs(self.filtItemDic) do
    v:InitAthEfccOneKeyFiltItem(k, self.__OnSelectFilt, (self.selectDic)[k])
  end
end

UINAthEfficiencyOneKeyFiltrate.__OnClickClose = function(self)
  -- function num : 0_5
  self:Hide()
end

UINAthEfficiencyOneKeyFiltrate.OnDelete = function(self)
