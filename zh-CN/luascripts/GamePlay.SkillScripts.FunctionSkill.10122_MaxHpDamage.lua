...
bs_10122.config = {hurt_config = {basehurt_formula = 10006}, effectId = 1002}
...
bs_10122.InitSkill = function(self, isMidwaySkill)
    ...
    self:AddTrigger(eSkillTriggerType.AfterHurt, "bs_10122_1", 1,
                    self.OnAfterHurt)
end

bs_10122.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss,
                                isCrit, isRealDmg)
