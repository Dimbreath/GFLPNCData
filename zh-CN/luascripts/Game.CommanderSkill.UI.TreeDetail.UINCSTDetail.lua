...
local UINCSTDetail_SkillNode = require("Game.CommanderSkill.UI.TreeDetail.UINCSTDetail_SkillNode")
local MasterGroup = require("Game.CommanderSkill.UI.TreeDetail.UINCSTDetail_MasterGroup")
UINCSTDetail.OnInit = function(self)
  ...
  ;
  (UIUtil.AddValueChangedListener)((self.ui).tog_SkillPage, self, self.SkillPageTogChange)
  ;
  (UIUtil.AddValueChangedListener)((self.ui).tog_MasterPage, self, self.MasterPageTogChange)
  ;
  ...
  self.MasterGroupPool = (UIItemPool.New)(MasterGroup, (self.ui).obj_skillGroupItem)
end
...
UINCSTDetail.SkillPageTogChange = function(self, bool)
  ...
  if bool then
    (self.skillNode):Show()
    ;
    ((self.ui).obj_SkillTogOnSelect):SetActive(true)
    ...
    (self.skillNode):Hide()
    ;
    ((self.ui).obj_SkillTogOnSelect):SetActive(false)
...
UINCSTDetail.MasterPageTogChange = function(self, bool)
  ...
  if bool then
    ...
    ;
    ((self.ui).obj_MasterTogOnSelect):SetActive(true)
    ...
    ;
    ((self.ui).obj_MasterTogOnSelect):SetActive(false)
