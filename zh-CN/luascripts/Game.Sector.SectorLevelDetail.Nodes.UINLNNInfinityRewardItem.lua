...
UINLNNInfinityRewardItem.InitReardItem =
    function(self, itemId, Num)
        ...
        if itemCfg == nil then
            ...
            self:Hide()
            return
        end -- DECOMPILER ERROR at PC21: Confused about usage of register: R4 in 'UnsetPending'
        
        ((self.ui).img_Icon).sprite = CRH:GetSprite(itemCfg.small_icon) -- DECOMPILER ERROR at PC27: Confused about usage of register: R4 in 'UnsetPending'
        ;
