...
UINHeroCardItem.InitHeroHeroData = function(self, heroData, resloader, selectFunc)
  -- function num : 0_1
...
UINHeroCardItem.RefreshHeroHeroData = function(self)
  ...
  self:SetStarUI((self.heroData).star)
  ...
  ;
  ((self.ui).tex_Level).text = "LV.<Size=20>" .. tostring((self.heroData).level) .. "</Size>"
  -- DECOMPILER ERROR at PC30: Confused about usage of register: R1 in 'UnsetPending'

  ;
  ((self.ui).img_Color).color = HeroRareColor[(self.heroData).rare]
  ...
  if self.freshTexture then
    ...
    ;
    (self.resloader):LoadABAssetAsync(PathConsts:GetCharacterPicPath((self.heroData):GetResName()), function(texture)
