...
UINHeroAttrItem.InitHeroAttrItem = function(self, attrId, attrValue)
    -- function num : 0_1 , upvalues : _ENV
    local name, valueStr, icon = ConfigData:GetAttribute(attrId, attrValue) -- DECOMPILER ERROR at PC11: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).img_Icon).sprite = CRH:GetSprite(icon) -- DECOMPILER ERROR at PC14: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).tex_attrName).text = name -- DECOMPILER ERROR at PC17: Confused about usage of register: R6 in 'UnsetPending'
    ;
    ((self.ui).tex_Num).text = valueStr
end
