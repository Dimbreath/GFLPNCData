...
UINAvgRecord.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).btn_Buttom, self, self.OnClickBtnButtom) -- DECOMPILER ERROR at PC18: Confused about usage of register: R1 in 'UnsetPending'
    ;
...
UINAvgRecord.ShowAcgRecord = function(self, recordDataList)
    -- function num : 0_2
    if recordDataList == nil then return end
    self:Show()
    self.recordDataList = recordDataList -- DECOMPILER ERROR at PC8: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.ui).scrollRect).verticalNormalizedPosition = 0 -- DECOMPILER ERROR at PC13: Confused about usage of register: R2 in 'UnsetPending'
    ;
...
UINAvgRecord.__OnChangeItem = function(self, go, index)
    ...
    if recordData == nil then
        error("Can\'t find recordData by index, index = " .. tonumber(index))
        return
    end
