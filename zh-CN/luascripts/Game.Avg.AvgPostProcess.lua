...
AvgPostProcess.InitAvgPP = function(self, ppProfile)
    ...
    local ok, ppColorGrading = (ppVolume.profile):TryGetSettings(
                                   typeof(CS_ppColorGrading))
    if ok then
...
AvgPostProcess.ChangeAvgPP = function(self, ppCfg)
    ...
    if colorGradient ~= nil and colorGradient.saturation ~= nil then
        ...
        end, colorGradient.saturation, tweenDuration) -- DECOMPILER ERROR at PC25: Confused about usage of register: R4 in 'UnsetPending'
        ;
