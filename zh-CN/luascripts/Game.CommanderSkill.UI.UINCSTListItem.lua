...
UINCSTListItem.OnInit = function(self)
  ...
  ;
  (UIUtil.AddValueChangedListener)((self.ui).tog_skillTreeItem, self, self.OnValueChange)
  self.__RefreshTreeActiveSkill = BindCallback(self, self.RefreshTreeActiveSkill)
  MsgCenter:AddListener(eMsgEventId.OnCommanderSkillOverLoad, self.__RefreshTreeActiveSkill)
end
...
UINCSTListItem.RefreshListItem = function(self, treeData)
  ...
  if not treeData.isUnlock then
    treeData:TryToUnlock()
  end
...
UINCSTListItem.RefreshTreeActiveSkill = function(self)
  ...
  for index,image in ipairs((self.ui).array_skillImg) do
    ...
    image.sprite = spriteAtlas:GetSprite(skillData:GetIcon())
  end
)
      end
    end
...
UINCSTListItem.SetColor = function(self)
  -- function num : 0_7
  self.color = (self.treeData):GetColor()
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'

  ;
  ((self.ui).img_UnSelect).color = self.color
  -- DECOMPILER ERROR at PC11: Confused about usage of register: R1 in 'UnsetPending'

  ;
  ((self.ui).img_LineColor).color = self.color
...
UINCSTListItem.SetIcon = function(self)
  ...
  (self.resloader):LoadABAssetAsync(PathConsts:GetAtlasAssetPath("CommanderSkillIcons"), function(spriteAtlas)
    ...
    ;
    ((self.ui).img_Icon).sprite = spriteAtlas:GetSprite((self.treeData):GetIcon())
  end
)
end

UINCSTListItem.RefreshRedDot = function(self)
  -- function num : 0_9
  ((self.ui).obj_RedDot):SetActive((self.treeData):CanThisTreeUpgrade())
end

UINCSTListItem.OnDelete = function(self)
  -- function num : 0_10 , upvalues : _ENV, base
  MsgCenter:RemoveListener(eMsgEventId.OnCommanderSkillOverLoad, self.__RefreshTreeActiveSkill)
  ;
  (base.OnDelete)(self)
end
