...
local UpdateHandle = function(self)
    ...
    for timer, _ in pairs(self.__update_timer) do timer:Update(false) end
    DelayRecycle(self, self.__update_timer)
end

local LateUpdateHandle = function(self)
    -- function num : 0_3 , upvalues : _ENV, DelayRecycle
    for timer, _ in pairs(self.__lateupdate_timer) do timer:Update(false) end
    DelayRecycle(self, self.__lateupdate_timer)
    for timer, _ in pairs(self.__update_toadd) do
        -- DECOMPILER ERROR at PC18: Confused about usage of register: R6 in 'UnsetPending'

        (self.__update_timer)[timer] = true -- DECOMPILER ERROR at PC20: Confused about usage of register: R6 in 'UnsetPending'
        ;
    ...
    for timer, _ in pairs(self.__lateupdate_toadd) do
        ...
        (self.__lateupdate_timer)[timer] = true -- DECOMPILER ERROR at PC30: Confused about usage of register: R6 in 'UnsetPending'
        ;
...
local FixedUpdateHandle = function(self)
    ...
    for timer, _ in pairs(self.__fixedupdate_timer) do timer:Update(true) end
    DelayRecycle(self, self.__fixedupdate_timer)
    for timer, _ in pairs(self.__fixedupdate_toadd) do
        -- DECOMPILER ERROR at PC18: Confused about usage of register: R6 in 'UnsetPending'

        (self.__fixedupdate_timer)[timer] = true -- DECOMPILER ERROR at PC20: Confused about usage of register: R6 in 'UnsetPending'
        ;
...
local InnerGetTimer = function(self, delay, func, obj, one_shot, use_frame,
                               unscaled)
...
TimerManager.GetTimer = function(self, delay, func, obj, one_shot, use_frame,
                                 unscaled)
    -- function num : 0_9 , upvalues : _ENV, InnerGetTimer
    assert((not (self.__update_timer)[timer] and
               not (self.__update_toadd)[timer]))
    local timer = InnerGetTimer(self, delay, func, obj, one_shot, use_frame,
                                unscaled) -- DECOMPILER ERROR at PC24: Confused about usage of register: R8 in 'UnsetPending'
    ;
...
TimerManager.GetLateTimer = function(self, delay, func, obj, one_shot,
                                     use_frame, unscaled)
    -- function num : 0_10 , upvalues : _ENV, InnerGetTimer
    assert((not (self.__lateupdate_timer)[timer] and
               not (self.__lateupdate_toadd)[timer]))
    local timer = InnerGetTimer(self, delay, func, obj, one_shot, use_frame,
                                unscaled) -- DECOMPILER ERROR at PC24: Confused about usage of register: R8 in 'UnsetPending'
    ;
...
TimerManager.GetFixedTimer = function(self, delay, func, obj, one_shot,
                                      use_frame)
    -- function num : 0_11 , upvalues : _ENV, InnerGetTimer
    assert((not (self.__fixedupdate_timer)[timer] and
               not (self.__fixedupdate_toadd)[timer]))
    local timer = InnerGetTimer(self, delay, func, obj, one_shot, use_frame,
                                false) -- DECOMPILER ERROR at PC24: Confused about usage of register: R7 in 'UnsetPending'
    ;
