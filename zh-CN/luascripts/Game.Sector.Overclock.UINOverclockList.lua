...
local UINOverclockListItem = require(
                                 "Game.Sector.Overclock.UINOverclockListItem")
UINOverclockList.OnInit = function(self)
    ...
    self.itemDic = {}
    self.itemDataList = {} -- DECOMPILER ERROR at PC23: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).overclockList).onInstantiateItem =
        BindCallback(self, self.__OnNewItem) -- DECOMPILER ERROR at PC30: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).overclockList).onChangeItem =
...
UINOverclockList.InitList = function(self, unlockDatas, itemClickCallBack)
    ...
    local num = #self.itemDataList -- DECOMPILER ERROR at PC26: Confused about usage of register: R4 in 'UnsetPending'
    ;
...
UINOverclockList.__OnNewItem = function(self, go)
    ...
    item:Init(go)
    item:BindCallBacks(self.itemClickCallBack) -- DECOMPILER ERROR at PC9: Confused about usage of register: R3 in 'UnsetPending'
    ;
