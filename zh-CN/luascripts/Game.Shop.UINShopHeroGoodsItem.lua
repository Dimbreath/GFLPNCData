...
UINShopHeroGoodsItem.InitNormalGoodsItem =
    function(self, goodData)
        ...
        if heroCfg == nil then
            error("heroCfg null,id:" .. tostring((goodData.goodCfg).hero))
            return
        end -- DECOMPILER ERROR at PC23: Confused about usage of register: R3 in 'UnsetPending'
        ...
        (self.resloader):LoadABAssetAsync(
            PathConsts:GetCharacterPicPath(resCfg.res_Name), function(texture)
                -- function num : 0_2_0 , upvalues : _ENV, self
        ...
        (self.resloader):LoadABAssetAsync(
            PathConsts:GetCampPicPath((LanguageUtil.GetLocaleText)(campCfg.icon)),
            function(texture)
                -- function num : 0_2_1 , upvalues : _ENV, self
                if IsNull(self.transform) then return end -- DECOMPILER ERROR at PC8: Confused about usage of register: R1 in 'UnsetPending'
...
UINShopHeroGoodsItem.RefreshCurrencyUI =
    function(self, goodData)
        -- function num : 0_3 , upvalues : _ENV
        -- DECOMPILER ERROR at PC3: Confused about usage of register: R2 in 'UnsetPending'
