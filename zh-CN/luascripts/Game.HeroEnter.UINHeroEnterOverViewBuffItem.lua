...
local valueFuncTable = {[eBuildingLogic.ResourceLimit] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  ;
  ((theSelf.ui).tex_BuildAdd):SetIndex(eBuildingLogic.ResourceLimit, itemName, temp)
end
, [eBuildingLogic.ResourceOutput] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  ;
  ((theSelf.ui).tex_BuildAdd):SetIndex(eBuildingLogic.ResourceOutput, itemName, temp)
end
, [eBuildingLogic.CampBuff] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  ;
  ((theSelf.ui).tex_BuildAdd):SetIndex(eBuildingLogic.CampBuff, campName, temp)
end
, [eBuildingLogic.CareerBuff] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  local temp = attrName .. "+" .. (math.floor)(attrValue * heroScoreRate)
  ;
  ((theSelf.ui).tex_BuildAdd):SetIndex(eBuildingLogic.CareerBuff, careerName, temp)
end
...
, [eBuildingLogic.GlobalExpCeiling] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  ;
  ((theSelf.ui).tex_BuildAdd):SetIndex(eBuildingLogic.GlobalExpCeiling, temp)
end
...
, [eBuildingLogic.ResOutputEfficiency] = function(heroScoreRate, newHreoScoreRate, theSelf)
  ...
  do
    ...
    ;
    ((theSelf.ui).tex_BuildAdd):SetIndex(eBuildingLogic.ResOutputEfficiency, itemName, temp)
  end
end
