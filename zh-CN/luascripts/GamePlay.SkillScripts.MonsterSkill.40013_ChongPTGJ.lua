...
, effectId = 10099, buffId = 66, buffTier = 1, buffDuration = 30, startAnimID = 1004, audioId1 = 25}
...
bs_40013.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddTrigger(eSkillTriggerType.BeforePlaySkill, "bs_40013_1", 1, self.OnBeforePlaySkill)
end

bs_40013.OnBeforePlaySkill = function(self, role, context)
  -- function num : 0_2 , upvalues : _ENV
  if (context.skill).maker == self.caster and (context.skill).dataId == 503 and LuaSkillCtrl:CallRange(1, 100) < (self.arglist)[1] then
    ...
    do
      ...
      if LuaSkillCtrl:IsAbleAttackTarget(self.caster, targetRole, 1) then
        ...
        LuaSkillCtrl:CallRoleActionWithTrigger(self, self.caster, (self.config).startAnimID, 1, 13, attackTrigger)
        ;
...
bs_40013.OnAttackTrigger = function(self, target, data)
  ...
  LuaSkillCtrl:HurtResult(skillResult1, (self.config).hurt_config1)
