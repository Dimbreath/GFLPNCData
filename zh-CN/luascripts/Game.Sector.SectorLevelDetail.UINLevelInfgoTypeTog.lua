...
UINLevelInfgoTypeTog.InitTog = function(self, infoNodeTypeId, isLast,
                                        openNodeCallback)
    -- function num : 0_1
    self.infoNodeTypeId = infoNodeTypeId;
    ((self.ui).texInfo_Name):SetIndex(infoNodeTypeId);
...
UINLevelInfgoTypeTog.OnValueChage = function(self, bool)
    ...
    if bool then
        ((self.ui).img_tog_Type).color = (self.ui).color_white -- DECOMPILER ERROR at PC11: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.ui).tex_Name).color = (self.ui).color_black
        if self.openNodeCallback ~= nil then (self.openNodeCallback)() end
    else
        -- DECOMPILER ERROR at PC22: Confused about usage of register: R2 in 'UnsetPending'


        ((self.ui).img_tog_Type).color = (self.ui).color_black -- DECOMPILER ERROR at PC27: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.ui).tex_Name).color = (self.ui).color_white
    end
    if self.colorCallback ~= nil then
