...
UnlockFunc.onUnlockTaskUI = function(self)
    ...
    if uiHome ~= nil then uiHome:OnTaskUIUnlock(true) end
end
...
UnlockFunc.onUnlockShop = function(self)
    ...
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnShopUnlock(true) end
...
UnlockFunc.onUnlockOasis = function(self)
    ...
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnOasisUnlock(true) end
end

UnlockFunc.onUnlockSector = function(self)
    -- function num : 0_4 , upvalues : _ENV
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnSectorUnlock(true) end
end

UnlockFunc.onUnlockHeroList = function(self)
    -- function num : 0_5 , upvalues : _ENV
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnHeroListUnlock(true) end
end

UnlockFunc.onUnlockLottery = function(self)
    -- function num : 0_6 , upvalues : _ENV
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnLotteryUnlock(true) end
end

UnlockFunc.onUnlockFactory = function(self)
    -- function num : 0_7 , upvalues : _ENV
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnFactoryUnlock(true) end
end

UnlockFunc.onUnlockTraining = function(self)
    -- function num : 0_8 , upvalues : _ENV
    local uiHome = UIManager:GetWindow(UIWindowTypeID.HomeSide)
    if uiHome ~= nil then uiHome:OnTrainingUnlock(true) end
end

UnlockFunc.onUnlockSocial = function(self)
    -- function num : 0_9 , upvalues : _ENV
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnSocialUnlock(true) end
end
...
UnlockFunc.onUnlockHeroEnter = function(self)
    ...
    if uiFactory ~= nil then uiFactory:OnStaffInfoUnlock(true) end
end
...
UnlockFunc.onUnlockDorm = function(self, self)
    ...
    local uiHome = UIManager:GetWindow(UIWindowTypeID.Home)
    if uiHome ~= nil then uiHome:OnDormUnlock(true) end
end
