    ...
    for fmtIndex, go in ipairs((self.ui).platform) do
        ...
        do
            ...
            do
                ...
                plat:Init(go)
                plat:InitFmtPlatform(fmtIndex, isBench, lockStr) -- DECOMPILER ERROR at PC60: Confused about usage of register: R11 in 'UnsetPending'
                ;
...
UIN3DFormation.OpenOverClock = function(self, isOpen)
    ...
    if isOpen then
        ...
        (UIUtil.AddButtonListener)((self.ui).btn_overLock, self,
...
UIN3DFormation.Init3DFormation = function(self, startBattleFunc, sectorStageId,
                                          fromModule)
    -- function num : 0_3
...
UIN3DFormation.Refresh3DFmt = function(self, formationData)
    ...
    end -- DECOMPILER ERROR at PC37: Confused about usage of register: R4 in 'UnsetPending'
...
UIN3DFormation.OnClickStartBattle = function(self)
    -- function num : 0_9
    if self.startBattleFunc ~= nil then (self.startBattleFunc)() end
end
...
UIN3DFormation.RefreshOverClockUI = function(self)
    ...
    for _, obj in ipairs(self.countItemList) do obj:SetActive(false) end
