...
ArithmeticNetwork.InitNetwork = function(self)
    ...
    self:RegisterNetwork(proto_csmsg_MSG_ID.MSG_SC_ATH_AthInherit, self,
                         proto_csmsg.SC_ATH_AthInherit, self.SC_ATH_AthInherit)
...
ArithmeticNetwork.CS_ATH_AthRefillOp = function(self, heroId, slotIdx, uid,
    ...
    (self.__athInstallTab).heroId = heroId -- DECOMPILER ERROR at PC3: Confused about usage of register: R8 in 'UnsetPending'
    ;
    (self.__athInstallTab).slotIdx = slotIdx -- DECOMPILER ERROR at PC5: Confused about usage of register: R8 in 'UnsetPending'
    ;
    (self.__athInstallTab).uid = uid -- DECOMPILER ERROR at PC7: Confused about usage of register: R8 in 'UnsetPending'
    ;
    (self.__athInstallTab).gridId = gridId -- DECOMPILER ERROR at PC9: Confused about usage of register: R8 in 'UnsetPending'
    ;
    (self.__athInstallTab).oldMove = oldMove -- DECOMPILER ERROR at PC11: Confused about usage of register: R8 in 'UnsetPending'
    ;
...
ArithmeticNetwork.CS_ATH_Move = function(self, uid, gridId, callBack)
    ...
    (self.__athMoveTab).uid = uid -- DECOMPILER ERROR at PC3: Confused about usage of register: R4 in 'UnsetPending'
    ;
...
ArithmeticNetwork.CS_ATH_SlotUpgrade = function(self, heroId, itemDic, athDic,
    ...
    (self.__slotUpdateTab).heroId = heroId -- DECOMPILER ERROR at PC3: Confused about usage of register: R5 in 'UnsetPending'
    ;
    (self.__slotUpdateTab).item = itemDic -- DECOMPILER ERROR at PC5: Confused about usage of register: R5 in 'UnsetPending'
    ;
...
ArithmeticNetwork.CS_ATH_AthOptimize = function(self, uid, idx, sect, callBack)
    ...
    (self.__athOptimizeTab).uid = uid -- DECOMPILER ERROR at PC3: Confused about usage of register: R5 in 'UnsetPending'
    ;
    (self.__athOptimizeTab).idx = idx -- DECOMPILER ERROR at PC5: Confused about usage of register: R5 in 'UnsetPending'
    ;
...
ArithmeticNetwork.CS_ATH_AthInherit = function(self, uidFrom, uidTo, idxFrom,
                                               idxTo, callBack)
    ...
    (self.__athInheritTab).from = uidFrom -- DECOMPILER ERROR at PC3: Confused about usage of register: R6 in 'UnsetPending'
    ;
    (self.__athInheritTab).to = uidTo -- DECOMPILER ERROR at PC5: Confused about usage of register: R6 in 'UnsetPending'
    ;
    (self.__athInheritTab).fromIdx = idxFrom -- DECOMPILER ERROR at PC7: Confused about usage of register: R6 in 'UnsetPending'
    ;
    (self.__athInheritTab).toIdx = idxTo
    self:SendMsg(proto_csmsg_MSG_ID.MSG_CS_ATH_AthInherit,
                 proto_csmsg.CS_ATH_AthInherit, self.__athInheritTab)
    cs_WaitNetworkResponse:StartWait(proto_csmsg_MSG_ID.MSG_CS_ATH_AthInherit,
                                     callBack,
                                     proto_csmsg_MSG_ID.MSG_SC_ATH_AthInherit,
                                     proto_csmsg_MSG_ID.MSG_SC_ATH_SyncUpdateDiff)
end
...
ArithmeticNetwork.SC_ATH_AthInherit = function(self, msg)
    ...
    if msg.ret ~= proto_csmsg_ErrorCode.None then
        ...
        if isGameDev then (cs_MessageCommon.ShowMessageTips)(err) end
        cs_WaitNetworkResponse:RemoveWait(
            proto_csmsg_MSG_ID.MSG_CS_ATH_AthInherit)
    end
end
...
ArithmeticNetwork.CS_ATH_OneKeyInstall =
    function(self, heroId, slotId, athGroupDic, callBack)
        ...
        (self.__oneKeyInstallTab).heroId = heroId -- DECOMPILER ERROR at PC3: Confused about usage of register: R5 in 'UnsetPending'
        ;
        (self.__oneKeyInstallTab).slotId = slotId -- DECOMPILER ERROR at PC5: Confused about usage of register: R5 in 'UnsetPending'
        ;
...
ArithmeticNetwork.CS_ATH_OneKeyUninstall =
    function(self, heroId, slotId, callBack)
        ...
        (self.__onekeyUninstallTab).heroId = heroId -- DECOMPILER ERROR at PC3: Confused about usage of register: R4 in 'UnsetPending'
        ;
