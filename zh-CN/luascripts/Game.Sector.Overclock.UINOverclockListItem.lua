...
UINOverclockListItem.OnInit = function(self)
    ...
    if itemCfg == nil then
        error("Can\'t find itemCfg by Id:" .. tostring(GameDefine.ItemIdOfG))
    end -- DECOMPILER ERROR at PC87: Confused about usage of register: R2 in 'UnsetPending'
...
UINOverclockListItem.__RefreshInfo = function(self)
    ...
    end -- DECOMPILER ERROR at PC59: Confused about usage of register: R5 in 'UnsetPending'
    
    ((self.ui).tex_Name).text = (LanguageUtil.GetLocaleText)(
                                    overclockLevelCfg.name) -- DECOMPILER ERROR at PC66: Confused about usage of register: R5 in 'UnsetPending'
    ;
...
UINOverclockListItem.__GetOverclockLevel =
    function(self)
        ...
        if BuildingData == nil then
            ...
            for index, logic in pairs(buildingLevelCfg.logic) do
                if logic == eLogicType.OverClock and
