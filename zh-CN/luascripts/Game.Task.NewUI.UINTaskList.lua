...
UINTaskList.RefreshTaskItems = function(self, TaskDataList, needSort)
    ...
    local num = #self.dataList -- DECOMPILER ERROR at PC24: Confused about usage of register: R4 in 'UnsetPending'
    ;
...
UINTaskList.__OnChangeItem = function(self, go, index)
    ...
    end -- DECOMPILER ERROR at PC26: Confused about usage of register: R5 in 'UnsetPending'
