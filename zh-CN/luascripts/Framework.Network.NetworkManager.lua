...
NetworkManager.ctor = function(self)
    -- function num : 0_1 , upvalues : _ENV, UpdateHandle, cs_NetworkManager
...
NetworkManager.InitNetwork = function(self)
    ...
    for k, v in pairs(NetworkTypeID) do
        ...
        local network = ((config.NetworkClass).New)() -- DECOMPILER ERROR at PC32: Confused about usage of register: R9 in 'UnsetPending'
        ;
...
NetworkManager.RegisterListener = function(self, cmdId, func)
    ...
    if (self.__msgEventTable)[cmdId] ~= nil then
        ...
        return
    end -- DECOMPILER ERROR at PC14: Confused about usage of register: R3 in 'UnsetPending'
...
NetworkManager.ResetAllNetwork = function(self)
    ...
    for k, v in pairs(self.__network_ctrls) do v:Reset() end
end

NetworkManager.Delete = function(self)
    -- function num : 0_9 , upvalues : _ENV, cs_NetworkManager
    for k, v in pairs(self.__network_ctrls) do v:OnDelete() end
