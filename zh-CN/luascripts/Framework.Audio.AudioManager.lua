...
local CS_AudioManager = (CS.AudioManager).Instance
AudioManager.AudioTypeCount = 3
AudioManager.PlayAudio = function(self, cueName, cueSheetName, sourceType,
                                  completeEvent, ignoreSameBgm)
    -- function num : 0_0 , upvalues : CS_AudioManager
    if ignoreSameBgm == nil then ignoreSameBgm = true end
    return CS_AudioManager:PlayAudio(cueName, cueSheetName, sourceType,
                                     completeEvent, ignoreSameBgm)
end

AudioManager.PlayAudioById = function(self, audioId, completeEvent,
                                      ignoreSameBgm)
    -- function num : 0_1 , upvalues : _ENV
    local cueName, cueSheetName, sourceType = ConfigData:GetAudioCfg(audioId)
    if (string.IsNullOrEmpty)(cueName) then
    ...
    return self:PlayAudio(cueName, cueSheetName, sourceType, completeEvent,
                          ignoreSameBgm)
end
...
AudioManager.SetSourceSelectorLabel =
    function(self, sourceType, selector, label)
        -- function num : 0_9 , upvalues : CS_AudioManager
        CS_AudioManager:SetSourceSelectorLabel(sourceType, selector, label)
    end
...
AudioManager.RemoveCueSheetsWithPrefix =
    function(self, prefix)
        -- function num : 0_11 , upvalues : CS_AudioManager
        CS_AudioManager:RemoveCueSheetsWithPrefix(prefix)
    end

AudioManager.SetSourceAisacControl = function(self, sourceType, controlName,
                                              value)
    -- function num : 0_12 , upvalues : CS_AudioManager
    CS_AudioManager:SetSourceAisacControl(sourceType, controlName, value)
end

AudioManager.SetBgmSourceFadeInAndOutTime =
    function(self, fadeInTime, fadeOutTime)
        -- function num : 0_13 , upvalues : CS_AudioManager
        CS_AudioManager:SetBgmSourceFadeInAndOutTime(fadeInTime, fadeOutTime)
    end
