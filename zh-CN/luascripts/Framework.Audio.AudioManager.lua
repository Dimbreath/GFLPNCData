...
AudioManager.PlayAudio = function(self, cueName, cueSheetName, sourceType, completeEvent)
  -- function num : 0_0 , upvalues : CS_AudioManager
  return CS_AudioManager:PlayAudio(cueName, cueSheetName, sourceType, completeEvent)
end
