...
bs_1021.InitSkill = function(self, isMidwaySkill)
    ...
    self:AddTrigger(eSkillTriggerType.SetHurt, "bs_1021_2", 2, self.OnSetHurt) -- DECOMPILER ERROR at PC9: Confused about usage of register: R2 in 'UnsetPending'
    ;
...
bs_1021.PlaySkill = function(self, data)
    ...
    ((self.caster).recordTable).sheildValue_1021 =
...
bs_1021.OnSetHurt = function(self, context)
    ...
    if context.target == self.caster and
        ((self.caster).recordTable).sheildValue_1021 ~= 0 then
        local realHurt = context.hurt -
                             ((self.caster).recordTable).sheildValue_1021
        if realHurt >= 0 then
            context.hurt = realHurt -- DECOMPILER ERROR at PC19: Confused about usage of register: R3 in 'UnsetPending'
            ;
            ((self.caster).recordTable).sheildValue_1021 = 0
        else
            context.hurt = 0 -- DECOMPILER ERROR at PC25: Confused about usage of register: R3 in 'UnsetPending'
            ;
            ((self.caster).recordTable).sheildValue_1021 = 0 - realHurt
        end
        if ((self.caster).recordTable).sheildValue_1021 == 0 and
