...
UIEpRoom.__ShowRoomChipPreview = function(self)
    ...
    ((self.ui).tex_MarkName):SetIndex(chipPreviewIndex) -- DECOMPILER ERROR at PC24: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.ui).img_markSD).sprite = (((self.ui).img_mark).image).sprite
end
...
UIEpRoom.ChangeUIState = function(self, eRoomState, withTween)
    ...
    if eRoomState == (ExplorationEnum.eRoomTypeState).Complete then
        if withTween then
            ...
            (((self.ui).normalNode).gameObject):SetActive(true) -- DECOMPILER ERROR at PC18: Confused about usage of register: R3 in 'UnsetPending'
            ;
            ((self.ui).normalNode).alpha = 1
            self.__normalNodeTween = ((self.ui).normalNode):DOFade(0, 0.5);
            (((self.ui).completeNode).gameObject):SetActive(true) -- DECOMPILER ERROR at PC34: Confused about usage of register: R3 in 'UnsetPending'
            ;
