...
UICarouselContainer.OnInit = function(self)
  -- function num : 0_0
end

UICarouselContainer.InitialWithData = function(self, dataList, bannerList, uiPictureIns, resLoader, selectWidth)
  -- function num : 0_1 , upvalues : _ENV, UIPictureItem
...
UICarouselContainer.InjectSelectObj = function(self, selectCountTrans, selectTrans, bannerSelectWidth)
  -- function num : 0_2
...
UICarouselContainer.OnPageIndexChanged = function(self, pageIndex)
...
UICarouselContainer.InitSelectUI = function(self)
    ...
    (self.selectCountTrans).sizeDelta = (Vector3.New)(width,
                                                      ((self.selectCountTrans).sizeDelta).y) -- DECOMPILER ERROR at PC33: Confused about usage of register: R2 in 'UnsetPending'
    ;
    (self.selectTrans).anchoredPosition3D =
        (Vector3.New)(self.bannerSelectWidth * (self.curPageNum - 1))
end
...
UICarouselContainer.OnPageIndexChanged =
    function(self, pageIndex)
        -- function num : 0_5 , upvalues : _ENV
        local page = pageIndex + 1
        self.curPageNum = page -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'
        ;
        (self.selectTrans).anchoredPosition3D =
            (Vector3.New)(self.bannerSelectWidth * (self.curPageNum - 1))
    end
