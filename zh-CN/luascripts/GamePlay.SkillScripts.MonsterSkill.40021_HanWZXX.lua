...
bs_40021.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : _ENV
    self:AddTrigger(eSkillTriggerType.SetHurt, "bs_40021_2", 1, self.OnSetHurt) -- DECOMPILER ERROR at PC9: Confused about usage of register: R2 in 'UnsetPending'
    ;
    ((self.caster).recordTable)["40021Suck"] = 0
end
        ...
        if targetlist.Count > 0 then
            ...
            do
                do
                    if ((self.caster).recordTable)["40021Suck"] > 0 then
                        local destime =
                            -((self.caster).recordTable)["40021Suck"];
                        (self.caster):AddRoleProperty(eHeroAttr.life_steal,
                                                      destime,
                                                      eHeroAttrType.Extra);
                        (self.caster):AddRoleProperty(
                            eHeroAttr.spell_life_steal, destime,
                            eHeroAttrType.Extra)
                    end
                    (self.caster):AddRoleProperty(eHeroAttr.life_steal, time,
                                                  eHeroAttrType.Extra);
                    (self.caster):AddRoleProperty(eHeroAttr.spell_life_steal,
                                                  time, eHeroAttrType.Extra) -- DECOMPILER ERROR at PC60: Confused about usage of register: R4 in 'UnsetPending'
                    ;
                    ((self.caster).recordTable)["40021Suck"] = time
                    if ((self.caster).recordTable)["40021Suck"] > 0 then
                        local destime =
