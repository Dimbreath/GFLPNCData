...
PathConsts = {
    ...
    PbFilePath = "Res/pb/",
    SkillIconPathHead = "Res/Images/SkillIcons/",
    CharacterPicPathHead = cs_PathConsts.CharacterPicPathHead,
    CharacterBigImgPrefabHead = cs_PathConsts.CharacterBigImgPrefabHead,
    FriendshipDungeonPicHead = "Res/Images/HeroStoryLevel/",
    MaterialDungeonPicHead = "Res/Images/MaterialLevel/Background/",
    OasisBuildingIconPath = "Res/Images/OasisBuilding/",
    AchievementIconPath = "Res/Images/AchievementIcon/",
    AchivLevelIconPath = "Res/Images/AchivLevelIcon/",
    MaterialDungeonBGIconPath = "Res/Images/MaterialLevel/Icon/",
    DormRoomPath = "Res/Model/Dorm/Rooms/",
    DormFntPath = "Res/Model/Dorm/Furnitures/",
    AvgImgPath = "Res/Images/Avg/",
    FormationPath = "Res/Model/Formation/",
    CampIconPath = "Res/Images/CampIcon/",
    EffectPath = "Res/Effect/Prefabs/",
    PersistentUserDataPath = cs_PathConsts.PersistentDataPath ..
        "save_data/user_data/",
    PersistentDataPath = cs_PathConsts.PersistentDataPath .. "save_data/",
    SectorBackgroundPath = "Res/Images/SectorLevel/",
    BannerPicPath = "Res/Images/HomeAdv/",
    LotteryPicPath = "Res/Images/Lottery/",
    LotteryModelPath = "Res/Model/LotteryShow/",
    SeceneIconPicPath = "Res/Images/SectorIcon/",
...
PathConsts.GetOasisBuildingEffetPrefabPath =
    function(self, resName)
        -- function num : 0_4 , upvalues : _ENV
        if (string.IsNullOrEmpty)(resName) then
            return ""
        else
            return self.OasisBuildingEffectPath .. resName ..
                       self.PrefabExtension
        end
    end
...
PathConsts.GetCharacterPicPath = function(self, resName)
    -- function num : 0_8
    return self.CharacterPicPathHead .. resName .. "/" .. "npic_" .. resName ..
               ".png"
end
...
PathConsts.GetCharacterLive2DPath = function(self, resName)
    -- function num : 0_9
    return self.CharacterPicPathHead .. resName .. "/L2D/" .. resName ..
               self.PrefabExtension
end
...
PathConsts.GetCharacterBigImgPrefabPath =
    function(self, resName)
        -- function num : 0_10
        return self.CharacterBigImgPrefabHead .. resName .. "/" .. "lpic_" ..
                   resName .. self.PrefabExtension
    end
...
PathConsts.GetCharacterSmallPicPath = function(self, resName)
    -- function num : 0_11
    return self.CharacterPicPathHead .. resName .. "/" .. "spic_" .. resName ..
               ".png"
end

-- DECOMPILER ERROR at PC90: Confused about usage of register: R1 in 'UnsetPending'

PathConsts.GetCharacterModelPrefabPath =
    function(self, prefabName)
        -- function num : 0_12
        return
            self.CharacterBigImgPrefabHead .. prefabName .. "/" .. "model_" ..
                prefabName .. self.PrefabExtension
    end

-- DECOMPILER ERROR at PC93: Confused about usage of register: R1 in 'UnsetPending'

PathConsts.GetFriendshipDungeonPicPath =
    function(self, resName)
        -- function num : 0_13
        return self.FriendshipDungeonPicHead .. "HeroStory" .. resName .. ".png"
    end
...
PathConsts.GetMaterialDungeonBGIconPath =
    function(self, resName)
        -- function num : 0_16
        return self.MaterialDungeonBGIconPath .. resName .. ".png"
    end
...
PathConsts.GetCharacterDormModelPath = function(self, prefabName)
    -- function num : 0_20
    return self.CharacterBigImgPrefabHead .. prefabName .. "/" .. "dmodel_" ..
               prefabName .. self.PrefabExtension
end
...
PathConsts.GetPersistentSystemDataPath =
