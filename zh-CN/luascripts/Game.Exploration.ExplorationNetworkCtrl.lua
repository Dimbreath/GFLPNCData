...
ExplorationNetworkCtrl.CS_EXPLORATION_Start = function(self, dungeonId, formId, moduleId, callBack)
  ...
  if not moduleId then
    ...
    if OverclockCtrl ~= nil then
      ...
      ;
      ((self.epSendStartData).ocChoice).data = OverclockCtrl.selectedOverclockOptionList
    end
...
ExplorationNetworkCtrl.SC_EXPLORATION_Settle = function(self, msg)
  ...
  do
    ...
    cs_WaitNetworkResponse:AddWaitData(proto_csmsg_MSG_ID.MSG_CS_EXPLORATION_Settle, msg.rewardsRecord)
...
ExplorationNetworkCtrl.SC_EXPLORATION_SettleFloor = function(self, msg)
  ...
  do
    ...
    cs_WaitNetworkResponse:AddWaitData(proto_csmsg_MSG_ID.MSG_CS_EXPLORATION_SettleFloor, msg.rewardsRecord)
  end
end
...
ExplorationNetworkCtrl.CS_EXPLORATION_AlgUpperLimit_Exit = function(self, position)
  ...
  cs_WaitNetworkResponse:StartWait(proto_csmsg_MSG_ID.MSG_CS_EXPLORATION_AlgUpperLimit_Exit, proto_csmsg_MSG_ID.MSG_SC_EXPLORATION_AlgUpperLimit_Exit)
end
