...
DynEpRoomData.SetMapData = function(self, map)
    ...
    do
        if self:IsBattleRoom() or self.type ==
            ...
            self.battleMap = (CS_BattleUtility.GenBattleMap)(stageCfg.size_row,
                                                             stageCfg.size_col,
                                                             stageCfg.deploy_rows) -- DECOMPILER ERROR at PC27: Confused about usage of register: R3 in 'UnsetPending'
            ;
...
DynEpRoomData.InitMonsterData = function(self, monsterGroup)
    -- function num : 0_4 , upvalues : _ENV, DynMonster, ChipData, ItemData, DynEffectGrid
    ...
    if monsterGroup.alg ~= nil then
        for k, v in ipairs(monsterGroup.alg) do
            local chipData = (ChipData.New)(v, 1) -- DECOMPILER ERROR at PC57: Confused about usage of register: R8 in 'UnsetPending'
            ;
    ...
    do
        ...
        if monsterGroup.monsterAlg ~= nil then
            for k, v in ipairs(monsterGroup.monsterAlg) do
                local chipData = (ChipData.New)(v, 1) -- DECOMPILER ERROR at PC111: Confused about usage of register: R8 in 'UnsetPending'
                ;
...
DynEpRoomData.InitTreasureRoomData = function(self, treasureGroup)
    -- function num : 0_13 , upvalues : _ENV, ChipData, ChipEnum
...
DynEpRoomData.IsBossRoom = function(self)
    -- function num : 0_33 , upvalues : ExplorationEnum
