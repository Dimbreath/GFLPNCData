...
local guideCheckFunc = {
    ...
    [eGuideCondition.InHome] = function()
        ...
        do
            return home ~= nil and not home.inShowState or
                       UIManager:GetWindow(UIWindowTypeID.Mail) == nil
        end
    ...
    [eGuideCondition.InEpTreasureRoom] = function()
        ...
        do return UIManager:GetWindow(UIWindowTypeID.TreasureRoom) ~= nil end
        -- DECOMPILER ERROR: 1 unprocessed JMP targets
    end,
...
GuideConditionChecker.CheckGuideCondition =
    function(condition_type, condition_arg)
        -- function num : 0_20 , upvalues : guideCheckFunc
