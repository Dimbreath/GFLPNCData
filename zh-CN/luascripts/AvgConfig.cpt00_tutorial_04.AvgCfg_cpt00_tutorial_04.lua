...
[2] = {
images = {
{imgId = 5, imgPath = "cpt00/cpt00_e_bg001", imgType = 4, alpha = 0, fullScreen = true}
}
, 
imgTween = {
...
[4] = {
images = {
{imgId = 9, imgPath = "croque_avg", imgType = 3, 
pos = {380, -300, 0}
, 
scale = {1.5, 1.5, 1.5}
, alpha = 0.1, order = 1}
