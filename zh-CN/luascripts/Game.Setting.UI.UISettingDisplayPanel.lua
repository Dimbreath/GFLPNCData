...
UISettingDisplayPanel.InitDisplayPanel = function(self, ctrl)
  ...
  self:InitMultiDisplayItem(resolution, (self.ui).str_Resolution, self.resolutionItemList, (self.ui).resolutionItem, resolutionCallback)
  ...
  self:InitMultiDisplayItem(textureLimit, (self.ui).str_TextureLimit, self.textureLimitItemList, (self.ui).textureLimitItem, textureLimitCallback)
  self.maxFpsItemList = {}
...
UISettingDisplayPanel.InitMultiDisplayItem = function(self, curValue, strList, ItemList, togGroup, bindEvent)
  -- function num : 0_2 , upvalues : UINDisplayTogItem
  for i = #strList, 1, -1 do
