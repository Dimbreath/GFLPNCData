...
UISettingDisplayPanel.InitDisplayPanel =
    function(self, ctrl)
        ...
        (UIUtil.AddValueChangedListener)((self.ui).tog_aa, self,
                                         self.OnAntiAliasingChanged) -- DECOMPILER ERROR at PC73: Confused about usage of register: R9 in 'UnsetPending'
        ;
        ((self.ui).tog_Shadow).isOn = displaySetting.dyn_shadow == 1 -- DECOMPILER ERROR at PC81: Confused about usage of register: R9 in 'UnsetPending'
        ;
...
UISettingDisplayPanel.InitMultiDisplayItem =
    function(self, curValue, strList, ItemList, togGroup, bindEvent)
