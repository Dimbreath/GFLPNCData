...
local eSortMannerType, SortMannerDefine =
    (table.unpack)(require("Game.Hero.SortList.HeroSortMannerHelper"))
...
UINHeroSortList.OnInit = function(self)
    ...
    (UIUtil.AddButtonListener)((self.ui).btn_Manner, self,
                               self.OnBtnSortMannerClicked);
    ...
    (UIUtil.AddButtonListener)((self.ui).btn_KindReset, self,
                               self.OnBtnKindResetClicked);
    (UIUtil.AddButtonListener)((self.ui).btn_KindConfirm, self,
                               self.OnBtnKindConfirmClicked) -- DECOMPILER ERROR at PC46: Confused about usage of register: R1 in 'UnsetPending'
    ;
    (self.ui).mannerNode =
        ((((self.ui).manner_Item).transform).parent).gameObject;
    ...
    self:__InitSortKind()
    self.heroItemDic = {}
    self.__selectHeroFunc = BindCallback(self, self.__OnHeroItemClicked) -- DECOMPILER ERROR at PC76: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).scrollView).onInstantiateItem =
        BindCallback(self, self.__OnNewItem) -- DECOMPILER ERROR at PC83: Confused about usage of register: R1 in 'UnsetPending'
    ;
...
UINHeroSortList.InitHeroSortList = function(self, resloader,
                                            refreshSelectHeroUI, conditionFunc,
                                            customSelectHero, ableNoSelect)
...
UINHeroSortList.SetInFormationHero = function(self, formationList)
    ...
    do
        self.inFormationDic = {}
        if formationList == nil then return end
        for k, heroId in pairs(formationList) do
            local heroItem = self:GetHeroItemById(heroId)
            if heroItem ~= nil then
                heroItem:SetInFormationActive(true) -- DECOMPILER ERROR at PC35: Confused about usage of register: R8 in 'UnsetPending'
                ;
...
UINHeroSortList.SetEnteredHero = function(self, stationedHeroList)
    ...
    do
        ...
        if stationedHeroList == nil then return end
        for k, heroId in pairs(stationedHeroList) do
            local heroItem = self:GetHeroItemById(heroId)
            if heroItem ~= nil then
                heroItem:SetIsWorkingActive(true) -- DECOMPILER ERROR at PC35: Confused about usage of register: R8 in 'UnsetPending'
                ;
...
UINHeroSortList.RefreshHeroList = function(self)
    ...
    if sortData == nil then sortData = SortMannerDefine[eSortMannerType.Rare] end
    local sortFunc = nil
    ...
    end -- DECOMPILER ERROR at PC80: Confused about usage of register: R4 in 'UnsetPending'
...
UINHeroSortList.__LoadHeroItemList = function(self)
    ...
    local heroCount = #self.originHeroList -- DECOMPILER ERROR at PC36: Confused about usage of register: R2 in 'UnsetPending'
    ;
...
UINHeroSortList.__InitSortManner = function(self)
    ...
    for k, v in pairs(SortMannerDefine) do
        ...
        do
            ...
            local index = k
            local sortValue = v
            local texName = (go.transform):FindComponent("Tex_Name",
                                                         eUnityComponentID.TextItemInfo)
            texName:SetIndex(index - 1)
            local btn = (go.transform):FindComponent("",
...
UINHeroSortList.OnBtnSortMannerClicked =
    function(self)
        -- function num : 0_8
        self:__SwitchMannerNodeActive(not ((self.ui).mannerNode).activeSelf)
    end

UINHeroSortList.__SwitchMannerNodeActive =
    function(self, open)
        -- function num : 0_9 , upvalues : _ENV
        if open then
            ((self.ui).mannerNode):SetActive(true) -- DECOMPILER ERROR at PC11: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).img_SortCube).color = (self.ui).color_highlight -- DECOMPILER ERROR at PC16: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).img_SortTri).color = (self.ui).color_highlight
        else

            ((self.ui).mannerNode):SetActive(false) -- DECOMPILER ERROR at PC27: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).img_SortCube).color = Color.white -- DECOMPILER ERROR at PC32: Confused about usage of register: R2 in 'UnsetPending'
            ;
...
UINHeroSortList.__InitSortKind = function(self)
    ...
    self.sortKindData = {
        [eSortKindType.Star] = {
            parent = (self.ui).kind_star,
            kindItems = {},
            selectIndexs = {},
            nocondition = true
        },
        [eSortKindType.Camp] = {
            parent = (self.ui).kind_camp,
            kindItems = {},
            selectIndexs = {},
            nocondition = true
        },
        [eSortKindType.Career] = {
            parent = (self.ui).kind_career,
            kindItems = {},
            selectIndexs = {},
            nocondition = true
        }
    ...
    for k, v in pairs(eSortKindType) do
        for i = 1, eSortKindMaxCount[v] do
            local go = ((self.ui).kind_Item):Instantiate(
                           ((self.sortKindData)[v]).parent)
            go:SetActive(true)
...
UINHeroSortList.__OnSortKindItemClicked =
    function(self, kindType, index, select)
        -- function num : 0_11
    end
...
UINHeroSortList.__SwitchSortKindNodeActive =
    function(self, open)
        -- function num : 0_13 , upvalues : _ENV
        if open then
            ((self.ui).kindNode):SetActive(true) -- DECOMPILER ERROR at PC11: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).img_KindCube).color = (self.ui).color_highlight -- DECOMPILER ERROR at PC16: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).img_KindTri).color = (self.ui).color_highlight
        else

            ((self.ui).kindNode):SetActive(false) -- DECOMPILER ERROR at PC27: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).img_KindCube).color = Color.white -- DECOMPILER ERROR at PC32: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).img_KindTri).color = Color.white
        end
    end

UINHeroSortList.OnBtnKindConfirmClicked =
    function(self)
        ...
        for k, v in pairs(eSortKindType) do
            ...
            for i = 1, eSortKindMaxCount[v] do
                ...
                end -- DECOMPILER ERROR at PC22: Confused about usage of register: R14 in 'UnsetPending'
...
UINHeroSortList.__ResetSortKindData = function(self)
    ...
    for k, v in pairs(eSortKindType) do
        for i = 1, eSortKindMaxCount[v] do
            ...
            kindItem:SetUISelectActive(false) -- DECOMPILER ERROR at PC19: Confused about usage of register: R11 in 'UnsetPending'
            ;
...
UINHeroSortList.__RefreshSortButtton = function(self)
    ...
    if self.is_ascend_order then
        ((self.ui).img_Descending).color = Color.white -- DECOMPILER ERROR at PC12: Confused about usage of register: R1 in 'UnsetPending'
        ;
        ...
        ((self.ui).img_Descending).color = (self.ui).color_highlight -- DECOMPILER ERROR at PC28: Confused about usage of register: R1 in 'UnsetPending'
        ;
        ...
        if self.ableNoSelect then
            do
                if self.selectHero ~= nil then
                    local lastHeroItem =
                        self:__GetHeroItemByData(self.selectHero)
...
UINHeroSortList.SwitchToPrevHero = function(self)
    -- function num : 0_21
    if #self.curHeroList <= 0 then return end
    if not self.selectHeroIndex then return end
    local nextIndex = 0
...
UINHeroSortList.OnUpdateHeroEvent = function(self, heroList)
    ...
    for k, v in pairs(heroList) do
        ...
        if heroItem ~= nil then
            ...
            if heroData ~= nil and (self.__conditionFunc == nil or
                (self.__conditionFunc)(heroData.dataId, heroData)) then
                (table.insert)(self.originHeroList, heroData)
            end
        end
    end
    self:RefreshHeroList()
    if self.selectHero ~= nil and heroList[(self.selectHero).dataId] ~= nil and
        self.__refreshSelectHeroUI ~= nil then
...
UINHeroSortList.__OnNewItem = function(self, go)
    ...
    heroItem:Init(go) -- DECOMPILER ERROR at PC6: Confused about usage of register: R3 in 'UnsetPending'
    ;
        ...
        do
            ...
            do
                if self.showRedDot then
                    local ok, heroNode =
                        RedDotController:GetRedDotNode(RedDotStaticTypeId.Main,
                                                       RedDotStaticTypeId.HeroWindow,
                                                       heroData.dataId)
                    heroItem:SetRedDotActive(
                        not ok or heroNode:GetRedDotCount() > 0)
                end
...
UINHeroSortList.__GetHeroItemGoByIndex =
    function(self, index)
        -- function num : 0_29
