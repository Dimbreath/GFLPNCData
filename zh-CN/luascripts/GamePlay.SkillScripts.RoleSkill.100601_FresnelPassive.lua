...
bs_1037.config = {buffId = 117, audioId1 = 32, buffId2 = 50}
...
bs_1037.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddSelfTrigger(eSkillTriggerType.SetHurt, "bs_1037_2", 1, self.OnSetHurt)
end
...
bs_1037.OnSetHurt = function(self, context)
  ...
  if context.target == self.caster and self:IsReadyToTake() and context.hurt ~= 0 then
    ...
    if grid ~= nil then
      ...
      LuaSkillCtrl:CallBuff(self, self.caster, (self.config).buffId2, 1, 15, true)
