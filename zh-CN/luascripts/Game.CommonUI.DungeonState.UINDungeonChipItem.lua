...
UINDungeonChipItem.InitChipItem =
    function(self, chipData, index, selectCallback)
        -- function num : 0_1
        self.chipData = chipData
        self.index = index
        self.selectCallback = selectCallback;
...
UINDungeonChipItem.OnItemClick = function(self)
    -- function num : 0_2
    if self.selectCallback ~= nil then (self.selectCallback)(self.index) end
end
...
UINDungeonChipItem.SetDungeonChipItemShowAlpha =
    function(self, alpha)
        -- function num : 0_5
        self.__showAlpha = alpha -- DECOMPILER ERROR at PC3: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ((self.ui).canvasGroup).alpha = alpha
    end

UINDungeonChipItem.GetChipItemWorldPos =
    function(self)
        -- function num : 0_6
        return ((self.chipItem).transform).position
    end
