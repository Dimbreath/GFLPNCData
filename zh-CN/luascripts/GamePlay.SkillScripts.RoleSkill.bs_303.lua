...
bs_303.config = {buffId1 = 135, buffId2 = 66, effectId3 = 10134, effectId2 = 10135, effectId1 = 10136, effectId0 = 10090}
...
bs_303.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddSelfTrigger(eSkillTriggerType.SetHurt, "bs_303_1", 1, self.OnSetHurt)
end
...
bs_303.OnSetHurt = function(self, context)
  ...
  if (self.caster):GetBuffTier((self.config).buffId1) ~= 0 and context.target == self.caster and context.hurt > 0 and LuaSkillCtrl:CallRange(1, 1000) <= (self.arglist)[3] then
    LuaSkillCtrl:CallEffectWithArg(context.sender, (self.config).effectId0, self, true, self.SkillEventFunc, context)
    context.hurt = 0
    ...
    if ((self.caster).recordTable)["303_HD"] == 2 and self.Effect_303_3 ~= nil then
