...
eHeroAttr = {hp = 1, maxHp = 2, pow = 3, def = 4, speed = 5, hit = 6, dodge = 7, move_speed = 8, crit = 9, crit_damage = 10, lucky = 11, sunder = 12, true_damage = 13, resistance = 14, battleEnd_hp_regen = 15, attack_range = 16, life_steal = 17, spell_life_steal = 18, damage_increase = 19, injury_reduce = 20, heal = 21, treatment = 22, cd_reduce = 23, return_damage = 24, hp_regen = 25, skill_intensity = 26}
...
eSkillTriggerType = {
    ...
    BeforePlaySkill = 11,
    AfterPlaySkill = 12,
    BeforeTargetSelect = 13,
    HurtResultStart = 14,
    HealResultStart = 15,
    AfterSelfUltEffectEnd = 16,
    AfterSelfUltInTimeLineEnd = 17,
    AfterSelfUltOutTimeLineEnd = 18,
    AfterSelfUltMovieEnd = 19,
    OnSelfUltMovieFadeOut = 25,
    StartSelfUltRoleAction = 20,
    OnBreakSkill = 21,
    OnBattleEnd = 22,
    BeforeBattleEnd = 26,
    OnSelfAttrChanged = 23,
    OnSelfAfterMove = 24
}
eSkillLuaTrigger = {OnDoodad = 1, OnSheldBroken = 2}
eBattleEffectEvent = {Create = 0, Trigger = 1, Arrive = 2, Die = 3}
