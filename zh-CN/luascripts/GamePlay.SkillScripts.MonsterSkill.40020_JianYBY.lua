...
bs_40020.config = {buffId = 1012, attackdelay = 15}
...
bs_40020.CallBack = function(self)
  ...
  LuaSkillCtrl:CallBuff(self, self.caster, (self.config).buffId, (self.arglist)[3])
end
...
bs_40020.InitSkill = function(self, isMidwaySkill)
    -- function num : 0_1 , upvalues : _ENV
    self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_40020_1", 1,
