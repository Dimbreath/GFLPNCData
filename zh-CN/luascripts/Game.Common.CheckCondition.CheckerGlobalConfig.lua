...
local CheckerGlobalConfig = {
    ...
    [CheckerTypeId.CompleteStage] = {
        Checker = require(
            "Game.Common.CheckCondition.Checker.CheckerSectorStage")
    },
    ...
    [CheckerTypeId.FrienshipLevel] = {
        Checker = require(
            "Game.Common.CheckCondition.Checker.CherkerFriendshipLevel")
    },
    [CheckerTypeId.CompleteDungeon] = {
        Checker = require(
            "Game.Common.CheckCondition.Checker.CherkerGeneralDungeon")
    },
    ...
    [CheckerTypeId.InfinityDungeon] = {
        Checker = require(
            "Game.Common.CheckCondition.Checker.CheckerInfinityDungeon")
    }
}
