...
local CheckerTypeId = {PlayerLevel = 1, CompleteTask = 2, CompleteStage = 3, BuildingLevel = 4, FunctionUnlock = 5, FrienshipLevel = 6, CompleteDungeon = 7, CompleteAvg = 8, MinHeroStar = 9, MaxHeroStar = 10, InfinityDungeon = 11}
