...
bs_40008.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_40008_1", 1, self.OnAfterBattleStart)
...
bs_40008.OnAfterBattleStart = function(self)
  ...
  self.damTimer = LuaSkillCtrl:StartTimer(self, (self.arglist)[1], self.CallBack, self, -1)
end

bs_40008.CallBack = function(self)
  -- function num : 0_3 , upvalues : _ENV
  LuaSkillCtrl:CallHeal(20 * ((self.caster).recordTable).healTime, self, self.caster)
  LuaSkillCtrl:CallEffect(self.caster, (self.config).healEffectId, self)
  -- DECOMPILER ERROR at PC22: Confused about usage of register: R1 in 'UnsetPending'

  ;
  ((self.caster).recordTable).healTime = ((self.caster).recordTable).healTime + 1
end
