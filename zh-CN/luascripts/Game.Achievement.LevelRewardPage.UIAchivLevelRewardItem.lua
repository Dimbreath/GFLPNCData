...
UIAchivLevelRewardItem.OnInit = function(self)
  ...
  self.levelRewardItemPool = (UIItemPool.New)(UICommonItem, (self.ui).rewardItem)
end

UIAchivLevelRewardItem.RefreshLevelRewardItem = function(self, level, picked, getRewardEvent)
...
UIAchivLevelRewardItem.OnClickGetReward = function(self)
