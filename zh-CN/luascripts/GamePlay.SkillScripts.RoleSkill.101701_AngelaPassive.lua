...
bs_1056.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddSelfTrigger(eSkillTriggerType.AfterHurt, "bs_1056_3", 1, self.OnAfterHurt)
end

bs_1056.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg, isTriggerSet)
  -- function num : 0_2 , upvalues : _ENV
  -- DECOMPILER ERROR at PC31: Unhandled construct in 'MakeBoolean' P1

  -- DECOMPILER ERROR at PC31: Unhandled construct in 'MakeBoolean' P1

  if sender == self.caster and skill.isCommonAttack and not isMiss and (self.arglist)[3] > 0 and LuaSkillCtrl:CallRange(1, 1000) <= (self.arglist)[1] * 2 then
