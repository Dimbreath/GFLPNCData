...
UINFactoryLineItem.InitLineItem = function(self, itemCfg, itemNum, isProduce, uiFactory)
  -- function num : 0_1 , upvalues : _ENV
  if not isProduce then
    isProduce = false
  end
  ...
  ;
  ((self.ui).tex_Count):SetIndex(0, (LanguageUtil.GetLocaleText)((self.itemCfg).name), tostring(self.itemNum))
end

UINFactoryLineItem.SetHightlightActive = function(self, active)
  -- function num : 0_2
