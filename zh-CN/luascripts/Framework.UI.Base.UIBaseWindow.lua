...
UIBaseWindow.AlignToFakeCamera = function(self, camera)
    ...
    local cs_UIManager = (CS.UIManager).Instance
    if self.canvas == nil then
        self.canvas = (camera.transform):GetComponentInChildren(
                          typeof(cs_Canvas))
    end
    local canvasScale = (self.canvas):FindComponent(
                            eUnityComponentID.CanvasScaler) -- DECOMPILER ERROR at PC19: Confused about usage of register: R4 in 'UnsetPending'
    ;
    (self.canvas).worldCamera = camera -- DECOMPILER ERROR at PC22: Confused about usage of register: R4 in 'UnsetPending'
    ;
    (self.canvas).renderMode = cs_ScreenSpaceCamera
    cs_UIManager:AdaptationCanvasScaler(canvasScale, true);
    (self.transform):SetParent((self.canvas).transform, false);
    (cs_Canvas.ForceUpdateCanvases)() -- DECOMPILER ERROR at PC37: Confused about usage of register: R4 in 'UnsetPending'
    ;
    (self.canvas).renderMode = cs_WorldSpace -- DECOMPILER ERROR at PC43: Confused about usage of register: R4 in 'UnsetPending'
    ;
    (self.canvas).worldCamera = ((CS.UnityEngine).Camera).main
    cs_UIManager:SetNotchTransfrom(self.transform)
end
...
UIBaseWindow.OnShow = function(self)
    ...
    if self.__typeID ~= nil then
        ...
        if animaType == EUIAnimaType.Fade then
            ((self.ui).canvasGroup).alpha = 0;
            (((self.ui).canvasGroup):DOFade(1, 0.8)):SetEase(
                (((CS.DG).Tweening).Ease).OutExpo)
        else
            -- DECOMPILER ERROR at PC34: Confused about usage of register: R2 in 'UnsetPending'
            ...
            if animaType == EUIAnimaType.FadeScaleUp then
                ((self.ui).canvasGroup).alpha = 0;
                (((self.ui).canvasGroup):DOFade(1, 0.8)):SetEase(
                    (((CS.DG).Tweening).Ease).OutExpo) -- DECOMPILER ERROR at PC55: Confused about usage of register: R2 in 'UnsetPending'
                ;
                (self.transform).localScale = (Vector3.New)(0.9, 0.9, 0.9);
                ((self.transform):DOScale(1, 0.8)):SetEase(
                    (((CS.DG).Tweening).Ease).OutExpo)
            else
                -- DECOMPILER ERROR at PC80: Confused about usage of register: R2 in 'UnsetPending'
...
UIBaseWindow.SwitchFakeCanvasScreen = function(self)
    -- function num : 0_5 , upvalues : cs_ScreenSpaceCamera
    if self.canvas == nil then return end -- DECOMPILER ERROR at PC6: Confused about usage of register: R1 in 'UnsetPending'
