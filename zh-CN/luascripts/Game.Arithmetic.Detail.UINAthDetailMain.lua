...
UINAthDetailMain.InitAthDetailNode = function(self, athData, efficiency, heroId,
...
UINAthDetailMain.__RefreshSuit = function(self, athData, heroId)
    ...
    if suitAthList ~= nil then
        ...
        for k, athId in ipairs(suitAthList) do
            ...
            local installed = (PlayerDataCenter.allAthData):HeroContainAthById(
                                  heroId, slotId, athId)
...
UINAthDetailMain.OnClickReplace = function(self)
    -- function num : 0_4
    if self.replaceEvent ~= nil then (self.replaceEvent)() end
end
