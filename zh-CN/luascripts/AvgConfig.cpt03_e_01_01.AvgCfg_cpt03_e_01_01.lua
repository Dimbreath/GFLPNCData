...
, 
{imgId = 101, imgType = 3, alpha = 0, imgPath = "phus_avg"}
, 
...
audio = {
bgm = {cue = "Mus_Story_Relax", sheet = "Music", fadeIn = 2, fadeOut = 4}
}
}
, 
...
, 
[21] = {content = 210, contentType = 3, speakerHeroId = 23, speakerHeroPosId = 1}
, 
[22] = {
imgTween = {
{imgId = 101, isDark = false}
...
local AvgCfg_cpt03_e_01_01 = {
    ...
    [2] = {
        imgTween = {
            {imgId = 101, isDark = true}, {imgId = 104, posId = 5},
            {imgId = 104, duration = 0.5, posId = 4}
        },
        content = 20,
        contentType = 3,
    ...
    [3] = {
        imgTween = {{imgId = 101, isDark = false}, {imgId = 104, isDark = true}},
        content = 30,
        contentType = 3,
        speakerHeroId = 24,
        speakerHeroPosId = 1,
    ...
    [4] = {
        imgTween = {{imgId = 101, isDark = true}, {imgId = 104, isDark = false}},
        content = 40,
        contentType = 3,
        speakerHeroId = 25,
        speakerHeroPosId = 3
    ...
    [5] = {
        ...
        contentType = 4,
        speakerName = 12,
        audio = {sfx = {cue = "Skill_Hubble_Ex_Cast", sheet = "Chara_Hubble"}}
    },
    [6] = {
        imgTween = {
            {imgId = 97, duration = 2, shake = true},
    ...
    [14] = {
        imgTween = {{imgId = 101, isDark = false}, {imgId = 102, isDark = true}},
        content = 140,
        contentType = 3,
        speakerHeroId = 24,
        speakerHeroPosId = 1
    ...
    [16] = {
        imgTween = {{imgId = 104, posId = 3, isDark = false, duration = 0.5}},
        content = 160,
        contentType = 3,
        speakerHeroId = 25,
        speakerHeroPosId = 2
    ...
    [19] = {
        ...
        speakerHeroId = 24,
        speakerHeroPosId = 3,
        audio = {sfx = {cue = "AVG_Door_Open_Close", sheet = "AVG_gf"}}
    },
    [20] = {
        imgTween = {
            {imgId = 101, isDark = true}, {imgId = 103, posId = 1},
            {imgId = 103, duration = 0.2, posId = 2}
        },
        content = 200,
        contentType = 3,
    ...
    [25] = {
        imgTween = {{imgId = 102, isDark = true}, {imgId = 103, isDark = false}},
        content = 250,
        contentType = 3,
        speakerHeroId = 23,
        speakerHeroPosId = 1
    ...
    [49] = {
        imgTween = {{imgId = 103, duration = 0.1, shake = true}},
        content = 490,
        contentType = 3,
        speakerHeroId = 23,
        speakerHeroPosId = 1
    ...
    [56] = {
        imgTween = {
            {imgId = 96, duration = 0.5, alpha = 0},
            {imgId = 94, duration = 0.5, alpha = 1}, {imgId = 101, alpha = 0},
            {imgId = 103, alpha = 0}
        },
        content = 560,
        contentType = 2,
        audio = {sfx = {cue = "AVG_Crowd_Run", sheet = "AVG_gf", audioId = 1}}
    },
    [57] = {
        imgTween = {
            {imgId = 96, duration = 0.5, alpha = 1},
            {imgId = 94, duration = 0.5, alpha = 0}, {imgId = 101, alpha = 1},
            {imgId = 103, alpha = 1, isDark = true}
        },
        content = 570,
        contentType = 3,
    ...
    [62] = {
        imgTween = {
            {imgId = 101, duration = 1, pos = {-250, -300, 0}},
            {imgId = 101, delay = 1, duration = 0.1, pos = {-251, -300, 0}},
            {
                imgId = 101,
                delay = 1.5,
                duration = 0.2,
                pos = {-500, -300, 0},
                alpha = 0
            }, {imgId = 103, alpha = 1, pos = {-400, -350, 0}, isDark = false},
            {imgId = 103, delay = 1.1, duration = 0.3, shake = true},
            {
                imgId = 103,
                delay = 1.5,
    ...
    [73] = {
        imgTween = {
            {imgId = 5, duration = 0.2, pos = {0, -300, 0}, isDark = false},
            {imgId = 1, duration = 0.2, posId = 1}
        },
        content = 730,
        contentType = 3,
