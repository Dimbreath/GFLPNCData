...
[3] = {}
  ...
  for unlocklevel,skillCfgs in pairs(unlockSkillCfg) do
    for skillId,skillCfg in pairs(skillCfgs) do
      local commanderSkillData = (CommanderSkillData.New)(skillId, unlocklevel)
      commanderSkillData.type = skillCfg.skill_type
      commanderSkillData.isUnlock = unlocklevel <= self.level
      commanderSkillData.place = skillCfg.place
...
CommanderSkillTreeData.__SortActiveSkill = function(self)
  -- function num : 0_9 , upvalues : _ENV
  for place,list in ipairs(self.slotSkillOverloadList) do
    (table.sort)(list, function(id1, id2)
    -- function num : 0_9_0 , upvalues : self
    local unlockLevel1 = ((self.commanderSkillDataDic)[id1]).unlockLevel
    local unlockLevel2 = ((self.commanderSkillDataDic)[id2]).unlockLevel
    if id1 >= id2 then
