...
UIHeroLevelUp.CheckItemUse = function(self)
  -- function num : 0_10 , upvalues : _ENV
  local heroMaxLevel = (PlayerDataCenter.playerBonus):GetHeroLevelCeiling()
  do return self.level < heroMaxLevel end
...
UIHeroLevelUp.CalAndShowExpBar = function(self, level, curExp, addExp)
    ...
    if (curExp) + (addExp) < requireExp then
        ...
        end -- DECOMPILER ERROR at PC111: Confused about usage of register: R8 in 'UnsetPending'
...
UIHeroLevelUp.RefreshConfirmBtn = function(self)
    ...
    ((self.ui).img_StarUp).color = (self.ui).color_gray -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'
    ;
    ((self.ui).btn_StarUp).interactable = false
    local isSelect = false
    if (table.count)(self.growupItemNums) ~= 0 then
    ...
    do
        ...
        if isSelect then
            ((self.ui).img_StarUp).color = (self.ui).color_orange -- DECOMPILER ERROR at PC33: Confused about usage of register: R2 in 'UnsetPending'
            ;
            ((self.ui).btn_StarUp).interactable = true
        end
        (((self.ui).img_ClearSelect).gameObject):SetActive(isSelect)
