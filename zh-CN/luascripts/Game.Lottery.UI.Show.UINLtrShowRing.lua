...
UINLtrShowRing.InitLtrShowRing = function(self, pos, color)
    -- function num : 0_1 , upvalues : _ENV
    self:__ClearFadeTween() -- DECOMPILER ERROR at PC3: Confused about usage of register: R3 in 'UnsetPending'
    ;
    (self.transform).anchoredPosition = pos -- DECOMPILER ERROR at PC7: Confused about usage of register: R3 in 'UnsetPending'
    ;
    (self.transform).sizeDelta = Vector2.zero -- DECOMPILER ERROR at PC10: Confused about usage of register: R3 in 'UnsetPending'
    ;
    ((self.ui).img).color = color
end
...
UINLtrShowRing.LtrShowRingFade = function(self)
    -- function num : 0_3
    if self.fadeTween ~= nil then return end
    self.fadeTween = (((self.ui).img):DOFade(0, 1)):OnComplete(
                         function()
            -- function num : 0_3_0 , upvalues : self
            self:__ClearFadeTween()
        end)
