...
bs_1064.OnAttackTrigger = function(self)
  ...
  do
    ...
    LuaSkillCtrl:DispelBuff(self.caster, 70, 1, true)
...
bs_1064.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, isRealDmg, isTriggerSet)
  -- function num : 0_4 , upvalues : _ENV
  if isMiss and target.roleType == 1 and target:GetBuffTier((self.config).buffId1) > 0 then
    LuaSkillCtrl:CallBuff(self, target, (self.config).buffId2, 1, (self.arglist)[5], true)
  end
end
