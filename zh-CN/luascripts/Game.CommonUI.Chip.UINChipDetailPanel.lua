...
UINChipDetailPanel.InitChipDetailPanel =
    function(self, index, chipData, dynPlayer, resloader, clickEvent,
             isHideNxtLvlInfo, powerType, isOwnData)
        -- function num : 0_1
        self.index = index
        self.__chipData = chipData
        self.__clickEvent = clickEvent
...
UINChipDetailPanel.__InitChipHeadInfo = function(self, chipData)
    ...
    ((self.ui).img_QualityIcon):SetIndex(chipData:GetQuality()) -- DECOMPILER ERROR at PC42: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).img_Mark).sprite = CRH:GetSprite(
                                      eChipCornerSprite[chipData:GetMarkIconIndex()],
                                      CommonAtlasType.ExplorationIcon) -- DECOMPILER ERROR at PC47: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).tex_ChipName).text = chipData:GetName() -- DECOMPILER ERROR at PC52: Confused about usage of register: R4 in 'UnsetPending'
    ;
    ((self.ui).tex_ChipIntro).text = chipData:GetChipInfo()
    local chipItem = (UINChipItem.New)()
    chipItem:Init((self.ui).chipItem)
...
UINChipDetailPanel.__InitChipEffectInfo =
    function(self, chipData, dynPlayer, isHideNxtLvlInfo, powerType, isOwnData)
        -- function num : 0_4 , upvalues : _ENV
        local chipCfg = chipData:GetChipCfg()
        local haveNum = 0
        do
                                                            ...
                                                            if powerType ==
                                                                ...
                                                                ((self.ui).tex_Power):SetIndex(
                                                                    ...
                                                                    GetPreciseDecimalStr(
                                                                        ...
                                                                        1))
                                                            elseif powerType ==
                                                                eChipDetailPowerType.Subtract then
                                                                ((self.ui).obj_Power):SetActive(
                                                                    true)
                                                                self.fightPower =
                                                                    dynPlayer:GetChipOriginFightPower(
                                                                        chipData) *
                                                                        100;
                                                                ((self.ui).tex_Power):SetIndex(
                                                                    1,
...
UINChipDetailPanel.ShowHeroHeadOrTacticActive =
...
UINChipDetailPanel.SetTacticNodeActive =
    function(self, active)
        -- function num : 0_8
        if (self.ui).tacticNode ~= nil then
            ((self.ui).tacticNode):SetActive(active)
