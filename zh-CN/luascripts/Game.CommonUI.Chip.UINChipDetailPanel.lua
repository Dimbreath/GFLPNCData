...
UINChipDetailPanel.InitChipDetailPanel = function(self, index, chipData, dynPlayer, resloader, clickEvent, isHideNxtLvlInfo, isHidePower, isOwnData)
  -- function num : 0_1
  self.index = index
  ...
  self:__InitChipEffectInfo(chipData, dynPlayer, isHideNxtLvlInfo, isHidePower, isOwnData)
end
...
UINChipDetailPanel.__InitChipEffectInfo = function(self, chipData, dynPlayer, isHideNxtLvlInfo, isHidePower, isOwnData)
                        ...
                        do
                          ...
                          if dynPlayer ~= nil then
                            ...
                            if not isHidePower then
                              ...
                              ;
                              ((self.ui).tex_Power):SetIndex(0, GetPreciseDecimalStr(dynPlayer:GetChipCombatEffect(chipData, isOwnData) * 100, 1))
                            else
