...
UISectorTaskAchiveItem.InitSectorTaskAchiveItem =
    function(self, achiveCfg, clickAction)
        -- function num : 0_1 , upvalues : _ENV
        self.achivCfg = achiveCfg
        self.id = achiveCfg.id
        self.__onClickAction = clickAction
        self.starCount = (achiveCfg.conditionNums)[1] -- DECOMPILER ERROR at PC12: Confused about usage of register: R3 in 'UnsetPending'
        ;
        ...
        if itemCfg == nil then
            ...
            return
        end -- DECOMPILER ERROR at PC34: Confused about usage of register: R5 in 'UnsetPending'
...
UISectorTaskAchiveItem.UpdateSectorAchivItem =
    function(self, state)
        -- function num : 0_3 , upvalues : SectorEnum
        self.state = state -- DECOMPILER ERROR at PC3: Confused about usage of register: R2 in 'UnsetPending'
        ;
        ...
        if state == (SectorEnum.eSectorAchivState).Normal then
            ...
            if state == (SectorEnum.eSectorAchivState).Completed then
                ...
                ((self.ui).obj_Accomplish):SetActive(true) -- DECOMPILER ERROR at PC46: Confused about usage of register: R2 in 'UnsetPending'
                ;
...
UISectorTaskAchiveItem.__onBtnClick = function(self)
    -- function num : 0_4
    if self.__onClickAction ~= nil then (self.__onClickAction)(self.id) end
end
