...
local UINCSTDetail_SkillNodeItem = class("UINCSTDetail_SkillNodeItem", UIBaseNode)
...
UINCSTDetail_SkillNodeItem.OnInit = function(self)
  ...
  ;
  (((self.ui).btn_skillItem).onPress):AddListener(BindCallback(self, self.__OnSkillLongPress))
  ;
  (((self.ui).btn_skillItem).onPressUp):AddListener(BindCallback(self, self.__OnSkillPressUp))
end
...
UINCSTDetail_SkillNodeItem.InitItem = function(self, skillData, resloader)
  ...
  if skillData.isUnlock then
    ...
    ;
    ((self.ui).img_skillItem).color = (self.ui).color_unlocked
    -- DECOMPILER ERROR at PC47: Confused about usage of register: R3 in 'UnsetPending'

    ;
    ((self.ui).tex_unlockLevel).color = Color.white
    ...
    ;
    ((self.ui).img_skillItem).color = (self.ui).color_locked
    -- DECOMPILER ERROR at PC83: Confused about usage of register: R3 in 'UnsetPending'

    ;
    ((self.ui).tex_unlockLevel).color = Color.black
...
UINCSTDetail_SkillNodeItem.SetFloatCallback = function(self, ShowSkillDescription, HideBuffDetail)
  -- function num : 0_2
  self.showDesCallback = ShowSkillDescription
  self.hideDesCallback = HideBuffDetail
end

UINCSTDetail_SkillNodeItem.__OnSkillLongPress = function(self)
  -- function num : 0_3
...
UINCSTDetail_SkillNodeItem.__OnSkillPressUp = function(self)
  -- function num : 0_4
  if self.hideDesCallback ~= nil then
    (self.hideDesCallback)()
  end
end
